/** dino_module_3939 — obstacle_spawn extended, humanized desktop */
export interface In3939{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3939{y:number;vy:number;sc:number}
const C3939={g:0.6, j:11};
export function extraRender_3939(inp:In3939, dt:number):Out3939 {
...
export const mm3939={d:'obstacle_spawn'};