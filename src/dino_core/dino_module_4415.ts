/** dino_module_4415 — obstacle_spawn extended, humanized desktop */
export interface In4415{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4415{y:number;vy:number;sc:number}
const C4415={g:0.5, j:12};
export function extraRender_4415(inp:In4415, dt:number):Out4415 {
...
export const mm4415={d:'obstacle_spawn'};