/** dino_module_4454 — dino_physics_jump extended, humanized desktop */
export interface In4454{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4454{y:number;vy:number;sc:number}
const C4454={g:0.8, j:12};
export function extraSpawn_4454(inp:In4454, dt:number):Out4454 {
...
export const mm4454={d:'dino_physics_jump'};