/** dino_module_3887 — score_speed extended, humanized desktop */
export interface In3887{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3887{y:number;vy:number;sc:number}
const C3887={g:0.6, j:12};
export function extraSpawn_3887(inp:In3887, dt:number):Out3887 {
...
export const mm3887={d:'score_speed'};