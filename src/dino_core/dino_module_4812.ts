/** dino_module_4812 — score_speed extended, humanized desktop */
export interface In4812{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4812{y:number;vy:number;sc:number}
const C4812={g:0.6, j:12};
export function extraPhysics_4812(inp:In4812, dt:number):Out4812 {
...
export const mm4812={d:'score_speed'};