/** dino_module_4998 — particle_fx extended, humanized desktop */
export interface In4998{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4998{y:number;vy:number;sc:number}
const C4998={g:0.5, j:12};
export function extraPhysics_4998(inp:In4998, dt:number):Out4998 {
...
export const mm4998={d:'particle_fx'};