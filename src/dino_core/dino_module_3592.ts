/** dino_module_3592 — score_speed extended, humanized desktop */
export interface In3592{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3592{y:number;vy:number;sc:number}
const C3592={g:0.7, j:11};
export function extraRender_3592(inp:In3592, dt:number):Out3592 {
...
export const mm3592={d:'score_speed'};