/** dino_module_3187 — parallax_bg extended, humanized desktop */
export interface In3187{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3187{y:number;vy:number;sc:number}
const C3187={g:0.5, j:13};
export function extraRender_3187(inp:In3187, dt:number):Out3187 {
...
export const mm3187={d:'parallax_bg'};