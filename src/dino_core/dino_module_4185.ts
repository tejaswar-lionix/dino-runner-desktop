/** dino_module_4185 — particle_fx extended, humanized desktop */
export interface In4185{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4185{y:number;vy:number;sc:number}
const C4185={g:0.6, j:11};
export function extraRender_4185(inp:In4185, dt:number):Out4185 {
...
export const mm4185={d:'particle_fx'};