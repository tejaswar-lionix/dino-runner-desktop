/** dino_module_4701 — parallax_bg extended, humanized desktop */
export interface In4701{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4701{y:number;vy:number;sc:number}
const C4701={g:0.5, j:11};
export function extraSpawn_4701(inp:In4701, dt:number):Out4701 {
...
export const mm4701={d:'parallax_bg'};