/** dino_module_4461 — dino_physics_jump extended, humanized desktop */
export interface In4461{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4461{y:number;vy:number;sc:number}
const C4461={g:0.5, j:13};
export function extraSpawn_4461(inp:In4461, dt:number):Out4461 {
...
export const mm4461={d:'dino_physics_jump'};