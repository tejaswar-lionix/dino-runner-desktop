/** dino_module_3449 — parallax_bg extended, humanized desktop */
export interface In3449{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3449{y:number;vy:number;sc:number}
const C3449={g:0.5, j:12};
export function extraRender_3449(inp:In3449, dt:number):Out3449 {
...
export const mm3449={d:'parallax_bg'};