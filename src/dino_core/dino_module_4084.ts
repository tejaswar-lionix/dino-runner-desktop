/** dino_module_4084 — score_speed extended, humanized desktop */
export interface In4084{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4084{y:number;vy:number;sc:number}
const C4084={g:0.6, j:12};
export function extraRender_4084(inp:In4084, dt:number):Out4084 {
...
export const mm4084={d:'score_speed'};