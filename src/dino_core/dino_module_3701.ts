/** dino_module_3701 — obstacle_spawn extended, humanized desktop */
export interface In3701{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3701{y:number;vy:number;sc:number}
const C3701={g:0.5, j:13};
export function extraSpawn_3701(inp:In3701, dt:number):Out3701 {
...
export const mm3701={d:'obstacle_spawn'};