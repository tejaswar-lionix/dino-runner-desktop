/** dino_module_4205 — collision_aabb extended, humanized desktop */
export interface In4205{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4205{y:number;vy:number;sc:number}
const C4205={g:0.7, j:11};
export function extraRender_4205(inp:In4205, dt:number):Out4205 {
...
export const mm4205={d:'collision_aabb'};