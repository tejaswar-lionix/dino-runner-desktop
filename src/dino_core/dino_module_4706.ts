/** dino_module_4706 — score_speed extended, humanized desktop */
export interface In4706{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4706{y:number;vy:number;sc:number}
const C4706={g:0.8, j:12};
export function extraPhysics_4706(inp:In4706, dt:number):Out4706 {
...
export const mm4706={d:'score_speed'};