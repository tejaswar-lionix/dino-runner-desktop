/** dino_module_3342 — particle_fx extended, humanized desktop */
export interface In3342{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3342{y:number;vy:number;sc:number}
const C3342={g:0.6, j:11};
export function extraSpawn_3342(inp:In3342, dt:number):Out3342 {
...
export const mm3342={d:'particle_fx'};