/** dino_module_3740 — obstacle_spawn extended, humanized desktop */
export interface In3740{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3740{y:number;vy:number;sc:number}
const C3740={g:0.6, j:13};
export function extraRender_3740(inp:In3740, dt:number):Out3740 {
...
export const mm3740={d:'obstacle_spawn'};