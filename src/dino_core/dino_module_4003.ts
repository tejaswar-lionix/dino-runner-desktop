/** dino_module_4003 — dino_physics_jump extended, humanized desktop */
export interface In4003{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4003{y:number;vy:number;sc:number}
const C4003={g:0.5, j:11};
export function extraPhysics_4003(inp:In4003, dt:number):Out4003 {
...
export const mm4003={d:'dino_physics_jump'};