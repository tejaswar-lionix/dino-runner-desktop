/** dino_module_3607 — collision_aabb extended, humanized desktop */
export interface In3607{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3607{y:number;vy:number;sc:number}
const C3607={g:0.5, j:11};
export function extraSpawn_3607(inp:In3607, dt:number):Out3607 {
...
export const mm3607={d:'collision_aabb'};