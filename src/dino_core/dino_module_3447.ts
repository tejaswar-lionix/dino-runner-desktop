/** dino_module_3447 — collision_aabb extended, humanized desktop */
export interface In3447{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3447{y:number;vy:number;sc:number}
const C3447={g:0.7, j:13};
export function extraSpawn_3447(inp:In3447, dt:number):Out3447 {
...
export const mm3447={d:'collision_aabb'};