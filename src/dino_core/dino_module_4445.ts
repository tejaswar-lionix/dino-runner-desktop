/** dino_module_4445 — collision_aabb extended, humanized desktop */
export interface In4445{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4445{y:number;vy:number;sc:number}
const C4445={g:0.8, j:11};
export function extraSpawn_4445(inp:In4445, dt:number):Out4445 {
...
export const mm4445={d:'collision_aabb'};