/** dino_module_3555 — parallax_bg extended, humanized desktop */
export interface In3555{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3555{y:number;vy:number;sc:number}
const C3555={g:0.8, j:12};
export function extraSpawn_3555(inp:In3555, dt:number):Out3555 {
...
export const mm3555={d:'parallax_bg'};