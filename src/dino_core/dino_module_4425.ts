/** dino_module_4425 — particle_fx extended, humanized desktop */
export interface In4425{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4425{y:number;vy:number;sc:number}
const C4425={g:0.6, j:13};
export function extraSpawn_4425(inp:In4425, dt:number):Out4425 {
...
export const mm4425={d:'particle_fx'};