/** dino_module_4830 — parallax_bg extended, humanized desktop */
export interface In4830{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4830{y:number;vy:number;sc:number}
const C4830={g:0.7, j:11};
export function extraRender_4830(inp:In4830, dt:number):Out4830 {
...
export const mm4830={d:'parallax_bg'};