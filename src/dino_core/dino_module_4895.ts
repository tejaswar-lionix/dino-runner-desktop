/** dino_module_4895 — obstacle_spawn extended, humanized desktop */
export interface In4895{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4895{y:number;vy:number;sc:number}
const C4895={g:0.6, j:12};
export function extraPhysics_4895(inp:In4895, dt:number):Out4895 {
...
export const mm4895={d:'obstacle_spawn'};