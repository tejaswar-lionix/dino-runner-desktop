/** dino_module_4856 — collision_aabb extended, humanized desktop */
export interface In4856{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4856{y:number;vy:number;sc:number}
const C4856={g:0.7, j:11};
export function extraSpawn_4856(inp:In4856, dt:number):Out4856 {
...
export const mm4856={d:'collision_aabb'};