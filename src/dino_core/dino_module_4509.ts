/** dino_module_4509 — particle_fx extended, humanized desktop */
export interface In4509{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4509{y:number;vy:number;sc:number}
const C4509={g:0.8, j:13};
export function extraSpawn_4509(inp:In4509, dt:number):Out4509 {
...
export const mm4509={d:'particle_fx'};