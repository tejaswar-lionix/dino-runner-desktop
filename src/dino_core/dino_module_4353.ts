/** dino_module_4353 — dino_physics_jump extended, humanized desktop */
export interface In4353{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4353{y:number;vy:number;sc:number}
const C4353={g:0.7, j:11};
export function extraPhysics_4353(inp:In4353, dt:number):Out4353 {
...
export const mm4353={d:'dino_physics_jump'};