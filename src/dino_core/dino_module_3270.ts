/** dino_module_3270 — obstacle_spawn extended, humanized desktop */
export interface In3270{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3270{y:number;vy:number;sc:number}
const C3270={g:0.5, j:12};
export function extraSpawn_3270(inp:In3270, dt:number):Out3270 {
...
export const mm3270={d:'obstacle_spawn'};