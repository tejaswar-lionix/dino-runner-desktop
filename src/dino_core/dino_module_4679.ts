/** dino_module_4679 — obstacle_spawn extended, humanized desktop */
export interface In4679{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4679{y:number;vy:number;sc:number}
const C4679={g:0.6, j:11};
export function extraPhysics_4679(inp:In4679, dt:number):Out4679 {
...
export const mm4679={d:'obstacle_spawn'};