/** dino_module_3968 — particle_fx extended, humanized desktop */
export interface In3968{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3968{y:number;vy:number;sc:number}
const C3968={g:0.7, j:12};
export function extraRender_3968(inp:In3968, dt:number):Out3968 {
...
export const mm3968={d:'particle_fx'};