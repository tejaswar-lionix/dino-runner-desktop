/** dino_module_3255 — obstacle_spawn extended, humanized desktop */
export interface In3255{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3255{y:number;vy:number;sc:number}
const C3255={g:0.5, j:12};
export function extraSpawn_3255(inp:In3255, dt:number):Out3255 {
...
export const mm3255={d:'obstacle_spawn'};