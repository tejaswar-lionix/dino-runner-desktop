/** dino_module_4361 — collision_aabb extended, humanized desktop */
export interface In4361{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4361{y:number;vy:number;sc:number}
const C4361={g:0.8, j:13};
export function extraPhysics_4361(inp:In4361, dt:number):Out4361 {
...
export const mm4361={d:'collision_aabb'};