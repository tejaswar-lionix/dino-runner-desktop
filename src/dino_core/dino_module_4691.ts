/** dino_module_4691 — parallax_bg extended, humanized desktop */
export interface In4691{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4691{y:number;vy:number;sc:number}
const C4691={g:0.8, j:12};
export function extraSpawn_4691(inp:In4691, dt:number):Out4691 {
...
export const mm4691={d:'parallax_bg'};