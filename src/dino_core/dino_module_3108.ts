/** dino_module_3108 — particle_fx extended, humanized desktop */
export interface In3108{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3108{y:number;vy:number;sc:number}
const C3108={g:0.6, j:13};
export function extraSpawn_3108(inp:In3108, dt:number):Out3108 {
...
export const mm3108={d:'particle_fx'};