/** dino_module_4641 — obstacle_spawn extended, humanized desktop */
export interface In4641{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4641{y:number;vy:number;sc:number}
const C4641={g:0.6, j:13};
export function extraPhysics_4641(inp:In4641, dt:number):Out4641 {
...
export const mm4641={d:'obstacle_spawn'};