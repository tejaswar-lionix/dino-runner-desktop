/** dino_module_3409 — parallax_bg extended, humanized desktop */
export interface In3409{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3409{y:number;vy:number;sc:number}
const C3409={g:0.7, j:13};
export function extraPhysics_3409(inp:In3409, dt:number):Out3409 {
...
export const mm3409={d:'parallax_bg'};