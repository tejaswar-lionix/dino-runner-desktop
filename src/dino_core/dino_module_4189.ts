/** dino_module_4189 — parallax_bg extended, humanized desktop */
export interface In4189{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4189{y:number;vy:number;sc:number}
const C4189={g:0.7, j:13};
export function extraPhysics_4189(inp:In4189, dt:number):Out4189 {
...
export const mm4189={d:'parallax_bg'};