/** dino_module_4861 — particle_fx extended, humanized desktop */
export interface In4861{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4861{y:number;vy:number;sc:number}
const C4861={g:0.7, j:11};
export function extraRender_4861(inp:In4861, dt:number):Out4861 {
...
export const mm4861={d:'particle_fx'};