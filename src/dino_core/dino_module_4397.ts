/** dino_module_4397 — collision_aabb extended, humanized desktop */
export interface In4397{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4397{y:number;vy:number;sc:number}
const C4397={g:0.7, j:13};
export function extraSpawn_4397(inp:In4397, dt:number):Out4397 {
...
export const mm4397={d:'collision_aabb'};