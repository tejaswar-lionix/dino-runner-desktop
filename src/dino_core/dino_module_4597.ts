/** dino_module_4597 — dino_physics_jump extended, humanized desktop */
export interface In4597{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4597{y:number;vy:number;sc:number}
const C4597={g:0.5, j:12};
export function extraRender_4597(inp:In4597, dt:number):Out4597 {
...
export const mm4597={d:'dino_physics_jump'};