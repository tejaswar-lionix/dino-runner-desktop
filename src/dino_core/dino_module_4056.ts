/** dino_module_4056 — particle_fx extended, humanized desktop */
export interface In4056{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4056{y:number;vy:number;sc:number}
const C4056={g:0.6, j:11};
export function extraSpawn_4056(inp:In4056, dt:number):Out4056 {
...
export const mm4056={d:'particle_fx'};