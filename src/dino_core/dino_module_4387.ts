/** dino_module_4387 — collision_aabb extended, humanized desktop */
export interface In4387{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4387{y:number;vy:number;sc:number}
const C4387={g:0.5, j:13};
export function extraSpawn_4387(inp:In4387, dt:number):Out4387 {
...
export const mm4387={d:'collision_aabb'};