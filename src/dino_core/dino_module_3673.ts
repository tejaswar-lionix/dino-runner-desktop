/** dino_module_3673 — score_speed extended, humanized desktop */
export interface In3673{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3673{y:number;vy:number;sc:number}
const C3673={g:0.5, j:11};
export function extraSpawn_3673(inp:In3673, dt:number):Out3673 {
...
export const mm3673={d:'score_speed'};