/** dino_module_4853 — score_speed extended, humanized desktop */
export interface In4853{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4853{y:number;vy:number;sc:number}
const C4853={g:0.7, j:12};
export function extraRender_4853(inp:In4853, dt:number):Out4853 {
...
export const mm4853={d:'score_speed'};