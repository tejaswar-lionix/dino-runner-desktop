/** dino_module_3016 — parallax_bg extended, humanized desktop */
export interface In3016{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3016{y:number;vy:number;sc:number}
const C3016={g:0.5, j:12};
export function extraSpawn_3016(inp:In3016, dt:number):Out3016 {
...
export const mm3016={d:'parallax_bg'};