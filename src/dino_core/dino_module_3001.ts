/** dino_module_3001 — particle_fx extended, humanized desktop */
export interface In3001{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3001{y:number;vy:number;sc:number}
const C3001={g:0.6, j:13};
export function extraSpawn_3001(inp:In3001, dt:number):Out3001 {
...
export const mm3001={d:'particle_fx'};