/** dino_module_4659 — collision_aabb extended, humanized desktop */
export interface In4659{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4659{y:number;vy:number;sc:number}
const C4659={g:0.5, j:13};
export function extraRender_4659(inp:In4659, dt:number):Out4659 {
...
export const mm4659={d:'collision_aabb'};