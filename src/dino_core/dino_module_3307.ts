/** dino_module_3307 — dino_physics_jump extended, humanized desktop */
export interface In3307{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3307{y:number;vy:number;sc:number}
const C3307={g:0.5, j:12};
export function extraPhysics_3307(inp:In3307, dt:number):Out3307 {
...
export const mm3307={d:'dino_physics_jump'};