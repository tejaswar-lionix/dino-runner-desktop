/** dino_module_4085 — score_speed extended, humanized desktop */
export interface In4085{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4085{y:number;vy:number;sc:number}
const C4085={g:0.5, j:12};
export function extraRender_4085(inp:In4085, dt:number):Out4085 {
...
export const mm4085={d:'score_speed'};