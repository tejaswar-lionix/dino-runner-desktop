/** dino_module_4985 — obstacle_spawn extended, humanized desktop */
export interface In4985{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4985{y:number;vy:number;sc:number}
const C4985={g:0.5, j:11};
export function extraPhysics_4985(inp:In4985, dt:number):Out4985 {
...
export const mm4985={d:'obstacle_spawn'};