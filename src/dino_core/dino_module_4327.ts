/** dino_module_4327 — particle_fx extended, humanized desktop */
export interface In4327{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4327{y:number;vy:number;sc:number}
const C4327={g:0.8, j:13};
export function extraSpawn_4327(inp:In4327, dt:number):Out4327 {
...
export const mm4327={d:'particle_fx'};