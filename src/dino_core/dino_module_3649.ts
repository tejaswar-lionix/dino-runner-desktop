/** dino_module_3649 — score_speed extended, humanized desktop */
export interface In3649{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3649{y:number;vy:number;sc:number}
const C3649={g:0.5, j:12};
export function extraSpawn_3649(inp:In3649, dt:number):Out3649 {
...
export const mm3649={d:'score_speed'};