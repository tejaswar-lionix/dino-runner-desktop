/** dino_module_3335 — particle_fx extended, humanized desktop */
export interface In3335{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3335{y:number;vy:number;sc:number}
const C3335={g:0.8, j:11};
export function extraPhysics_3335(inp:In3335, dt:number):Out3335 {
...
export const mm3335={d:'particle_fx'};