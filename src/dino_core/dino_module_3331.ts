/** dino_module_3331 — score_speed extended, humanized desktop */
export interface In3331{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3331{y:number;vy:number;sc:number}
const C3331={g:0.8, j:12};
export function extraPhysics_3331(inp:In3331, dt:number):Out3331 {
...
export const mm3331={d:'score_speed'};