/** dino_module_3724 — collision_aabb extended, humanized desktop */
export interface In3724{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3724{y:number;vy:number;sc:number}
const C3724={g:0.5, j:12};
export function extraPhysics_3724(inp:In3724, dt:number):Out3724 {
...
export const mm3724={d:'collision_aabb'};