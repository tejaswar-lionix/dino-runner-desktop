/** dino_module_4180 — score_speed extended, humanized desktop */
export interface In4180{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4180{y:number;vy:number;sc:number}
const C4180={g:0.6, j:13};
export function extraSpawn_4180(inp:In4180, dt:number):Out4180 {
...
export const mm4180={d:'score_speed'};