/** dino_module_4628 — collision_aabb extended, humanized desktop */
export interface In4628{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4628{y:number;vy:number;sc:number}
const C4628={g:0.6, j:12};
export function extraRender_4628(inp:In4628, dt:number):Out4628 {
...
export const mm4628={d:'collision_aabb'};