/** dino_module_3808 — particle_fx extended, humanized desktop */
export interface In3808{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3808{y:number;vy:number;sc:number}
const C3808={g:0.5, j:11};
export function extraSpawn_3808(inp:In3808, dt:number):Out3808 {
...
export const mm3808={d:'particle_fx'};