/** dino_module_4328 — obstacle_spawn extended, humanized desktop */
export interface In4328{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4328{y:number;vy:number;sc:number}
const C4328={g:0.7, j:11};
export function extraRender_4328(inp:In4328, dt:number):Out4328 {
...
export const mm4328={d:'obstacle_spawn'};