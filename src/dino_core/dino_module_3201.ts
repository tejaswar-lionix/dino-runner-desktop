/** dino_module_3201 — dino_physics_jump extended, humanized desktop */
export interface In3201{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3201{y:number;vy:number;sc:number}
const C3201={g:0.8, j:11};
export function extraSpawn_3201(inp:In3201, dt:number):Out3201 {
...
export const mm3201={d:'dino_physics_jump'};