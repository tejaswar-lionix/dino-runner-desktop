/** dino_module_4844 — dino_physics_jump extended, humanized desktop */
export interface In4844{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4844{y:number;vy:number;sc:number}
const C4844={g:0.5, j:12};
export function extraSpawn_4844(inp:In4844, dt:number):Out4844 {
...
export const mm4844={d:'dino_physics_jump'};