/** dino_module_3427 — particle_fx extended, humanized desktop */
export interface In3427{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3427{y:number;vy:number;sc:number}
const C3427={g:0.7, j:12};
export function extraPhysics_3427(inp:In3427, dt:number):Out3427 {
...
export const mm3427={d:'particle_fx'};