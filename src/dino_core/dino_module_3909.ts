/** dino_module_3909 — parallax_bg extended, humanized desktop */
export interface In3909{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3909{y:number;vy:number;sc:number}
const C3909={g:0.6, j:13};
export function extraSpawn_3909(inp:In3909, dt:number):Out3909 {
...
export const mm3909={d:'parallax_bg'};