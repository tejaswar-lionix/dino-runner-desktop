/** dino_module_4675 — dino_physics_jump extended, humanized desktop */
export interface In4675{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4675{y:number;vy:number;sc:number}
const C4675={g:0.7, j:12};
export function extraRender_4675(inp:In4675, dt:number):Out4675 {
...
export const mm4675={d:'dino_physics_jump'};