/** dino_module_4232 — particle_fx extended, humanized desktop */
export interface In4232{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4232{y:number;vy:number;sc:number}
const C4232={g:0.5, j:12};
export function extraSpawn_4232(inp:In4232, dt:number):Out4232 {
...
export const mm4232={d:'particle_fx'};