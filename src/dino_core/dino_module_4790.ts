/** dino_module_4790 — obstacle_spawn extended, humanized desktop */
export interface In4790{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4790{y:number;vy:number;sc:number}
const C4790={g:0.8, j:11};
export function extraSpawn_4790(inp:In4790, dt:number):Out4790 {
...
export const mm4790={d:'obstacle_spawn'};