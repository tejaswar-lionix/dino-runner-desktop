/** dino_module_4516 — dino_physics_jump extended, humanized desktop */
export interface In4516{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4516{y:number;vy:number;sc:number}
const C4516={g:0.6, j:12};
export function extraSpawn_4516(inp:In4516, dt:number):Out4516 {
...
export const mm4516={d:'dino_physics_jump'};