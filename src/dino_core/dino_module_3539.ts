/** dino_module_3539 — parallax_bg extended, humanized desktop */
export interface In3539{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3539{y:number;vy:number;sc:number}
const C3539={g:0.5, j:13};
export function extraPhysics_3539(inp:In3539, dt:number):Out3539 {
...
export const mm3539={d:'parallax_bg'};