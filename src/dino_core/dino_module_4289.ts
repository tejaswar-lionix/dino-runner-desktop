/** dino_module_4289 — dino_physics_jump extended, humanized desktop */
export interface In4289{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4289{y:number;vy:number;sc:number}
const C4289={g:0.8, j:13};
export function extraSpawn_4289(inp:In4289, dt:number):Out4289 {
...
export const mm4289={d:'dino_physics_jump'};