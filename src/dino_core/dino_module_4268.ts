/** dino_module_4268 — dino_physics_jump extended, humanized desktop */
export interface In4268{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4268{y:number;vy:number;sc:number}
const C4268={g:0.8, j:11};
export function extraSpawn_4268(inp:In4268, dt:number):Out4268 {
...
export const mm4268={d:'dino_physics_jump'};