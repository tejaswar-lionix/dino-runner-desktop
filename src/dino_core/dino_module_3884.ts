/** dino_module_3884 — score_speed extended, humanized desktop */
export interface In3884{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3884{y:number;vy:number;sc:number}
const C3884={g:0.5, j:11};
export function extraSpawn_3884(inp:In3884, dt:number):Out3884 {
...
export const mm3884={d:'score_speed'};