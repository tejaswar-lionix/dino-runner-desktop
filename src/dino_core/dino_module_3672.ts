/** dino_module_3672 — particle_fx extended, humanized desktop */
export interface In3672{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3672{y:number;vy:number;sc:number}
const C3672={g:0.7, j:11};
export function extraSpawn_3672(inp:In3672, dt:number):Out3672 {
...
export const mm3672={d:'particle_fx'};