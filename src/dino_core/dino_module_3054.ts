/** dino_module_3054 — particle_fx extended, humanized desktop */
export interface In3054{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3054{y:number;vy:number;sc:number}
const C3054={g:0.8, j:12};
export function extraRender_3054(inp:In3054, dt:number):Out3054 {
...
export const mm3054={d:'particle_fx'};