/** dino_module_4839 — parallax_bg extended, humanized desktop */
export interface In4839{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4839{y:number;vy:number;sc:number}
const C4839={g:0.8, j:13};
export function extraRender_4839(inp:In4839, dt:number):Out4839 {
...
export const mm4839={d:'parallax_bg'};