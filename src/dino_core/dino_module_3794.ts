/** dino_module_3794 — score_speed extended, humanized desktop */
export interface In3794{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3794{y:number;vy:number;sc:number}
const C3794={g:0.5, j:13};
export function extraSpawn_3794(inp:In3794, dt:number):Out3794 {
...
export const mm3794={d:'score_speed'};