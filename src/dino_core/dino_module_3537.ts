/** dino_module_3537 — collision_aabb extended, humanized desktop */
export interface In3537{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3537{y:number;vy:number;sc:number}
const C3537={g:0.5, j:11};
export function extraPhysics_3537(inp:In3537, dt:number):Out3537 {
...
export const mm3537={d:'collision_aabb'};