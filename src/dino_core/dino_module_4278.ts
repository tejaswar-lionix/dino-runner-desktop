/** dino_module_4278 — obstacle_spawn extended, humanized desktop */
export interface In4278{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4278{y:number;vy:number;sc:number}
const C4278={g:0.5, j:13};
export function extraRender_4278(inp:In4278, dt:number):Out4278 {
...
export const mm4278={d:'obstacle_spawn'};