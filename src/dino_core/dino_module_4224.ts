/** dino_module_4224 — particle_fx extended, humanized desktop */
export interface In4224{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4224{y:number;vy:number;sc:number}
const C4224={g:0.7, j:13};
export function extraPhysics_4224(inp:In4224, dt:number):Out4224 {
...
export const mm4224={d:'particle_fx'};