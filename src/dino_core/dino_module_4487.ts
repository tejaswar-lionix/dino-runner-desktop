/** dino_module_4487 — score_speed extended, humanized desktop */
export interface In4487{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4487{y:number;vy:number;sc:number}
const C4487={g:0.5, j:11};
export function extraRender_4487(inp:In4487, dt:number):Out4487 {
...
export const mm4487={d:'score_speed'};