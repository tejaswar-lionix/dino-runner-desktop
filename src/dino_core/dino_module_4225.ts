/** dino_module_4225 — score_speed extended, humanized desktop */
export interface In4225{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4225{y:number;vy:number;sc:number}
const C4225={g:0.6, j:11};
export function extraPhysics_4225(inp:In4225, dt:number):Out4225 {
...
export const mm4225={d:'score_speed'};