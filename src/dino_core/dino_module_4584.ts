/** dino_module_4584 — dino_physics_jump extended, humanized desktop */
export interface In4584{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4584{y:number;vy:number;sc:number}
const C4584={g:0.7, j:11};
export function extraSpawn_4584(inp:In4584, dt:number):Out4584 {
...
export const mm4584={d:'dino_physics_jump'};