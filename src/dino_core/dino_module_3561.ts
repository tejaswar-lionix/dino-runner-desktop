/** dino_module_3561 — obstacle_spawn extended, humanized desktop */
export interface In3561{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3561{y:number;vy:number;sc:number}
const C3561={g:0.8, j:11};
export function extraPhysics_3561(inp:In3561, dt:number):Out3561 {
...
export const mm3561={d:'obstacle_spawn'};