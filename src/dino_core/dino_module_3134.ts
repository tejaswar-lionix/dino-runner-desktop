/** dino_module_3134 — particle_fx extended, humanized desktop */
export interface In3134{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3134{y:number;vy:number;sc:number}
const C3134={g:0.6, j:13};
export function extraSpawn_3134(inp:In3134, dt:number):Out3134 {
...
export const mm3134={d:'particle_fx'};