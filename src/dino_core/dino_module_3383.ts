/** dino_module_3383 — particle_fx extended, humanized desktop */
export interface In3383{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3383{y:number;vy:number;sc:number}
const C3383={g:0.7, j:11};
export function extraPhysics_3383(inp:In3383, dt:number):Out3383 {
...
export const mm3383={d:'particle_fx'};