/** dino_module_3639 — parallax_bg extended, humanized desktop */
export interface In3639{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3639{y:number;vy:number;sc:number}
const C3639={g:0.7, j:11};
export function extraRender_3639(inp:In3639, dt:number):Out3639 {
...
export const mm3639={d:'parallax_bg'};