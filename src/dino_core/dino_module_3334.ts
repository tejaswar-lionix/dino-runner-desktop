/** dino_module_3334 — parallax_bg extended, humanized desktop */
export interface In3334{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3334{y:number;vy:number;sc:number}
const C3334={g:0.6, j:13};
export function extraPhysics_3334(inp:In3334, dt:number):Out3334 {
...
export const mm3334={d:'parallax_bg'};