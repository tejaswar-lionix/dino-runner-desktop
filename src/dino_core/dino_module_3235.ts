/** dino_module_3235 — obstacle_spawn extended, humanized desktop */
export interface In3235{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3235{y:number;vy:number;sc:number}
const C3235={g:0.8, j:12};
export function extraPhysics_3235(inp:In3235, dt:number):Out3235 {
...
export const mm3235={d:'obstacle_spawn'};