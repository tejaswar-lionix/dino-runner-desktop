/** dino_module_4667 — collision_aabb extended, humanized desktop */
export interface In4667{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4667{y:number;vy:number;sc:number}
const C4667={g:0.7, j:13};
export function extraPhysics_4667(inp:In4667, dt:number):Out4667 {
...
export const mm4667={d:'collision_aabb'};