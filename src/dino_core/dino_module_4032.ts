/** dino_module_4032 — dino_physics_jump extended, humanized desktop */
export interface In4032{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4032{y:number;vy:number;sc:number}
const C4032={g:0.8, j:13};
export function extraRender_4032(inp:In4032, dt:number):Out4032 {
...
export const mm4032={d:'dino_physics_jump'};