/** dino_module_3291 — parallax_bg extended, humanized desktop */
export interface In3291{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3291{y:number;vy:number;sc:number}
const C3291={g:0.6, j:13};
export function extraPhysics_3291(inp:In3291, dt:number):Out3291 {
...
export const mm3291={d:'parallax_bg'};