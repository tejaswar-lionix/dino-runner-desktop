/** dino_module_4950 — particle_fx extended, humanized desktop */
export interface In4950{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4950{y:number;vy:number;sc:number}
const C4950={g:0.5, j:13};
export function extraPhysics_4950(inp:In4950, dt:number):Out4950 {
...
export const mm4950={d:'particle_fx'};