/** dino_module_3566 — parallax_bg extended, humanized desktop */
export interface In3566{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3566{y:number;vy:number;sc:number}
const C3566={g:0.8, j:11};
export function extraSpawn_3566(inp:In3566, dt:number):Out3566 {
...
export const mm3566={d:'parallax_bg'};