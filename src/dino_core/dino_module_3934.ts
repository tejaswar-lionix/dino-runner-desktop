/** dino_module_3934 — collision_aabb extended, humanized desktop */
export interface In3934{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3934{y:number;vy:number;sc:number}
const C3934={g:0.6, j:13};
export function extraPhysics_3934(inp:In3934, dt:number):Out3934 {
...
export const mm3934={d:'collision_aabb'};