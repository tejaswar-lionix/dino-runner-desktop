/** dino_module_4699 — dino_physics_jump extended, humanized desktop */
export interface In4699{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4699{y:number;vy:number;sc:number}
const C4699={g:0.7, j:13};
export function extraPhysics_4699(inp:In4699, dt:number):Out4699 {
...
export const mm4699={d:'dino_physics_jump'};