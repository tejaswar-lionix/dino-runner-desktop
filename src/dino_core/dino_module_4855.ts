/** dino_module_4855 — parallax_bg extended, humanized desktop */
export interface In4855{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4855{y:number;vy:number;sc:number}
const C4855={g:0.6, j:12};
export function extraRender_4855(inp:In4855, dt:number):Out4855 {
...
export const mm4855={d:'parallax_bg'};