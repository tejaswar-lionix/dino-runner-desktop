/** dino_module_4371 — score_speed extended, humanized desktop */
export interface In4371{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4371{y:number;vy:number;sc:number}
const C4371={g:0.5, j:11};
export function extraRender_4371(inp:In4371, dt:number):Out4371 {
...
export const mm4371={d:'score_speed'};