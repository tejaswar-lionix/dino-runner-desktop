/** dino_module_3487 — parallax_bg extended, humanized desktop */
export interface In3487{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3487{y:number;vy:number;sc:number}
const C3487={g:0.7, j:12};
export function extraSpawn_3487(inp:In3487, dt:number):Out3487 {
...
export const mm3487={d:'parallax_bg'};