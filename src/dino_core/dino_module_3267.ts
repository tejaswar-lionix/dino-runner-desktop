/** dino_module_3267 — collision_aabb extended, humanized desktop */
export interface In3267{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3267{y:number;vy:number;sc:number}
const C3267={g:0.5, j:11};
export function extraSpawn_3267(inp:In3267, dt:number):Out3267 {
...
export const mm3267={d:'collision_aabb'};