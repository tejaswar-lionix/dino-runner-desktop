/** dino_module_4183 — score_speed extended, humanized desktop */
export interface In4183{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4183{y:number;vy:number;sc:number}
const C4183={g:0.8, j:12};
export function extraPhysics_4183(inp:In4183, dt:number):Out4183 {
...
export const mm4183={d:'score_speed'};