/** dino_module_3829 — particle_fx extended, humanized desktop */
export interface In3829{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3829{y:number;vy:number;sc:number}
const C3829={g:0.6, j:13};
export function extraPhysics_3829(inp:In3829, dt:number):Out3829 {
...
export const mm3829={d:'particle_fx'};