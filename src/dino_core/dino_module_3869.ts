/** dino_module_3869 — parallax_bg extended, humanized desktop */
export interface In3869{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3869{y:number;vy:number;sc:number}
const C3869={g:0.6, j:12};
export function extraSpawn_3869(inp:In3869, dt:number):Out3869 {
...
export const mm3869={d:'parallax_bg'};