/** dino_module_3728 — particle_fx extended, humanized desktop */
export interface In3728{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3728{y:number;vy:number;sc:number}
const C3728={g:0.7, j:11};
export function extraPhysics_3728(inp:In3728, dt:number):Out3728 {
...
export const mm3728={d:'particle_fx'};