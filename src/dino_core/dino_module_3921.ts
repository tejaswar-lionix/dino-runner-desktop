/** dino_module_3921 — parallax_bg extended, humanized desktop */
export interface In3921{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3921{y:number;vy:number;sc:number}
const C3921={g:0.8, j:13};
export function extraSpawn_3921(inp:In3921, dt:number):Out3921 {
...
export const mm3921={d:'parallax_bg'};