/** dino_module_3594 — collision_aabb extended, humanized desktop */
export interface In3594{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3594{y:number;vy:number;sc:number}
const C3594={g:0.5, j:13};
export function extraPhysics_3594(inp:In3594, dt:number):Out3594 {
...
export const mm3594={d:'collision_aabb'};