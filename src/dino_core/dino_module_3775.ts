/** dino_module_3775 — obstacle_spawn extended, humanized desktop */
export interface In3775{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3775{y:number;vy:number;sc:number}
const C3775={g:0.7, j:12};
export function extraPhysics_3775(inp:In3775, dt:number):Out3775 {
...
export const mm3775={d:'obstacle_spawn'};