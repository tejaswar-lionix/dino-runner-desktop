/** dino_module_4315 — obstacle_spawn extended, humanized desktop */
export interface In4315{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4315{y:number;vy:number;sc:number}
const C4315={g:0.6, j:11};
export function extraSpawn_4315(inp:In4315, dt:number):Out4315 {
...
export const mm4315={d:'obstacle_spawn'};