/** dino_module_4452 — dino_physics_jump extended, humanized desktop */
export interface In4452{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4452{y:number;vy:number;sc:number}
const C4452={g:0.8, j:11};
export function extraPhysics_4452(inp:In4452, dt:number):Out4452 {
...
export const mm4452={d:'dino_physics_jump'};