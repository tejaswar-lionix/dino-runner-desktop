/** dino_module_4558 — dino_physics_jump extended, humanized desktop */
export interface In4558{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4558{y:number;vy:number;sc:number}
const C4558={g:0.8, j:12};
export function extraRender_4558(inp:In4558, dt:number):Out4558 {
...
export const mm4558={d:'dino_physics_jump'};