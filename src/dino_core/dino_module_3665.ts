/** dino_module_3665 — obstacle_spawn extended, humanized desktop */
export interface In3665{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3665{y:number;vy:number;sc:number}
const C3665={g:0.5, j:13};
export function extraSpawn_3665(inp:In3665, dt:number):Out3665 {
...
export const mm3665={d:'obstacle_spawn'};