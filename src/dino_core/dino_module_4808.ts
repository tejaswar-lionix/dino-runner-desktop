/** dino_module_4808 — parallax_bg extended, humanized desktop */
export interface In4808{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4808{y:number;vy:number;sc:number}
const C4808={g:0.5, j:12};
export function extraRender_4808(inp:In4808, dt:number):Out4808 {
...
export const mm4808={d:'parallax_bg'};