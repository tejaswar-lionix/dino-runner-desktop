/** dino_module_4868 — parallax_bg extended, humanized desktop */
export interface In4868{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4868{y:number;vy:number;sc:number}
const C4868={g:0.7, j:13};
export function extraPhysics_4868(inp:In4868, dt:number):Out4868 {
...
export const mm4868={d:'parallax_bg'};