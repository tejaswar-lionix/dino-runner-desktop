/** dino_module_4050 — parallax_bg extended, humanized desktop */
export interface In4050{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4050{y:number;vy:number;sc:number}
const C4050={g:0.7, j:13};
export function extraPhysics_4050(inp:In4050, dt:number):Out4050 {
...
export const mm4050={d:'parallax_bg'};