/** dino_module_3504 — collision_aabb extended, humanized desktop */
export interface In3504{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3504{y:number;vy:number;sc:number}
const C3504={g:0.5, j:11};
export function extraPhysics_3504(inp:In3504, dt:number):Out3504 {
...
export const mm3504={d:'collision_aabb'};