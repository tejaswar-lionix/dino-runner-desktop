/** dino_module_3600 — parallax_bg extended, humanized desktop */
export interface In3600{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3600{y:number;vy:number;sc:number}
const C3600={g:0.8, j:11};
export function extraPhysics_3600(inp:In3600, dt:number):Out3600 {
...
export const mm3600={d:'parallax_bg'};