/** dino_module_4687 — obstacle_spawn extended, humanized desktop */
export interface In4687{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4687{y:number;vy:number;sc:number}
const C4687={g:0.7, j:12};
export function extraPhysics_4687(inp:In4687, dt:number):Out4687 {
...
export const mm4687={d:'obstacle_spawn'};