/** dino_module_3617 — dino_physics_jump extended, humanized desktop */
export interface In3617{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3617{y:number;vy:number;sc:number}
const C3617={g:0.6, j:12};
export function extraRender_3617(inp:In3617, dt:number):Out3617 {
...
export const mm3617={d:'dino_physics_jump'};