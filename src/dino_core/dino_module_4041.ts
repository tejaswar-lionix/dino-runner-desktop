/** dino_module_4041 — parallax_bg extended, humanized desktop */
export interface In4041{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4041{y:number;vy:number;sc:number}
const C4041={g:0.5, j:13};
export function extraSpawn_4041(inp:In4041, dt:number):Out4041 {
...
export const mm4041={d:'parallax_bg'};