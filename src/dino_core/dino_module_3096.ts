/** dino_module_3096 — score_speed extended, humanized desktop */
export interface In3096{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3096{y:number;vy:number;sc:number}
const C3096={g:0.7, j:12};
export function extraRender_3096(inp:In3096, dt:number):Out3096 {
...
export const mm3096={d:'score_speed'};