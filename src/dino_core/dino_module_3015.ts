/** dino_module_3015 — dino_physics_jump extended, humanized desktop */
export interface In3015{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3015{y:number;vy:number;sc:number}
const C3015={g:0.7, j:12};
export function extraRender_3015(inp:In3015, dt:number):Out3015 {
...
export const mm3015={d:'dino_physics_jump'};