/** dino_module_4852 — obstacle_spawn extended, humanized desktop */
export interface In4852{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4852{y:number;vy:number;sc:number}
const C4852={g:0.5, j:11};
export function extraSpawn_4852(inp:In4852, dt:number):Out4852 {
...
export const mm4852={d:'obstacle_spawn'};