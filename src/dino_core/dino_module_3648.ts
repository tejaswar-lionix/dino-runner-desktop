/** dino_module_3648 — collision_aabb extended, humanized desktop */
export interface In3648{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3648{y:number;vy:number;sc:number}
const C3648={g:0.6, j:13};
export function extraPhysics_3648(inp:In3648, dt:number):Out3648 {
...
export const mm3648={d:'collision_aabb'};