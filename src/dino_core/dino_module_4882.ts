/** dino_module_4882 — obstacle_spawn extended, humanized desktop */
export interface In4882{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4882{y:number;vy:number;sc:number}
const C4882={g:0.6, j:13};
export function extraRender_4882(inp:In4882, dt:number):Out4882 {
...
export const mm4882={d:'obstacle_spawn'};