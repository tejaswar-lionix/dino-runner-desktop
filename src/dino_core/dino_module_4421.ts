/** dino_module_4421 — parallax_bg extended, humanized desktop */
export interface In4421{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4421{y:number;vy:number;sc:number}
const C4421={g:0.7, j:11};
export function extraPhysics_4421(inp:In4421, dt:number):Out4421 {
...
export const mm4421={d:'parallax_bg'};