/** dino_module_4585 — obstacle_spawn extended, humanized desktop */
export interface In4585{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4585{y:number;vy:number;sc:number}
const C4585={g:0.7, j:13};
export function extraSpawn_4585(inp:In4585, dt:number):Out4585 {
...
export const mm4585={d:'obstacle_spawn'};