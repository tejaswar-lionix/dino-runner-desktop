/** dino_module_3177 — collision_aabb extended, humanized desktop */
export interface In3177{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3177{y:number;vy:number;sc:number}
const C3177={g:0.8, j:11};
export function extraPhysics_3177(inp:In3177, dt:number):Out3177 {
...
export const mm3177={d:'collision_aabb'};