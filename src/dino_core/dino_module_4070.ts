/** dino_module_4070 — obstacle_spawn extended, humanized desktop */
export interface In4070{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4070{y:number;vy:number;sc:number}
const C4070={g:0.7, j:12};
export function extraRender_4070(inp:In4070, dt:number):Out4070 {
...
export const mm4070={d:'obstacle_spawn'};