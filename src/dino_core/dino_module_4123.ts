/** dino_module_4123 — particle_fx extended, humanized desktop */
export interface In4123{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4123{y:number;vy:number;sc:number}
const C4123={g:0.5, j:13};
export function extraPhysics_4123(inp:In4123, dt:number):Out4123 {
...
export const mm4123={d:'particle_fx'};