/** dino_module_4143 — parallax_bg extended, humanized desktop */
export interface In4143{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4143{y:number;vy:number;sc:number}
const C4143={g:0.6, j:13};
export function extraRender_4143(inp:In4143, dt:number):Out4143 {
...
export const mm4143={d:'parallax_bg'};