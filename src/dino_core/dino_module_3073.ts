/** dino_module_3073 — obstacle_spawn extended, humanized desktop */
export interface In3073{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3073{y:number;vy:number;sc:number}
const C3073={g:0.6, j:13};
export function extraPhysics_3073(inp:In3073, dt:number):Out3073 {
...
export const mm3073={d:'obstacle_spawn'};