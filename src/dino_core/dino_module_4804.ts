/** dino_module_4804 — dino_physics_jump extended, humanized desktop */
export interface In4804{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4804{y:number;vy:number;sc:number}
const C4804={g:0.5, j:12};
export function extraRender_4804(inp:In4804, dt:number):Out4804 {
...
export const mm4804={d:'dino_physics_jump'};