/** dino_module_4083 — collision_aabb extended, humanized desktop */
export interface In4083{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4083{y:number;vy:number;sc:number}
const C4083={g:0.7, j:12};
export function extraRender_4083(inp:In4083, dt:number):Out4083 {
...
export const mm4083={d:'collision_aabb'};