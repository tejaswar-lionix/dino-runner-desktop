/** dino_module_4248 — obstacle_spawn extended, humanized desktop */
export interface In4248{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4248{y:number;vy:number;sc:number}
const C4248={g:0.7, j:12};
export function extraSpawn_4248(inp:In4248, dt:number):Out4248 {
...
export const mm4248={d:'obstacle_spawn'};