/** dino_module_4775 — obstacle_spawn extended, humanized desktop */
export interface In4775{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4775{y:number;vy:number;sc:number}
const C4775={g:0.7, j:13};
export function extraSpawn_4775(inp:In4775, dt:number):Out4775 {
...
export const mm4775={d:'obstacle_spawn'};