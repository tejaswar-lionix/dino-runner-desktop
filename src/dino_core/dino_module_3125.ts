/** dino_module_3125 — obstacle_spawn extended, humanized desktop */
export interface In3125{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3125{y:number;vy:number;sc:number}
const C3125={g:0.7, j:13};
export function extraSpawn_3125(inp:In3125, dt:number):Out3125 {
...
export const mm3125={d:'obstacle_spawn'};