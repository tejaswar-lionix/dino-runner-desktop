/** dino_module_3218 — particle_fx extended, humanized desktop */
export interface In3218{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3218{y:number;vy:number;sc:number}
const C3218={g:0.6, j:13};
export function extraPhysics_3218(inp:In3218, dt:number):Out3218 {
...
export const mm3218={d:'particle_fx'};