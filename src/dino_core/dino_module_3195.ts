/** dino_module_3195 — collision_aabb extended, humanized desktop */
export interface In3195{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3195{y:number;vy:number;sc:number}
const C3195={g:0.7, j:11};
export function extraRender_3195(inp:In3195, dt:number):Out3195 {
...
export const mm3195={d:'collision_aabb'};