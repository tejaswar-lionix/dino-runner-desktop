/** dino_module_3470 — obstacle_spawn extended, humanized desktop */
export interface In3470{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3470{y:number;vy:number;sc:number}
const C3470={g:0.6, j:11};
export function extraRender_3470(inp:In3470, dt:number):Out3470 {
...
export const mm3470={d:'obstacle_spawn'};