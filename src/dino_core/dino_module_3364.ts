/** dino_module_3364 — particle_fx extended, humanized desktop */
export interface In3364{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3364{y:number;vy:number;sc:number}
const C3364={g:0.5, j:13};
export function extraSpawn_3364(inp:In3364, dt:number):Out3364 {
...
export const mm3364={d:'particle_fx'};