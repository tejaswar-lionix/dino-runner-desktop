/** dino_module_4242 — dino_physics_jump extended, humanized desktop */
export interface In4242{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4242{y:number;vy:number;sc:number}
const C4242={g:0.8, j:11};
export function extraSpawn_4242(inp:In4242, dt:number):Out4242 {
...
export const mm4242={d:'dino_physics_jump'};