/** dino_module_3723 — score_speed extended, humanized desktop */
export interface In3723{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3723{y:number;vy:number;sc:number}
const C3723={g:0.6, j:11};
export function extraSpawn_3723(inp:In3723, dt:number):Out3723 {
...
export const mm3723={d:'score_speed'};