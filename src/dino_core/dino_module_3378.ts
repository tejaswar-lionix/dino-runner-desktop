/** dino_module_3378 — collision_aabb extended, humanized desktop */
export interface In3378{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3378{y:number;vy:number;sc:number}
const C3378={g:0.6, j:11};
export function extraRender_3378(inp:In3378, dt:number):Out3378 {
...
export const mm3378={d:'collision_aabb'};