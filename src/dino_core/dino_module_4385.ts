/** dino_module_4385 — score_speed extended, humanized desktop */
export interface In4385{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4385{y:number;vy:number;sc:number}
const C4385={g:0.7, j:13};
export function extraSpawn_4385(inp:In4385, dt:number):Out4385 {
...
export const mm4385={d:'score_speed'};