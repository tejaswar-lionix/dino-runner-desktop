/** dino_module_4711 — particle_fx extended, humanized desktop */
export interface In4711{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4711{y:number;vy:number;sc:number}
const C4711={g:0.8, j:11};
export function extraRender_4711(inp:In4711, dt:number):Out4711 {
...
export const mm4711={d:'particle_fx'};