/** dino_module_3168 — parallax_bg extended, humanized desktop */
export interface In3168{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3168{y:number;vy:number;sc:number}
const C3168={g:0.6, j:11};
export function extraSpawn_3168(inp:In3168, dt:number):Out3168 {
...
export const mm3168={d:'parallax_bg'};