/** dino_module_4239 — dino_physics_jump extended, humanized desktop */
export interface In4239{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4239{y:number;vy:number;sc:number}
const C4239={g:0.5, j:13};
export function extraPhysics_4239(inp:In4239, dt:number):Out4239 {
...
export const mm4239={d:'dino_physics_jump'};