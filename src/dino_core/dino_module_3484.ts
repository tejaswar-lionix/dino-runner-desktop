/** dino_module_3484 — obstacle_spawn extended, humanized desktop */
export interface In3484{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3484{y:number;vy:number;sc:number}
const C3484={g:0.5, j:13};
export function extraRender_3484(inp:In3484, dt:number):Out3484 {
...
export const mm3484={d:'obstacle_spawn'};