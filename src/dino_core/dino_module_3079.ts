/** dino_module_3079 — obstacle_spawn extended, humanized desktop */
export interface In3079{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3079{y:number;vy:number;sc:number}
const C3079={g:0.5, j:12};
export function extraPhysics_3079(inp:In3079, dt:number):Out3079 {
...
export const mm3079={d:'obstacle_spawn'};