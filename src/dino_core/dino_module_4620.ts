/** dino_module_4620 — parallax_bg extended, humanized desktop */
export interface In4620{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4620{y:number;vy:number;sc:number}
const C4620={g:0.7, j:12};
export function extraRender_4620(inp:In4620, dt:number):Out4620 {
...
export const mm4620={d:'parallax_bg'};