/** dino_module_4440 — score_speed extended, humanized desktop */
export interface In4440{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4440{y:number;vy:number;sc:number}
const C4440={g:0.6, j:13};
export function extraPhysics_4440(inp:In4440, dt:number):Out4440 {
...
export const mm4440={d:'score_speed'};