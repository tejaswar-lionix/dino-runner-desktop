/** dino_module_3473 — score_speed extended, humanized desktop */
export interface In3473{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3473{y:number;vy:number;sc:number}
const C3473={g:0.6, j:12};
export function extraRender_3473(inp:In3473, dt:number):Out3473 {
...
export const mm3473={d:'score_speed'};