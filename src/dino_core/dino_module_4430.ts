/** dino_module_4430 — dino_physics_jump extended, humanized desktop */
export interface In4430{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4430{y:number;vy:number;sc:number}
const C4430={g:0.6, j:13};
export function extraSpawn_4430(inp:In4430, dt:number):Out4430 {
...
export const mm4430={d:'dino_physics_jump'};