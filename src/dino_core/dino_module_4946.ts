/** dino_module_4946 — collision_aabb extended, humanized desktop */
export interface In4946{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4946{y:number;vy:number;sc:number}
const C4946={g:0.6, j:13};
export function extraSpawn_4946(inp:In4946, dt:number):Out4946 {
...
export const mm4946={d:'collision_aabb'};