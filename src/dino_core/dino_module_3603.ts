/** dino_module_3603 — collision_aabb extended, humanized desktop */
export interface In3603{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3603{y:number;vy:number;sc:number}
const C3603={g:0.6, j:13};
export function extraPhysics_3603(inp:In3603, dt:number):Out3603 {
...
export const mm3603={d:'collision_aabb'};