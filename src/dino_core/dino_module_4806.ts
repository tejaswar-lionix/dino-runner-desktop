/** dino_module_4806 — particle_fx extended, humanized desktop */
export interface In4806{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4806{y:number;vy:number;sc:number}
const C4806={g:0.8, j:11};
export function extraRender_4806(inp:In4806, dt:number):Out4806 {
...
export const mm4806={d:'particle_fx'};