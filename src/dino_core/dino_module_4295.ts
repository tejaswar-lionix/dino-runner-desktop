/** dino_module_4295 — collision_aabb extended, humanized desktop */
export interface In4295{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4295{y:number;vy:number;sc:number}
const C4295={g:0.5, j:13};
export function extraRender_4295(inp:In4295, dt:number):Out4295 {
...
export const mm4295={d:'collision_aabb'};