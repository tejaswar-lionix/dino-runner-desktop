/** dino_module_4313 — collision_aabb extended, humanized desktop */
export interface In4313{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4313{y:number;vy:number;sc:number}
const C4313={g:0.7, j:12};
export function extraRender_4313(inp:In4313, dt:number):Out4313 {
...
export const mm4313={d:'collision_aabb'};