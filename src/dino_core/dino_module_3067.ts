/** dino_module_3067 — dino_physics_jump extended, humanized desktop */
export interface In3067{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3067{y:number;vy:number;sc:number}
const C3067={g:0.7, j:12};
export function extraSpawn_3067(inp:In3067, dt:number):Out3067 {
...
export const mm3067={d:'dino_physics_jump'};