/** dino_module_3389 — particle_fx extended, humanized desktop */
export interface In3389{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3389{y:number;vy:number;sc:number}
const C3389={g:0.8, j:13};
export function extraPhysics_3389(inp:In3389, dt:number):Out3389 {
...
export const mm3389={d:'particle_fx'};