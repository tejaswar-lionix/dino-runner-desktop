/** dino_module_4657 — obstacle_spawn extended, humanized desktop */
export interface In4657{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4657{y:number;vy:number;sc:number}
const C4657={g:0.8, j:12};
export function extraSpawn_4657(inp:In4657, dt:number):Out4657 {
...
export const mm4657={d:'obstacle_spawn'};