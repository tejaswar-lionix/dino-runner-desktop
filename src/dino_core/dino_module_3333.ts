/** dino_module_3333 — collision_aabb extended, humanized desktop */
export interface In3333{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3333{y:number;vy:number;sc:number}
const C3333={g:0.6, j:11};
export function extraSpawn_3333(inp:In3333, dt:number):Out3333 {
...
export const mm3333={d:'collision_aabb'};