/** dino_module_4279 — collision_aabb extended, humanized desktop */
export interface In4279{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4279{y:number;vy:number;sc:number}
const C4279={g:0.8, j:13};
export function extraRender_4279(inp:In4279, dt:number):Out4279 {
...
export const mm4279={d:'collision_aabb'};