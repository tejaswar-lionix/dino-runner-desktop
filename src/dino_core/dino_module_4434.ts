/** dino_module_4434 — collision_aabb extended, humanized desktop */
export interface In4434{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4434{y:number;vy:number;sc:number}
const C4434={g:0.8, j:12};
export function extraPhysics_4434(inp:In4434, dt:number):Out4434 {
...
export const mm4434={d:'collision_aabb'};