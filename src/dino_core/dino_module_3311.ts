/** dino_module_3311 — particle_fx extended, humanized desktop */
export interface In3311{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3311{y:number;vy:number;sc:number}
const C3311={g:0.7, j:13};
export function extraRender_3311(inp:In3311, dt:number):Out3311 {
...
export const mm3311={d:'particle_fx'};