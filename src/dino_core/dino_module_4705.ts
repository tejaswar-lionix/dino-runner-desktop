/** dino_module_4705 — obstacle_spawn extended, humanized desktop */
export interface In4705{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4705{y:number;vy:number;sc:number}
const C4705={g:0.7, j:13};
export function extraRender_4705(inp:In4705, dt:number):Out4705 {
...
export const mm4705={d:'obstacle_spawn'};