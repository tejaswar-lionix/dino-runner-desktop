/** dino_module_4733 — obstacle_spawn extended, humanized desktop */
export interface In4733{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4733{y:number;vy:number;sc:number}
const C4733={g:0.8, j:11};
export function extraRender_4733(inp:In4733, dt:number):Out4733 {
...
export const mm4733={d:'obstacle_spawn'};