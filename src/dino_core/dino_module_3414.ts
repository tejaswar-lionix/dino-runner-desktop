/** dino_module_3414 — score_speed extended, humanized desktop */
export interface In3414{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3414{y:number;vy:number;sc:number}
const C3414={g:0.7, j:11};
export function extraRender_3414(inp:In3414, dt:number):Out3414 {
...
export const mm3414={d:'score_speed'};