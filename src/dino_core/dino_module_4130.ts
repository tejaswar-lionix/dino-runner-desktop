/** dino_module_4130 — score_speed extended, humanized desktop */
export interface In4130{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4130{y:number;vy:number;sc:number}
const C4130={g:0.8, j:13};
export function extraPhysics_4130(inp:In4130, dt:number):Out4130 {
...
export const mm4130={d:'score_speed'};