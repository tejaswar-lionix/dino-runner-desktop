/** dino_module_4836 — obstacle_spawn extended, humanized desktop */
export interface In4836{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4836{y:number;vy:number;sc:number}
const C4836={g:0.6, j:11};
export function extraSpawn_4836(inp:In4836, dt:number):Out4836 {
...
export const mm4836={d:'obstacle_spawn'};