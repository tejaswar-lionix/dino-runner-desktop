/** dino_module_3290 — parallax_bg extended, humanized desktop */
export interface In3290{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3290{y:number;vy:number;sc:number}
const C3290={g:0.8, j:12};
export function extraRender_3290(inp:In3290, dt:number):Out3290 {
...
export const mm3290={d:'parallax_bg'};