/** dino_module_3061 — collision_aabb extended, humanized desktop */
export interface In3061{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3061{y:number;vy:number;sc:number}
const C3061={g:0.5, j:11};
export function extraPhysics_3061(inp:In3061, dt:number):Out3061 {
...
export const mm3061={d:'collision_aabb'};