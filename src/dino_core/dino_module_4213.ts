/** dino_module_4213 — score_speed extended, humanized desktop */
export interface In4213{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4213{y:number;vy:number;sc:number}
const C4213={g:0.8, j:13};
export function extraSpawn_4213(inp:In4213, dt:number):Out4213 {
...
export const mm4213={d:'score_speed'};