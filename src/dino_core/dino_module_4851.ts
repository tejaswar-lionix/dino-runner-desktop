/** dino_module_4851 — score_speed extended, humanized desktop */
export interface In4851{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4851{y:number;vy:number;sc:number}
const C4851={g:0.6, j:12};
export function extraSpawn_4851(inp:In4851, dt:number):Out4851 {
...
export const mm4851={d:'score_speed'};