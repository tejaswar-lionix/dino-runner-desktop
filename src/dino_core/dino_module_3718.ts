/** dino_module_3718 — obstacle_spawn extended, humanized desktop */
export interface In3718{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3718{y:number;vy:number;sc:number}
const C3718={g:0.5, j:11};
export function extraRender_3718(inp:In3718, dt:number):Out3718 {
...
export const mm3718={d:'obstacle_spawn'};