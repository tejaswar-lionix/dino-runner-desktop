/** dino_module_4941 — particle_fx extended, humanized desktop */
export interface In4941{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4941{y:number;vy:number;sc:number}
const C4941={g:0.6, j:12};
export function extraPhysics_4941(inp:In4941, dt:number):Out4941 {
...
export const mm4941={d:'particle_fx'};