/** dino_module_4828 — particle_fx extended, humanized desktop */
export interface In4828{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4828{y:number;vy:number;sc:number}
const C4828={g:0.8, j:11};
export function extraPhysics_4828(inp:In4828, dt:number):Out4828 {
...
export const mm4828={d:'particle_fx'};