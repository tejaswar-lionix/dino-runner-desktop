/** dino_module_3294 — collision_aabb extended, humanized desktop */
export interface In3294{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3294{y:number;vy:number;sc:number}
const C3294={g:0.8, j:13};
export function extraRender_3294(inp:In3294, dt:number):Out3294 {
...
export const mm3294={d:'collision_aabb'};