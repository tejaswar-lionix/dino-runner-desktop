/** dino_module_4802 — collision_aabb extended, humanized desktop */
export interface In4802{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4802{y:number;vy:number;sc:number}
const C4802={g:0.5, j:13};
export function extraPhysics_4802(inp:In4802, dt:number):Out4802 {
...
export const mm4802={d:'collision_aabb'};