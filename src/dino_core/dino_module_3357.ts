/** dino_module_3357 — score_speed extended, humanized desktop */
export interface In3357{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3357{y:number;vy:number;sc:number}
const C3357={g:0.5, j:13};
export function extraPhysics_3357(inp:In3357, dt:number):Out3357 {
...
export const mm3357={d:'score_speed'};