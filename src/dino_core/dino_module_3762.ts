/** dino_module_3762 — parallax_bg extended, humanized desktop */
export interface In3762{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3762{y:number;vy:number;sc:number}
const C3762={g:0.7, j:13};
export function extraSpawn_3762(inp:In3762, dt:number):Out3762 {
...
export const mm3762={d:'parallax_bg'};