/** dino_module_3699 — collision_aabb extended, humanized desktop */
export interface In3699{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3699{y:number;vy:number;sc:number}
const C3699={g:0.6, j:13};
export function extraRender_3699(inp:In3699, dt:number):Out3699 {
...
export const mm3699={d:'collision_aabb'};