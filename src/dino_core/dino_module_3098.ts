/** dino_module_3098 — parallax_bg extended, humanized desktop */
export interface In3098{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3098{y:number;vy:number;sc:number}
const C3098={g:0.8, j:12};
export function extraPhysics_3098(inp:In3098, dt:number):Out3098 {
...
export const mm3098={d:'parallax_bg'};