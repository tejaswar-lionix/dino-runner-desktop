/** dino_module_4793 — particle_fx extended, humanized desktop */
export interface In4793{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4793{y:number;vy:number;sc:number}
const C4793={g:0.7, j:11};
export function extraSpawn_4793(inp:In4793, dt:number):Out4793 {
...
export const mm4793={d:'particle_fx'};