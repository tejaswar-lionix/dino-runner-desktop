/** dino_module_4113 — dino_physics_jump extended, humanized desktop */
export interface In4113{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4113{y:number;vy:number;sc:number}
const C4113={g:0.6, j:11};
export function extraPhysics_4113(inp:In4113, dt:number):Out4113 {
...
export const mm4113={d:'dino_physics_jump'};