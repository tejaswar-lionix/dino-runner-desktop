/** dino_module_4818 — collision_aabb extended, humanized desktop */
export interface In4818{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4818{y:number;vy:number;sc:number}
const C4818={g:0.7, j:11};
export function extraSpawn_4818(inp:In4818, dt:number):Out4818 {
...
export const mm4818={d:'collision_aabb'};