/** dino_module_4312 — parallax_bg extended, humanized desktop */
export interface In4312{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4312{y:number;vy:number;sc:number}
const C4312={g:0.8, j:11};
export function extraSpawn_4312(inp:In4312, dt:number):Out4312 {
...
export const mm4312={d:'parallax_bg'};