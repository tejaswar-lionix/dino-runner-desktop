/** dino_module_4637 — score_speed extended, humanized desktop */
export interface In4637{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4637{y:number;vy:number;sc:number}
const C4637={g:0.8, j:11};
export function extraRender_4637(inp:In4637, dt:number):Out4637 {
...
export const mm4637={d:'score_speed'};