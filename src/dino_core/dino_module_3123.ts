/** dino_module_3123 — particle_fx extended, humanized desktop */
export interface In3123{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3123{y:number;vy:number;sc:number}
const C3123={g:0.8, j:11};
export function extraRender_3123(inp:In3123, dt:number):Out3123 {
...
export const mm3123={d:'particle_fx'};