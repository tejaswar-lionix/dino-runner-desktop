/** dino_module_4929 — score_speed extended, humanized desktop */
export interface In4929{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4929{y:number;vy:number;sc:number}
const C4929={g:0.5, j:11};
export function extraSpawn_4929(inp:In4929, dt:number):Out4929 {
...
export const mm4929={d:'score_speed'};