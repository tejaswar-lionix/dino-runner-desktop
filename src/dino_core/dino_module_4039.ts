/** dino_module_4039 — score_speed extended, humanized desktop */
export interface In4039{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4039{y:number;vy:number;sc:number}
const C4039={g:0.6, j:13};
export function extraRender_4039(inp:In4039, dt:number):Out4039 {
...
export const mm4039={d:'score_speed'};