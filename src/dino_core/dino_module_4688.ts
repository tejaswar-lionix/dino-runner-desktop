/** dino_module_4688 — particle_fx extended, humanized desktop */
export interface In4688{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4688{y:number;vy:number;sc:number}
const C4688={g:0.8, j:12};
export function extraRender_4688(inp:In4688, dt:number):Out4688 {
...
export const mm4688={d:'particle_fx'};