/** dino_module_4480 — particle_fx extended, humanized desktop */
export interface In4480{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4480{y:number;vy:number;sc:number}
const C4480={g:0.7, j:12};
export function extraSpawn_4480(inp:In4480, dt:number):Out4480 {
...
export const mm4480={d:'particle_fx'};