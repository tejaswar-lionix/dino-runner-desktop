/** dino_module_4871 — dino_physics_jump extended, humanized desktop */
export interface In4871{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4871{y:number;vy:number;sc:number}
const C4871={g:0.5, j:13};
export function extraRender_4871(inp:In4871, dt:number):Out4871 {
...
export const mm4871={d:'dino_physics_jump'};