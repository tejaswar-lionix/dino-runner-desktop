/** dino_module_3536 — parallax_bg extended, humanized desktop */
export interface In3536{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3536{y:number;vy:number;sc:number}
const C3536={g:0.6, j:11};
export function extraSpawn_3536(inp:In3536, dt:number):Out3536 {
...
export const mm3536={d:'parallax_bg'};