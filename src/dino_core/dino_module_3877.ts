/** dino_module_3877 — parallax_bg extended, humanized desktop */
export interface In3877{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3877{y:number;vy:number;sc:number}
const C3877={g:0.6, j:11};
export function extraRender_3877(inp:In3877, dt:number):Out3877 {
...
export const mm3877={d:'parallax_bg'};