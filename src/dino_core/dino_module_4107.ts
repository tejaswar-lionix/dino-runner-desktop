/** dino_module_4107 — score_speed extended, humanized desktop */
export interface In4107{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4107{y:number;vy:number;sc:number}
const C4107={g:0.8, j:12};
export function extraRender_4107(inp:In4107, dt:number):Out4107 {
...
export const mm4107={d:'score_speed'};