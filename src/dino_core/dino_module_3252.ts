/** dino_module_3252 — parallax_bg extended, humanized desktop */
export interface In3252{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3252{y:number;vy:number;sc:number}
const C3252={g:0.5, j:13};
export function extraRender_3252(inp:In3252, dt:number):Out3252 {
...
export const mm3252={d:'parallax_bg'};