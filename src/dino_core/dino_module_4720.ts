/** dino_module_4720 — obstacle_spawn extended, humanized desktop */
export interface In4720{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4720{y:number;vy:number;sc:number}
const C4720={g:0.7, j:12};
export function extraSpawn_4720(inp:In4720, dt:number):Out4720 {
...
export const mm4720={d:'obstacle_spawn'};