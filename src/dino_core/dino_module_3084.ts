/** dino_module_3084 — particle_fx extended, humanized desktop */
export interface In3084{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3084{y:number;vy:number;sc:number}
const C3084={g:0.5, j:13};
export function extraSpawn_3084(inp:In3084, dt:number):Out3084 {
...
export const mm3084={d:'particle_fx'};