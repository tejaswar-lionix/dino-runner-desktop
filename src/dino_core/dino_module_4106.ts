/** dino_module_4106 — parallax_bg extended, humanized desktop */
export interface In4106{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4106{y:number;vy:number;sc:number}
const C4106={g:0.7, j:11};
export function extraSpawn_4106(inp:In4106, dt:number):Out4106 {
...
export const mm4106={d:'parallax_bg'};