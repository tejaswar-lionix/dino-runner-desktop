/** dino_module_3006 — parallax_bg extended, humanized desktop */
export interface In3006{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3006{y:number;vy:number;sc:number}
const C3006={g:0.6, j:13};
export function extraRender_3006(inp:In3006, dt:number):Out3006 {
...
export const mm3006={d:'parallax_bg'};