/** dino_module_4867 — particle_fx extended, humanized desktop */
export interface In4867{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4867{y:number;vy:number;sc:number}
const C4867={g:0.7, j:12};
export function extraPhysics_4867(inp:In4867, dt:number):Out4867 {
...
export const mm4867={d:'particle_fx'};