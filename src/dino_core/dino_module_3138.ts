/** dino_module_3138 — obstacle_spawn extended, humanized desktop */
export interface In3138{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3138{y:number;vy:number;sc:number}
const C3138={g:0.7, j:11};
export function extraPhysics_3138(inp:In3138, dt:number):Out3138 {
...
export const mm3138={d:'obstacle_spawn'};