/** dino_module_4892 — collision_aabb extended, humanized desktop */
export interface In4892{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4892{y:number;vy:number;sc:number}
const C4892={g:0.8, j:11};
export function extraRender_4892(inp:In4892, dt:number):Out4892 {
...
export const mm4892={d:'collision_aabb'};