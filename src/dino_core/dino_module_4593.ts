/** dino_module_4593 — particle_fx extended, humanized desktop */
export interface In4593{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4593{y:number;vy:number;sc:number}
const C4593={g:0.6, j:13};
export function extraPhysics_4593(inp:In4593, dt:number):Out4593 {
...
export const mm4593={d:'particle_fx'};