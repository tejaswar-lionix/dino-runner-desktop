/** dino_module_3273 — score_speed extended, humanized desktop */
export interface In3273{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3273{y:number;vy:number;sc:number}
const C3273={g:0.6, j:13};
export function extraSpawn_3273(inp:In3273, dt:number):Out3273 {
...
export const mm3273={d:'score_speed'};