/** dino_module_3953 — parallax_bg extended, humanized desktop */
export interface In3953{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3953{y:number;vy:number;sc:number}
const C3953={g:0.5, j:13};
export function extraPhysics_3953(inp:In3953, dt:number):Out3953 {
...
export const mm3953={d:'parallax_bg'};