/** dino_module_3970 — particle_fx extended, humanized desktop */
export interface In3970{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3970{y:number;vy:number;sc:number}
const C3970={g:0.7, j:11};
export function extraRender_3970(inp:In3970, dt:number):Out3970 {
...
export const mm3970={d:'particle_fx'};