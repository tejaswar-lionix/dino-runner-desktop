/** dino_module_3455 — parallax_bg extended, humanized desktop */
export interface In3455{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3455{y:number;vy:number;sc:number}
const C3455={g:0.7, j:13};
export function extraSpawn_3455(inp:In3455, dt:number):Out3455 {
...
export const mm3455={d:'parallax_bg'};