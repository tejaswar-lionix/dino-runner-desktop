/** dino_module_3005 — collision_aabb extended, humanized desktop */
export interface In3005{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3005{y:number;vy:number;sc:number}
const C3005={g:0.7, j:11};
export function extraRender_3005(inp:In3005, dt:number):Out3005 {
...
export const mm3005={d:'collision_aabb'};