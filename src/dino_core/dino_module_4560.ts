/** dino_module_4560 — score_speed extended, humanized desktop */
export interface In4560{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4560{y:number;vy:number;sc:number}
const C4560={g:0.7, j:13};
export function extraRender_4560(inp:In4560, dt:number):Out4560 {
...
export const mm4560={d:'score_speed'};