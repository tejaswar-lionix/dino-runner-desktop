/** dino_module_4881 — score_speed extended, humanized desktop */
export interface In4881{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4881{y:number;vy:number;sc:number}
const C4881={g:0.8, j:11};
export function extraRender_4881(inp:In4881, dt:number):Out4881 {
...
export const mm4881={d:'score_speed'};