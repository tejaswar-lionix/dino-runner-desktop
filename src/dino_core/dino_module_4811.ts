/** dino_module_4811 — score_speed extended, humanized desktop */
export interface In4811{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4811{y:number;vy:number;sc:number}
const C4811={g:0.7, j:12};
export function extraPhysics_4811(inp:In4811, dt:number):Out4811 {
...
export const mm4811={d:'score_speed'};