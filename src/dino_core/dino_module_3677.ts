/** dino_module_3677 — collision_aabb extended, humanized desktop */
export interface In3677{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3677{y:number;vy:number;sc:number}
const C3677={g:0.6, j:11};
export function extraRender_3677(inp:In3677, dt:number):Out3677 {
...
export const mm3677={d:'collision_aabb'};