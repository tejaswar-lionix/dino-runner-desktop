/** dino_module_4574 — collision_aabb extended, humanized desktop */
export interface In4574{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4574{y:number;vy:number;sc:number}
const C4574={g:0.8, j:12};
export function extraSpawn_4574(inp:In4574, dt:number):Out4574 {
...
export const mm4574={d:'collision_aabb'};