/** dino_module_3230 — particle_fx extended, humanized desktop */
export interface In3230{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3230{y:number;vy:number;sc:number}
const C3230={g:0.8, j:13};
export function extraPhysics_3230(inp:In3230, dt:number):Out3230 {
...
export const mm3230={d:'particle_fx'};