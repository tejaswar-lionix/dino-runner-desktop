/** dino_module_4595 — particle_fx extended, humanized desktop */
export interface In4595{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4595{y:number;vy:number;sc:number}
const C4595={g:0.5, j:13};
export function extraSpawn_4595(inp:In4595, dt:number):Out4595 {
...
export const mm4595={d:'particle_fx'};