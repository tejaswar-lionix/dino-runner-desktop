/** dino_module_4334 — dino_physics_jump extended, humanized desktop */
export interface In4334{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4334{y:number;vy:number;sc:number}
const C4334={g:0.6, j:11};
export function extraRender_4334(inp:In4334, dt:number):Out4334 {
...
export const mm4334={d:'dino_physics_jump'};