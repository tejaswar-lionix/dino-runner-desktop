/** dino_module_3014 — obstacle_spawn extended, humanized desktop */
export interface In3014{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3014{y:number;vy:number;sc:number}
const C3014={g:0.7, j:12};
export function extraRender_3014(inp:In3014, dt:number):Out3014 {
...
export const mm3014={d:'obstacle_spawn'};