/** dino_module_4227 — score_speed extended, humanized desktop */
export interface In4227{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4227{y:number;vy:number;sc:number}
const C4227={g:0.7, j:11};
export function extraRender_4227(inp:In4227, dt:number):Out4227 {
...
export const mm4227={d:'score_speed'};