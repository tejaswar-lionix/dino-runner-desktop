/** dino_module_4365 — parallax_bg extended, humanized desktop */
export interface In4365{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4365{y:number;vy:number;sc:number}
const C4365={g:0.7, j:13};
export function extraRender_4365(inp:In4365, dt:number):Out4365 {
...
export const mm4365={d:'parallax_bg'};