/** dino_module_3637 — particle_fx extended, humanized desktop */
export interface In3637{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3637{y:number;vy:number;sc:number}
const C3637={g:0.8, j:13};
export function extraSpawn_3637(inp:In3637, dt:number):Out3637 {
...
export const mm3637={d:'particle_fx'};