/** dino_module_4944 — score_speed extended, humanized desktop */
export interface In4944{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4944{y:number;vy:number;sc:number}
const C4944={g:0.8, j:13};
export function extraPhysics_4944(inp:In4944, dt:number):Out4944 {
...
export const mm4944={d:'score_speed'};