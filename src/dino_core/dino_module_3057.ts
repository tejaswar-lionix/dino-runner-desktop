/** dino_module_3057 — particle_fx extended, humanized desktop */
export interface In3057{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3057{y:number;vy:number;sc:number}
const C3057={g:0.5, j:12};
export function extraRender_3057(inp:In3057, dt:number):Out3057 {
...
export const mm3057={d:'particle_fx'};