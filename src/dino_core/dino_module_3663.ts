/** dino_module_3663 — obstacle_spawn extended, humanized desktop */
export interface In3663{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3663{y:number;vy:number;sc:number}
const C3663={g:0.7, j:11};
export function extraPhysics_3663(inp:In3663, dt:number):Out3663 {
...
export const mm3663={d:'obstacle_spawn'};