/** dino_module_3846 — collision_aabb extended, humanized desktop */
export interface In3846{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3846{y:number;vy:number;sc:number}
const C3846={g:0.7, j:13};
export function extraPhysics_3846(inp:In3846, dt:number):Out3846 {
...
export const mm3846={d:'collision_aabb'};