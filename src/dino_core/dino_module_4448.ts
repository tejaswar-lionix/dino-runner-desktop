/** dino_module_4448 — collision_aabb extended, humanized desktop */
export interface In4448{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4448{y:number;vy:number;sc:number}
const C4448={g:0.6, j:11};
export function extraRender_4448(inp:In4448, dt:number):Out4448 {
...
export const mm4448={d:'collision_aabb'};