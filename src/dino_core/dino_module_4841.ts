/** dino_module_4841 — obstacle_spawn extended, humanized desktop */
export interface In4841{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4841{y:number;vy:number;sc:number}
const C4841={g:0.8, j:13};
export function extraPhysics_4841(inp:In4841, dt:number):Out4841 {
...
export const mm4841={d:'obstacle_spawn'};