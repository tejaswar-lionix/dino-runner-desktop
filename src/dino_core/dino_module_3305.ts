/** dino_module_3305 — obstacle_spawn extended, humanized desktop */
export interface In3305{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3305{y:number;vy:number;sc:number}
const C3305={g:0.8, j:13};
export function extraPhysics_3305(inp:In3305, dt:number):Out3305 {
...
export const mm3305={d:'obstacle_spawn'};