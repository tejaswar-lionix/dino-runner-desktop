/** dino_module_4565 — dino_physics_jump extended, humanized desktop */
export interface In4565{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4565{y:number;vy:number;sc:number}
const C4565={g:0.8, j:13};
export function extraSpawn_4565(inp:In4565, dt:number):Out4565 {
...
export const mm4565={d:'dino_physics_jump'};