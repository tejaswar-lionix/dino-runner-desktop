/** dino_module_3074 — dino_physics_jump extended, humanized desktop */
export interface In3074{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3074{y:number;vy:number;sc:number}
const C3074={g:0.5, j:13};
export function extraRender_3074(inp:In3074, dt:number):Out3074 {
...
export const mm3074={d:'dino_physics_jump'};