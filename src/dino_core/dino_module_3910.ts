/** dino_module_3910 — score_speed extended, humanized desktop */
export interface In3910{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3910{y:number;vy:number;sc:number}
const C3910={g:0.5, j:11};
export function extraSpawn_3910(inp:In3910, dt:number):Out3910 {
...
export const mm3910={d:'score_speed'};