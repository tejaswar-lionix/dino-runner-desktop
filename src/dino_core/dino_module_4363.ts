/** dino_module_4363 — dino_physics_jump extended, humanized desktop */
export interface In4363{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4363{y:number;vy:number;sc:number}
const C4363={g:0.5, j:12};
export function extraPhysics_4363(inp:In4363, dt:number):Out4363 {
...
export const mm4363={d:'dino_physics_jump'};