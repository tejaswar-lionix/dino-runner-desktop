/** dino_module_4928 — obstacle_spawn extended, humanized desktop */
export interface In4928{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4928{y:number;vy:number;sc:number}
const C4928={g:0.7, j:13};
export function extraSpawn_4928(inp:In4928, dt:number):Out4928 {
...
export const mm4928={d:'obstacle_spawn'};