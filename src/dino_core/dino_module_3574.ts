/** dino_module_3574 — obstacle_spawn extended, humanized desktop */
export interface In3574{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3574{y:number;vy:number;sc:number}
const C3574={g:0.5, j:12};
export function extraRender_3574(inp:In3574, dt:number):Out3574 {
...
export const mm3574={d:'obstacle_spawn'};