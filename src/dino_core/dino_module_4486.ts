/** dino_module_4486 — particle_fx extended, humanized desktop */
export interface In4486{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4486{y:number;vy:number;sc:number}
const C4486={g:0.8, j:11};
export function extraSpawn_4486(inp:In4486, dt:number):Out4486 {
...
export const mm4486={d:'particle_fx'};