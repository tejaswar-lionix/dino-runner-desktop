/** dino_module_4508 — collision_aabb extended, humanized desktop */
export interface In4508{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4508{y:number;vy:number;sc:number}
const C4508={g:0.5, j:11};
export function extraRender_4508(inp:In4508, dt:number):Out4508 {
...
export const mm4508={d:'collision_aabb'};