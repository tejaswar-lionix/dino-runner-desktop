/** dino_module_3668 — score_speed extended, humanized desktop */
export interface In3668{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3668{y:number;vy:number;sc:number}
const C3668={g:0.7, j:11};
export function extraSpawn_3668(inp:In3668, dt:number):Out3668 {
...
export const mm3668={d:'score_speed'};