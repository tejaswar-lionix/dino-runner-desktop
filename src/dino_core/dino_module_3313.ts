/** dino_module_3313 — obstacle_spawn extended, humanized desktop */
export interface In3313{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3313{y:number;vy:number;sc:number}
const C3313={g:0.7, j:12};
export function extraPhysics_3313(inp:In3313, dt:number):Out3313 {
...
export const mm3313={d:'obstacle_spawn'};