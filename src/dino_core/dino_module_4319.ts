/** dino_module_4319 — obstacle_spawn extended, humanized desktop */
export interface In4319{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4319{y:number;vy:number;sc:number}
const C4319={g:0.7, j:11};
export function extraRender_4319(inp:In4319, dt:number):Out4319 {
...
export const mm4319={d:'obstacle_spawn'};