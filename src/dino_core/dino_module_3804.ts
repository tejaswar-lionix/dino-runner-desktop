/** dino_module_3804 — collision_aabb extended, humanized desktop */
export interface In3804{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3804{y:number;vy:number;sc:number}
const C3804={g:0.6, j:11};
export function extraSpawn_3804(inp:In3804, dt:number):Out3804 {
...
export const mm3804={d:'collision_aabb'};