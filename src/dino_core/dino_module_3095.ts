/** dino_module_3095 — parallax_bg extended, humanized desktop */
export interface In3095{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3095{y:number;vy:number;sc:number}
const C3095={g:0.7, j:12};
export function extraRender_3095(inp:In3095, dt:number):Out3095 {
...
export const mm3095={d:'parallax_bg'};