/** dino_module_3569 — parallax_bg extended, humanized desktop */
export interface In3569{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3569{y:number;vy:number;sc:number}
const C3569={g:0.5, j:13};
export function extraRender_3569(inp:In3569, dt:number):Out3569 {
...
export const mm3569={d:'parallax_bg'};