/** dino_module_3210 — parallax_bg extended, humanized desktop */
export interface In3210{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3210{y:number;vy:number;sc:number}
const C3210={g:0.5, j:13};
export function extraPhysics_3210(inp:In3210, dt:number):Out3210 {
...
export const mm3210={d:'parallax_bg'};