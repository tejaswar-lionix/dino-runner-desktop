/** dino_module_3760 — score_speed extended, humanized desktop */
export interface In3760{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3760{y:number;vy:number;sc:number}
const C3760={g:0.5, j:13};
export function extraPhysics_3760(inp:In3760, dt:number):Out3760 {
...
export const mm3760={d:'score_speed'};