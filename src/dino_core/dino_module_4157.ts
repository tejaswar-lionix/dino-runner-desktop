/** dino_module_4157 — particle_fx extended, humanized desktop */
export interface In4157{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4157{y:number;vy:number;sc:number}
const C4157={g:0.7, j:13};
export function extraPhysics_4157(inp:In4157, dt:number):Out4157 {
...
export const mm4157={d:'particle_fx'};