/** dino_module_4100 — dino_physics_jump extended, humanized desktop */
export interface In4100{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4100{y:number;vy:number;sc:number}
const C4100={g:0.6, j:12};
export function extraPhysics_4100(inp:In4100, dt:number):Out4100 {
...
export const mm4100={d:'dino_physics_jump'};