/** dino_module_3801 — dino_physics_jump extended, humanized desktop */
export interface In3801{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3801{y:number;vy:number;sc:number}
const C3801={g:0.7, j:12};
export function extraRender_3801(inp:In3801, dt:number):Out3801 {
...
export const mm3801={d:'dino_physics_jump'};