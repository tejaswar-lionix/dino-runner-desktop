/** dino_module_4821 — particle_fx extended, humanized desktop */
export interface In4821{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4821{y:number;vy:number;sc:number}
const C4821={g:0.5, j:12};
export function extraPhysics_4821(inp:In4821, dt:number):Out4821 {
...
export const mm4821={d:'particle_fx'};