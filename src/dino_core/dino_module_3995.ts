/** dino_module_3995 — dino_physics_jump extended, humanized desktop */
export interface In3995{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3995{y:number;vy:number;sc:number}
const C3995={g:0.6, j:11};
export function extraPhysics_3995(inp:In3995, dt:number):Out3995 {
...
export const mm3995={d:'dino_physics_jump'};