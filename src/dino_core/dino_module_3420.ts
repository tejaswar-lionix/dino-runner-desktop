/** dino_module_3420 — particle_fx extended, humanized desktop */
export interface In3420{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3420{y:number;vy:number;sc:number}
const C3420={g:0.5, j:13};
export function extraPhysics_3420(inp:In3420, dt:number):Out3420 {
...
export const mm3420={d:'particle_fx'};