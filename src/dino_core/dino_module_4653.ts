/** dino_module_4653 — particle_fx extended, humanized desktop */
export interface In4653{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4653{y:number;vy:number;sc:number}
const C4653={g:0.5, j:13};
export function extraSpawn_4653(inp:In4653, dt:number):Out4653 {
...
export const mm4653={d:'particle_fx'};