/** dino_module_3675 — dino_physics_jump extended, humanized desktop */
export interface In3675{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3675{y:number;vy:number;sc:number}
const C3675={g:0.5, j:12};
export function extraSpawn_3675(inp:In3675, dt:number):Out3675 {
...
export const mm3675={d:'dino_physics_jump'};