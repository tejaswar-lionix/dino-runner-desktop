/** dino_module_4206 — collision_aabb extended, humanized desktop */
export interface In4206{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4206{y:number;vy:number;sc:number}
const C4206={g:0.5, j:13};
export function extraSpawn_4206(inp:In4206, dt:number):Out4206 {
...
export const mm4206={d:'collision_aabb'};