/** dino_module_3048 — collision_aabb extended, humanized desktop */
export interface In3048{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3048{y:number;vy:number;sc:number}
const C3048={g:0.6, j:13};
export function extraPhysics_3048(inp:In3048, dt:number):Out3048 {
...
export const mm3048={d:'collision_aabb'};