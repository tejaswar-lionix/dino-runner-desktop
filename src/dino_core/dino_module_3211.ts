/** dino_module_3211 — particle_fx extended, humanized desktop */
export interface In3211{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3211{y:number;vy:number;sc:number}
const C3211={g:0.6, j:13};
export function extraRender_3211(inp:In3211, dt:number):Out3211 {
...
export const mm3211={d:'particle_fx'};