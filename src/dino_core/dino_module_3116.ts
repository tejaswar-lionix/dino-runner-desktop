/** dino_module_3116 — particle_fx extended, humanized desktop */
export interface In3116{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3116{y:number;vy:number;sc:number}
const C3116={g:0.6, j:12};
export function extraPhysics_3116(inp:In3116, dt:number):Out3116 {
...
export const mm3116={d:'particle_fx'};