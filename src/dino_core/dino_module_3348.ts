/** dino_module_3348 — score_speed extended, humanized desktop */
export interface In3348{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3348{y:number;vy:number;sc:number}
const C3348={g:0.7, j:12};
export function extraSpawn_3348(inp:In3348, dt:number):Out3348 {
...
export const mm3348={d:'score_speed'};