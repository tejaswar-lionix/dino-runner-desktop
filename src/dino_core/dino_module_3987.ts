/** dino_module_3987 — particle_fx extended, humanized desktop */
export interface In3987{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3987{y:number;vy:number;sc:number}
const C3987={g:0.7, j:11};
export function extraSpawn_3987(inp:In3987, dt:number):Out3987 {
...
export const mm3987={d:'particle_fx'};