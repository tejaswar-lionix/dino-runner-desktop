/** dino_module_3857 — obstacle_spawn extended, humanized desktop */
export interface In3857{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3857{y:number;vy:number;sc:number}
const C3857={g:0.6, j:13};
export function extraSpawn_3857(inp:In3857, dt:number):Out3857 {
...
export const mm3857={d:'obstacle_spawn'};