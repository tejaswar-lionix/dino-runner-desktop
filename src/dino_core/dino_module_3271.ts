/** dino_module_3271 — obstacle_spawn extended, humanized desktop */
export interface In3271{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3271{y:number;vy:number;sc:number}
const C3271={g:0.8, j:13};
export function extraRender_3271(inp:In3271, dt:number):Out3271 {
...
export const mm3271={d:'obstacle_spawn'};