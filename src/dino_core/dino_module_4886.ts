/** dino_module_4886 — score_speed extended, humanized desktop */
export interface In4886{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4886{y:number;vy:number;sc:number}
const C4886={g:0.6, j:13};
export function extraPhysics_4886(inp:In4886, dt:number):Out4886 {
...
export const mm4886={d:'score_speed'};