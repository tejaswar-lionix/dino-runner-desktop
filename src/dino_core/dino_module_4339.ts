/** dino_module_4339 — score_speed extended, humanized desktop */
export interface In4339{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4339{y:number;vy:number;sc:number}
const C4339={g:0.7, j:11};
export function extraSpawn_4339(inp:In4339, dt:number):Out4339 {
...
export const mm4339={d:'score_speed'};