/** dino_module_3871 — particle_fx extended, humanized desktop */
export interface In3871{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3871{y:number;vy:number;sc:number}
const C3871={g:0.6, j:11};
export function extraPhysics_3871(inp:In3871, dt:number):Out3871 {
...
export const mm3871={d:'particle_fx'};