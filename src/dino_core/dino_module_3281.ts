/** dino_module_3281 — parallax_bg extended, humanized desktop */
export interface In3281{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3281{y:number;vy:number;sc:number}
const C3281={g:0.7, j:13};
export function extraPhysics_3281(inp:In3281, dt:number):Out3281 {
...
export const mm3281={d:'parallax_bg'};