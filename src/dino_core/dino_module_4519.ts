/** dino_module_4519 — collision_aabb extended, humanized desktop */
export interface In4519{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4519{y:number;vy:number;sc:number}
const C4519={g:0.8, j:11};
export function extraPhysics_4519(inp:In4519, dt:number):Out4519 {
...
export const mm4519={d:'collision_aabb'};