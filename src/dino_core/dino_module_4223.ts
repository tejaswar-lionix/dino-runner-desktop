/** dino_module_4223 — collision_aabb extended, humanized desktop */
export interface In4223{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4223{y:number;vy:number;sc:number}
const C4223={g:0.8, j:12};
export function extraPhysics_4223(inp:In4223, dt:number):Out4223 {
...
export const mm4223={d:'collision_aabb'};