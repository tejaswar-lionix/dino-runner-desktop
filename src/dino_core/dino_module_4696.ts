/** dino_module_4696 — collision_aabb extended, humanized desktop */
export interface In4696{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4696{y:number;vy:number;sc:number}
const C4696={g:0.5, j:12};
export function extraPhysics_4696(inp:In4696, dt:number):Out4696 {
...
export const mm4696={d:'collision_aabb'};