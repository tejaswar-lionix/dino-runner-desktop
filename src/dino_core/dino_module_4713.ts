/** dino_module_4713 — parallax_bg extended, humanized desktop */
export interface In4713{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4713{y:number;vy:number;sc:number}
const C4713={g:0.6, j:13};
export function extraRender_4713(inp:In4713, dt:number):Out4713 {
...
export const mm4713={d:'parallax_bg'};