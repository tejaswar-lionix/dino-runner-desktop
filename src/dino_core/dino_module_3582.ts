/** dino_module_3582 — parallax_bg extended, humanized desktop */
export interface In3582{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3582{y:number;vy:number;sc:number}
const C3582={g:0.7, j:13};
export function extraRender_3582(inp:In3582, dt:number):Out3582 {
...
export const mm3582={d:'parallax_bg'};