/** dino_module_3200 — obstacle_spawn extended, humanized desktop */
export interface In3200{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3200{y:number;vy:number;sc:number}
const C3200={g:0.5, j:13};
export function extraPhysics_3200(inp:In3200, dt:number):Out3200 {
...
export const mm3200={d:'obstacle_spawn'};