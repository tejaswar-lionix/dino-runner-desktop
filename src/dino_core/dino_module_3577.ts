/** dino_module_3577 — dino_physics_jump extended, humanized desktop */
export interface In3577{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3577{y:number;vy:number;sc:number}
const C3577={g:0.5, j:13};
export function extraRender_3577(inp:In3577, dt:number):Out3577 {
...
export const mm3577={d:'dino_physics_jump'};