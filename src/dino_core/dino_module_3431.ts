/** dino_module_3431 — particle_fx extended, humanized desktop */
export interface In3431{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3431{y:number;vy:number;sc:number}
const C3431={g:0.5, j:11};
export function extraPhysics_3431(inp:In3431, dt:number):Out3431 {
...
export const mm3431={d:'particle_fx'};