/** dino_module_3172 — particle_fx extended, humanized desktop */
export interface In3172{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3172{y:number;vy:number;sc:number}
const C3172={g:0.5, j:13};
export function extraRender_3172(inp:In3172, dt:number):Out3172 {
...
export const mm3172={d:'particle_fx'};