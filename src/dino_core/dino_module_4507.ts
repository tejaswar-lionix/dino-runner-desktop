/** dino_module_4507 — dino_physics_jump extended, humanized desktop */
export interface In4507{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4507{y:number;vy:number;sc:number}
const C4507={g:0.6, j:11};
export function extraSpawn_4507(inp:In4507, dt:number):Out4507 {
...
export const mm4507={d:'dino_physics_jump'};