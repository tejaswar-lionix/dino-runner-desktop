/** dino_module_4601 — particle_fx extended, humanized desktop */
export interface In4601{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4601{y:number;vy:number;sc:number}
const C4601={g:0.5, j:11};
export function extraPhysics_4601(inp:In4601, dt:number):Out4601 {
...
export const mm4601={d:'particle_fx'};