/** dino_module_4568 — collision_aabb extended, humanized desktop */
export interface In4568{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4568{y:number;vy:number;sc:number}
const C4568={g:0.5, j:13};
export function extraSpawn_4568(inp:In4568, dt:number):Out4568 {
...
export const mm4568={d:'collision_aabb'};