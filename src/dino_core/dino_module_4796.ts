/** dino_module_4796 — obstacle_spawn extended, humanized desktop */
export interface In4796{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4796{y:number;vy:number;sc:number}
const C4796={g:0.5, j:13};
export function extraRender_4796(inp:In4796, dt:number):Out4796 {
...
export const mm4796={d:'obstacle_spawn'};