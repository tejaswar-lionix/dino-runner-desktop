/** dino_module_4192 — obstacle_spawn extended, humanized desktop */
export interface In4192{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4192{y:number;vy:number;sc:number}
const C4192={g:0.5, j:13};
export function extraPhysics_4192(inp:In4192, dt:number):Out4192 {
...
export const mm4192={d:'obstacle_spawn'};