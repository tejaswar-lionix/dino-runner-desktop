/** dino_module_3633 — obstacle_spawn extended, humanized desktop */
export interface In3633{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3633{y:number;vy:number;sc:number}
const C3633={g:0.8, j:13};
export function extraPhysics_3633(inp:In3633, dt:number):Out3633 {
...
export const mm3633={d:'obstacle_spawn'};