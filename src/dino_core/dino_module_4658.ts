/** dino_module_4658 — dino_physics_jump extended, humanized desktop */
export interface In4658{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4658{y:number;vy:number;sc:number}
const C4658={g:0.6, j:13};
export function extraRender_4658(inp:In4658, dt:number):Out4658 {
...
export const mm4658={d:'dino_physics_jump'};