/** dino_module_4053 — parallax_bg extended, humanized desktop */
export interface In4053{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4053{y:number;vy:number;sc:number}
const C4053={g:0.6, j:12};
export function extraRender_4053(inp:In4053, dt:number):Out4053 {
...
export const mm4053={d:'parallax_bg'};