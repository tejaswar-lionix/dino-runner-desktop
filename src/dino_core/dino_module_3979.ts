/** dino_module_3979 — collision_aabb extended, humanized desktop */
export interface In3979{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3979{y:number;vy:number;sc:number}
const C3979={g:0.7, j:11};
export function extraSpawn_3979(inp:In3979, dt:number):Out3979 {
...
export const mm3979={d:'collision_aabb'};