/** dino_module_4591 — obstacle_spawn extended, humanized desktop */
export interface In4591{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4591{y:number;vy:number;sc:number}
const C4591={g:0.7, j:12};
export function extraSpawn_4591(inp:In4591, dt:number):Out4591 {
...
export const mm4591={d:'obstacle_spawn'};