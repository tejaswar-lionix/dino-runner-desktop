/** dino_module_3739 — obstacle_spawn extended, humanized desktop */
export interface In3739{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3739{y:number;vy:number;sc:number}
const C3739={g:0.8, j:12};
export function extraRender_3739(inp:In3739, dt:number):Out3739 {
...
export const mm3739={d:'obstacle_spawn'};