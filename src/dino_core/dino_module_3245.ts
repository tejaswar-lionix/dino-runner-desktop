/** dino_module_3245 — particle_fx extended, humanized desktop */
export interface In3245{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3245{y:number;vy:number;sc:number}
const C3245={g:0.5, j:11};
export function extraSpawn_3245(inp:In3245, dt:number):Out3245 {
...
export const mm3245={d:'particle_fx'};