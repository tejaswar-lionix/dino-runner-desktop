/** dino_module_4049 — particle_fx extended, humanized desktop */
export interface In4049{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4049{y:number;vy:number;sc:number}
const C4049={g:0.7, j:11};
export function extraSpawn_4049(inp:In4049, dt:number):Out4049 {
...
export const mm4049={d:'particle_fx'};