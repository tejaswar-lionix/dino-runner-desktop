/** dino_module_4674 — collision_aabb extended, humanized desktop */
export interface In4674{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4674{y:number;vy:number;sc:number}
const C4674={g:0.7, j:12};
export function extraRender_4674(inp:In4674, dt:number):Out4674 {
...
export const mm4674={d:'collision_aabb'};