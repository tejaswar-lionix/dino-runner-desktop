/** dino_module_4522 — obstacle_spawn extended, humanized desktop */
export interface In4522{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4522{y:number;vy:number;sc:number}
const C4522={g:0.6, j:11};
export function extraPhysics_4522(inp:In4522, dt:number):Out4522 {
...
export const mm4522={d:'obstacle_spawn'};