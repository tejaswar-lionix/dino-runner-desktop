/** dino_module_3854 — score_speed extended, humanized desktop */
export interface In3854{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3854{y:number;vy:number;sc:number}
const C3854={g:0.5, j:12};
export function extraSpawn_3854(inp:In3854, dt:number):Out3854 {
...
export const mm3854={d:'score_speed'};