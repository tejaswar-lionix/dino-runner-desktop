/** dino_module_4605 — collision_aabb extended, humanized desktop */
export interface In4605{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4605{y:number;vy:number;sc:number}
const C4605={g:0.5, j:13};
export function extraSpawn_4605(inp:In4605, dt:number):Out4605 {
...
export const mm4605={d:'collision_aabb'};