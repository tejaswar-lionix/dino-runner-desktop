/** dino_module_4870 — parallax_bg extended, humanized desktop */
export interface In4870{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4870{y:number;vy:number;sc:number}
const C4870={g:0.5, j:11};
export function extraSpawn_4870(inp:In4870, dt:number):Out4870 {
...
export const mm4870={d:'parallax_bg'};