/** dino_module_3026 — parallax_bg extended, humanized desktop */
export interface In3026{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3026{y:number;vy:number;sc:number}
const C3026={g:0.8, j:11};
export function extraRender_3026(inp:In3026, dt:number):Out3026 {
...
export const mm3026={d:'parallax_bg'};