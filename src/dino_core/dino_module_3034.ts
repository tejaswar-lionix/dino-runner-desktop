/** dino_module_3034 — particle_fx extended, humanized desktop */
export interface In3034{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3034{y:number;vy:number;sc:number}
const C3034={g:0.5, j:13};
export function extraSpawn_3034(inp:In3034, dt:number):Out3034 {
...
export const mm3034={d:'particle_fx'};