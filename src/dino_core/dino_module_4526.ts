/** dino_module_4526 — obstacle_spawn extended, humanized desktop */
export interface In4526{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4526{y:number;vy:number;sc:number}
const C4526={g:0.8, j:12};
export function extraPhysics_4526(inp:In4526, dt:number):Out4526 {
...
export const mm4526={d:'obstacle_spawn'};