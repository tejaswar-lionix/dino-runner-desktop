/** dino_module_3152 — particle_fx extended, humanized desktop */
export interface In3152{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3152{y:number;vy:number;sc:number}
const C3152={g:0.8, j:13};
export function extraRender_3152(inp:In3152, dt:number):Out3152 {
...
export const mm3152={d:'particle_fx'};