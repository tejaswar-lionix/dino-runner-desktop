/** dino_module_3704 — particle_fx extended, humanized desktop */
export interface In3704{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3704{y:number;vy:number;sc:number}
const C3704={g:0.8, j:12};
export function extraRender_3704(inp:In3704, dt:number):Out3704 {
...
export const mm3704={d:'particle_fx'};