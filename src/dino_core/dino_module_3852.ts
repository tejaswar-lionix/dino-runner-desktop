/** dino_module_3852 — particle_fx extended, humanized desktop */
export interface In3852{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3852{y:number;vy:number;sc:number}
const C3852={g:0.8, j:13};
export function extraPhysics_3852(inp:In3852, dt:number):Out3852 {
...
export const mm3852={d:'particle_fx'};