/** dino_module_3490 — collision_aabb extended, humanized desktop */
export interface In3490{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3490{y:number;vy:number;sc:number}
const C3490={g:0.5, j:12};
export function extraSpawn_3490(inp:In3490, dt:number):Out3490 {
...
export const mm3490={d:'collision_aabb'};