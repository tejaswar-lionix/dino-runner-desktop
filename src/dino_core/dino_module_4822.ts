/** dino_module_4822 — parallax_bg extended, humanized desktop */
export interface In4822{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4822{y:number;vy:number;sc:number}
const C4822={g:0.7, j:13};
export function extraSpawn_4822(inp:In4822, dt:number):Out4822 {
...
export const mm4822={d:'parallax_bg'};