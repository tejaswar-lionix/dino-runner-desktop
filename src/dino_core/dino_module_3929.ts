/** dino_module_3929 — collision_aabb extended, humanized desktop */
export interface In3929{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3929{y:number;vy:number;sc:number}
const C3929={g:0.7, j:13};
export function extraPhysics_3929(inp:In3929, dt:number):Out3929 {
...
export const mm3929={d:'collision_aabb'};