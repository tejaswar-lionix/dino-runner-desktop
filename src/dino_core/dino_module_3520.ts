/** dino_module_3520 — obstacle_spawn extended, humanized desktop */
export interface In3520{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3520{y:number;vy:number;sc:number}
const C3520={g:0.6, j:13};
export function extraPhysics_3520(inp:In3520, dt:number):Out3520 {
...
export const mm3520={d:'obstacle_spawn'};