/** dino_module_3022 — obstacle_spawn extended, humanized desktop */
export interface In3022{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3022{y:number;vy:number;sc:number}
const C3022={g:0.6, j:11};
export function extraRender_3022(inp:In3022, dt:number):Out3022 {
...
export const mm3022={d:'obstacle_spawn'};