/** dino_module_3862 — collision_aabb extended, humanized desktop */
export interface In3862{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3862{y:number;vy:number;sc:number}
const C3862={g:0.8, j:11};
export function extraSpawn_3862(inp:In3862, dt:number):Out3862 {
...
export const mm3862={d:'collision_aabb'};