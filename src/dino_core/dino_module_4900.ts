/** dino_module_4900 — parallax_bg extended, humanized desktop */
export interface In4900{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4900{y:number;vy:number;sc:number}
const C4900={g:0.8, j:13};
export function extraPhysics_4900(inp:In4900, dt:number):Out4900 {
...
export const mm4900={d:'parallax_bg'};