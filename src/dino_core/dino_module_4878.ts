/** dino_module_4878 — score_speed extended, humanized desktop */
export interface In4878{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4878{y:number;vy:number;sc:number}
const C4878={g:0.6, j:13};
export function extraSpawn_4878(inp:In4878, dt:number):Out4878 {
...
export const mm4878={d:'score_speed'};