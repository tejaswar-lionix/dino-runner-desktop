/** dino_module_4209 — score_speed extended, humanized desktop */
export interface In4209{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4209{y:number;vy:number;sc:number}
const C4209={g:0.8, j:13};
export function extraSpawn_4209(inp:In4209, dt:number):Out4209 {
...
export const mm4209={d:'score_speed'};