/** dino_module_3491 — parallax_bg extended, humanized desktop */
export interface In3491{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3491{y:number;vy:number;sc:number}
const C3491={g:0.8, j:13};
export function extraSpawn_3491(inp:In3491, dt:number):Out3491 {
...
export const mm3491={d:'parallax_bg'};