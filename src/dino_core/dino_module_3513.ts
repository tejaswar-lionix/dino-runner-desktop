/** dino_module_3513 — collision_aabb extended, humanized desktop */
export interface In3513{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3513{y:number;vy:number;sc:number}
const C3513={g:0.7, j:13};
export function extraSpawn_3513(inp:In3513, dt:number):Out3513 {
...
export const mm3513={d:'collision_aabb'};