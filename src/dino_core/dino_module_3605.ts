/** dino_module_3605 — obstacle_spawn extended, humanized desktop */
export interface In3605{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3605{y:number;vy:number;sc:number}
const C3605={g:0.8, j:11};
export function extraPhysics_3605(inp:In3605, dt:number):Out3605 {
...
export const mm3605={d:'obstacle_spawn'};