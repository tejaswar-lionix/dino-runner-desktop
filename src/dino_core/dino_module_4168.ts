/** dino_module_4168 — collision_aabb extended, humanized desktop */
export interface In4168{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4168{y:number;vy:number;sc:number}
const C4168={g:0.8, j:11};
export function extraRender_4168(inp:In4168, dt:number):Out4168 {
...
export const mm4168={d:'collision_aabb'};