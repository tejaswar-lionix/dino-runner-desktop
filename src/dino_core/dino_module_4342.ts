/** dino_module_4342 — score_speed extended, humanized desktop */
export interface In4342{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4342{y:number;vy:number;sc:number}
const C4342={g:0.8, j:13};
export function extraSpawn_4342(inp:In4342, dt:number):Out4342 {
...
export const mm4342={d:'score_speed'};