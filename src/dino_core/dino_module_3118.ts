/** dino_module_3118 — score_speed extended, humanized desktop */
export interface In3118{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3118{y:number;vy:number;sc:number}
const C3118={g:0.5, j:11};
export function extraRender_3118(inp:In3118, dt:number):Out3118 {
...
export const mm3118={d:'score_speed'};