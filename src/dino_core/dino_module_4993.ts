/** dino_module_4993 — dino_physics_jump extended, humanized desktop */
export interface In4993{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4993{y:number;vy:number;sc:number}
const C4993={g:0.5, j:11};
export function extraPhysics_4993(inp:In4993, dt:number):Out4993 {
...
export const mm4993={d:'dino_physics_jump'};