/** dino_module_4246 — particle_fx extended, humanized desktop */
export interface In4246{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4246{y:number;vy:number;sc:number}
const C4246={g:0.7, j:13};
export function extraSpawn_4246(inp:In4246, dt:number):Out4246 {
...
export const mm4246={d:'particle_fx'};