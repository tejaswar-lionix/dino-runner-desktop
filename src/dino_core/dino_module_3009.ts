/** dino_module_3009 — collision_aabb extended, humanized desktop */
export interface In3009{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3009{y:number;vy:number;sc:number}
const C3009={g:0.5, j:13};
export function extraPhysics_3009(inp:In3009, dt:number):Out3009 {
...
export const mm3009={d:'collision_aabb'};