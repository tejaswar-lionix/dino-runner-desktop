/** dino_module_4742 — score_speed extended, humanized desktop */
export interface In4742{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4742{y:number;vy:number;sc:number}
const C4742={g:0.6, j:12};
export function extraPhysics_4742(inp:In4742, dt:number):Out4742 {
...
export const mm4742={d:'score_speed'};