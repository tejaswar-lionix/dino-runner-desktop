/** dino_module_3872 — collision_aabb extended, humanized desktop */
export interface In3872{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3872{y:number;vy:number;sc:number}
const C3872={g:0.6, j:12};
export function extraRender_3872(inp:In3872, dt:number):Out3872 {
...
export const mm3872={d:'collision_aabb'};