/** dino_module_4459 — particle_fx extended, humanized desktop */
export interface In4459{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4459{y:number;vy:number;sc:number}
const C4459={g:0.8, j:12};
export function extraSpawn_4459(inp:In4459, dt:number):Out4459 {
...
export const mm4459={d:'particle_fx'};