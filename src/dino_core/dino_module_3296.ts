/** dino_module_3296 — parallax_bg extended, humanized desktop */
export interface In3296{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3296{y:number;vy:number;sc:number}
const C3296={g:0.5, j:12};
export function extraSpawn_3296(inp:In3296, dt:number):Out3296 {
...
export const mm3296={d:'parallax_bg'};