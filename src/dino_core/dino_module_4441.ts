/** dino_module_4441 — particle_fx extended, humanized desktop */
export interface In4441{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4441{y:number;vy:number;sc:number}
const C4441={g:0.5, j:13};
export function extraRender_4441(inp:In4441, dt:number):Out4441 {
...
export const mm4441={d:'particle_fx'};