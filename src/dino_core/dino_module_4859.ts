/** dino_module_4859 — parallax_bg extended, humanized desktop */
export interface In4859{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4859{y:number;vy:number;sc:number}
const C4859={g:0.5, j:11};
export function extraSpawn_4859(inp:In4859, dt:number):Out4859 {
...
export const mm4859={d:'parallax_bg'};