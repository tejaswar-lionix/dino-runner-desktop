/** dino_module_3825 — dino_physics_jump extended, humanized desktop */
export interface In3825{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3825{y:number;vy:number;sc:number}
const C3825={g:0.6, j:13};
export function extraSpawn_3825(inp:In3825, dt:number):Out3825 {
...
export const mm3825={d:'dino_physics_jump'};