/** dino_module_3163 — particle_fx extended, humanized desktop */
export interface In3163{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3163{y:number;vy:number;sc:number}
const C3163={g:0.7, j:11};
export function extraRender_3163(inp:In3163, dt:number):Out3163 {
...
export const mm3163={d:'particle_fx'};