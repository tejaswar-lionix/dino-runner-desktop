/** dino_module_3028 — parallax_bg extended, humanized desktop */
export interface In3028{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3028{y:number;vy:number;sc:number}
const C3028={g:0.5, j:11};
export function extraPhysics_3028(inp:In3028, dt:number):Out3028 {
...
export const mm3028={d:'parallax_bg'};