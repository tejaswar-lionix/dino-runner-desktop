/** dino_module_3947 — dino_physics_jump extended, humanized desktop */
export interface In3947{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3947{y:number;vy:number;sc:number}
const C3947={g:0.7, j:11};
export function extraSpawn_3947(inp:In3947, dt:number):Out3947 {
...
export const mm3947={d:'dino_physics_jump'};