/** dino_module_3844 — dino_physics_jump extended, humanized desktop */
export interface In3844{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3844{y:number;vy:number;sc:number}
const C3844={g:0.7, j:11};
export function extraSpawn_3844(inp:In3844, dt:number):Out3844 {
...
export const mm3844={d:'dino_physics_jump'};