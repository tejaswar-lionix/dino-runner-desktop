/** dino_module_3956 — score_speed extended, humanized desktop */
export interface In3956{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3956{y:number;vy:number;sc:number}
const C3956={g:0.7, j:13};
export function extraPhysics_3956(inp:In3956, dt:number):Out3956 {
...
export const mm3956={d:'score_speed'};