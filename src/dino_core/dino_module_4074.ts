/** dino_module_4074 — collision_aabb extended, humanized desktop */
export interface In4074{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4074{y:number;vy:number;sc:number}
const C4074={g:0.5, j:13};
export function extraSpawn_4074(inp:In4074, dt:number):Out4074 {
...
export const mm4074={d:'collision_aabb'};