/** dino_module_3542 — obstacle_spawn extended, humanized desktop */
export interface In3542{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3542{y:number;vy:number;sc:number}
const C3542={g:0.7, j:12};
export function extraSpawn_3542(inp:In3542, dt:number):Out3542 {
...
export const mm3542={d:'obstacle_spawn'};