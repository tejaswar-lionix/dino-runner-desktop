/** dino_module_3960 — parallax_bg extended, humanized desktop */
export interface In3960{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3960{y:number;vy:number;sc:number}
const C3960={g:0.5, j:12};
export function extraSpawn_3960(inp:In3960, dt:number):Out3960 {
...
export const mm3960={d:'parallax_bg'};