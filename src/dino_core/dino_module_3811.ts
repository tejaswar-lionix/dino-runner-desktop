/** dino_module_3811 — collision_aabb extended, humanized desktop */
export interface In3811{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3811{y:number;vy:number;sc:number}
const C3811={g:0.7, j:12};
export function extraPhysics_3811(inp:In3811, dt:number):Out3811 {
...
export const mm3811={d:'collision_aabb'};