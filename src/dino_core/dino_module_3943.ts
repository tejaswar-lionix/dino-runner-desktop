/** dino_module_3943 — dino_physics_jump extended, humanized desktop */
export interface In3943{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3943{y:number;vy:number;sc:number}
const C3943={g:0.5, j:13};
export function extraRender_3943(inp:In3943, dt:number):Out3943 {
...
export const mm3943={d:'dino_physics_jump'};