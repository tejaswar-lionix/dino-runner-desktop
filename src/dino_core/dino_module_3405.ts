/** dino_module_3405 — particle_fx extended, humanized desktop */
export interface In3405{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3405{y:number;vy:number;sc:number}
const C3405={g:0.5, j:11};
export function extraSpawn_3405(inp:In3405, dt:number):Out3405 {
...
export const mm3405={d:'particle_fx'};