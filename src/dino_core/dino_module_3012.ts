/** dino_module_3012 — obstacle_spawn extended, humanized desktop */
export interface In3012{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3012{y:number;vy:number;sc:number}
const C3012={g:0.7, j:12};
export function extraPhysics_3012(inp:In3012, dt:number):Out3012 {
...
export const mm3012={d:'obstacle_spawn'};