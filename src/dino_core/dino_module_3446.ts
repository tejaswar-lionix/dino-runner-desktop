/** dino_module_3446 — particle_fx extended, humanized desktop */
export interface In3446{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3446{y:number;vy:number;sc:number}
const C3446={g:0.6, j:11};
export function extraSpawn_3446(inp:In3446, dt:number):Out3446 {
...
export const mm3446={d:'particle_fx'};