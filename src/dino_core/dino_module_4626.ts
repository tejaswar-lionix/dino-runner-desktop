/** dino_module_4626 — parallax_bg extended, humanized desktop */
export interface In4626{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4626{y:number;vy:number;sc:number}
const C4626={g:0.7, j:12};
export function extraSpawn_4626(inp:In4626, dt:number):Out4626 {
...
export const mm4626={d:'parallax_bg'};