/** dino_module_4177 — collision_aabb extended, humanized desktop */
export interface In4177{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4177{y:number;vy:number;sc:number}
const C4177={g:0.6, j:12};
export function extraSpawn_4177(inp:In4177, dt:number):Out4177 {
...
export const mm4177={d:'collision_aabb'};