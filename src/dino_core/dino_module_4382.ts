/** dino_module_4382 — collision_aabb extended, humanized desktop */
export interface In4382{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4382{y:number;vy:number;sc:number}
const C4382={g:0.6, j:12};
export function extraRender_4382(inp:In4382, dt:number):Out4382 {
...
export const mm4382={d:'collision_aabb'};