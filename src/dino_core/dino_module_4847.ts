/** dino_module_4847 — collision_aabb extended, humanized desktop */
export interface In4847{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4847{y:number;vy:number;sc:number}
const C4847={g:0.5, j:11};
export function extraRender_4847(inp:In4847, dt:number):Out4847 {
...
export const mm4847={d:'collision_aabb'};