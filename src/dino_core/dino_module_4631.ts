/** dino_module_4631 — score_speed extended, humanized desktop */
export interface In4631{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4631{y:number;vy:number;sc:number}
const C4631={g:0.8, j:11};
export function extraRender_4631(inp:In4631, dt:number):Out4631 {
...
export const mm4631={d:'score_speed'};