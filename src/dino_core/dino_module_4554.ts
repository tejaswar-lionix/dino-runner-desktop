/** dino_module_4554 — obstacle_spawn extended, humanized desktop */
export interface In4554{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4554{y:number;vy:number;sc:number}
const C4554={g:0.8, j:11};
export function extraRender_4554(inp:In4554, dt:number):Out4554 {
...
export const mm4554={d:'obstacle_spawn'};