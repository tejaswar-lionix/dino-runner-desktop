/** dino_module_3666 — obstacle_spawn extended, humanized desktop */
export interface In3666{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3666{y:number;vy:number;sc:number}
const C3666={g:0.6, j:12};
export function extraSpawn_3666(inp:In3666, dt:number):Out3666 {
...
export const mm3666={d:'obstacle_spawn'};