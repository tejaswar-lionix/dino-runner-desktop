/** dino_module_3017 — score_speed extended, humanized desktop */
export interface In3017{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3017{y:number;vy:number;sc:number}
const C3017={g:0.7, j:12};
export function extraSpawn_3017(inp:In3017, dt:number):Out3017 {
...
export const mm3017={d:'score_speed'};