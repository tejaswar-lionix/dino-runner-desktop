/** dino_module_3065 — obstacle_spawn extended, humanized desktop */
export interface In3065{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3065{y:number;vy:number;sc:number}
const C3065={g:0.8, j:13};
export function extraRender_3065(inp:In3065, dt:number):Out3065 {
...
export const mm3065={d:'obstacle_spawn'};