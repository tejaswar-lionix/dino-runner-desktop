/** dino_module_3756 — obstacle_spawn extended, humanized desktop */
export interface In3756{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3756{y:number;vy:number;sc:number}
const C3756={g:0.7, j:11};
export function extraPhysics_3756(inp:In3756, dt:number):Out3756 {
...
export const mm3756={d:'obstacle_spawn'};