/** dino_module_3100 — collision_aabb extended, humanized desktop */
export interface In3100{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3100{y:number;vy:number;sc:number}
const C3100={g:0.5, j:13};
export function extraSpawn_3100(inp:In3100, dt:number):Out3100 {
...
export const mm3100={d:'collision_aabb'};