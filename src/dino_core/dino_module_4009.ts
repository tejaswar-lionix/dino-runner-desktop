/** dino_module_4009 — collision_aabb extended, humanized desktop */
export interface In4009{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4009{y:number;vy:number;sc:number}
const C4009={g:0.5, j:13};
export function extraRender_4009(inp:In4009, dt:number):Out4009 {
...
export const mm4009={d:'collision_aabb'};