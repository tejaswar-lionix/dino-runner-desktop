/** dino_module_4577 — parallax_bg extended, humanized desktop */
export interface In4577{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4577{y:number;vy:number;sc:number}
const C4577={g:0.7, j:12};
export function extraSpawn_4577(inp:In4577, dt:number):Out4577 {
...
export const mm4577={d:'parallax_bg'};