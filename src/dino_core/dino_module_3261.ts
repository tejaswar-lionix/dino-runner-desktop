/** dino_module_3261 — collision_aabb extended, humanized desktop */
export interface In3261{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3261{y:number;vy:number;sc:number}
const C3261={g:0.6, j:11};
export function extraSpawn_3261(inp:In3261, dt:number):Out3261 {
...
export const mm3261={d:'collision_aabb'};