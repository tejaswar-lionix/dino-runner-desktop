/** dino_module_4660 — score_speed extended, humanized desktop */
export interface In4660{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4660{y:number;vy:number;sc:number}
const C4660={g:0.5, j:12};
export function extraRender_4660(inp:In4660, dt:number):Out4660 {
...
export const mm4660={d:'score_speed'};