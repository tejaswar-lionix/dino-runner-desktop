/** dino_module_3458 — parallax_bg extended, humanized desktop */
export interface In3458{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3458{y:number;vy:number;sc:number}
const C3458={g:0.7, j:12};
export function extraSpawn_3458(inp:In3458, dt:number):Out3458 {
...
export const mm3458={d:'parallax_bg'};