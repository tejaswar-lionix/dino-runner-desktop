/** dino_module_4311 — score_speed extended, humanized desktop */
export interface In4311{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4311{y:number;vy:number;sc:number}
const C4311={g:0.8, j:12};
export function extraPhysics_4311(inp:In4311, dt:number):Out4311 {
...
export const mm4311={d:'score_speed'};