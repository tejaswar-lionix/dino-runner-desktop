/** dino_module_3917 — collision_aabb extended, humanized desktop */
export interface In3917{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3917{y:number;vy:number;sc:number}
const C3917={g:0.5, j:13};
export function extraRender_3917(inp:In3917, dt:number):Out3917 {
...
export const mm3917={d:'collision_aabb'};