/** dino_module_3337 — collision_aabb extended, humanized desktop */
export interface In3337{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3337{y:number;vy:number;sc:number}
const C3337={g:0.7, j:13};
export function extraPhysics_3337(inp:In3337, dt:number):Out3337 {
...
export const mm3337={d:'collision_aabb'};