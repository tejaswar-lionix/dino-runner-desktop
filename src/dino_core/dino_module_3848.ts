/** dino_module_3848 — score_speed extended, humanized desktop */
export interface In3848{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3848{y:number;vy:number;sc:number}
const C3848={g:0.8, j:13};
export function extraPhysics_3848(inp:In3848, dt:number):Out3848 {
...
export const mm3848={d:'score_speed'};