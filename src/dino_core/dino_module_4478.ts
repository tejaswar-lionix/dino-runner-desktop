/** dino_module_4478 — obstacle_spawn extended, humanized desktop */
export interface In4478{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4478{y:number;vy:number;sc:number}
const C4478={g:0.6, j:12};
export function extraRender_4478(inp:In4478, dt:number):Out4478 {
...
export const mm4478={d:'obstacle_spawn'};