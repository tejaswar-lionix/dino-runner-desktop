/** dino_module_4283 — collision_aabb extended, humanized desktop */
export interface In4283{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4283{y:number;vy:number;sc:number}
const C4283={g:0.8, j:13};
export function extraSpawn_4283(inp:In4283, dt:number):Out4283 {
...
export const mm4283={d:'collision_aabb'};