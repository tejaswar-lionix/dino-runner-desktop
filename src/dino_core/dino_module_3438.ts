/** dino_module_3438 — particle_fx extended, humanized desktop */
export interface In3438{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3438{y:number;vy:number;sc:number}
const C3438={g:0.8, j:13};
export function extraSpawn_3438(inp:In3438, dt:number):Out3438 {
...
export const mm3438={d:'particle_fx'};