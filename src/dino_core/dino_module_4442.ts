/** dino_module_4442 — collision_aabb extended, humanized desktop */
export interface In4442{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4442{y:number;vy:number;sc:number}
const C4442={g:0.7, j:11};
export function extraRender_4442(inp:In4442, dt:number):Out4442 {
...
export const mm4442={d:'collision_aabb'};