/** dino_module_4349 — collision_aabb extended, humanized desktop */
export interface In4349{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4349{y:number;vy:number;sc:number}
const C4349={g:0.5, j:13};
export function extraRender_4349(inp:In4349, dt:number):Out4349 {
...
export const mm4349={d:'collision_aabb'};