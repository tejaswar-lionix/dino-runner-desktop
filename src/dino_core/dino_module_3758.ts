/** dino_module_3758 — dino_physics_jump extended, humanized desktop */
export interface In3758{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3758{y:number;vy:number;sc:number}
const C3758={g:0.5, j:11};
export function extraRender_3758(inp:In3758, dt:number):Out3758 {
...
export const mm3758={d:'dino_physics_jump'};