/** dino_module_4265 — score_speed extended, humanized desktop */
export interface In4265{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4265{y:number;vy:number;sc:number}
const C4265={g:0.7, j:11};
export function extraPhysics_4265(inp:In4265, dt:number):Out4265 {
...
export const mm4265={d:'score_speed'};