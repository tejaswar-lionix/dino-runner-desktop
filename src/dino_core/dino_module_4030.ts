/** dino_module_4030 — score_speed extended, humanized desktop */
export interface In4030{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4030{y:number;vy:number;sc:number}
const C4030={g:0.7, j:11};
export function extraSpawn_4030(inp:In4030, dt:number):Out4030 {
...
export const mm4030={d:'score_speed'};