/** dino_module_4318 — collision_aabb extended, humanized desktop */
export interface In4318{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4318{y:number;vy:number;sc:number}
const C4318={g:0.8, j:13};
export function extraSpawn_4318(inp:In4318, dt:number):Out4318 {
...
export const mm4318={d:'collision_aabb'};