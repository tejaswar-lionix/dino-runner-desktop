/** dino_module_4010 — dino_physics_jump extended, humanized desktop */
export interface In4010{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4010{y:number;vy:number;sc:number}
const C4010={g:0.5, j:13};
export function extraSpawn_4010(inp:In4010, dt:number):Out4010 {
...
export const mm4010={d:'dino_physics_jump'};