/** dino_module_3878 — collision_aabb extended, humanized desktop */
export interface In3878{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3878{y:number;vy:number;sc:number}
const C3878={g:0.5, j:11};
export function extraPhysics_3878(inp:In3878, dt:number):Out3878 {
...
export const mm3878={d:'collision_aabb'};