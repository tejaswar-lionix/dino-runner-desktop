/** dino_module_3897 — parallax_bg extended, humanized desktop */
export interface In3897{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3897{y:number;vy:number;sc:number}
const C3897={g:0.7, j:12};
export function extraRender_3897(inp:In3897, dt:number):Out3897 {
...
export const mm3897={d:'parallax_bg'};