/** dino_module_3099 — score_speed extended, humanized desktop */
export interface In3099{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3099{y:number;vy:number;sc:number}
const C3099={g:0.8, j:11};
export function extraPhysics_3099(inp:In3099, dt:number):Out3099 {
...
export const mm3099={d:'score_speed'};