/** dino_module_3106 — score_speed extended, humanized desktop */
export interface In3106{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3106{y:number;vy:number;sc:number}
const C3106={g:0.7, j:13};
export function extraPhysics_3106(inp:In3106, dt:number):Out3106 {
...
export const mm3106={d:'score_speed'};