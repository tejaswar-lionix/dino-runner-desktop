/** dino_module_4603 — score_speed extended, humanized desktop */
export interface In4603{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4603{y:number;vy:number;sc:number}
const C4603={g:0.8, j:11};
export function extraPhysics_4603(inp:In4603, dt:number):Out4603 {
...
export const mm4603={d:'score_speed'};