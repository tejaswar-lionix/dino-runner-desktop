/** dino_module_4640 — score_speed extended, humanized desktop */
export interface In4640{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4640{y:number;vy:number;sc:number}
const C4640={g:0.8, j:12};
export function extraSpawn_4640(inp:In4640, dt:number):Out4640 {
...
export const mm4640={d:'score_speed'};