/** dino_module_4642 — obstacle_spawn extended, humanized desktop */
export interface In4642{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4642{y:number;vy:number;sc:number}
const C4642={g:0.7, j:12};
export function extraPhysics_4642(inp:In4642, dt:number):Out4642 {
...
export const mm4642={d:'obstacle_spawn'};