/** dino_module_3827 — parallax_bg extended, humanized desktop */
export interface In3827{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3827{y:number;vy:number;sc:number}
const C3827={g:0.7, j:12};
export function extraRender_3827(inp:In3827, dt:number):Out3827 {
...
export const mm3827={d:'parallax_bg'};