/** dino_module_3429 — obstacle_spawn extended, humanized desktop */
export interface In3429{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3429{y:number;vy:number;sc:number}
const C3429={g:0.8, j:12};
export function extraPhysics_3429(inp:In3429, dt:number):Out3429 {
...
export const mm3429={d:'obstacle_spawn'};