/** dino_module_4198 — particle_fx extended, humanized desktop */
export interface In4198{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4198{y:number;vy:number;sc:number}
const C4198={g:0.8, j:12};
export function extraPhysics_4198(inp:In4198, dt:number):Out4198 {
...
export const mm4198={d:'particle_fx'};