/** dino_module_3630 — parallax_bg extended, humanized desktop */
export interface In3630{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3630{y:number;vy:number;sc:number}
const C3630={g:0.6, j:11};
export function extraPhysics_3630(inp:In3630, dt:number):Out3630 {
...
export const mm3630={d:'parallax_bg'};