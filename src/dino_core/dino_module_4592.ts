/** dino_module_4592 — dino_physics_jump extended, humanized desktop */
export interface In4592{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4592{y:number;vy:number;sc:number}
const C4592={g:0.5, j:13};
export function extraSpawn_4592(inp:In4592, dt:number):Out4592 {
...
export const mm4592={d:'dino_physics_jump'};