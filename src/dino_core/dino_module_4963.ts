/** dino_module_4963 — collision_aabb extended, humanized desktop */
export interface In4963{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4963{y:number;vy:number;sc:number}
const C4963={g:0.5, j:11};
export function extraSpawn_4963(inp:In4963, dt:number):Out4963 {
...
export const mm4963={d:'collision_aabb'};