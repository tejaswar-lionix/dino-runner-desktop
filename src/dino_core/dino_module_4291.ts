/** dino_module_4291 — dino_physics_jump extended, humanized desktop */
export interface In4291{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4291{y:number;vy:number;sc:number}
const C4291={g:0.7, j:12};
export function extraSpawn_4291(inp:In4291, dt:number):Out4291 {
...
export const mm4291={d:'dino_physics_jump'};