/** dino_module_3379 — dino_physics_jump extended, humanized desktop */
export interface In3379{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3379{y:number;vy:number;sc:number}
const C3379={g:0.6, j:13};
export function extraSpawn_3379(inp:In3379, dt:number):Out3379 {
...
export const mm3379={d:'dino_physics_jump'};