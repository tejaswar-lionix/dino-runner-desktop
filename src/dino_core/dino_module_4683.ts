/** dino_module_4683 — collision_aabb extended, humanized desktop */
export interface In4683{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4683{y:number;vy:number;sc:number}
const C4683={g:0.8, j:12};
export function extraRender_4683(inp:In4683, dt:number):Out4683 {
...
export const mm4683={d:'collision_aabb'};