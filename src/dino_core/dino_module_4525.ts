/** dino_module_4525 — collision_aabb extended, humanized desktop */
export interface In4525{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4525{y:number;vy:number;sc:number}
const C4525={g:0.5, j:11};
export function extraPhysics_4525(inp:In4525, dt:number):Out4525 {
...
export const mm4525={d:'collision_aabb'};