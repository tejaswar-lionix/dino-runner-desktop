/** dino_module_3264 — parallax_bg extended, humanized desktop */
export interface In3264{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3264{y:number;vy:number;sc:number}
const C3264={g:0.8, j:12};
export function extraSpawn_3264(inp:In3264, dt:number):Out3264 {
...
export const mm3264={d:'parallax_bg'};