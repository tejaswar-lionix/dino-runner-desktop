/** dino_module_4236 — parallax_bg extended, humanized desktop */
export interface In4236{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4236{y:number;vy:number;sc:number}
const C4236={g:0.5, j:13};
export function extraSpawn_4236(inp:In4236, dt:number):Out4236 {
...
export const mm4236={d:'parallax_bg'};