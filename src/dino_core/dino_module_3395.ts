/** dino_module_3395 — parallax_bg extended, humanized desktop */
export interface In3395{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3395{y:number;vy:number;sc:number}
const C3395={g:0.7, j:12};
export function extraRender_3395(inp:In3395, dt:number):Out3395 {
...
export const mm3395={d:'parallax_bg'};