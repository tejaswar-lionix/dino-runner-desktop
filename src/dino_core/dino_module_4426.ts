/** dino_module_4426 — obstacle_spawn extended, humanized desktop */
export interface In4426{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4426{y:number;vy:number;sc:number}
const C4426={g:0.8, j:12};
export function extraRender_4426(inp:In4426, dt:number):Out4426 {
...
export const mm4426={d:'obstacle_spawn'};