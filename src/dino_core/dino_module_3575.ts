/** dino_module_3575 — parallax_bg extended, humanized desktop */
export interface In3575{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3575{y:number;vy:number;sc:number}
const C3575={g:0.8, j:13};
export function extraRender_3575(inp:In3575, dt:number):Out3575 {
...
export const mm3575={d:'parallax_bg'};