/** dino_module_3250 — parallax_bg extended, humanized desktop */
export interface In3250{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3250{y:number;vy:number;sc:number}
const C3250={g:0.5, j:12};
export function extraPhysics_3250(inp:In3250, dt:number):Out3250 {
...
export const mm3250={d:'parallax_bg'};