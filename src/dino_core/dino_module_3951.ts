/** dino_module_3951 — particle_fx extended, humanized desktop */
export interface In3951{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3951{y:number;vy:number;sc:number}
const C3951={g:0.5, j:11};
export function extraRender_3951(inp:In3951, dt:number):Out3951 {
...
export const mm3951={d:'particle_fx'};