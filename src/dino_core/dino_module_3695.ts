/** dino_module_3695 — collision_aabb extended, humanized desktop */
export interface In3695{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3695{y:number;vy:number;sc:number}
const C3695={g:0.8, j:11};
export function extraPhysics_3695(inp:In3695, dt:number):Out3695 {
...
export const mm3695={d:'collision_aabb'};