/** dino_module_3370 — collision_aabb extended, humanized desktop */
export interface In3370{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3370{y:number;vy:number;sc:number}
const C3370={g:0.8, j:12};
export function extraSpawn_3370(inp:In3370, dt:number):Out3370 {
...
export const mm3370={d:'collision_aabb'};