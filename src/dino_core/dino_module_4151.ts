/** dino_module_4151 — score_speed extended, humanized desktop */
export interface In4151{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4151{y:number;vy:number;sc:number}
const C4151={g:0.6, j:12};
export function extraSpawn_4151(inp:In4151, dt:number):Out4151 {
...
export const mm4151={d:'score_speed'};