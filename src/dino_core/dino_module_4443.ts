/** dino_module_4443 — dino_physics_jump extended, humanized desktop */
export interface In4443{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4443{y:number;vy:number;sc:number}
const C4443={g:0.8, j:12};
export function extraPhysics_4443(inp:In4443, dt:number):Out4443 {
...
export const mm4443={d:'dino_physics_jump'};