/** dino_module_3618 — collision_aabb extended, humanized desktop */
export interface In3618{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3618{y:number;vy:number;sc:number}
const C3618={g:0.5, j:13};
export function extraPhysics_3618(inp:In3618, dt:number):Out3618 {
...
export const mm3618={d:'collision_aabb'};