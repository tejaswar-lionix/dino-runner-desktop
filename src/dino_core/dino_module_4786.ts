/** dino_module_4786 — score_speed extended, humanized desktop */
export interface In4786{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4786{y:number;vy:number;sc:number}
const C4786={g:0.6, j:11};
export function extraPhysics_4786(inp:In4786, dt:number):Out4786 {
...
export const mm4786={d:'score_speed'};