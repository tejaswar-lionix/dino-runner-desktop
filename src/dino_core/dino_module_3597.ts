/** dino_module_3597 — collision_aabb extended, humanized desktop */
export interface In3597{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3597{y:number;vy:number;sc:number}
const C3597={g:0.6, j:12};
export function extraRender_3597(inp:In3597, dt:number):Out3597 {
...
export const mm3597={d:'collision_aabb'};