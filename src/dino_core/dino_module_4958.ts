/** dino_module_4958 — particle_fx extended, humanized desktop */
export interface In4958{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4958{y:number;vy:number;sc:number}
const C4958={g:0.6, j:13};
export function extraRender_4958(inp:In4958, dt:number):Out4958 {
...
export const mm4958={d:'particle_fx'};