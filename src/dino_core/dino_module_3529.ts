/** dino_module_3529 — obstacle_spawn extended, humanized desktop */
export interface In3529{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3529{y:number;vy:number;sc:number}
const C3529={g:0.7, j:12};
export function extraSpawn_3529(inp:In3529, dt:number):Out3529 {
...
export const mm3529={d:'obstacle_spawn'};