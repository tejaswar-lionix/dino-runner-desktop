/** dino_module_4902 — score_speed extended, humanized desktop */
export interface In4902{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4902{y:number;vy:number;sc:number}
const C4902={g:0.8, j:13};
export function extraSpawn_4902(inp:In4902, dt:number):Out4902 {
...
export const mm4902={d:'score_speed'};