/** dino_module_4351 — collision_aabb extended, humanized desktop */
export interface In4351{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4351{y:number;vy:number;sc:number}
const C4351={g:0.8, j:12};
export function extraSpawn_4351(inp:In4351, dt:number):Out4351 {
...
export const mm4351={d:'collision_aabb'};