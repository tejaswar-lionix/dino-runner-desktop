/** dino_module_3730 — collision_aabb extended, humanized desktop */
export interface In3730{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3730{y:number;vy:number;sc:number}
const C3730={g:0.5, j:13};
export function extraPhysics_3730(inp:In3730, dt:number):Out3730 {
...
export const mm3730={d:'collision_aabb'};