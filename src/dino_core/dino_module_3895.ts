/** dino_module_3895 — score_speed extended, humanized desktop */
export interface In3895{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3895{y:number;vy:number;sc:number}
const C3895={g:0.7, j:12};
export function extraSpawn_3895(inp:In3895, dt:number):Out3895 {
...
export const mm3895={d:'score_speed'};