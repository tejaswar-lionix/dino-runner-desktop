/** dino_module_3949 — parallax_bg extended, humanized desktop */
export interface In3949{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3949{y:number;vy:number;sc:number}
const C3949={g:0.8, j:12};
export function extraSpawn_3949(inp:In3949, dt:number):Out3949 {
...
export const mm3949={d:'parallax_bg'};