/** dino_module_4896 — obstacle_spawn extended, humanized desktop */
export interface In4896{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4896{y:number;vy:number;sc:number}
const C4896={g:0.7, j:13};
export function extraSpawn_4896(inp:In4896, dt:number):Out4896 {
...
export const mm4896={d:'obstacle_spawn'};