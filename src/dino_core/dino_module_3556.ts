/** dino_module_3556 — obstacle_spawn extended, humanized desktop */
export interface In3556{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3556{y:number;vy:number;sc:number}
const C3556={g:0.7, j:11};
export function extraSpawn_3556(inp:In3556, dt:number):Out3556 {
...
export const mm3556={d:'obstacle_spawn'};