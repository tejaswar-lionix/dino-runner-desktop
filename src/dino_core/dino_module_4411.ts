/** dino_module_4411 — dino_physics_jump extended, humanized desktop */
export interface In4411{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4411{y:number;vy:number;sc:number}
const C4411={g:0.5, j:11};
export function extraSpawn_4411(inp:In4411, dt:number):Out4411 {
...
export const mm4411={d:'dino_physics_jump'};