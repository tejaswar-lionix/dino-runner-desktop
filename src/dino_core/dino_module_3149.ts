/** dino_module_3149 — dino_physics_jump extended, humanized desktop */
export interface In3149{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3149{y:number;vy:number;sc:number}
const C3149={g:0.8, j:11};
export function extraSpawn_3149(inp:In3149, dt:number):Out3149 {
...
export const mm3149={d:'dino_physics_jump'};