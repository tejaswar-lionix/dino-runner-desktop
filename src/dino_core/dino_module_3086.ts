/** dino_module_3086 — obstacle_spawn extended, humanized desktop */
export interface In3086{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3086{y:number;vy:number;sc:number}
const C3086={g:0.6, j:12};
export function extraPhysics_3086(inp:In3086, dt:number):Out3086 {
...
export const mm3086={d:'obstacle_spawn'};