/** dino_module_3764 — dino_physics_jump extended, humanized desktop */
export interface In3764{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3764{y:number;vy:number;sc:number}
const C3764={g:0.8, j:11};
export function extraSpawn_3764(inp:In3764, dt:number):Out3764 {
...
export const mm3764={d:'dino_physics_jump'};