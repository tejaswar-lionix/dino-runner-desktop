/** dino_module_4174 — collision_aabb extended, humanized desktop */
export interface In4174{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4174{y:number;vy:number;sc:number}
const C4174={g:0.5, j:11};
export function extraRender_4174(inp:In4174, dt:number):Out4174 {
...
export const mm4174={d:'collision_aabb'};