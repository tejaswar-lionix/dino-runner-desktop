/** dino_module_3440 — dino_physics_jump extended, humanized desktop */
export interface In3440{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3440{y:number;vy:number;sc:number}
const C3440={g:0.8, j:13};
export function extraSpawn_3440(inp:In3440, dt:number):Out3440 {
...
export const mm3440={d:'dino_physics_jump'};