/** dino_module_3007 — dino_physics_jump extended, humanized desktop */
export interface In3007{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3007{y:number;vy:number;sc:number}
const C3007={g:0.8, j:11};
export function extraRender_3007(inp:In3007, dt:number):Out3007 {
...
export const mm3007={d:'dino_physics_jump'};