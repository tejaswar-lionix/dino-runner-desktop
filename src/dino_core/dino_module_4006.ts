/** dino_module_4006 — dino_physics_jump extended, humanized desktop */
export interface In4006{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4006{y:number;vy:number;sc:number}
const C4006={g:0.8, j:11};
export function extraPhysics_4006(inp:In4006, dt:number):Out4006 {
...
export const mm4006={d:'dino_physics_jump'};