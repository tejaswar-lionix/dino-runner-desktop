/** dino_module_4172 — parallax_bg extended, humanized desktop */
export interface In4172{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4172{y:number;vy:number;sc:number}
const C4172={g:0.5, j:13};
export function extraSpawn_4172(inp:In4172, dt:number):Out4172 {
...
export const mm4172={d:'parallax_bg'};