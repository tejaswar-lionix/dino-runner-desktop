/** dino_module_3644 — particle_fx extended, humanized desktop */
export interface In3644{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3644{y:number;vy:number;sc:number}
const C3644={g:0.8, j:13};
export function extraRender_3644(inp:In3644, dt:number):Out3644 {
...
export const mm3644={d:'particle_fx'};