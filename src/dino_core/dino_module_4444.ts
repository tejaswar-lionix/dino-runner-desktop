/** dino_module_4444 — dino_physics_jump extended, humanized desktop */
export interface In4444{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4444{y:number;vy:number;sc:number}
const C4444={g:0.8, j:11};
export function extraSpawn_4444(inp:In4444, dt:number):Out4444 {
...
export const mm4444={d:'dino_physics_jump'};