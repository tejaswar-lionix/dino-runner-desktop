/** dino_module_4436 — parallax_bg extended, humanized desktop */
export interface In4436{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4436{y:number;vy:number;sc:number}
const C4436={g:0.7, j:11};
export function extraRender_4436(inp:In4436, dt:number):Out4436 {
...
export const mm4436={d:'parallax_bg'};