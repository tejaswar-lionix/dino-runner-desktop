/** dino_module_4249 — collision_aabb extended, humanized desktop */
export interface In4249{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4249{y:number;vy:number;sc:number}
const C4249={g:0.5, j:13};
export function extraSpawn_4249(inp:In4249, dt:number):Out4249 {
...
export const mm4249={d:'collision_aabb'};