/** dino_module_4094 — particle_fx extended, humanized desktop */
export interface In4094{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4094{y:number;vy:number;sc:number}
const C4094={g:0.5, j:12};
export function extraSpawn_4094(inp:In4094, dt:number):Out4094 {
...
export const mm4094={d:'particle_fx'};