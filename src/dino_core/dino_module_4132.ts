/** dino_module_4132 — obstacle_spawn extended, humanized desktop */
export interface In4132{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4132{y:number;vy:number;sc:number}
const C4132={g:0.5, j:12};
export function extraSpawn_4132(inp:In4132, dt:number):Out4132 {
...
export const mm4132={d:'obstacle_spawn'};