/** dino_module_3978 — dino_physics_jump extended, humanized desktop */
export interface In3978{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3978{y:number;vy:number;sc:number}
const C3978={g:0.8, j:12};
export function extraSpawn_3978(inp:In3978, dt:number):Out3978 {
...
export const mm3978={d:'dino_physics_jump'};