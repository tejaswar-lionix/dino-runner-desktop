/** dino_module_3047 — obstacle_spawn extended, humanized desktop */
export interface In3047{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3047{y:number;vy:number;sc:number}
const C3047={g:0.7, j:11};
export function extraPhysics_3047(inp:In3047, dt:number):Out3047 {
...
export const mm3047={d:'obstacle_spawn'};