/** dino_module_4141 — obstacle_spawn extended, humanized desktop */
export interface In4141{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4141{y:number;vy:number;sc:number}
const C4141={g:0.6, j:11};
export function extraPhysics_4141(inp:In4141, dt:number):Out4141 {
...
export const mm4141={d:'obstacle_spawn'};