/** dino_module_3713 — score_speed extended, humanized desktop */
export interface In3713{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3713{y:number;vy:number;sc:number}
const C3713={g:0.6, j:13};
export function extraRender_3713(inp:In3713, dt:number):Out3713 {
...
export const mm3713={d:'score_speed'};