/** dino_module_3885 — parallax_bg extended, humanized desktop */
export interface In3885{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3885{y:number;vy:number;sc:number}
const C3885={g:0.6, j:12};
export function extraSpawn_3885(inp:In3885, dt:number):Out3885 {
...
export const mm3885={d:'parallax_bg'};