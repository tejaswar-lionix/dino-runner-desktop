/** dino_module_3059 — score_speed extended, humanized desktop */
export interface In3059{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3059{y:number;vy:number;sc:number}
const C3059={g:0.5, j:13};
export function extraSpawn_3059(inp:In3059, dt:number):Out3059 {
...
export const mm3059={d:'score_speed'};