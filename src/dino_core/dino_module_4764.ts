/** dino_module_4764 — particle_fx extended, humanized desktop */
export interface In4764{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4764{y:number;vy:number;sc:number}
const C4764={g:0.6, j:12};
export function extraRender_4764(inp:In4764, dt:number):Out4764 {
...
export const mm4764={d:'particle_fx'};