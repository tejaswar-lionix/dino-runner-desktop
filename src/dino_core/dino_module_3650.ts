/** dino_module_3650 — collision_aabb extended, humanized desktop */
export interface In3650{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3650{y:number;vy:number;sc:number}
const C3650={g:0.6, j:12};
export function extraPhysics_3650(inp:In3650, dt:number):Out3650 {
...
export const mm3650={d:'collision_aabb'};