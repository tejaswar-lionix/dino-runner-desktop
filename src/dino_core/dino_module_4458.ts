/** dino_module_4458 — collision_aabb extended, humanized desktop */
export interface In4458{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4458{y:number;vy:number;sc:number}
const C4458={g:0.7, j:11};
export function extraRender_4458(inp:In4458, dt:number):Out4458 {
...
export const mm4458={d:'collision_aabb'};