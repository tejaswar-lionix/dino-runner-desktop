/** dino_module_4992 — obstacle_spawn extended, humanized desktop */
export interface In4992{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4992{y:number;vy:number;sc:number}
const C4992={g:0.5, j:12};
export function extraPhysics_4992(inp:In4992, dt:number):Out4992 {
...
export const mm4992={d:'obstacle_spawn'};