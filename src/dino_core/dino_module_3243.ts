/** dino_module_3243 — score_speed extended, humanized desktop */
export interface In3243{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3243{y:number;vy:number;sc:number}
const C3243={g:0.8, j:12};
export function extraSpawn_3243(inp:In3243, dt:number):Out3243 {
...
export const mm3243={d:'score_speed'};