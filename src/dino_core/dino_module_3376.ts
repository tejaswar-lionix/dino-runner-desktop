/** dino_module_3376 — parallax_bg extended, humanized desktop */
export interface In3376{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3376{y:number;vy:number;sc:number}
const C3376={g:0.5, j:11};
export function extraSpawn_3376(inp:In3376, dt:number):Out3376 {
...
export const mm3376={d:'parallax_bg'};