/** dino_module_4460 — dino_physics_jump extended, humanized desktop */
export interface In4460{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4460{y:number;vy:number;sc:number}
const C4460={g:0.5, j:11};
export function extraPhysics_4460(inp:In4460, dt:number):Out4460 {
...
export const mm4460={d:'dino_physics_jump'};