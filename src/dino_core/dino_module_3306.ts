/** dino_module_3306 — collision_aabb extended, humanized desktop */
export interface In3306{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3306{y:number;vy:number;sc:number}
const C3306={g:0.8, j:13};
export function extraSpawn_3306(inp:In3306, dt:number):Out3306 {
...
export const mm3306={d:'collision_aabb'};