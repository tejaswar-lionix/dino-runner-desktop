/** dino_module_4069 — particle_fx extended, humanized desktop */
export interface In4069{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4069{y:number;vy:number;sc:number}
const C4069={g:0.6, j:12};
export function extraPhysics_4069(inp:In4069, dt:number):Out4069 {
...
export const mm4069={d:'particle_fx'};