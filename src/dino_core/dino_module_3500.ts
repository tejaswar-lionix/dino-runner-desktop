/** dino_module_3500 — dino_physics_jump extended, humanized desktop */
export interface In3500{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3500{y:number;vy:number;sc:number}
const C3500={g:0.7, j:11};
export function extraPhysics_3500(inp:In3500, dt:number):Out3500 {
...
export const mm3500={d:'dino_physics_jump'};