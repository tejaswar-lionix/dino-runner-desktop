/** dino_module_3996 — score_speed extended, humanized desktop */
export interface In3996{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3996{y:number;vy:number;sc:number}
const C3996={g:0.5, j:13};
export function extraSpawn_3996(inp:In3996, dt:number):Out3996 {
...
export const mm3996={d:'score_speed'};