/** dino_module_4693 — score_speed extended, humanized desktop */
export interface In4693{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4693{y:number;vy:number;sc:number}
const C4693={g:0.5, j:12};
export function extraSpawn_4693(inp:In4693, dt:number):Out4693 {
...
export const mm4693={d:'score_speed'};