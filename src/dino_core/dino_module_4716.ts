/** dino_module_4716 — obstacle_spawn extended, humanized desktop */
export interface In4716{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4716{y:number;vy:number;sc:number}
const C4716={g:0.5, j:13};
export function extraPhysics_4716(inp:In4716, dt:number):Out4716 {
...
export const mm4716={d:'obstacle_spawn'};