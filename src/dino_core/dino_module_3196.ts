/** dino_module_3196 — dino_physics_jump extended, humanized desktop */
export interface In3196{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3196{y:number;vy:number;sc:number}
const C3196={g:0.7, j:11};
export function extraRender_3196(inp:In3196, dt:number):Out3196 {
...
export const mm3196={d:'dino_physics_jump'};