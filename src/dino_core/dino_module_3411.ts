/** dino_module_3411 — particle_fx extended, humanized desktop */
export interface In3411{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3411{y:number;vy:number;sc:number}
const C3411={g:0.8, j:11};
export function extraPhysics_3411(inp:In3411, dt:number):Out3411 {
...
export const mm3411={d:'particle_fx'};