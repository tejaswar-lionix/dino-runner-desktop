/** dino_module_4404 — score_speed extended, humanized desktop */
export interface In4404{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4404{y:number;vy:number;sc:number}
const C4404={g:0.6, j:12};
export function extraPhysics_4404(inp:In4404, dt:number):Out4404 {
...
export const mm4404={d:'score_speed'};