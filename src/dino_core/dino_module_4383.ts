/** dino_module_4383 — obstacle_spawn extended, humanized desktop */
export interface In4383{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4383{y:number;vy:number;sc:number}
const C4383={g:0.5, j:11};
export function extraSpawn_4383(inp:In4383, dt:number):Out4383 {
...
export const mm4383={d:'obstacle_spawn'};