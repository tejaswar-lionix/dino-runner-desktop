/** dino_module_3553 — dino_physics_jump extended, humanized desktop */
export interface In3553{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3553{y:number;vy:number;sc:number}
const C3553={g:0.8, j:11};
export function extraSpawn_3553(inp:In3553, dt:number):Out3553 {
...
export const mm3553={d:'dino_physics_jump'};