/** dino_module_3638 — dino_physics_jump extended, humanized desktop */
export interface In3638{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3638{y:number;vy:number;sc:number}
const C3638={g:0.5, j:11};
export function extraRender_3638(inp:In3638, dt:number):Out3638 {
...
export const mm3638={d:'dino_physics_jump'};