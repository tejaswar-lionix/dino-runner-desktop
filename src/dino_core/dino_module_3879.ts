/** dino_module_3879 — score_speed extended, humanized desktop */
export interface In3879{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3879{y:number;vy:number;sc:number}
const C3879={g:0.7, j:13};
export function extraPhysics_3879(inp:In3879, dt:number):Out3879 {
...
export const mm3879={d:'score_speed'};