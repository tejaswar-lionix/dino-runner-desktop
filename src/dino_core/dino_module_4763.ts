/** dino_module_4763 — parallax_bg extended, humanized desktop */
export interface In4763{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4763{y:number;vy:number;sc:number}
const C4763={g:0.8, j:11};
export function extraSpawn_4763(inp:In4763, dt:number):Out4763 {
...
export const mm4763={d:'parallax_bg'};