/** dino_module_4798 — score_speed extended, humanized desktop */
export interface In4798{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4798{y:number;vy:number;sc:number}
const C4798={g:0.8, j:11};
export function extraPhysics_4798(inp:In4798, dt:number):Out4798 {
...
export const mm4798={d:'score_speed'};