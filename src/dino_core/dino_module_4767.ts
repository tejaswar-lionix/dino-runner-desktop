/** dino_module_4767 — parallax_bg extended, humanized desktop */
export interface In4767{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4767{y:number;vy:number;sc:number}
const C4767={g:0.5, j:11};
export function extraRender_4767(inp:In4767, dt:number):Out4767 {
...
export const mm4767={d:'parallax_bg'};