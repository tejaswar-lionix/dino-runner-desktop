/** dino_module_3855 — dino_physics_jump extended, humanized desktop */
export interface In3855{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3855{y:number;vy:number;sc:number}
const C3855={g:0.8, j:11};
export function extraRender_3855(inp:In3855, dt:number):Out3855 {
...
export const mm3855={d:'dino_physics_jump'};