/** dino_module_4002 — particle_fx extended, humanized desktop */
export interface In4002{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4002{y:number;vy:number;sc:number}
const C4002={g:0.5, j:11};
export function extraPhysics_4002(inp:In4002, dt:number):Out4002 {
...
export const mm4002={d:'particle_fx'};