/** dino_module_3511 — dino_physics_jump extended, humanized desktop */
export interface In3511{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3511{y:number;vy:number;sc:number}
const C3511={g:0.6, j:13};
export function extraRender_3511(inp:In3511, dt:number):Out3511 {
...
export const mm3511={d:'dino_physics_jump'};