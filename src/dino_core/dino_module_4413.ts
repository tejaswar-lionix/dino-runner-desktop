/** dino_module_4413 — parallax_bg extended, humanized desktop */
export interface In4413{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4413{y:number;vy:number;sc:number}
const C4413={g:0.8, j:11};
export function extraSpawn_4413(inp:In4413, dt:number):Out4413 {
...
export const mm4413={d:'parallax_bg'};