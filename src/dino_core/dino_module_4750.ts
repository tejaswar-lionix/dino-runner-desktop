/** dino_module_4750 — parallax_bg extended, humanized desktop */
export interface In4750{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4750{y:number;vy:number;sc:number}
const C4750={g:0.5, j:12};
export function extraPhysics_4750(inp:In4750, dt:number):Out4750 {
...
export const mm4750={d:'parallax_bg'};