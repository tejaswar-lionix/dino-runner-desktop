/** dino_module_3441 — collision_aabb extended, humanized desktop */
export interface In3441{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3441{y:number;vy:number;sc:number}
const C3441={g:0.5, j:11};
export function extraRender_3441(inp:In3441, dt:number):Out3441 {
...
export const mm3441={d:'collision_aabb'};