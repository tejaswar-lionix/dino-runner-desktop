/** dino_module_3662 — dino_physics_jump extended, humanized desktop */
export interface In3662{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3662{y:number;vy:number;sc:number}
const C3662={g:0.6, j:11};
export function extraSpawn_3662(inp:In3662, dt:number):Out3662 {
...
export const mm3662={d:'dino_physics_jump'};