/** dino_module_4553 — parallax_bg extended, humanized desktop */
export interface In4553{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4553{y:number;vy:number;sc:number}
const C4553={g:0.5, j:13};
export function extraPhysics_4553(inp:In4553, dt:number):Out4553 {
...
export const mm4553={d:'parallax_bg'};