/** dino_module_4044 — parallax_bg extended, humanized desktop */
export interface In4044{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4044{y:number;vy:number;sc:number}
const C4044={g:0.7, j:11};
export function extraPhysics_4044(inp:In4044, dt:number):Out4044 {
...
export const mm4044={d:'parallax_bg'};