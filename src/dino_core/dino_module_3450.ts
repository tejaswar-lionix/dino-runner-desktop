/** dino_module_3450 — parallax_bg extended, humanized desktop */
export interface In3450{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3450{y:number;vy:number;sc:number}
const C3450={g:0.5, j:11};
export function extraSpawn_3450(inp:In3450, dt:number):Out3450 {
...
export const mm3450={d:'parallax_bg'};