/** dino_module_3642 — dino_physics_jump extended, humanized desktop */
export interface In3642{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3642{y:number;vy:number;sc:number}
const C3642={g:0.6, j:12};
export function extraRender_3642(inp:In3642, dt:number):Out3642 {
...
export const mm3642={d:'dino_physics_jump'};