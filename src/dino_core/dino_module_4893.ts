/** dino_module_4893 — parallax_bg extended, humanized desktop */
export interface In4893{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4893{y:number;vy:number;sc:number}
const C4893={g:0.8, j:13};
export function extraSpawn_4893(inp:In4893, dt:number):Out4893 {
...
export const mm4893={d:'parallax_bg'};