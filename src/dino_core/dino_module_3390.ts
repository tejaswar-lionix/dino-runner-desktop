/** dino_module_3390 — collision_aabb extended, humanized desktop */
export interface In3390{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3390{y:number;vy:number;sc:number}
const C3390={g:0.8, j:13};
export function extraSpawn_3390(inp:In3390, dt:number):Out3390 {
...
export const mm3390={d:'collision_aabb'};