/** dino_module_4290 — collision_aabb extended, humanized desktop */
export interface In4290{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4290{y:number;vy:number;sc:number}
const C4290={g:0.7, j:11};
export function extraPhysics_4290(inp:In4290, dt:number):Out4290 {
...
export const mm4290={d:'collision_aabb'};