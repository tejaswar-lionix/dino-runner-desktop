/** dino_module_3288 — obstacle_spawn extended, humanized desktop */
export interface In3288{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3288{y:number;vy:number;sc:number}
const C3288={g:0.7, j:13};
export function extraPhysics_3288(inp:In3288, dt:number):Out3288 {
...
export const mm3288={d:'obstacle_spawn'};