/** dino_module_3417 — particle_fx extended, humanized desktop */
export interface In3417{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3417{y:number;vy:number;sc:number}
const C3417={g:0.7, j:13};
export function extraPhysics_3417(inp:In3417, dt:number):Out3417 {
...
export const mm3417={d:'particle_fx'};