/** dino_module_3865 — score_speed extended, humanized desktop */
export interface In3865{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3865{y:number;vy:number;sc:number}
const C3865={g:0.7, j:11};
export function extraSpawn_3865(inp:In3865, dt:number):Out3865 {
...
export const mm3865={d:'score_speed'};