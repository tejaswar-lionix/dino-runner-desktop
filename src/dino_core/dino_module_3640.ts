/** dino_module_3640 — dino_physics_jump extended, humanized desktop */
export interface In3640{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3640{y:number;vy:number;sc:number}
const C3640={g:0.6, j:13};
export function extraRender_3640(inp:In3640, dt:number):Out3640 {
...
export const mm3640={d:'dino_physics_jump'};