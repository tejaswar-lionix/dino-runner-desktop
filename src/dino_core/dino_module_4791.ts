/** dino_module_4791 — particle_fx extended, humanized desktop */
export interface In4791{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4791{y:number;vy:number;sc:number}
const C4791={g:0.7, j:12};
export function extraSpawn_4791(inp:In4791, dt:number):Out4791 {
...
export const mm4791={d:'particle_fx'};