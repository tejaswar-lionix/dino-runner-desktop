/** dino_module_3310 — collision_aabb extended, humanized desktop */
export interface In3310{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3310{y:number;vy:number;sc:number}
const C3310={g:0.5, j:12};
export function extraPhysics_3310(inp:In3310, dt:number):Out3310 {
...
export const mm3310={d:'collision_aabb'};