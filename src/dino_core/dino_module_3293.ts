/** dino_module_3293 — obstacle_spawn extended, humanized desktop */
export interface In3293{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3293{y:number;vy:number;sc:number}
const C3293={g:0.5, j:11};
export function extraSpawn_3293(inp:In3293, dt:number):Out3293 {
...
export const mm3293={d:'obstacle_spawn'};