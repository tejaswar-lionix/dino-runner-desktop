/** dino_module_4418 — collision_aabb extended, humanized desktop */
export interface In4418{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4418{y:number;vy:number;sc:number}
const C4418={g:0.7, j:11};
export function extraRender_4418(inp:In4418, dt:number):Out4418 {
...
export const mm4418={d:'collision_aabb'};