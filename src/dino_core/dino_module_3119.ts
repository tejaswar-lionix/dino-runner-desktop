/** dino_module_3119 — collision_aabb extended, humanized desktop */
export interface In3119{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3119{y:number;vy:number;sc:number}
const C3119={g:0.5, j:11};
export function extraPhysics_3119(inp:In3119, dt:number):Out3119 {
...
export const mm3119={d:'collision_aabb'};