/** dino_module_3915 — score_speed extended, humanized desktop */
export interface In3915{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3915{y:number;vy:number;sc:number}
const C3915={g:0.8, j:12};
export function extraRender_3915(inp:In3915, dt:number):Out3915 {
...
export const mm3915={d:'score_speed'};