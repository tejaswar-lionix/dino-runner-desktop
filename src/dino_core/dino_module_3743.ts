/** dino_module_3743 — collision_aabb extended, humanized desktop */
export interface In3743{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3743{y:number;vy:number;sc:number}
const C3743={g:0.5, j:11};
export function extraPhysics_3743(inp:In3743, dt:number):Out3743 {
...
export const mm3743={d:'collision_aabb'};