/** dino_module_4938 — particle_fx extended, humanized desktop */
export interface In4938{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4938{y:number;vy:number;sc:number}
const C4938={g:0.8, j:13};
export function extraPhysics_4938(inp:In4938, dt:number):Out4938 {
...
export const mm4938={d:'particle_fx'};