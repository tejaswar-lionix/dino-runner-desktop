/** dino_module_4149 — parallax_bg extended, humanized desktop */
export interface In4149{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4149{y:number;vy:number;sc:number}
const C4149={g:0.6, j:12};
export function extraPhysics_4149(inp:In4149, dt:number):Out4149 {
...
export const mm4149={d:'parallax_bg'};