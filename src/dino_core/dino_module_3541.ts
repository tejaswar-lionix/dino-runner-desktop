/** dino_module_3541 — obstacle_spawn extended, humanized desktop */
export interface In3541{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3541{y:number;vy:number;sc:number}
const C3541={g:0.8, j:11};
export function extraSpawn_3541(inp:In3541, dt:number):Out3541 {
...
export const mm3541={d:'obstacle_spawn'};