/** dino_module_3239 — dino_physics_jump extended, humanized desktop */
export interface In3239{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3239{y:number;vy:number;sc:number}
const C3239={g:0.5, j:12};
export function extraRender_3239(inp:In3239, dt:number):Out3239 {
...
export const mm3239={d:'dino_physics_jump'};