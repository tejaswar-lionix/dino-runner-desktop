/** dino_module_3002 — dino_physics_jump extended, humanized desktop */
export interface In3002{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3002{y:number;vy:number;sc:number}
const C3002={g:0.8, j:11};
export function extraPhysics_3002(inp:In3002, dt:number):Out3002 {
...
export const mm3002={d:'dino_physics_jump'};