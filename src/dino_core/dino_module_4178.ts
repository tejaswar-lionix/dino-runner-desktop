/** dino_module_4178 — parallax_bg extended, humanized desktop */
export interface In4178{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4178{y:number;vy:number;sc:number}
const C4178={g:0.7, j:12};
export function extraPhysics_4178(inp:In4178, dt:number):Out4178 {
...
export const mm4178={d:'parallax_bg'};