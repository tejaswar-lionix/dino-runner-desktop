/** dino_module_4211 — particle_fx extended, humanized desktop */
export interface In4211{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4211{y:number;vy:number;sc:number}
const C4211={g:0.5, j:12};
export function extraPhysics_4211(inp:In4211, dt:number):Out4211 {
...
export const mm4211={d:'particle_fx'};