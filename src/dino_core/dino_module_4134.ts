/** dino_module_4134 — score_speed extended, humanized desktop */
export interface In4134{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4134{y:number;vy:number;sc:number}
const C4134={g:0.8, j:13};
export function extraRender_4134(inp:In4134, dt:number):Out4134 {
...
export const mm4134={d:'score_speed'};