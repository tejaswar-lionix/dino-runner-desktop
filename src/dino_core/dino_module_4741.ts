/** dino_module_4741 — dino_physics_jump extended, humanized desktop */
export interface In4741{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4741{y:number;vy:number;sc:number}
const C4741={g:0.8, j:13};
export function extraSpawn_4741(inp:In4741, dt:number):Out4741 {
...
export const mm4741={d:'dino_physics_jump'};