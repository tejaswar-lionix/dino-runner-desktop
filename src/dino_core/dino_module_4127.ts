/** dino_module_4127 — particle_fx extended, humanized desktop */
export interface In4127{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4127{y:number;vy:number;sc:number}
const C4127={g:0.5, j:11};
export function extraRender_4127(inp:In4127, dt:number):Out4127 {
...
export const mm4127={d:'particle_fx'};