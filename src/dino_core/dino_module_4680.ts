/** dino_module_4680 — dino_physics_jump extended, humanized desktop */
export interface In4680{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4680{y:number;vy:number;sc:number}
const C4680={g:0.6, j:13};
export function extraPhysics_4680(inp:In4680, dt:number):Out4680 {
...
export const mm4680={d:'dino_physics_jump'};