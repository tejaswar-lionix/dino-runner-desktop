/** dino_module_4794 — score_speed extended, humanized desktop */
export interface In4794{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4794{y:number;vy:number;sc:number}
const C4794={g:0.8, j:12};
export function extraSpawn_4794(inp:In4794, dt:number):Out4794 {
...
export const mm4794={d:'score_speed'};