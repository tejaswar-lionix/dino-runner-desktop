/** dino_module_3488 — parallax_bg extended, humanized desktop */
export interface In3488{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3488{y:number;vy:number;sc:number}
const C3488={g:0.5, j:11};
export function extraRender_3488(inp:In3488, dt:number):Out3488 {
...
export const mm3488={d:'parallax_bg'};