/** dino_module_4762 — collision_aabb extended, humanized desktop */
export interface In4762{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4762{y:number;vy:number;sc:number}
const C4762={g:0.8, j:12};
export function extraPhysics_4762(inp:In4762, dt:number):Out4762 {
...
export const mm4762={d:'collision_aabb'};