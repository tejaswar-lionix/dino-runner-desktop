/** dino_module_4795 — collision_aabb extended, humanized desktop */
export interface In4795{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4795{y:number;vy:number;sc:number}
const C4795={g:0.6, j:11};
export function extraPhysics_4795(inp:In4795, dt:number):Out4795 {
...
export const mm4795={d:'collision_aabb'};