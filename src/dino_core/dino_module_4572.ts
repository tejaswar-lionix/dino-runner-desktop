/** dino_module_4572 — parallax_bg extended, humanized desktop */
export interface In4572{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4572{y:number;vy:number;sc:number}
const C4572={g:0.6, j:11};
export function extraRender_4572(inp:In4572, dt:number):Out4572 {
...
export const mm4572={d:'parallax_bg'};