/** dino_module_3841 — dino_physics_jump extended, humanized desktop */
export interface In3841{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3841{y:number;vy:number;sc:number}
const C3841={g:0.6, j:13};
export function extraPhysics_3841(inp:In3841, dt:number):Out3841 {
...
export const mm3841={d:'dino_physics_jump'};