/** dino_module_3709 — dino_physics_jump extended, humanized desktop */
export interface In3709{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3709{y:number;vy:number;sc:number}
const C3709={g:0.8, j:11};
export function extraPhysics_3709(inp:In3709, dt:number):Out3709 {
...
export const mm3709={d:'dino_physics_jump'};