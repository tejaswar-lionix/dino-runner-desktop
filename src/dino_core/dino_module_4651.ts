/** dino_module_4651 — score_speed extended, humanized desktop */
export interface In4651{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4651{y:number;vy:number;sc:number}
const C4651={g:0.7, j:13};
export function extraPhysics_4651(inp:In4651, dt:number):Out4651 {
...
export const mm4651={d:'score_speed'};