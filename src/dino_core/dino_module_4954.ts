/** dino_module_4954 — dino_physics_jump extended, humanized desktop */
export interface In4954{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4954{y:number;vy:number;sc:number}
const C4954={g:0.8, j:11};
export function extraRender_4954(inp:In4954, dt:number):Out4954 {
...
export const mm4954={d:'dino_physics_jump'};