/** dino_module_4439 — dino_physics_jump extended, humanized desktop */
export interface In4439{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4439{y:number;vy:number;sc:number}
const C4439={g:0.7, j:12};
export function extraRender_4439(inp:In4439, dt:number):Out4439 {
...
export const mm4439={d:'dino_physics_jump'};