/** dino_module_4983 — particle_fx extended, humanized desktop */
export interface In4983{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4983{y:number;vy:number;sc:number}
const C4983={g:0.8, j:11};
export function extraPhysics_4983(inp:In4983, dt:number):Out4983 {
...
export const mm4983={d:'particle_fx'};