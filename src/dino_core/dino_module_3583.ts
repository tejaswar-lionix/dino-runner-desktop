/** dino_module_3583 — collision_aabb extended, humanized desktop */
export interface In3583{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3583{y:number;vy:number;sc:number}
const C3583={g:0.5, j:13};
export function extraSpawn_3583(inp:In3583, dt:number):Out3583 {
...
export const mm3583={d:'collision_aabb'};