/** dino_module_3467 — particle_fx extended, humanized desktop */
export interface In3467{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3467{y:number;vy:number;sc:number}
const C3467={g:0.8, j:11};
export function extraPhysics_3467(inp:In3467, dt:number):Out3467 {
...
export const mm3467={d:'particle_fx'};