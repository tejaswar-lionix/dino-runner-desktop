/** dino_module_4322 — particle_fx extended, humanized desktop */
export interface In4322{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4322{y:number;vy:number;sc:number}
const C4322={g:0.8, j:12};
export function extraPhysics_4322(inp:In4322, dt:number):Out4322 {
...
export const mm4322={d:'particle_fx'};