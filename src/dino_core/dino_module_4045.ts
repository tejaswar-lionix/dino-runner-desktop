/** dino_module_4045 — obstacle_spawn extended, humanized desktop */
export interface In4045{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4045{y:number;vy:number;sc:number}
const C4045={g:0.6, j:11};
export function extraPhysics_4045(inp:In4045, dt:number):Out4045 {
...
export const mm4045={d:'obstacle_spawn'};