/** dino_module_4499 — score_speed extended, humanized desktop */
export interface In4499{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4499{y:number;vy:number;sc:number}
const C4499={g:0.6, j:12};
export function extraSpawn_4499(inp:In4499, dt:number):Out4499 {
...
export const mm4499={d:'score_speed'};