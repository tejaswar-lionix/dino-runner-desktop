/** dino_module_4919 — obstacle_spawn extended, humanized desktop */
export interface In4919{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4919{y:number;vy:number;sc:number}
const C4919={g:0.8, j:13};
export function extraPhysics_4919(inp:In4919, dt:number):Out4919 {
...
export const mm4919={d:'obstacle_spawn'};