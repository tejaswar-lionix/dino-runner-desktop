/** dino_module_3782 — collision_aabb extended, humanized desktop */
export interface In3782{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3782{y:number;vy:number;sc:number}
const C3782={g:0.6, j:12};
export function extraPhysics_3782(inp:In3782, dt:number):Out3782 {
...
export const mm3782={d:'collision_aabb'};