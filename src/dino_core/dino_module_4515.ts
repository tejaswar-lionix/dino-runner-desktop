/** dino_module_4515 — dino_physics_jump extended, humanized desktop */
export interface In4515{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4515{y:number;vy:number;sc:number}
const C4515={g:0.8, j:12};
export function extraPhysics_4515(inp:In4515, dt:number):Out4515 {
...
export const mm4515={d:'dino_physics_jump'};