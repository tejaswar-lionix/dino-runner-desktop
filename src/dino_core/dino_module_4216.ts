/** dino_module_4216 — dino_physics_jump extended, humanized desktop */
export interface In4216{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4216{y:number;vy:number;sc:number}
const C4216={g:0.6, j:13};
export function extraRender_4216(inp:In4216, dt:number):Out4216 {
...
export const mm4216={d:'dino_physics_jump'};