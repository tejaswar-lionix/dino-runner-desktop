/** dino_module_4748 — obstacle_spawn extended, humanized desktop */
export interface In4748{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4748{y:number;vy:number;sc:number}
const C4748={g:0.6, j:12};
export function extraRender_4748(inp:In4748, dt:number):Out4748 {
...
export const mm4748={d:'obstacle_spawn'};