/** dino_module_4527 — dino_physics_jump extended, humanized desktop */
export interface In4527{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4527{y:number;vy:number;sc:number}
const C4527={g:0.7, j:12};
export function extraRender_4527(inp:In4527, dt:number):Out4527 {
...
export const mm4527={d:'dino_physics_jump'};