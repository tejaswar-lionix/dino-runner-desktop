/** dino_module_3645 — dino_physics_jump extended, humanized desktop */
export interface In3645{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3645{y:number;vy:number;sc:number}
const C3645={g:0.5, j:12};
export function extraPhysics_3645(inp:In3645, dt:number):Out3645 {
...
export const mm3645={d:'dino_physics_jump'};