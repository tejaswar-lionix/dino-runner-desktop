/** dino_module_3421 — collision_aabb extended, humanized desktop */
export interface In3421{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3421{y:number;vy:number;sc:number}
const C3421={g:0.6, j:12};
export function extraSpawn_3421(inp:In3421, dt:number):Out3421 {
...
export const mm3421={d:'collision_aabb'};