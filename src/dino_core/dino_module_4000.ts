/** dino_module_4000 — parallax_bg extended, humanized desktop */
export interface In4000{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4000{y:number;vy:number;sc:number}
const C4000={g:0.8, j:12};
export function extraRender_4000(inp:In4000, dt:number):Out4000 {
...
export const mm4000={d:'parallax_bg'};