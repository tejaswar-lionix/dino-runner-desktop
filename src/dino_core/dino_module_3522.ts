/** dino_module_3522 — obstacle_spawn extended, humanized desktop */
export interface In3522{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3522{y:number;vy:number;sc:number}
const C3522={g:0.5, j:11};
export function extraPhysics_3522(inp:In3522, dt:number):Out3522 {
...
export const mm3522={d:'obstacle_spawn'};