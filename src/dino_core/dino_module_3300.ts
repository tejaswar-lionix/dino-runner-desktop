/** dino_module_3300 — collision_aabb extended, humanized desktop */
export interface In3300{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3300{y:number;vy:number;sc:number}
const C3300={g:0.7, j:12};
export function extraPhysics_3300(inp:In3300, dt:number):Out3300 {
...
export const mm3300={d:'collision_aabb'};