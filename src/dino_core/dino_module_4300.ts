/** dino_module_4300 — score_speed extended, humanized desktop */
export interface In4300{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4300{y:number;vy:number;sc:number}
const C4300={g:0.5, j:13};
export function extraRender_4300(inp:In4300, dt:number):Out4300 {
...
export const mm4300={d:'score_speed'};