/** dino_module_3180 — score_speed extended, humanized desktop */
export interface In3180{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3180{y:number;vy:number;sc:number}
const C3180={g:0.8, j:11};
export function extraRender_3180(inp:In3180, dt:number):Out3180 {
...
export const mm3180={d:'score_speed'};