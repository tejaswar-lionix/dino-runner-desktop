/** dino_module_4724 — dino_physics_jump extended, humanized desktop */
export interface In4724{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4724{y:number;vy:number;sc:number}
const C4724={g:0.8, j:11};
export function extraRender_4724(inp:In4724, dt:number):Out4724 {
...
export const mm4724={d:'dino_physics_jump'};