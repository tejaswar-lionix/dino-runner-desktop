/** dino_module_3194 — collision_aabb extended, humanized desktop */
export interface In3194{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3194{y:number;vy:number;sc:number}
const C3194={g:0.8, j:13};
export function extraSpawn_3194(inp:In3194, dt:number):Out3194 {
...
export const mm3194={d:'collision_aabb'};