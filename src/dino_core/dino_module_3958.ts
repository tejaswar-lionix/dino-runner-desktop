/** dino_module_3958 — parallax_bg extended, humanized desktop */
export interface In3958{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3958{y:number;vy:number;sc:number}
const C3958={g:0.8, j:12};
export function extraRender_3958(inp:In3958, dt:number):Out3958 {
...
export const mm3958={d:'parallax_bg'};