/** dino_module_3816 — parallax_bg extended, humanized desktop */
export interface In3816{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3816{y:number;vy:number;sc:number}
const C3816={g:0.8, j:11};
export function extraPhysics_3816(inp:In3816, dt:number):Out3816 {
...
export const mm3816={d:'parallax_bg'};