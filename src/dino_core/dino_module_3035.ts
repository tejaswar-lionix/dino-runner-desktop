/** dino_module_3035 — collision_aabb extended, humanized desktop */
export interface In3035{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3035{y:number;vy:number;sc:number}
const C3035={g:0.6, j:13};
export function extraSpawn_3035(inp:In3035, dt:number):Out3035 {
...
export const mm3035={d:'collision_aabb'};