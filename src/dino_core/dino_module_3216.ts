/** dino_module_3216 — score_speed extended, humanized desktop */
export interface In3216{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3216{y:number;vy:number;sc:number}
const C3216={g:0.5, j:11};
export function extraPhysics_3216(inp:In3216, dt:number):Out3216 {
...
export const mm3216={d:'score_speed'};