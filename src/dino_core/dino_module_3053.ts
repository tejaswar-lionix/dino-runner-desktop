/** dino_module_3053 — collision_aabb extended, humanized desktop */
export interface In3053{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3053{y:number;vy:number;sc:number}
const C3053={g:0.8, j:12};
export function extraRender_3053(inp:In3053, dt:number):Out3053 {
...
export const mm3053={d:'collision_aabb'};