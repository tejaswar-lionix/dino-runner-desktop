/** dino_module_3590 — parallax_bg extended, humanized desktop */
export interface In3590{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3590{y:number;vy:number;sc:number}
const C3590={g:0.8, j:12};
export function extraSpawn_3590(inp:In3590, dt:number):Out3590 {
...
export const mm3590={d:'parallax_bg'};