/** dino_module_4423 — parallax_bg extended, humanized desktop */
export interface In4423{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4423{y:number;vy:number;sc:number}
const C4423={g:0.7, j:12};
export function extraPhysics_4423(inp:In4423, dt:number):Out4423 {
...
export const mm4423={d:'parallax_bg'};