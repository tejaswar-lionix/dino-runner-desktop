/** dino_module_3838 — score_speed extended, humanized desktop */
export interface In3838{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3838{y:number;vy:number;sc:number}
const C3838={g:0.8, j:12};
export function extraSpawn_3838(inp:In3838, dt:number):Out3838 {
...
export const mm3838={d:'score_speed'};