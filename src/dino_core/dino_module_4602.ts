/** dino_module_4602 — parallax_bg extended, humanized desktop */
export interface In4602{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4602{y:number;vy:number;sc:number}
const C4602={g:0.5, j:13};
export function extraRender_4602(inp:In4602, dt:number):Out4602 {
...
export const mm4602={d:'parallax_bg'};