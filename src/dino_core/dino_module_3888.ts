/** dino_module_3888 — dino_physics_jump extended, humanized desktop */
export interface In3888{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3888{y:number;vy:number;sc:number}
const C3888={g:0.7, j:12};
export function extraRender_3888(inp:In3888, dt:number):Out3888 {
...
export const mm3888={d:'dino_physics_jump'};