/** dino_module_3687 — particle_fx extended, humanized desktop */
export interface In3687{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3687{y:number;vy:number;sc:number}
const C3687={g:0.8, j:13};
export function extraPhysics_3687(inp:In3687, dt:number):Out3687 {
...
export const mm3687={d:'particle_fx'};