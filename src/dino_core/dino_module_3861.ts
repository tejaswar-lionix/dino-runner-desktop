/** dino_module_3861 — collision_aabb extended, humanized desktop */
export interface In3861{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3861{y:number;vy:number;sc:number}
const C3861={g:0.7, j:11};
export function extraPhysics_3861(inp:In3861, dt:number):Out3861 {
...
export const mm3861={d:'collision_aabb'};