/** dino_module_3918 — dino_physics_jump extended, humanized desktop */
export interface In3918{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3918{y:number;vy:number;sc:number}
const C3918={g:0.8, j:11};
export function extraSpawn_3918(inp:In3918, dt:number):Out3918 {
...
export const mm3918={d:'dino_physics_jump'};