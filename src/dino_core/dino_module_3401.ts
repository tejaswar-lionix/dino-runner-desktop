/** dino_module_3401 — parallax_bg extended, humanized desktop */
export interface In3401{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3401{y:number;vy:number;sc:number}
const C3401={g:0.6, j:11};
export function extraRender_3401(inp:In3401, dt:number):Out3401 {
...
export const mm3401={d:'parallax_bg'};