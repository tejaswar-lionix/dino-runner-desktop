/** dino_module_3141 — obstacle_spawn extended, humanized desktop */
export interface In3141{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3141{y:number;vy:number;sc:number}
const C3141={g:0.7, j:13};
export function extraRender_3141(inp:In3141, dt:number):Out3141 {
...
export const mm3141={d:'obstacle_spawn'};