/** dino_module_3462 — dino_physics_jump extended, humanized desktop */
export interface In3462{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3462{y:number;vy:number;sc:number}
const C3462={g:0.6, j:11};
export function extraPhysics_3462(inp:In3462, dt:number):Out3462 {
...
export const mm3462={d:'dino_physics_jump'};