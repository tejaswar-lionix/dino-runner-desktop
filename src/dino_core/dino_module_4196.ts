/** dino_module_4196 — score_speed extended, humanized desktop */
export interface In4196{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4196{y:number;vy:number;sc:number}
const C4196={g:0.7, j:12};
export function extraRender_4196(inp:In4196, dt:number):Out4196 {
...
export const mm4196={d:'score_speed'};