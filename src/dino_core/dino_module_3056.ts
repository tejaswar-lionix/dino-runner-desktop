/** dino_module_3056 — score_speed extended, humanized desktop */
export interface In3056{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3056{y:number;vy:number;sc:number}
const C3056={g:0.6, j:12};
export function extraPhysics_3056(inp:In3056, dt:number):Out3056 {
...
export const mm3056={d:'score_speed'};