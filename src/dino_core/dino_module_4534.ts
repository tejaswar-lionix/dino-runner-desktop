/** dino_module_4534 — particle_fx extended, humanized desktop */
export interface In4534{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4534{y:number;vy:number;sc:number}
const C4534={g:0.7, j:12};
export function extraPhysics_4534(inp:In4534, dt:number):Out4534 {
...
export const mm4534={d:'particle_fx'};