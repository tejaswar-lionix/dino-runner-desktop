/** dino_module_3499 — collision_aabb extended, humanized desktop */
export interface In3499{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3499{y:number;vy:number;sc:number}
const C3499={g:0.5, j:11};
export function extraRender_3499(inp:In3499, dt:number):Out3499 {
...
export const mm3499={d:'collision_aabb'};