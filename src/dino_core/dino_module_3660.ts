/** dino_module_3660 — collision_aabb extended, humanized desktop */
export interface In3660{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3660{y:number;vy:number;sc:number}
const C3660={g:0.6, j:11};
export function extraRender_3660(inp:In3660, dt:number):Out3660 {
...
export const mm3660={d:'collision_aabb'};