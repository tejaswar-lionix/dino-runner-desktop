/** dino_module_4466 — particle_fx extended, humanized desktop */
export interface In4466{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4466{y:number;vy:number;sc:number}
const C4466={g:0.5, j:12};
export function extraRender_4466(inp:In4466, dt:number):Out4466 {
...
export const mm4466={d:'particle_fx'};