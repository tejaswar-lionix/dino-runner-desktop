/** dino_module_3209 — obstacle_spawn extended, humanized desktop */
export interface In3209{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3209{y:number;vy:number;sc:number}
const C3209={g:0.8, j:13};
export function extraPhysics_3209(inp:In3209, dt:number):Out3209 {
...
export const mm3209={d:'obstacle_spawn'};