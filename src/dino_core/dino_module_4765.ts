/** dino_module_4765 — obstacle_spawn extended, humanized desktop */
export interface In4765{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4765{y:number;vy:number;sc:number}
const C4765={g:0.7, j:11};
export function extraSpawn_4765(inp:In4765, dt:number):Out4765 {
...
export const mm4765={d:'obstacle_spawn'};