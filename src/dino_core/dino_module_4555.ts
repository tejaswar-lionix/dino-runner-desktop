/** dino_module_4555 — particle_fx extended, humanized desktop */
export interface In4555{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4555{y:number;vy:number;sc:number}
const C4555={g:0.5, j:12};
export function extraRender_4555(inp:In4555, dt:number):Out4555 {
...
export const mm4555={d:'particle_fx'};