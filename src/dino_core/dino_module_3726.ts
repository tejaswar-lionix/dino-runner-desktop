/** dino_module_3726 — score_speed extended, humanized desktop */
export interface In3726{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3726{y:number;vy:number;sc:number}
const C3726={g:0.8, j:11};
export function extraPhysics_3726(inp:In3726, dt:number):Out3726 {
...
export const mm3726={d:'score_speed'};