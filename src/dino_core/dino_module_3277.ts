/** dino_module_3277 — collision_aabb extended, humanized desktop */
export interface In3277{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3277{y:number;vy:number;sc:number}
const C3277={g:0.5, j:13};
export function extraRender_3277(inp:In3277, dt:number):Out3277 {
...
export const mm3277={d:'collision_aabb'};