/** dino_module_4062 — obstacle_spawn extended, humanized desktop */
export interface In4062{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4062{y:number;vy:number;sc:number}
const C4062={g:0.6, j:12};
export function extraRender_4062(inp:In4062, dt:number):Out4062 {
...
export const mm4062={d:'obstacle_spawn'};