/** dino_module_3680 — dino_physics_jump extended, humanized desktop */
export interface In3680{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3680{y:number;vy:number;sc:number}
const C3680={g:0.8, j:11};
export function extraPhysics_3680(inp:In3680, dt:number):Out3680 {
...
export const mm3680={d:'dino_physics_jump'};