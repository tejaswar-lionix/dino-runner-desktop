/** dino_module_3714 — dino_physics_jump extended, humanized desktop */
export interface In3714{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3714{y:number;vy:number;sc:number}
const C3714={g:0.5, j:11};
export function extraPhysics_3714(inp:In3714, dt:number):Out3714 {
...
export const mm3714={d:'dino_physics_jump'};