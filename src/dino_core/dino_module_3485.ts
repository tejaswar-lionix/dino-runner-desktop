/** dino_module_3485 — score_speed extended, humanized desktop */
export interface In3485{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3485{y:number;vy:number;sc:number}
const C3485={g:0.8, j:11};
export function extraPhysics_3485(inp:In3485, dt:number):Out3485 {
...
export const mm3485={d:'score_speed'};