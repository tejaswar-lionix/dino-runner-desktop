/** dino_module_4255 — dino_physics_jump extended, humanized desktop */
export interface In4255{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4255{y:number;vy:number;sc:number}
const C4255={g:0.6, j:12};
export function extraPhysics_4255(inp:In4255, dt:number):Out4255 {
...
export const mm4255={d:'dino_physics_jump'};