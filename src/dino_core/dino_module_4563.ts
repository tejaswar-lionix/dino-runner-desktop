/** dino_module_4563 — obstacle_spawn extended, humanized desktop */
export interface In4563{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4563{y:number;vy:number;sc:number}
const C4563={g:0.5, j:13};
export function extraRender_4563(inp:In4563, dt:number):Out4563 {
...
export const mm4563={d:'obstacle_spawn'};