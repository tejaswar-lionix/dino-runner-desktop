/** dino_module_3480 — particle_fx extended, humanized desktop */
export interface In3480{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3480{y:number;vy:number;sc:number}
const C3480={g:0.5, j:11};
export function extraSpawn_3480(inp:In3480, dt:number):Out3480 {
...
export const mm3480={d:'particle_fx'};