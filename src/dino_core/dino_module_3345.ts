/** dino_module_3345 — collision_aabb extended, humanized desktop */
export interface In3345{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3345{y:number;vy:number;sc:number}
const C3345={g:0.8, j:12};
export function extraSpawn_3345(inp:In3345, dt:number):Out3345 {
...
export const mm3345={d:'collision_aabb'};