/** dino_module_4348 — collision_aabb extended, humanized desktop */
export interface In4348{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4348{y:number;vy:number;sc:number}
const C4348={g:0.7, j:12};
export function extraPhysics_4348(inp:In4348, dt:number):Out4348 {
...
export const mm4348={d:'collision_aabb'};