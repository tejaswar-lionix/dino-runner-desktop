/** dino_module_3615 — parallax_bg extended, humanized desktop */
export interface In3615{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3615{y:number;vy:number;sc:number}
const C3615={g:0.5, j:13};
export function extraSpawn_3615(inp:In3615, dt:number):Out3615 {
...
export const mm3615={d:'parallax_bg'};