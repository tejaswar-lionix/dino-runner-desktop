/** dino_module_3080 — parallax_bg extended, humanized desktop */
export interface In3080{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3080{y:number;vy:number;sc:number}
const C3080={g:0.7, j:13};
export function extraPhysics_3080(inp:In3080, dt:number):Out3080 {
...
export const mm3080={d:'parallax_bg'};