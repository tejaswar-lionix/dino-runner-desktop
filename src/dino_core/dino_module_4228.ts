/** dino_module_4228 — score_speed extended, humanized desktop */
export interface In4228{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4228{y:number;vy:number;sc:number}
const C4228={g:0.8, j:11};
export function extraSpawn_4228(inp:In4228, dt:number):Out4228 {
...
export const mm4228={d:'score_speed'};