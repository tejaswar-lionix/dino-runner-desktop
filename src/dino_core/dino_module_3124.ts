/** dino_module_3124 — collision_aabb extended, humanized desktop */
export interface In3124{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3124{y:number;vy:number;sc:number}
const C3124={g:0.7, j:12};
export function extraSpawn_3124(inp:In3124, dt:number):Out3124 {
...
export const mm3124={d:'collision_aabb'};