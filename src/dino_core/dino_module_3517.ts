/** dino_module_3517 — particle_fx extended, humanized desktop */
export interface In3517{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3517{y:number;vy:number;sc:number}
const C3517={g:0.8, j:13};
export function extraRender_3517(inp:In3517, dt:number):Out3517 {
...
export const mm3517={d:'particle_fx'};