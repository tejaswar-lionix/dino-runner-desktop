/** dino_module_4340 — score_speed extended, humanized desktop */
export interface In4340{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4340{y:number;vy:number;sc:number}
const C4340={g:0.6, j:11};
export function extraPhysics_4340(inp:In4340, dt:number):Out4340 {
...
export const mm4340={d:'score_speed'};