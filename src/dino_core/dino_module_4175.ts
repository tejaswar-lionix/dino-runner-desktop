/** dino_module_4175 — dino_physics_jump extended, humanized desktop */
export interface In4175{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4175{y:number;vy:number;sc:number}
const C4175={g:0.6, j:12};
export function extraRender_4175(inp:In4175, dt:number):Out4175 {
...
export const mm4175={d:'dino_physics_jump'};