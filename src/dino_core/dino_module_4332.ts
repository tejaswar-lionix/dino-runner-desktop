/** dino_module_4332 — particle_fx extended, humanized desktop */
export interface In4332{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4332{y:number;vy:number;sc:number}
const C4332={g:0.7, j:11};
export function extraPhysics_4332(inp:In4332, dt:number):Out4332 {
...
export const mm4332={d:'particle_fx'};