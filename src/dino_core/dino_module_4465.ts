/** dino_module_4465 — parallax_bg extended, humanized desktop */
export interface In4465{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4465{y:number;vy:number;sc:number}
const C4465={g:0.5, j:12};
export function extraPhysics_4465(inp:In4465, dt:number):Out4465 {
...
export const mm4465={d:'parallax_bg'};