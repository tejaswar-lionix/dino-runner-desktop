/** dino_module_3233 — dino_physics_jump extended, humanized desktop */
export interface In3233{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3233{y:number;vy:number;sc:number}
const C3233={g:0.5, j:12};
export function extraSpawn_3233(inp:In3233, dt:number):Out3233 {
...
export const mm3233={d:'dino_physics_jump'};