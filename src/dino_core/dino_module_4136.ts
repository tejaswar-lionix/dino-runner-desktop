/** dino_module_4136 — obstacle_spawn extended, humanized desktop */
export interface In4136{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4136{y:number;vy:number;sc:number}
const C4136={g:0.7, j:12};
export function extraRender_4136(inp:In4136, dt:number):Out4136 {
...
export const mm4136={d:'obstacle_spawn'};