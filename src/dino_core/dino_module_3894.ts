/** dino_module_3894 — parallax_bg extended, humanized desktop */
export interface In3894{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3894{y:number;vy:number;sc:number}
const C3894={g:0.5, j:13};
export function extraPhysics_3894(inp:In3894, dt:number):Out3894 {
...
export const mm3894={d:'parallax_bg'};