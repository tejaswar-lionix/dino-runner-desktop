/** dino_module_4850 — particle_fx extended, humanized desktop */
export interface In4850{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4850{y:number;vy:number;sc:number}
const C4850={g:0.7, j:13};
export function extraRender_4850(inp:In4850, dt:number):Out4850 {
...
export const mm4850={d:'particle_fx'};