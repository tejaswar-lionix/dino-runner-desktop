/** dino_module_3374 — dino_physics_jump extended, humanized desktop */
export interface In3374{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3374{y:number;vy:number;sc:number}
const C3374={g:0.5, j:13};
export function extraPhysics_3374(inp:In3374, dt:number):Out3374 {
...
export const mm3374={d:'dino_physics_jump'};