/** dino_module_4171 — dino_physics_jump extended, humanized desktop */
export interface In4171{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4171{y:number;vy:number;sc:number}
const C4171={g:0.6, j:12};
export function extraPhysics_4171(inp:In4171, dt:number):Out4171 {
...
export const mm4171={d:'dino_physics_jump'};