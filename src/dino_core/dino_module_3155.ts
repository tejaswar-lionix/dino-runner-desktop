/** dino_module_3155 — obstacle_spawn extended, humanized desktop */
export interface In3155{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3155{y:number;vy:number;sc:number}
const C3155={g:0.8, j:12};
export function extraSpawn_3155(inp:In3155, dt:number):Out3155 {
...
export const mm3155={d:'obstacle_spawn'};