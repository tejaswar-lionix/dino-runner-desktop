/** dino_module_4345 — score_speed extended, humanized desktop */
export interface In4345{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4345{y:number;vy:number;sc:number}
const C4345={g:0.5, j:12};
export function extraRender_4345(inp:In4345, dt:number):Out4345 {
...
export const mm4345={d:'score_speed'};