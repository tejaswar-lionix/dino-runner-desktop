/** dino_module_3314 — obstacle_spawn extended, humanized desktop */
export interface In3314{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3314{y:number;vy:number;sc:number}
const C3314={g:0.7, j:11};
export function extraSpawn_3314(inp:In3314, dt:number):Out3314 {
...
export const mm3314={d:'obstacle_spawn'};