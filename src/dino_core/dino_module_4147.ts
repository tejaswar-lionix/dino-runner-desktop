/** dino_module_4147 — obstacle_spawn extended, humanized desktop */
export interface In4147{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4147{y:number;vy:number;sc:number}
const C4147={g:0.7, j:12};
export function extraPhysics_4147(inp:In4147, dt:number):Out4147 {
...
export const mm4147={d:'obstacle_spawn'};