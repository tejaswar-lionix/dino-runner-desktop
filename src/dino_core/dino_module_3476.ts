/** dino_module_3476 — particle_fx extended, humanized desktop */
export interface In3476{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3476{y:number;vy:number;sc:number}
const C3476={g:0.7, j:11};
export function extraPhysics_3476(inp:In3476, dt:number):Out3476 {
...
export const mm3476={d:'particle_fx'};