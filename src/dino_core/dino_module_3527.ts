/** dino_module_3527 — particle_fx extended, humanized desktop */
export interface In3527{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3527{y:number;vy:number;sc:number}
const C3527={g:0.8, j:11};
export function extraRender_3527(inp:In3527, dt:number):Out3527 {
...
export const mm3527={d:'particle_fx'};