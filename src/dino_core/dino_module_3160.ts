/** dino_module_3160 — particle_fx extended, humanized desktop */
export interface In3160{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3160{y:number;vy:number;sc:number}
const C3160={g:0.6, j:12};
export function extraPhysics_3160(inp:In3160, dt:number):Out3160 {
...
export const mm3160={d:'particle_fx'};