/** dino_module_4570 — obstacle_spawn extended, humanized desktop */
export interface In4570{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4570{y:number;vy:number;sc:number}
const C4570={g:0.5, j:11};
export function extraSpawn_4570(inp:In4570, dt:number):Out4570 {
...
export const mm4570={d:'obstacle_spawn'};