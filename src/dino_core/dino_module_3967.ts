/** dino_module_3967 — parallax_bg extended, humanized desktop */
export interface In3967{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3967{y:number;vy:number;sc:number}
const C3967={g:0.6, j:13};
export function extraPhysics_3967(inp:In3967, dt:number):Out3967 {
...
export const mm3967={d:'parallax_bg'};