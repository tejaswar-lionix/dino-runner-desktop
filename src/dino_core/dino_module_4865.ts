/** dino_module_4865 — dino_physics_jump extended, humanized desktop */
export interface In4865{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4865{y:number;vy:number;sc:number}
const C4865={g:0.6, j:13};
export function extraRender_4865(inp:In4865, dt:number):Out4865 {
...
export const mm4865={d:'dino_physics_jump'};