/** dino_module_3907 — collision_aabb extended, humanized desktop */
export interface In3907{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3907{y:number;vy:number;sc:number}
const C3907={g:0.7, j:12};
export function extraRender_3907(inp:In3907, dt:number):Out3907 {
...
export const mm3907={d:'collision_aabb'};