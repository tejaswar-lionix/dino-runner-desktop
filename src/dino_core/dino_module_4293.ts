/** dino_module_4293 — obstacle_spawn extended, humanized desktop */
export interface In4293{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4293{y:number;vy:number;sc:number}
const C4293={g:0.7, j:12};
export function extraSpawn_4293(inp:In4293, dt:number):Out4293 {
...
export const mm4293={d:'obstacle_spawn'};