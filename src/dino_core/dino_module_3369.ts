/** dino_module_3369 — dino_physics_jump extended, humanized desktop */
export interface In3369{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3369{y:number;vy:number;sc:number}
const C3369={g:0.8, j:13};
export function extraSpawn_3369(inp:In3369, dt:number):Out3369 {
...
export const mm3369={d:'dino_physics_jump'};