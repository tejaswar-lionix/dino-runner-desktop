/** dino_module_4661 — obstacle_spawn extended, humanized desktop */
export interface In4661{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4661{y:number;vy:number;sc:number}
const C4661={g:0.7, j:12};
export function extraRender_4661(inp:In4661, dt:number):Out4661 {
...
export const mm4661={d:'obstacle_spawn'};