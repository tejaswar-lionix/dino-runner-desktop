/** dino_module_3087 — particle_fx extended, humanized desktop */
export interface In3087{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3087{y:number;vy:number;sc:number}
const C3087={g:0.7, j:12};
export function extraRender_3087(inp:In3087, dt:number):Out3087 {
...
export const mm3087={d:'particle_fx'};