/** dino_module_3703 — parallax_bg extended, humanized desktop */
export interface In3703{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3703{y:number;vy:number;sc:number}
const C3703={g:0.7, j:12};
export function extraPhysics_3703(inp:In3703, dt:number):Out3703 {
...
export const mm3703={d:'parallax_bg'};