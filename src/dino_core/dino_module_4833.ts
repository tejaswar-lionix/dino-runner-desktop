/** dino_module_4833 — score_speed extended, humanized desktop */
export interface In4833{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4833{y:number;vy:number;sc:number}
const C4833={g:0.8, j:11};
export function extraSpawn_4833(inp:In4833, dt:number):Out4833 {
...
export const mm4833={d:'score_speed'};