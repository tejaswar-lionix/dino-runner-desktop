/** dino_module_3107 — dino_physics_jump extended, humanized desktop */
export interface In3107{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3107{y:number;vy:number;sc:number}
const C3107={g:0.7, j:12};
export function extraRender_3107(inp:In3107, dt:number):Out3107 {
...
export const mm3107={d:'dino_physics_jump'};