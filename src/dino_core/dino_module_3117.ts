/** dino_module_3117 — score_speed extended, humanized desktop */
export interface In3117{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3117{y:number;vy:number;sc:number}
const C3117={g:0.6, j:12};
export function extraSpawn_3117(inp:In3117, dt:number):Out3117 {
...
export const mm3117={d:'score_speed'};