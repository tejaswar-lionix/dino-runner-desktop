/** dino_module_4678 — particle_fx extended, humanized desktop */
export interface In4678{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4678{y:number;vy:number;sc:number}
const C4678={g:0.5, j:11};
export function extraSpawn_4678(inp:In4678, dt:number):Out4678 {
...
export const mm4678={d:'particle_fx'};