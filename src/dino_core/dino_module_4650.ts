/** dino_module_4650 — score_speed extended, humanized desktop */
export interface In4650{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4650{y:number;vy:number;sc:number}
const C4650={g:0.5, j:11};
export function extraRender_4650(inp:In4650, dt:number):Out4650 {
...
export const mm4650={d:'score_speed'};