/** dino_module_4816 — score_speed extended, humanized desktop */
export interface In4816{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4816{y:number;vy:number;sc:number}
const C4816={g:0.7, j:11};
export function extraPhysics_4816(inp:In4816, dt:number):Out4816 {
...
export const mm4816={d:'score_speed'};