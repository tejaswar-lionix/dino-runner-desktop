/** dino_module_3676 — collision_aabb extended, humanized desktop */
export interface In3676{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3676{y:number;vy:number;sc:number}
const C3676={g:0.8, j:12};
export function extraSpawn_3676(inp:In3676, dt:number):Out3676 {
...
export const mm3676={d:'collision_aabb'};