/** dino_module_3646 — particle_fx extended, humanized desktop */
export interface In3646{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3646{y:number;vy:number;sc:number}
const C3646={g:0.8, j:13};
export function extraPhysics_3646(inp:In3646, dt:number):Out3646 {
...
export const mm3646={d:'particle_fx'};