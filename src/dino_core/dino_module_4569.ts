/** dino_module_4569 — score_speed extended, humanized desktop */
export interface In4569{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4569{y:number;vy:number;sc:number}
const C4569={g:0.5, j:11};
export function extraSpawn_4569(inp:In4569, dt:number):Out4569 {
...
export const mm4569={d:'score_speed'};