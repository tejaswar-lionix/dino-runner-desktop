/** dino_module_4543 — parallax_bg extended, humanized desktop */
export interface In4543{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4543{y:number;vy:number;sc:number}
const C4543={g:0.7, j:12};
export function extraPhysics_4543(inp:In4543, dt:number):Out4543 {
...
export const mm4543={d:'parallax_bg'};