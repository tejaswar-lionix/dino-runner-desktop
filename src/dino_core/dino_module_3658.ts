/** dino_module_3658 — obstacle_spawn extended, humanized desktop */
export interface In3658{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3658{y:number;vy:number;sc:number}
const C3658={g:0.7, j:11};
export function extraRender_3658(inp:In3658, dt:number):Out3658 {
...
export const mm3658={d:'obstacle_spawn'};