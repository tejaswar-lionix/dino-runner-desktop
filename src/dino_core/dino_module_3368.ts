/** dino_module_3368 — obstacle_spawn extended, humanized desktop */
export interface In3368{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3368{y:number;vy:number;sc:number}
const C3368={g:0.7, j:11};
export function extraRender_3368(inp:In3368, dt:number):Out3368 {
...
export const mm3368={d:'obstacle_spawn'};