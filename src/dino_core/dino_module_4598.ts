/** dino_module_4598 — collision_aabb extended, humanized desktop */
export interface In4598{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4598{y:number;vy:number;sc:number}
const C4598={g:0.5, j:13};
export function extraRender_4598(inp:In4598, dt:number):Out4598 {
...
export const mm4598={d:'collision_aabb'};