/** dino_module_3325 — parallax_bg extended, humanized desktop */
export interface In3325{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3325{y:number;vy:number;sc:number}
const C3325={g:0.5, j:12};
export function extraRender_3325(inp:In3325, dt:number):Out3325 {
...
export const mm3325={d:'parallax_bg'};