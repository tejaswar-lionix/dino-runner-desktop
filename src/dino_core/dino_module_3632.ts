/** dino_module_3632 — parallax_bg extended, humanized desktop */
export interface In3632{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3632{y:number;vy:number;sc:number}
const C3632={g:0.8, j:13};
export function extraRender_3632(inp:In3632, dt:number):Out3632 {
...
export const mm3632={d:'parallax_bg'};