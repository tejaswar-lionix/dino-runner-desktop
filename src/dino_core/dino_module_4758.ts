/** dino_module_4758 — dino_physics_jump extended, humanized desktop */
export interface In4758{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4758{y:number;vy:number;sc:number}
const C4758={g:0.8, j:13};
export function extraSpawn_4758(inp:In4758, dt:number):Out4758 {
...
export const mm4758={d:'dino_physics_jump'};