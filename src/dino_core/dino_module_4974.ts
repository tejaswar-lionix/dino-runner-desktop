/** dino_module_4974 — parallax_bg extended, humanized desktop */
export interface In4974{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4974{y:number;vy:number;sc:number}
const C4974={g:0.7, j:12};
export function extraSpawn_4974(inp:In4974, dt:number):Out4974 {
...
export const mm4974={d:'parallax_bg'};