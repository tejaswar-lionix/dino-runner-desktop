/** dino_module_4370 — particle_fx extended, humanized desktop */
export interface In4370{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4370{y:number;vy:number;sc:number}
const C4370={g:0.5, j:13};
export function extraSpawn_4370(inp:In4370, dt:number):Out4370 {
...
export const mm4370={d:'particle_fx'};