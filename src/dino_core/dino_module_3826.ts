/** dino_module_3826 — parallax_bg extended, humanized desktop */
export interface In3826{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3826{y:number;vy:number;sc:number}
const C3826={g:0.5, j:12};
export function extraRender_3826(inp:In3826, dt:number):Out3826 {
...
export const mm3826={d:'parallax_bg'};