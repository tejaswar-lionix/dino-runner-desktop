/** dino_module_3880 — obstacle_spawn extended, humanized desktop */
export interface In3880{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3880{y:number;vy:number;sc:number}
const C3880={g:0.5, j:13};
export function extraSpawn_3880(inp:In3880, dt:number):Out3880 {
...
export const mm3880={d:'obstacle_spawn'};