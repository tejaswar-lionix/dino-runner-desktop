/** dino_module_3043 — particle_fx extended, humanized desktop */
export interface In3043{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3043{y:number;vy:number;sc:number}
const C3043={g:0.5, j:11};
export function extraSpawn_3043(inp:In3043, dt:number):Out3043 {
...
export const mm3043={d:'particle_fx'};