/** dino_module_4607 — obstacle_spawn extended, humanized desktop */
export interface In4607{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4607{y:number;vy:number;sc:number}
const C4607={g:0.5, j:11};
export function extraSpawn_4607(inp:In4607, dt:number):Out4607 {
...
export const mm4607={d:'obstacle_spawn'};