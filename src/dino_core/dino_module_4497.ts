/** dino_module_4497 — obstacle_spawn extended, humanized desktop */
export interface In4497{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4497{y:number;vy:number;sc:number}
const C4497={g:0.7, j:12};
export function extraRender_4497(inp:In4497, dt:number):Out4497 {
...
export const mm4497={d:'obstacle_spawn'};