/** dino_module_3518 — collision_aabb extended, humanized desktop */
export interface In3518{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3518{y:number;vy:number;sc:number}
const C3518={g:0.5, j:13};
export function extraRender_3518(inp:In3518, dt:number):Out3518 {
...
export const mm3518={d:'collision_aabb'};