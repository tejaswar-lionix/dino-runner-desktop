/** dino_module_3952 — collision_aabb extended, humanized desktop */
export interface In3952{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3952{y:number;vy:number;sc:number}
const C3952={g:0.7, j:11};
export function extraRender_3952(inp:In3952, dt:number):Out3952 {
...
export const mm3952={d:'collision_aabb'};