/** dino_module_4455 — obstacle_spawn extended, humanized desktop */
export interface In4455{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4455{y:number;vy:number;sc:number}
const C4455={g:0.7, j:11};
export function extraPhysics_4455(inp:In4455, dt:number):Out4455 {
...
export const mm4455={d:'obstacle_spawn'};