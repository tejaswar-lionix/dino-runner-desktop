/** dino_module_4093 — parallax_bg extended, humanized desktop */
export interface In4093{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4093{y:number;vy:number;sc:number}
const C4093={g:0.8, j:12};
export function extraSpawn_4093(inp:In4093, dt:number):Out4093 {
...
export const mm4093={d:'parallax_bg'};