/** dino_module_3505 — score_speed extended, humanized desktop */
export interface In3505{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3505{y:number;vy:number;sc:number}
const C3505={g:0.7, j:12};
export function extraPhysics_3505(inp:In3505, dt:number):Out3505 {
...
export const mm3505={d:'score_speed'};