/** dino_module_4052 — obstacle_spawn extended, humanized desktop */
export interface In4052{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4052{y:number;vy:number;sc:number}
const C4052={g:0.6, j:13};
export function extraPhysics_4052(inp:In4052, dt:number):Out4052 {
...
export const mm4052={d:'obstacle_spawn'};