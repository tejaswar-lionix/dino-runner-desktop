/** dino_module_3241 — parallax_bg extended, humanized desktop */
export interface In3241{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3241{y:number;vy:number;sc:number}
const C3241={g:0.6, j:12};
export function extraPhysics_3241(inp:In3241, dt:number):Out3241 {
...
export const mm3241={d:'parallax_bg'};