/** dino_module_3899 — obstacle_spawn extended, humanized desktop */
export interface In3899{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3899{y:number;vy:number;sc:number}
const C3899={g:0.7, j:12};
export function extraPhysics_3899(inp:In3899, dt:number):Out3899 {
...
export const mm3899={d:'obstacle_spawn'};