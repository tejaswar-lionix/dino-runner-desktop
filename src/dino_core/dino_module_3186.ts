/** dino_module_3186 — obstacle_spawn extended, humanized desktop */
export interface In3186{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3186{y:number;vy:number;sc:number}
const C3186={g:0.6, j:13};
export function extraSpawn_3186(inp:In3186, dt:number):Out3186 {
...
export const mm3186={d:'obstacle_spawn'};