/** dino_module_3384 — particle_fx extended, humanized desktop */
export interface In3384{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3384{y:number;vy:number;sc:number}
const C3384={g:0.7, j:11};
export function extraRender_3384(inp:In3384, dt:number):Out3384 {
...
export const mm3384={d:'particle_fx'};