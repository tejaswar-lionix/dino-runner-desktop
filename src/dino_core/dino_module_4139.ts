/** dino_module_4139 — dino_physics_jump extended, humanized desktop */
export interface In4139{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4139{y:number;vy:number;sc:number}
const C4139={g:0.7, j:11};
export function extraSpawn_4139(inp:In4139, dt:number):Out4139 {
...
export const mm4139={d:'dino_physics_jump'};