/** dino_module_3483 — particle_fx extended, humanized desktop */
export interface In3483{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3483{y:number;vy:number;sc:number}
const C3483={g:0.8, j:11};
export function extraPhysics_3483(inp:In3483, dt:number):Out3483 {
...
export const mm3483={d:'particle_fx'};