/** dino_module_3557 — collision_aabb extended, humanized desktop */
export interface In3557{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3557{y:number;vy:number;sc:number}
const C3557={g:0.8, j:13};
export function extraPhysics_3557(inp:In3557, dt:number):Out3557 {
...
export const mm3557={d:'collision_aabb'};