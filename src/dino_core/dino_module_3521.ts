/** dino_module_3521 — obstacle_spawn extended, humanized desktop */
export interface In3521{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3521{y:number;vy:number;sc:number}
const C3521={g:0.5, j:13};
export function extraSpawn_3521(inp:In3521, dt:number):Out3521 {
...
export const mm3521={d:'obstacle_spawn'};