/** dino_module_3299 — obstacle_spawn extended, humanized desktop */
export interface In3299{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3299{y:number;vy:number;sc:number}
const C3299={g:0.5, j:11};
export function extraRender_3299(inp:In3299, dt:number):Out3299 {
...
export const mm3299={d:'obstacle_spawn'};