/** dino_module_3346 — collision_aabb extended, humanized desktop */
export interface In3346{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3346{y:number;vy:number;sc:number}
const C3346={g:0.6, j:12};
export function extraRender_3346(inp:In3346, dt:number):Out3346 {
...
export const mm3346={d:'collision_aabb'};