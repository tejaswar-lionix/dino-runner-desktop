/** dino_module_3727 — particle_fx extended, humanized desktop */
export interface In3727{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3727{y:number;vy:number;sc:number}
const C3727={g:0.8, j:11};
export function extraSpawn_3727(inp:In3727, dt:number):Out3727 {
...
export const mm3727={d:'particle_fx'};