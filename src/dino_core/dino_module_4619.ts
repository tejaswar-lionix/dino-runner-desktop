/** dino_module_4619 — dino_physics_jump extended, humanized desktop */
export interface In4619{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4619{y:number;vy:number;sc:number}
const C4619={g:0.7, j:12};
export function extraSpawn_4619(inp:In4619, dt:number):Out4619 {
...
export const mm4619={d:'dino_physics_jump'};