/** dino_module_4379 — parallax_bg extended, humanized desktop */
export interface In4379{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4379{y:number;vy:number;sc:number}
const C4379={g:0.8, j:12};
export function extraRender_4379(inp:In4379, dt:number):Out4379 {
...
export const mm4379={d:'parallax_bg'};