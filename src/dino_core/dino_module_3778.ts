/** dino_module_3778 — collision_aabb extended, humanized desktop */
export interface In3778{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3778{y:number;vy:number;sc:number}
const C3778={g:0.6, j:12};
export function extraRender_3778(inp:In3778, dt:number):Out3778 {
...
export const mm3778={d:'collision_aabb'};