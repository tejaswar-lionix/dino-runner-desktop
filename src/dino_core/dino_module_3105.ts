/** dino_module_3105 — collision_aabb extended, humanized desktop */
export interface In3105{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3105{y:number;vy:number;sc:number}
const C3105={g:0.6, j:13};
export function extraPhysics_3105(inp:In3105, dt:number):Out3105 {
...
export const mm3105={d:'collision_aabb'};