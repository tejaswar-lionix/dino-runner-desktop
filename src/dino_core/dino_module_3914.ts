/** dino_module_3914 — parallax_bg extended, humanized desktop */
export interface In3914{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3914{y:number;vy:number;sc:number}
const C3914={g:0.6, j:11};
export function extraPhysics_3914(inp:In3914, dt:number):Out3914 {
...
export const mm3914={d:'parallax_bg'};