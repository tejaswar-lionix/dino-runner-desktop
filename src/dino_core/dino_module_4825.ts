/** dino_module_4825 — score_speed extended, humanized desktop */
export interface In4825{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4825{y:number;vy:number;sc:number}
const C4825={g:0.5, j:11};
export function extraPhysics_4825(inp:In4825, dt:number):Out4825 {
...
export const mm4825={d:'score_speed'};