/** dino_module_4362 — obstacle_spawn extended, humanized desktop */
export interface In4362{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4362{y:number;vy:number;sc:number}
const C4362={g:0.5, j:13};
export function extraSpawn_4362(inp:In4362, dt:number):Out4362 {
...
export const mm4362={d:'obstacle_spawn'};