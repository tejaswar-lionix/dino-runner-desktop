/** dino_module_3158 — collision_aabb extended, humanized desktop */
export interface In3158{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3158{y:number;vy:number;sc:number}
const C3158={g:0.6, j:12};
export function extraSpawn_3158(inp:In3158, dt:number):Out3158 {
...
export const mm3158={d:'collision_aabb'};