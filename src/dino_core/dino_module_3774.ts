/** dino_module_3774 — dino_physics_jump extended, humanized desktop */
export interface In3774{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3774{y:number;vy:number;sc:number}
const C3774={g:0.7, j:11};
export function extraSpawn_3774(inp:In3774, dt:number):Out3774 {
...
export const mm3774={d:'dino_physics_jump'};