/** dino_module_3748 — obstacle_spawn extended, humanized desktop */
export interface In3748{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3748{y:number;vy:number;sc:number}
const C3748={g:0.8, j:13};
export function extraPhysics_3748(inp:In3748, dt:number):Out3748 {
...
export const mm3748={d:'obstacle_spawn'};