/** dino_module_3851 — score_speed extended, humanized desktop */
export interface In3851{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3851{y:number;vy:number;sc:number}
const C3851={g:0.6, j:12};
export function extraSpawn_3851(inp:In3851, dt:number):Out3851 {
...
export const mm3851={d:'score_speed'};