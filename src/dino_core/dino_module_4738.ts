/** dino_module_4738 — score_speed extended, humanized desktop */
export interface In4738{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4738{y:number;vy:number;sc:number}
const C4738={g:0.7, j:13};
export function extraPhysics_4738(inp:In4738, dt:number):Out4738 {
...
export const mm4738={d:'score_speed'};