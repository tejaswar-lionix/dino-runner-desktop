/** dino_module_3711 — dino_physics_jump extended, humanized desktop */
export interface In3711{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3711{y:number;vy:number;sc:number}
const C3711={g:0.5, j:13};
export function extraSpawn_3711(inp:In3711, dt:number):Out3711 {
...
export const mm3711={d:'dino_physics_jump'};