/** dino_module_4858 — parallax_bg extended, humanized desktop */
export interface In4858{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4858{y:number;vy:number;sc:number}
const C4858={g:0.8, j:13};
export function extraRender_4858(inp:In4858, dt:number):Out4858 {
...
export const mm4858={d:'parallax_bg'};