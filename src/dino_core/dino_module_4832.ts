/** dino_module_4832 — score_speed extended, humanized desktop */
export interface In4832{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4832{y:number;vy:number;sc:number}
const C4832={g:0.6, j:11};
export function extraRender_4832(inp:In4832, dt:number):Out4832 {
...
export const mm4832={d:'score_speed'};