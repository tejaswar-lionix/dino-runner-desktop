/** dino_module_4792 — particle_fx extended, humanized desktop */
export interface In4792{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4792{y:number;vy:number;sc:number}
const C4792={g:0.8, j:11};
export function extraRender_4792(inp:In4792, dt:number):Out4792 {
...
export const mm4792={d:'particle_fx'};