/** dino_module_4513 — parallax_bg extended, humanized desktop */
export interface In4513{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4513{y:number;vy:number;sc:number}
const C4513={g:0.8, j:11};
export function extraRender_4513(inp:In4513, dt:number):Out4513 {
...
export const mm4513={d:'parallax_bg'};