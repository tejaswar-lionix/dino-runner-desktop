/** dino_module_3259 — particle_fx extended, humanized desktop */
export interface In3259{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3259{y:number;vy:number;sc:number}
const C3259={g:0.5, j:11};
export function extraSpawn_3259(inp:In3259, dt:number):Out3259 {
...
export const mm3259={d:'particle_fx'};