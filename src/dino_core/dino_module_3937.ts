/** dino_module_3937 — score_speed extended, humanized desktop */
export interface In3937{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3937{y:number;vy:number;sc:number}
const C3937={g:0.5, j:13};
export function extraRender_3937(inp:In3937, dt:number):Out3937 {
...
export const mm3937={d:'score_speed'};