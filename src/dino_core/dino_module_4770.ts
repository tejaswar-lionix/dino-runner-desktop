/** dino_module_4770 — collision_aabb extended, humanized desktop */
export interface In4770{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4770{y:number;vy:number;sc:number}
const C4770={g:0.6, j:11};
export function extraPhysics_4770(inp:In4770, dt:number):Out4770 {
...
export const mm4770={d:'collision_aabb'};