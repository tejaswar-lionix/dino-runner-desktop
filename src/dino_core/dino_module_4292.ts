/** dino_module_4292 — obstacle_spawn extended, humanized desktop */
export interface In4292{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4292{y:number;vy:number;sc:number}
const C4292={g:0.5, j:12};
export function extraPhysics_4292(inp:In4292, dt:number):Out4292 {
...
export const mm4292={d:'obstacle_spawn'};