/** dino_module_4608 — particle_fx extended, humanized desktop */
export interface In4608{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4608{y:number;vy:number;sc:number}
const C4608={g:0.7, j:12};
export function extraPhysics_4608(inp:In4608, dt:number):Out4608 {
...
export const mm4608={d:'particle_fx'};