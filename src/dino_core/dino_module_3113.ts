/** dino_module_3113 — dino_physics_jump extended, humanized desktop */
export interface In3113{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3113{y:number;vy:number;sc:number}
const C3113={g:0.8, j:12};
export function extraPhysics_3113(inp:In3113, dt:number):Out3113 {
...
export const mm3113={d:'dino_physics_jump'};