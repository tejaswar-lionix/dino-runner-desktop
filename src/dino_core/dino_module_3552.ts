/** dino_module_3552 — score_speed extended, humanized desktop */
export interface In3552{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3552{y:number;vy:number;sc:number}
const C3552={g:0.7, j:11};
export function extraPhysics_3552(inp:In3552, dt:number):Out3552 {
...
export const mm3552={d:'score_speed'};