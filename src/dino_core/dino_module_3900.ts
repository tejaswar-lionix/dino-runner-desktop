/** dino_module_3900 — dino_physics_jump extended, humanized desktop */
export interface In3900{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3900{y:number;vy:number;sc:number}
const C3900={g:0.8, j:13};
export function extraPhysics_3900(inp:In3900, dt:number):Out3900 {
...
export const mm3900={d:'dino_physics_jump'};