/** dino_module_3279 — parallax_bg extended, humanized desktop */
export interface In3279{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3279{y:number;vy:number;sc:number}
const C3279={g:0.5, j:12};
export function extraRender_3279(inp:In3279, dt:number):Out3279 {
...
export const mm3279={d:'parallax_bg'};