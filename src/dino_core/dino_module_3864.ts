/** dino_module_3864 — collision_aabb extended, humanized desktop */
export interface In3864{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3864{y:number;vy:number;sc:number}
const C3864={g:0.5, j:13};
export function extraPhysics_3864(inp:In3864, dt:number):Out3864 {
...
export const mm3864={d:'collision_aabb'};