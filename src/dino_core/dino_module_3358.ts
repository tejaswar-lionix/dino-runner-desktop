/** dino_module_3358 — obstacle_spawn extended, humanized desktop */
export interface In3358{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3358{y:number;vy:number;sc:number}
const C3358={g:0.8, j:12};
export function extraRender_3358(inp:In3358, dt:number):Out3358 {
...
export const mm3358={d:'obstacle_spawn'};