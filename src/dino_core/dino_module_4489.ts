/** dino_module_4489 — score_speed extended, humanized desktop */
export interface In4489{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4489{y:number;vy:number;sc:number}
const C4489={g:0.8, j:13};
export function extraSpawn_4489(inp:In4489, dt:number):Out4489 {
...
export const mm4489={d:'score_speed'};