/** dino_module_3408 — obstacle_spawn extended, humanized desktop */
export interface In3408{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3408{y:number;vy:number;sc:number}
const C3408={g:0.5, j:11};
export function extraPhysics_3408(inp:In3408, dt:number):Out3408 {
...
export const mm3408={d:'obstacle_spawn'};