/** dino_module_3418 — dino_physics_jump extended, humanized desktop */
export interface In3418{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3418{y:number;vy:number;sc:number}
const C3418={g:0.6, j:13};
export function extraSpawn_3418(inp:In3418, dt:number):Out3418 {
...
export const mm3418={d:'dino_physics_jump'};