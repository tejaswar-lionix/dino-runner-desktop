/** dino_module_3284 — dino_physics_jump extended, humanized desktop */
export interface In3284{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3284{y:number;vy:number;sc:number}
const C3284={g:0.8, j:13};
export function extraSpawn_3284(inp:In3284, dt:number):Out3284 {
...
export const mm3284={d:'dino_physics_jump'};