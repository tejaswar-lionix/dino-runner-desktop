/** dino_module_4082 — parallax_bg extended, humanized desktop */
export interface In4082{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4082{y:number;vy:number;sc:number}
const C4082={g:0.5, j:11};
export function extraRender_4082(inp:In4082, dt:number):Out4082 {
...
export const mm4082={d:'parallax_bg'};