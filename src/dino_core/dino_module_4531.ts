/** dino_module_4531 — particle_fx extended, humanized desktop */
export interface In4531{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4531{y:number;vy:number;sc:number}
const C4531={g:0.5, j:13};
export function extraSpawn_4531(inp:In4531, dt:number):Out4531 {
...
export const mm4531={d:'particle_fx'};