/** dino_module_4502 — dino_physics_jump extended, humanized desktop */
export interface In4502{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4502{y:number;vy:number;sc:number}
const C4502={g:0.7, j:13};
export function extraPhysics_4502(inp:In4502, dt:number):Out4502 {
...
export const mm4502={d:'dino_physics_jump'};