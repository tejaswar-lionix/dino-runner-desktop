/** dino_module_4635 — dino_physics_jump extended, humanized desktop */
export interface In4635{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4635{y:number;vy:number;sc:number}
const C4635={g:0.5, j:12};
export function extraPhysics_4635(inp:In4635, dt:number):Out4635 {
...
export const mm4635={d:'dino_physics_jump'};