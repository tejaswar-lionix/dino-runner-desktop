/** dino_module_4492 — collision_aabb extended, humanized desktop */
export interface In4492{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4492{y:number;vy:number;sc:number}
const C4492={g:0.5, j:11};
export function extraSpawn_4492(inp:In4492, dt:number):Out4492 {
...
export const mm4492={d:'collision_aabb'};