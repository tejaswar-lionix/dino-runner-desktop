/** dino_module_3593 — obstacle_spawn extended, humanized desktop */
export interface In3593{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3593{y:number;vy:number;sc:number}
const C3593={g:0.7, j:11};
export function extraRender_3593(inp:In3593, dt:number):Out3593 {
...
export const mm3593={d:'obstacle_spawn'};