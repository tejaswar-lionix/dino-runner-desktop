/** dino_module_4146 — score_speed extended, humanized desktop */
export interface In4146{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4146{y:number;vy:number;sc:number}
const C4146={g:0.6, j:12};
export function extraPhysics_4146(inp:In4146, dt:number):Out4146 {
...
export const mm4146={d:'score_speed'};