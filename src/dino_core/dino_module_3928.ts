/** dino_module_3928 — score_speed extended, humanized desktop */
export interface In3928{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3928{y:number;vy:number;sc:number}
const C3928={g:0.5, j:12};
export function extraRender_3928(inp:In3928, dt:number):Out3928 {
...
export const mm3928={d:'score_speed'};