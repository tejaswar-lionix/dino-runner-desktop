/** dino_module_3472 — obstacle_spawn extended, humanized desktop */
export interface In3472{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3472{y:number;vy:number;sc:number}
const C3472={g:0.8, j:11};
export function extraRender_3472(inp:In3472, dt:number):Out3472 {
...
export const mm3472={d:'obstacle_spawn'};