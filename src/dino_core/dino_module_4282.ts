/** dino_module_4282 — dino_physics_jump extended, humanized desktop */
export interface In4282{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4282{y:number;vy:number;sc:number}
const C4282={g:0.5, j:13};
export function extraRender_4282(inp:In4282, dt:number):Out4282 {
...
export const mm4282={d:'dino_physics_jump'};