/** dino_module_3540 — score_speed extended, humanized desktop */
export interface In3540{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3540{y:number;vy:number;sc:number}
const C3540={g:0.6, j:13};
export function extraRender_3540(inp:In3540, dt:number):Out3540 {
...
export const mm3540={d:'score_speed'};