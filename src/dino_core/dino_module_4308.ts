/** dino_module_4308 — parallax_bg extended, humanized desktop */
export interface In4308{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4308{y:number;vy:number;sc:number}
const C4308={g:0.7, j:13};
export function extraRender_4308(inp:In4308, dt:number):Out4308 {
...
export const mm4308={d:'parallax_bg'};