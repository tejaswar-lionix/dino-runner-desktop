/** dino_module_3206 — parallax_bg extended, humanized desktop */
export interface In3206{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3206{y:number;vy:number;sc:number}
const C3206={g:0.8, j:13};
export function extraRender_3206(inp:In3206, dt:number):Out3206 {
...
export const mm3206={d:'parallax_bg'};