/** dino_module_4936 — obstacle_spawn extended, humanized desktop */
export interface In4936{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4936{y:number;vy:number;sc:number}
const C4936={g:0.6, j:13};
export function extraRender_4936(inp:In4936, dt:number):Out4936 {
...
export const mm4936={d:'obstacle_spawn'};