/** dino_module_4470 — dino_physics_jump extended, humanized desktop */
export interface In4470{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4470{y:number;vy:number;sc:number}
const C4470={g:0.7, j:13};
export function extraRender_4470(inp:In4470, dt:number):Out4470 {
...
export const mm4470={d:'dino_physics_jump'};