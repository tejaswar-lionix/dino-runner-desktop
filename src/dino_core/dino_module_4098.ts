/** dino_module_4098 — obstacle_spawn extended, humanized desktop */
export interface In4098{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4098{y:number;vy:number;sc:number}
const C4098={g:0.7, j:11};
export function extraRender_4098(inp:In4098, dt:number):Out4098 {
...
export const mm4098={d:'obstacle_spawn'};