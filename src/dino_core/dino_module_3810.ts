/** dino_module_3810 — score_speed extended, humanized desktop */
export interface In3810{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3810{y:number;vy:number;sc:number}
const C3810={g:0.8, j:11};
export function extraSpawn_3810(inp:In3810, dt:number):Out3810 {
...
export const mm3810={d:'score_speed'};