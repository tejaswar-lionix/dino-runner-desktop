/** dino_module_3156 — particle_fx extended, humanized desktop */
export interface In3156{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3156{y:number;vy:number;sc:number}
const C3156={g:0.7, j:13};
export function extraSpawn_3156(inp:In3156, dt:number):Out3156 {
...
export const mm3156={d:'particle_fx'};