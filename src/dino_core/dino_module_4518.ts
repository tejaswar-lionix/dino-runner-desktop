/** dino_module_4518 — obstacle_spawn extended, humanized desktop */
export interface In4518{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4518{y:number;vy:number;sc:number}
const C4518={g:0.8, j:12};
export function extraRender_4518(inp:In4518, dt:number):Out4518 {
...
export const mm4518={d:'obstacle_spawn'};