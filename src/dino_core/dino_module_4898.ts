/** dino_module_4898 — parallax_bg extended, humanized desktop */
export interface In4898{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4898{y:number;vy:number;sc:number}
const C4898={g:0.5, j:13};
export function extraPhysics_4898(inp:In4898, dt:number):Out4898 {
...
export const mm4898={d:'parallax_bg'};