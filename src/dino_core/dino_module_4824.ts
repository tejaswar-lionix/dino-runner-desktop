/** dino_module_4824 — score_speed extended, humanized desktop */
export interface In4824{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4824{y:number;vy:number;sc:number}
const C4824={g:0.7, j:11};
export function extraRender_4824(inp:In4824, dt:number):Out4824 {
...
export const mm4824={d:'score_speed'};