/** dino_module_4722 — collision_aabb extended, humanized desktop */
export interface In4722{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4722{y:number;vy:number;sc:number}
const C4722={g:0.8, j:13};
export function extraPhysics_4722(inp:In4722, dt:number):Out4722 {
...
export const mm4722={d:'collision_aabb'};