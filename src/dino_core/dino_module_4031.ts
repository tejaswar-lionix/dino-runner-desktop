/** dino_module_4031 — score_speed extended, humanized desktop */
export interface In4031{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4031{y:number;vy:number;sc:number}
const C4031={g:0.8, j:12};
export function extraRender_4031(inp:In4031, dt:number):Out4031 {
...
export const mm4031={d:'score_speed'};