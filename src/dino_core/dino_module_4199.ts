/** dino_module_4199 — obstacle_spawn extended, humanized desktop */
export interface In4199{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4199{y:number;vy:number;sc:number}
const C4199={g:0.7, j:12};
export function extraPhysics_4199(inp:In4199, dt:number):Out4199 {
...
export const mm4199={d:'obstacle_spawn'};