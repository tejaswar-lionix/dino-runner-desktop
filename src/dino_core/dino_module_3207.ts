/** dino_module_3207 — score_speed extended, humanized desktop */
export interface In3207{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3207{y:number;vy:number;sc:number}
const C3207={g:0.7, j:11};
export function extraRender_3207(inp:In3207, dt:number):Out3207 {
...
export const mm3207={d:'score_speed'};