/** dino_module_4043 — obstacle_spawn extended, humanized desktop */
export interface In4043{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4043{y:number;vy:number;sc:number}
const C4043={g:0.8, j:12};
export function extraSpawn_4043(inp:In4043, dt:number):Out4043 {
...
export const mm4043={d:'obstacle_spawn'};