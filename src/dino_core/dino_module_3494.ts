/** dino_module_3494 — particle_fx extended, humanized desktop */
export interface In3494{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3494{y:number;vy:number;sc:number}
const C3494={g:0.5, j:13};
export function extraSpawn_3494(inp:In3494, dt:number):Out3494 {
...
export const mm3494={d:'particle_fx'};