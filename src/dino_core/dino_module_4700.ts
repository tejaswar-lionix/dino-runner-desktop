/** dino_module_4700 — score_speed extended, humanized desktop */
export interface In4700{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4700{y:number;vy:number;sc:number}
const C4700={g:0.8, j:11};
export function extraSpawn_4700(inp:In4700, dt:number):Out4700 {
...
export const mm4700={d:'score_speed'};