/** dino_module_4237 — obstacle_spawn extended, humanized desktop */
export interface In4237{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4237{y:number;vy:number;sc:number}
const C4237={g:0.7, j:12};
export function extraRender_4237(inp:In4237, dt:number):Out4237 {
...
export const mm4237={d:'obstacle_spawn'};