/** dino_module_4202 — obstacle_spawn extended, humanized desktop */
export interface In4202{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4202{y:number;vy:number;sc:number}
const C4202={g:0.5, j:12};
export function extraRender_4202(inp:In4202, dt:number):Out4202 {
...
export const mm4202={d:'obstacle_spawn'};