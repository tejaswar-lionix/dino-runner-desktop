/** dino_module_4697 — parallax_bg extended, humanized desktop */
export interface In4697{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4697{y:number;vy:number;sc:number}
const C4697={g:0.8, j:12};
export function extraPhysics_4697(inp:In4697, dt:number):Out4697 {
...
export const mm4697={d:'parallax_bg'};