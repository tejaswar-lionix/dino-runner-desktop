/** dino_module_4630 — parallax_bg extended, humanized desktop */
export interface In4630{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4630{y:number;vy:number;sc:number}
const C4630={g:0.8, j:11};
export function extraSpawn_4630(inp:In4630, dt:number):Out4630 {
...
export const mm4630={d:'parallax_bg'};