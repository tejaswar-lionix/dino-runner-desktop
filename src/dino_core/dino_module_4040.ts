/** dino_module_4040 — score_speed extended, humanized desktop */
export interface In4040{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4040{y:number;vy:number;sc:number}
const C4040={g:0.7, j:11};
export function extraRender_4040(inp:In4040, dt:number):Out4040 {
...
export const mm4040={d:'score_speed'};