/** dino_module_4433 — collision_aabb extended, humanized desktop */
export interface In4433{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4433{y:number;vy:number;sc:number}
const C4433={g:0.8, j:11};
export function extraSpawn_4433(inp:In4433, dt:number):Out4433 {
...
export const mm4433={d:'collision_aabb'};