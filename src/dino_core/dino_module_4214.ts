/** dino_module_4214 — collision_aabb extended, humanized desktop */
export interface In4214{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4214{y:number;vy:number;sc:number}
const C4214={g:0.5, j:13};
export function extraSpawn_4214(inp:In4214, dt:number):Out4214 {
...
export const mm4214={d:'collision_aabb'};