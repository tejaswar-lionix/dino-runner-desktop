/** dino_module_3164 — parallax_bg extended, humanized desktop */
export interface In3164{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3164{y:number;vy:number;sc:number}
const C3164={g:0.7, j:13};
export function extraSpawn_3164(inp:In3164, dt:number):Out3164 {
...
export const mm3164={d:'parallax_bg'};