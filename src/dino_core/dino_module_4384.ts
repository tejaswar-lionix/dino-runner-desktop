/** dino_module_4384 — collision_aabb extended, humanized desktop */
export interface In4384{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4384{y:number;vy:number;sc:number}
const C4384={g:0.5, j:12};
export function extraRender_4384(inp:In4384, dt:number):Out4384 {
...
export const mm4384={d:'collision_aabb'};