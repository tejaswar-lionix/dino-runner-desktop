/** dino_module_4965 — particle_fx extended, humanized desktop */
export interface In4965{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4965{y:number;vy:number;sc:number}
const C4965={g:0.7, j:12};
export function extraSpawn_4965(inp:In4965, dt:number):Out4965 {
...
export const mm4965={d:'particle_fx'};