/** dino_module_3785 — obstacle_spawn extended, humanized desktop */
export interface In3785{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3785{y:number;vy:number;sc:number}
const C3785={g:0.6, j:11};
export function extraSpawn_3785(inp:In3785, dt:number):Out3785 {
...
export const mm3785={d:'obstacle_spawn'};