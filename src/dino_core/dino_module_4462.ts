/** dino_module_4462 — score_speed extended, humanized desktop */
export interface In4462{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4462{y:number;vy:number;sc:number}
const C4462={g:0.6, j:12};
export function extraPhysics_4462(inp:In4462, dt:number):Out4462 {
...
export const mm4462={d:'score_speed'};