/** dino_module_4368 — parallax_bg extended, humanized desktop */
export interface In4368{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4368{y:number;vy:number;sc:number}
const C4368={g:0.7, j:12};
export function extraRender_4368(inp:In4368, dt:number):Out4368 {
...
export const mm4368={d:'parallax_bg'};