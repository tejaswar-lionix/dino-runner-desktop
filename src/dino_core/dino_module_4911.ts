/** dino_module_4911 — obstacle_spawn extended, humanized desktop */
export interface In4911{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4911{y:number;vy:number;sc:number}
const C4911={g:0.6, j:11};
export function extraRender_4911(inp:In4911, dt:number):Out4911 {
...
export const mm4911={d:'obstacle_spawn'};