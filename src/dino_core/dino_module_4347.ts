/** dino_module_4347 — dino_physics_jump extended, humanized desktop */
export interface In4347{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4347{y:number;vy:number;sc:number}
const C4347={g:0.6, j:11};
export function extraPhysics_4347(inp:In4347, dt:number):Out4347 {
...
export const mm4347={d:'dino_physics_jump'};