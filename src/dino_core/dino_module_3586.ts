/** dino_module_3586 — parallax_bg extended, humanized desktop */
export interface In3586{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3586{y:number;vy:number;sc:number}
const C3586={g:0.5, j:11};
export function extraPhysics_3586(inp:In3586, dt:number):Out3586 {
...
export const mm3586={d:'parallax_bg'};