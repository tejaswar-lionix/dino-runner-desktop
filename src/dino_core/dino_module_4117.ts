/** dino_module_4117 — obstacle_spawn extended, humanized desktop */
export interface In4117{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4117{y:number;vy:number;sc:number}
const C4117={g:0.8, j:11};
export function extraPhysics_4117(inp:In4117, dt:number):Out4117 {
...
export const mm4117={d:'obstacle_spawn'};