/** dino_module_3289 — parallax_bg extended, humanized desktop */
export interface In3289{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3289{y:number;vy:number;sc:number}
const C3289={g:0.6, j:13};
export function extraSpawn_3289(inp:In3289, dt:number):Out3289 {
...
export const mm3289={d:'parallax_bg'};