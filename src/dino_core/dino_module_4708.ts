/** dino_module_4708 — particle_fx extended, humanized desktop */
export interface In4708{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4708{y:number;vy:number;sc:number}
const C4708={g:0.7, j:12};
export function extraRender_4708(inp:In4708, dt:number):Out4708 {
...
export const mm4708={d:'particle_fx'};