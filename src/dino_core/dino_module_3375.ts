/** dino_module_3375 — particle_fx extended, humanized desktop */
export interface In3375{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3375{y:number;vy:number;sc:number}
const C3375={g:0.5, j:12};
export function extraPhysics_3375(inp:In3375, dt:number):Out3375 {
...
export const mm3375={d:'particle_fx'};