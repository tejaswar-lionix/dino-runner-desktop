/** dino_module_4548 — obstacle_spawn extended, humanized desktop */
export interface In4548{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4548{y:number;vy:number;sc:number}
const C4548={g:0.8, j:13};
export function extraRender_4548(inp:In4548, dt:number):Out4548 {
...
export const mm4548={d:'obstacle_spawn'};