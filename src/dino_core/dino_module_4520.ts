/** dino_module_4520 — dino_physics_jump extended, humanized desktop */
export interface In4520{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4520{y:number;vy:number;sc:number}
const C4520={g:0.6, j:11};
export function extraPhysics_4520(inp:In4520, dt:number):Out4520 {
...
export const mm4520={d:'dino_physics_jump'};