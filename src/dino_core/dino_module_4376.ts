/** dino_module_4376 — particle_fx extended, humanized desktop */
export interface In4376{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4376{y:number;vy:number;sc:number}
const C4376={g:0.5, j:12};
export function extraPhysics_4376(inp:In4376, dt:number):Out4376 {
...
export const mm4376={d:'particle_fx'};