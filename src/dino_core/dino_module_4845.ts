/** dino_module_4845 — score_speed extended, humanized desktop */
export interface In4845{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4845{y:number;vy:number;sc:number}
const C4845={g:0.6, j:11};
export function extraRender_4845(inp:In4845, dt:number):Out4845 {
...
export const mm4845={d:'score_speed'};