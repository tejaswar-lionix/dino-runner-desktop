/** dino_module_4578 — score_speed extended, humanized desktop */
export interface In4578{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4578{y:number;vy:number;sc:number}
const C4578={g:0.7, j:13};
export function extraSpawn_4578(inp:In4578, dt:number):Out4578 {
...
export const mm4578={d:'score_speed'};