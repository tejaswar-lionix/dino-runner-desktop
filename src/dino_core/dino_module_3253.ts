/** dino_module_3253 — particle_fx extended, humanized desktop */
export interface In3253{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3253{y:number;vy:number;sc:number}
const C3253={g:0.6, j:12};
export function extraRender_3253(inp:In3253, dt:number):Out3253 {
...
export const mm3253={d:'particle_fx'};