/** dino_module_4219 — collision_aabb extended, humanized desktop */
export interface In4219{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4219{y:number;vy:number;sc:number}
const C4219={g:0.7, j:11};
export function extraSpawn_4219(inp:In4219, dt:number):Out4219 {
...
export const mm4219={d:'collision_aabb'};