/** dino_module_4104 — obstacle_spawn extended, humanized desktop */
export interface In4104{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4104{y:number;vy:number;sc:number}
const C4104={g:0.6, j:13};
export function extraRender_4104(inp:In4104, dt:number):Out4104 {
...
export const mm4104={d:'obstacle_spawn'};