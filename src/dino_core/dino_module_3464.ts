/** dino_module_3464 — obstacle_spawn extended, humanized desktop */
export interface In3464{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3464{y:number;vy:number;sc:number}
const C3464={g:0.6, j:12};
export function extraPhysics_3464(inp:In3464, dt:number):Out3464 {
...
export const mm3464={d:'obstacle_spawn'};