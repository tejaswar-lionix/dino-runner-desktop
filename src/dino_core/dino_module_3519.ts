/** dino_module_3519 — score_speed extended, humanized desktop */
export interface In3519{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3519{y:number;vy:number;sc:number}
const C3519={g:0.5, j:12};
export function extraRender_3519(inp:In3519, dt:number):Out3519 {
...
export const mm3519={d:'score_speed'};