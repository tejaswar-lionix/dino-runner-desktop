/** dino_module_3339 — obstacle_spawn extended, humanized desktop */
export interface In3339{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3339{y:number;vy:number;sc:number}
const C3339={g:0.6, j:12};
export function extraSpawn_3339(inp:In3339, dt:number):Out3339 {
...
export const mm3339={d:'obstacle_spawn'};