/** dino_module_4152 — score_speed extended, humanized desktop */
export interface In4152{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4152{y:number;vy:number;sc:number}
const C4152={g:0.5, j:11};
export function extraSpawn_4152(inp:In4152, dt:number):Out4152 {
...
export const mm4152={d:'score_speed'};