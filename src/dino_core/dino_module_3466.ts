/** dino_module_3466 — parallax_bg extended, humanized desktop */
export interface In3466{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3466{y:number;vy:number;sc:number}
const C3466={g:0.5, j:12};
export function extraRender_3466(inp:In3466, dt:number):Out3466 {
...
export const mm3466={d:'parallax_bg'};