/** dino_module_3606 — particle_fx extended, humanized desktop */
export interface In3606{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3606{y:number;vy:number;sc:number}
const C3606={g:0.6, j:11};
export function extraRender_3606(inp:In3606, dt:number):Out3606 {
...
export const mm3606={d:'particle_fx'};