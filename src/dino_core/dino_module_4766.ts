/** dino_module_4766 — score_speed extended, humanized desktop */
export interface In4766{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4766{y:number;vy:number;sc:number}
const C4766={g:0.7, j:12};
export function extraSpawn_4766(inp:In4766, dt:number):Out4766 {
...
export const mm4766={d:'score_speed'};