/** dino_module_4613 — obstacle_spawn extended, humanized desktop */
export interface In4613{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4613{y:number;vy:number;sc:number}
const C4613={g:0.7, j:12};
export function extraPhysics_4613(inp:In4613, dt:number):Out4613 {
...
export const mm4613={d:'obstacle_spawn'};