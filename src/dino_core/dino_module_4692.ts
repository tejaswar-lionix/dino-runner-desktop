/** dino_module_4692 — parallax_bg extended, humanized desktop */
export interface In4692{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4692{y:number;vy:number;sc:number}
const C4692={g:0.8, j:12};
export function extraPhysics_4692(inp:In4692, dt:number):Out4692 {
...
export const mm4692={d:'parallax_bg'};