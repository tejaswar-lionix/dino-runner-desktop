/** dino_module_4266 — score_speed extended, humanized desktop */
export interface In4266{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4266{y:number;vy:number;sc:number}
const C4266={g:0.7, j:12};
export function extraRender_4266(inp:In4266, dt:number):Out4266 {
...
export const mm4266={d:'score_speed'};