/** dino_module_4432 — dino_physics_jump extended, humanized desktop */
export interface In4432{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4432{y:number;vy:number;sc:number}
const C4432={g:0.6, j:13};
export function extraRender_4432(inp:In4432, dt:number):Out4432 {
...
export const mm4432={d:'dino_physics_jump'};