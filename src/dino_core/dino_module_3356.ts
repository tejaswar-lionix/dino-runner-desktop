/** dino_module_3356 — particle_fx extended, humanized desktop */
export interface In3356{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3356{y:number;vy:number;sc:number}
const C3356={g:0.7, j:12};
export function extraSpawn_3356(inp:In3356, dt:number):Out3356 {
...
export const mm3356={d:'particle_fx'};