/** dino_module_4782 — parallax_bg extended, humanized desktop */
export interface In4782{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4782{y:number;vy:number;sc:number}
const C4782={g:0.6, j:11};
export function extraSpawn_4782(inp:In4782, dt:number):Out4782 {
...
export const mm4782={d:'parallax_bg'};