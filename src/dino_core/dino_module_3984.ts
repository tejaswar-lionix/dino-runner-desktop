/** dino_module_3984 — parallax_bg extended, humanized desktop */
export interface In3984{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3984{y:number;vy:number;sc:number}
const C3984={g:0.5, j:13};
export function extraPhysics_3984(inp:In3984, dt:number):Out3984 {
...
export const mm3984={d:'parallax_bg'};