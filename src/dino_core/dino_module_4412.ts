/** dino_module_4412 — score_speed extended, humanized desktop */
export interface In4412{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4412{y:number;vy:number;sc:number}
const C4412={g:0.8, j:12};
export function extraRender_4412(inp:In4412, dt:number):Out4412 {
...
export const mm4412={d:'score_speed'};