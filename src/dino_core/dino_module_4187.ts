/** dino_module_4187 — obstacle_spawn extended, humanized desktop */
export interface In4187{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4187{y:number;vy:number;sc:number}
const C4187={g:0.5, j:11};
export function extraSpawn_4187(inp:In4187, dt:number):Out4187 {
...
export const mm4187={d:'obstacle_spawn'};