/** dino_module_3064 — particle_fx extended, humanized desktop */
export interface In3064{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3064{y:number;vy:number;sc:number}
const C3064={g:0.5, j:12};
export function extraSpawn_3064(inp:In3064, dt:number):Out3064 {
...
export const mm3064={d:'particle_fx'};