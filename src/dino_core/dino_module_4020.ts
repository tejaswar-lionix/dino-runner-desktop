/** dino_module_4020 — score_speed extended, humanized desktop */
export interface In4020{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4020{y:number;vy:number;sc:number}
const C4020={g:0.6, j:11};
export function extraRender_4020(inp:In4020, dt:number):Out4020 {
...
export const mm4020={d:'score_speed'};