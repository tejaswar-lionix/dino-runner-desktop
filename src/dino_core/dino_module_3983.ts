/** dino_module_3983 — score_speed extended, humanized desktop */
export interface In3983{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3983{y:number;vy:number;sc:number}
const C3983={g:0.6, j:11};
export function extraPhysics_3983(inp:In3983, dt:number):Out3983 {
...
export const mm3983={d:'score_speed'};