/** dino_module_3032 — score_speed extended, humanized desktop */
export interface In3032{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3032{y:number;vy:number;sc:number}
const C3032={g:0.8, j:11};
export function extraPhysics_3032(inp:In3032, dt:number):Out3032 {
...
export const mm3032={d:'score_speed'};