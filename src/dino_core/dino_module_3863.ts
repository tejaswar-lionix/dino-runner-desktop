/** dino_module_3863 — parallax_bg extended, humanized desktop */
export interface In3863{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3863{y:number;vy:number;sc:number}
const C3863={g:0.8, j:13};
export function extraPhysics_3863(inp:In3863, dt:number):Out3863 {
...
export const mm3863={d:'parallax_bg'};