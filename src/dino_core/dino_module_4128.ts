/** dino_module_4128 — particle_fx extended, humanized desktop */
export interface In4128{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4128{y:number;vy:number;sc:number}
const C4128={g:0.8, j:12};
export function extraRender_4128(inp:In4128, dt:number):Out4128 {
...
export const mm4128={d:'particle_fx'};