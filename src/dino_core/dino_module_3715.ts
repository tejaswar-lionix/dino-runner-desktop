/** dino_module_3715 — score_speed extended, humanized desktop */
export interface In3715{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3715{y:number;vy:number;sc:number}
const C3715={g:0.8, j:13};
export function extraPhysics_3715(inp:In3715, dt:number):Out3715 {
...
export const mm3715={d:'score_speed'};