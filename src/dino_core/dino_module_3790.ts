/** dino_module_3790 — obstacle_spawn extended, humanized desktop */
export interface In3790{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3790{y:number;vy:number;sc:number}
const C3790={g:0.6, j:12};
export function extraPhysics_3790(inp:In3790, dt:number):Out3790 {
...
export const mm3790={d:'obstacle_spawn'};