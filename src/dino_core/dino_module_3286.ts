/** dino_module_3286 — score_speed extended, humanized desktop */
export interface In3286{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3286{y:number;vy:number;sc:number}
const C3286={g:0.6, j:13};
export function extraRender_3286(inp:In3286, dt:number):Out3286 {
...
export const mm3286={d:'score_speed'};