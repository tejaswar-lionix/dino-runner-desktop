/** dino_module_3814 — parallax_bg extended, humanized desktop */
export interface In3814{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3814{y:number;vy:number;sc:number}
const C3814={g:0.8, j:12};
export function extraSpawn_3814(inp:In3814, dt:number):Out3814 {
...
export const mm3814={d:'parallax_bg'};