/** dino_module_4267 — parallax_bg extended, humanized desktop */
export interface In4267{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4267{y:number;vy:number;sc:number}
const C4267={g:0.6, j:12};
export function extraPhysics_4267(inp:In4267, dt:number):Out4267 {
...
export const mm4267={d:'parallax_bg'};