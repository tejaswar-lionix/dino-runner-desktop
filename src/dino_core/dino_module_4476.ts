/** dino_module_4476 — particle_fx extended, humanized desktop */
export interface In4476{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4476{y:number;vy:number;sc:number}
const C4476={g:0.8, j:12};
export function extraSpawn_4476(inp:In4476, dt:number):Out4476 {
...
export const mm4476={d:'particle_fx'};