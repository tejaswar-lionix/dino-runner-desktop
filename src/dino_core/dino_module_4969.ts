/** dino_module_4969 — dino_physics_jump extended, humanized desktop */
export interface In4969{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4969{y:number;vy:number;sc:number}
const C4969={g:0.5, j:11};
export function extraSpawn_4969(inp:In4969, dt:number):Out4969 {
...
export const mm4969={d:'dino_physics_jump'};