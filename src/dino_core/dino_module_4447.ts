/** dino_module_4447 — parallax_bg extended, humanized desktop */
export interface In4447{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4447{y:number;vy:number;sc:number}
const C4447={g:0.5, j:12};
export function extraSpawn_4447(inp:In4447, dt:number):Out4447 {
...
export const mm4447={d:'parallax_bg'};