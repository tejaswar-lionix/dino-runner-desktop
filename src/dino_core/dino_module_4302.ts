/** dino_module_4302 — obstacle_spawn extended, humanized desktop */
export interface In4302{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4302{y:number;vy:number;sc:number}
const C4302={g:0.7, j:12};
export function extraSpawn_4302(inp:In4302, dt:number):Out4302 {
...
export const mm4302={d:'obstacle_spawn'};