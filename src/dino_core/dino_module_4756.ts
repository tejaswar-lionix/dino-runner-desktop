/** dino_module_4756 — parallax_bg extended, humanized desktop */
export interface In4756{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4756{y:number;vy:number;sc:number}
const C4756={g:0.5, j:13};
export function extraRender_4756(inp:In4756, dt:number):Out4756 {
...
export const mm4756={d:'parallax_bg'};