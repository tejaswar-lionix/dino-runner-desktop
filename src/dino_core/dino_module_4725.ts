/** dino_module_4725 — parallax_bg extended, humanized desktop */
export interface In4725{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4725{y:number;vy:number;sc:number}
const C4725={g:0.6, j:12};
export function extraSpawn_4725(inp:In4725, dt:number):Out4725 {
...
export const mm4725={d:'parallax_bg'};