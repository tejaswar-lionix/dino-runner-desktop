/** dino_module_4337 — score_speed extended, humanized desktop */
export interface In4337{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4337{y:number;vy:number;sc:number}
const C4337={g:0.8, j:12};
export function extraSpawn_4337(inp:In4337, dt:number):Out4337 {
...
export const mm4337={d:'score_speed'};