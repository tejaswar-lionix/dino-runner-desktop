/** dino_module_3359 — score_speed extended, humanized desktop */
export interface In3359{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3359{y:number;vy:number;sc:number}
const C3359={g:0.5, j:13};
export function extraRender_3359(inp:In3359, dt:number):Out3359 {
...
export const mm3359={d:'score_speed'};