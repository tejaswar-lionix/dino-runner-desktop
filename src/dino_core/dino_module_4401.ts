/** dino_module_4401 — score_speed extended, humanized desktop */
export interface In4401{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4401{y:number;vy:number;sc:number}
const C4401={g:0.6, j:12};
export function extraRender_4401(inp:In4401, dt:number):Out4401 {
...
export const mm4401={d:'score_speed'};