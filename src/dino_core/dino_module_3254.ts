/** dino_module_3254 — score_speed extended, humanized desktop */
export interface In3254{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3254{y:number;vy:number;sc:number}
const C3254={g:0.5, j:11};
export function extraRender_3254(inp:In3254, dt:number):Out3254 {
...
export const mm3254={d:'score_speed'};