/** dino_module_3916 — dino_physics_jump extended, humanized desktop */
export interface In3916{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3916{y:number;vy:number;sc:number}
const C3916={g:0.8, j:13};
export function extraRender_3916(inp:In3916, dt:number):Out3916 {
...
export const mm3916={d:'dino_physics_jump'};