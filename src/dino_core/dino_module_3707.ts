/** dino_module_3707 — dino_physics_jump extended, humanized desktop */
export interface In3707{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3707{y:number;vy:number;sc:number}
const C3707={g:0.8, j:12};
export function extraPhysics_3707(inp:In3707, dt:number):Out3707 {
...
export const mm3707={d:'dino_physics_jump'};