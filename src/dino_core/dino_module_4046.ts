/** dino_module_4046 — particle_fx extended, humanized desktop */
export interface In4046{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4046{y:number;vy:number;sc:number}
const C4046={g:0.6, j:11};
export function extraPhysics_4046(inp:In4046, dt:number):Out4046 {
...
export const mm4046={d:'particle_fx'};