/** dino_module_3454 — obstacle_spawn extended, humanized desktop */
export interface In3454{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3454{y:number;vy:number;sc:number}
const C3454={g:0.8, j:13};
export function extraRender_3454(inp:In3454, dt:number):Out3454 {
...
export const mm3454={d:'obstacle_spawn'};