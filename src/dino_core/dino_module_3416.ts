/** dino_module_3416 — parallax_bg extended, humanized desktop */
export interface In3416{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3416{y:number;vy:number;sc:number}
const C3416={g:0.8, j:13};
export function extraSpawn_3416(inp:In3416, dt:number):Out3416 {
...
export const mm3416={d:'parallax_bg'};