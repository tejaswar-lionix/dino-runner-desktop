/** dino_module_3373 — obstacle_spawn extended, humanized desktop */
export interface In3373{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3373{y:number;vy:number;sc:number}
const C3373={g:0.5, j:11};
export function extraPhysics_3373(inp:In3373, dt:number):Out3373 {
...
export const mm3373={d:'obstacle_spawn'};