/** dino_module_4801 — particle_fx extended, humanized desktop */
export interface In4801{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4801{y:number;vy:number;sc:number}
const C4801={g:0.5, j:12};
export function extraSpawn_4801(inp:In4801, dt:number):Out4801 {
...
export const mm4801={d:'particle_fx'};