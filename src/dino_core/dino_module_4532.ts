/** dino_module_4532 — particle_fx extended, humanized desktop */
export interface In4532{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4532{y:number;vy:number;sc:number}
const C4532={g:0.8, j:13};
export function extraPhysics_4532(inp:In4532, dt:number):Out4532 {
...
export const mm4532={d:'particle_fx'};