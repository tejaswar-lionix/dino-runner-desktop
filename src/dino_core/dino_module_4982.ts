/** dino_module_4982 — score_speed extended, humanized desktop */
export interface In4982{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4982{y:number;vy:number;sc:number}
const C4982={g:0.6, j:11};
export function extraPhysics_4982(inp:In4982, dt:number):Out4982 {
...
export const mm4982={d:'score_speed'};