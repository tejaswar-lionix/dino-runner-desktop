/** dino_module_4930 — particle_fx extended, humanized desktop */
export interface In4930{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4930{y:number;vy:number;sc:number}
const C4930={g:0.8, j:12};
export function extraPhysics_4930(inp:In4930, dt:number):Out4930 {
...
export const mm4930={d:'particle_fx'};