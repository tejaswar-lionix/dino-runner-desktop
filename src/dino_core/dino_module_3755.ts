/** dino_module_3755 — score_speed extended, humanized desktop */
export interface In3755{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3755{y:number;vy:number;sc:number}
const C3755={g:0.7, j:13};
export function extraRender_3755(inp:In3755, dt:number):Out3755 {
...
export const mm3755={d:'score_speed'};