/** dino_module_3515 — score_speed extended, humanized desktop */
export interface In3515{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3515{y:number;vy:number;sc:number}
const C3515={g:0.7, j:13};
export function extraSpawn_3515(inp:In3515, dt:number):Out3515 {
...
export const mm3515={d:'score_speed'};