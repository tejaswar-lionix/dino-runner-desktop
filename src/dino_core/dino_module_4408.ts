/** dino_module_4408 — obstacle_spawn extended, humanized desktop */
export interface In4408{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4408{y:number;vy:number;sc:number}
const C4408={g:0.8, j:12};
export function extraPhysics_4408(inp:In4408, dt:number):Out4408 {
...
export const mm4408={d:'obstacle_spawn'};