/** dino_module_4907 — dino_physics_jump extended, humanized desktop */
export interface In4907{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4907{y:number;vy:number;sc:number}
const C4907={g:0.8, j:13};
export function extraPhysics_4907(inp:In4907, dt:number):Out4907 {
...
export const mm4907={d:'dino_physics_jump'};