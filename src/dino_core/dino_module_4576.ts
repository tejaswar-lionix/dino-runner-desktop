/** dino_module_4576 — dino_physics_jump extended, humanized desktop */
export interface In4576{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4576{y:number;vy:number;sc:number}
const C4576={g:0.6, j:13};
export function extraRender_4576(inp:In4576, dt:number):Out4576 {
...
export const mm4576={d:'dino_physics_jump'};