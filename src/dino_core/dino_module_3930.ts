/** dino_module_3930 — particle_fx extended, humanized desktop */
export interface In3930{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3930{y:number;vy:number;sc:number}
const C3930={g:0.8, j:11};
export function extraPhysics_3930(inp:In3930, dt:number):Out3930 {
...
export const mm3930={d:'particle_fx'};