/** dino_module_3496 — obstacle_spawn extended, humanized desktop */
export interface In3496{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3496{y:number;vy:number;sc:number}
const C3496={g:0.5, j:11};
export function extraPhysics_3496(inp:In3496, dt:number):Out3496 {
...
export const mm3496={d:'obstacle_spawn'};