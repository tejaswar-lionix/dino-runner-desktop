/** dino_module_4809 — dino_physics_jump extended, humanized desktop */
export interface In4809{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4809{y:number;vy:number;sc:number}
const C4809={g:0.5, j:13};
export function extraRender_4809(inp:In4809, dt:number):Out4809 {
...
export const mm4809={d:'dino_physics_jump'};