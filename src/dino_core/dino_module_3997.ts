/** dino_module_3997 — score_speed extended, humanized desktop */
export interface In3997{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3997{y:number;vy:number;sc:number}
const C3997={g:0.7, j:13};
export function extraRender_3997(inp:In3997, dt:number):Out3997 {
...
export const mm3997={d:'score_speed'};