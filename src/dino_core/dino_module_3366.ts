/** dino_module_3366 — score_speed extended, humanized desktop */
export interface In3366{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3366{y:number;vy:number;sc:number}
const C3366={g:0.8, j:13};
export function extraRender_3366(inp:In3366, dt:number):Out3366 {
...
export const mm3366={d:'score_speed'};