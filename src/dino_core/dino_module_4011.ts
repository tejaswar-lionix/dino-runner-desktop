/** dino_module_4011 — parallax_bg extended, humanized desktop */
export interface In4011{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4011{y:number;vy:number;sc:number}
const C4011={g:0.8, j:11};
export function extraPhysics_4011(inp:In4011, dt:number):Out4011 {
...
export const mm4011={d:'parallax_bg'};