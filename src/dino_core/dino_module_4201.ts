/** dino_module_4201 — dino_physics_jump extended, humanized desktop */
export interface In4201{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4201{y:number;vy:number;sc:number}
const C4201={g:0.6, j:12};
export function extraSpawn_4201(inp:In4201, dt:number):Out4201 {
...
export const mm4201={d:'dino_physics_jump'};