/** dino_module_4743 — dino_physics_jump extended, humanized desktop */
export interface In4743{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4743{y:number;vy:number;sc:number}
const C4743={g:0.8, j:11};
export function extraSpawn_4743(inp:In4743, dt:number):Out4743 {
...
export const mm4743={d:'dino_physics_jump'};