/** dino_module_3955 — parallax_bg extended, humanized desktop */
export interface In3955{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3955{y:number;vy:number;sc:number}
const C3955={g:0.6, j:11};
export function extraSpawn_3955(inp:In3955, dt:number):Out3955 {
...
export const mm3955={d:'parallax_bg'};