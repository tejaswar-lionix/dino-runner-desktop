/** dino_module_3920 — parallax_bg extended, humanized desktop */
export interface In3920{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3920{y:number;vy:number;sc:number}
const C3920={g:0.8, j:13};
export function extraSpawn_3920(inp:In3920, dt:number):Out3920 {
...
export const mm3920={d:'parallax_bg'};