/** dino_module_3731 — dino_physics_jump extended, humanized desktop */
export interface In3731{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3731{y:number;vy:number;sc:number}
const C3731={g:0.8, j:13};
export function extraPhysics_3731(inp:In3731, dt:number):Out3731 {
...
export const mm3731={d:'dino_physics_jump'};