/** dino_module_4914 — parallax_bg extended, humanized desktop */
export interface In4914{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4914{y:number;vy:number;sc:number}
const C4914={g:0.8, j:11};
export function extraSpawn_4914(inp:In4914, dt:number):Out4914 {
...
export const mm4914={d:'parallax_bg'};