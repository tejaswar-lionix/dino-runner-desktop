/** dino_module_3176 — particle_fx extended, humanized desktop */
export interface In3176{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3176{y:number;vy:number;sc:number}
const C3176={g:0.7, j:12};
export function extraPhysics_3176(inp:In3176, dt:number):Out3176 {
...
export const mm3176={d:'particle_fx'};