/** dino_module_4837 — dino_physics_jump extended, humanized desktop */
export interface In4837{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4837{y:number;vy:number;sc:number}
const C4837={g:0.6, j:11};
export function extraRender_4837(inp:In4837, dt:number):Out4837 {
...
export const mm4837={d:'dino_physics_jump'};