/** dino_module_3481 — particle_fx extended, humanized desktop */
export interface In3481{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3481{y:number;vy:number;sc:number}
const C3481={g:0.5, j:12};
export function extraSpawn_3481(inp:In3481, dt:number):Out3481 {
...
export const mm3481={d:'particle_fx'};