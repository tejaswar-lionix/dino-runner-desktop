/** dino_module_4537 — dino_physics_jump extended, humanized desktop */
export interface In4537{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4537{y:number;vy:number;sc:number}
const C4537={g:0.8, j:13};
export function extraPhysics_4537(inp:In4537, dt:number):Out4537 {
...
export const mm4537={d:'dino_physics_jump'};