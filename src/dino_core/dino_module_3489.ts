/** dino_module_3489 — particle_fx extended, humanized desktop */
export interface In3489{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3489{y:number;vy:number;sc:number}
const C3489={g:0.7, j:12};
export function extraPhysics_3489(inp:In3489, dt:number):Out3489 {
...
export const mm3489={d:'particle_fx'};