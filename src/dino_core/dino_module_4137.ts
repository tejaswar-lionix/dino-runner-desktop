/** dino_module_4137 — dino_physics_jump extended, humanized desktop */
export interface In4137{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4137{y:number;vy:number;sc:number}
const C4137={g:0.7, j:11};
export function extraRender_4137(inp:In4137, dt:number):Out4137 {
...
export const mm4137={d:'dino_physics_jump'};