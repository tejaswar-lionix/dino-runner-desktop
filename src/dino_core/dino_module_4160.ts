/** dino_module_4160 — score_speed extended, humanized desktop */
export interface In4160{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4160{y:number;vy:number;sc:number}
const C4160={g:0.7, j:11};
export function extraRender_4160(inp:In4160, dt:number):Out4160 {
...
export const mm4160={d:'score_speed'};