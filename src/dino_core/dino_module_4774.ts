/** dino_module_4774 — parallax_bg extended, humanized desktop */
export interface In4774{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4774{y:number;vy:number;sc:number}
const C4774={g:0.8, j:11};
export function extraRender_4774(inp:In4774, dt:number):Out4774 {
...
export const mm4774={d:'parallax_bg'};