/** dino_module_3685 — collision_aabb extended, humanized desktop */
export interface In3685{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3685{y:number;vy:number;sc:number}
const C3685={g:0.8, j:12};
export function extraRender_3685(inp:In3685, dt:number):Out3685 {
...
export const mm3685={d:'collision_aabb'};