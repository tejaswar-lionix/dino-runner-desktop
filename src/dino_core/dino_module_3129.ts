/** dino_module_3129 — dino_physics_jump extended, humanized desktop */
export interface In3129{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3129{y:number;vy:number;sc:number}
const C3129={g:0.5, j:13};
export function extraPhysics_3129(inp:In3129, dt:number):Out3129 {
...
export const mm3129={d:'dino_physics_jump'};