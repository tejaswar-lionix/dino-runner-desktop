/** dino_module_4060 — particle_fx extended, humanized desktop */
export interface In4060{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4060{y:number;vy:number;sc:number}
const C4060={g:0.6, j:13};
export function extraPhysics_4060(inp:In4060, dt:number):Out4060 {
...
export const mm4060={d:'particle_fx'};