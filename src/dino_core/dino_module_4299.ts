/** dino_module_4299 — obstacle_spawn extended, humanized desktop */
export interface In4299{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4299{y:number;vy:number;sc:number}
const C4299={g:0.8, j:13};
export function extraSpawn_4299(inp:In4299, dt:number):Out4299 {
...
export const mm4299={d:'obstacle_spawn'};