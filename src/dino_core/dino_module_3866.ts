/** dino_module_3866 — collision_aabb extended, humanized desktop */
export interface In3866{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3866{y:number;vy:number;sc:number}
const C3866={g:0.5, j:11};
export function extraSpawn_3866(inp:In3866, dt:number):Out3866 {
...
export const mm3866={d:'collision_aabb'};