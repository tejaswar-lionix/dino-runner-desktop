/** dino_module_3692 — obstacle_spawn extended, humanized desktop */
export interface In3692{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3692{y:number;vy:number;sc:number}
const C3692={g:0.6, j:13};
export function extraRender_3692(inp:In3692, dt:number):Out3692 {
...
export const mm3692={d:'obstacle_spawn'};