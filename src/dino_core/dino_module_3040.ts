/** dino_module_3040 — collision_aabb extended, humanized desktop */
export interface In3040{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3040{y:number;vy:number;sc:number}
const C3040={g:0.7, j:11};
export function extraRender_3040(inp:In3040, dt:number):Out3040 {
...
export const mm3040={d:'collision_aabb'};