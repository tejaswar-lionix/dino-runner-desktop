/** dino_module_4715 — score_speed extended, humanized desktop */
export interface In4715{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4715{y:number;vy:number;sc:number}
const C4715={g:0.5, j:11};
export function extraPhysics_4715(inp:In4715, dt:number):Out4715 {
...
export const mm4715={d:'score_speed'};