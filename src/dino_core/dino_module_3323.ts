/** dino_module_3323 — collision_aabb extended, humanized desktop */
export interface In3323{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3323{y:number;vy:number;sc:number}
const C3323={g:0.8, j:11};
export function extraPhysics_3323(inp:In3323, dt:number):Out3323 {
...
export const mm3323={d:'collision_aabb'};