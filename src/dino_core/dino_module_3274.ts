/** dino_module_3274 — score_speed extended, humanized desktop */
export interface In3274{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3274{y:number;vy:number;sc:number}
const C3274={g:0.7, j:11};
export function extraRender_3274(inp:In3274, dt:number):Out3274 {
...
export const mm3274={d:'score_speed'};