/** dino_module_4924 — dino_physics_jump extended, humanized desktop */
export interface In4924{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4924{y:number;vy:number;sc:number}
const C4924={g:0.7, j:12};
export function extraSpawn_4924(inp:In4924, dt:number):Out4924 {
...
export const mm4924={d:'dino_physics_jump'};