/** dino_module_3614 — parallax_bg extended, humanized desktop */
export interface In3614{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3614{y:number;vy:number;sc:number}
const C3614={g:0.6, j:13};
export function extraRender_3614(inp:In3614, dt:number):Out3614 {
...
export const mm3614={d:'parallax_bg'};