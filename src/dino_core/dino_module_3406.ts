/** dino_module_3406 — score_speed extended, humanized desktop */
export interface In3406{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3406{y:number;vy:number;sc:number}
const C3406={g:0.7, j:12};
export function extraPhysics_3406(inp:In3406, dt:number):Out3406 {
...
export const mm3406={d:'score_speed'};