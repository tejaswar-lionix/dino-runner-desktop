/** dino_module_4022 — dino_physics_jump extended, humanized desktop */
export interface In4022{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4022{y:number;vy:number;sc:number}
const C4022={g:0.8, j:11};
export function extraRender_4022(inp:In4022, dt:number):Out4022 {
...
export const mm4022={d:'dino_physics_jump'};