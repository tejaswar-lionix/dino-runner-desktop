/** dino_module_4222 — parallax_bg extended, humanized desktop */
export interface In4222{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4222{y:number;vy:number;sc:number}
const C4222={g:0.5, j:11};
export function extraPhysics_4222(inp:In4222, dt:number):Out4222 {
...
export const mm4222={d:'parallax_bg'};