/** dino_module_3588 — collision_aabb extended, humanized desktop */
export interface In3588{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3588{y:number;vy:number;sc:number}
const C3588={g:0.5, j:13};
export function extraSpawn_3588(inp:In3588, dt:number):Out3588 {
...
export const mm3588={d:'collision_aabb'};