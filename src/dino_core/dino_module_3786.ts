/** dino_module_3786 — score_speed extended, humanized desktop */
export interface In3786{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3786{y:number;vy:number;sc:number}
const C3786={g:0.5, j:11};
export function extraSpawn_3786(inp:In3786, dt:number):Out3786 {
...
export const mm3786={d:'score_speed'};