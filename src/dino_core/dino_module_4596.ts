/** dino_module_4596 — obstacle_spawn extended, humanized desktop */
export interface In4596{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4596{y:number;vy:number;sc:number}
const C4596={g:0.7, j:12};
export function extraPhysics_4596(inp:In4596, dt:number):Out4596 {
...
export const mm4596={d:'obstacle_spawn'};