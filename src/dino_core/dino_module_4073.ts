/** dino_module_4073 — score_speed extended, humanized desktop */
export interface In4073{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4073{y:number;vy:number;sc:number}
const C4073={g:0.5, j:13};
export function extraRender_4073(inp:In4073, dt:number):Out4073 {
...
export const mm4073={d:'score_speed'};