/** dino_module_3403 — particle_fx extended, humanized desktop */
export interface In3403{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3403{y:number;vy:number;sc:number}
const C3403={g:0.5, j:12};
export function extraSpawn_3403(inp:In3403, dt:number):Out3403 {
...
export const mm3403={d:'particle_fx'};