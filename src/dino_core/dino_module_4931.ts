/** dino_module_4931 — dino_physics_jump extended, humanized desktop */
export interface In4931{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4931{y:number;vy:number;sc:number}
const C4931={g:0.7, j:13};
export function extraSpawn_4931(inp:In4931, dt:number):Out4931 {
...
export const mm4931={d:'dino_physics_jump'};