/** dino_module_3349 — score_speed extended, humanized desktop */
export interface In3349{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3349{y:number;vy:number;sc:number}
const C3349={g:0.6, j:13};
export function extraPhysics_3349(inp:In3349, dt:number):Out3349 {
...
export const mm3349={d:'score_speed'};