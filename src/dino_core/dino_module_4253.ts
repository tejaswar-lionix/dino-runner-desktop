/** dino_module_4253 — obstacle_spawn extended, humanized desktop */
export interface In4253{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4253{y:number;vy:number;sc:number}
const C4253={g:0.6, j:13};
export function extraSpawn_4253(inp:In4253, dt:number):Out4253 {
...
export const mm4253={d:'obstacle_spawn'};