/** dino_module_4547 — score_speed extended, humanized desktop */
export interface In4547{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4547{y:number;vy:number;sc:number}
const C4547={g:0.6, j:11};
export function extraSpawn_4547(inp:In4547, dt:number):Out4547 {
...
export const mm4547={d:'score_speed'};