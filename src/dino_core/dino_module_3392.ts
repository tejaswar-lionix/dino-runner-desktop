/** dino_module_3392 — obstacle_spawn extended, humanized desktop */
export interface In3392{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3392{y:number;vy:number;sc:number}
const C3392={g:0.8, j:11};
export function extraPhysics_3392(inp:In3392, dt:number):Out3392 {
...
export const mm3392={d:'obstacle_spawn'};