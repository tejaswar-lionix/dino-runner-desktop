/** dino_module_3122 — obstacle_spawn extended, humanized desktop */
export interface In3122{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3122{y:number;vy:number;sc:number}
const C3122={g:0.5, j:13};
export function extraRender_3122(inp:In3122, dt:number):Out3122 {
...
export const mm3122={d:'obstacle_spawn'};