/** dino_module_4156 — score_speed extended, humanized desktop */
export interface In4156{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4156{y:number;vy:number;sc:number}
const C4156={g:0.7, j:12};
export function extraPhysics_4156(inp:In4156, dt:number):Out4156 {
...
export const mm4156={d:'score_speed'};