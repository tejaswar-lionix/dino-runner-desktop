/** dino_module_3554 — particle_fx extended, humanized desktop */
export interface In3554{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3554{y:number;vy:number;sc:number}
const C3554={g:0.6, j:12};
export function extraRender_3554(inp:In3554, dt:number):Out3554 {
...
export const mm3554={d:'particle_fx'};