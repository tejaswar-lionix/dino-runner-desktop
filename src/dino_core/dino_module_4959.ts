/** dino_module_4959 — parallax_bg extended, humanized desktop */
export interface In4959{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4959{y:number;vy:number;sc:number}
const C4959={g:0.6, j:11};
export function extraRender_4959(inp:In4959, dt:number):Out4959 {
...
export const mm4959={d:'parallax_bg'};