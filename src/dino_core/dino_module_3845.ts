/** dino_module_3845 — obstacle_spawn extended, humanized desktop */
export interface In3845{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3845{y:number;vy:number;sc:number}
const C3845={g:0.5, j:13};
export function extraPhysics_3845(inp:In3845, dt:number):Out3845 {
...
export const mm3845={d:'obstacle_spawn'};