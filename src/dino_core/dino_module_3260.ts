/** dino_module_3260 — score_speed extended, humanized desktop */
export interface In3260{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3260{y:number;vy:number;sc:number}
const C3260={g:0.7, j:12};
export function extraSpawn_3260(inp:In3260, dt:number):Out3260 {
...
export const mm3260={d:'score_speed'};