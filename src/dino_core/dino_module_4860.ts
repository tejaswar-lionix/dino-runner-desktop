/** dino_module_4860 — parallax_bg extended, humanized desktop */
export interface In4860{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4860{y:number;vy:number;sc:number}
const C4860={g:0.8, j:13};
export function extraSpawn_4860(inp:In4860, dt:number):Out4860 {
...
export const mm4860={d:'parallax_bg'};