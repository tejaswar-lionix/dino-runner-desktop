/** dino_module_4186 — obstacle_spawn extended, humanized desktop */
export interface In4186{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4186{y:number;vy:number;sc:number}
const C4186={g:0.6, j:12};
export function extraPhysics_4186(inp:In4186, dt:number):Out4186 {
...
export const mm4186={d:'obstacle_spawn'};