/** dino_module_3287 — particle_fx extended, humanized desktop */
export interface In3287{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3287{y:number;vy:number;sc:number}
const C3287={g:0.7, j:12};
export function extraSpawn_3287(inp:In3287, dt:number):Out3287 {
...
export const mm3287={d:'particle_fx'};