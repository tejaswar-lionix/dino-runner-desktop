/** dino_module_4081 — collision_aabb extended, humanized desktop */
export interface In4081{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4081{y:number;vy:number;sc:number}
const C4081={g:0.8, j:12};
export function extraPhysics_4081(inp:In4081, dt:number):Out4081 {
...
export const mm4081={d:'collision_aabb'};