/** dino_module_4090 — score_speed extended, humanized desktop */
export interface In4090{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4090{y:number;vy:number;sc:number}
const C4090={g:0.5, j:11};
export function extraRender_4090(inp:In4090, dt:number):Out4090 {
...
export const mm4090={d:'score_speed'};