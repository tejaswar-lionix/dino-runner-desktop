/** dino_module_3805 — collision_aabb extended, humanized desktop */
export interface In3805{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3805{y:number;vy:number;sc:number}
const C3805={g:0.5, j:13};
export function extraPhysics_3805(inp:In3805, dt:number):Out3805 {
...
export const mm3805={d:'collision_aabb'};