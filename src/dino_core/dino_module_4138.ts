/** dino_module_4138 — collision_aabb extended, humanized desktop */
export interface In4138{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4138{y:number;vy:number;sc:number}
const C4138={g:0.7, j:12};
export function extraPhysics_4138(inp:In4138, dt:number):Out4138 {
...
export const mm4138={d:'collision_aabb'};