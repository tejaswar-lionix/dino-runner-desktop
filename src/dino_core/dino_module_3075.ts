/** dino_module_3075 — collision_aabb extended, humanized desktop */
export interface In3075{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3075{y:number;vy:number;sc:number}
const C3075={g:0.6, j:12};
export function extraSpawn_3075(inp:In3075, dt:number):Out3075 {
...
export const mm3075={d:'collision_aabb'};