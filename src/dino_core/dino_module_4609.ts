/** dino_module_4609 — collision_aabb extended, humanized desktop */
export interface In4609{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4609{y:number;vy:number;sc:number}
const C4609={g:0.7, j:13};
export function extraRender_4609(inp:In4609, dt:number):Out4609 {
...
export const mm4609={d:'collision_aabb'};