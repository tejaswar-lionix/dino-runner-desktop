/** dino_module_4059 — dino_physics_jump extended, humanized desktop */
export interface In4059{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4059{y:number;vy:number;sc:number}
const C4059={g:0.6, j:12};
export function extraPhysics_4059(inp:In4059, dt:number):Out4059 {
...
export const mm4059={d:'dino_physics_jump'};