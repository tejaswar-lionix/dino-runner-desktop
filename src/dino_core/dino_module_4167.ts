/** dino_module_4167 — score_speed extended, humanized desktop */
export interface In4167{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4167{y:number;vy:number;sc:number}
const C4167={g:0.8, j:11};
export function extraPhysics_4167(inp:In4167, dt:number):Out4167 {
...
export const mm4167={d:'score_speed'};