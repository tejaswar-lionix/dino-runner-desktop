/** dino_module_4629 — obstacle_spawn extended, humanized desktop */
export interface In4629{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4629{y:number;vy:number;sc:number}
const C4629={g:0.7, j:13};
export function extraPhysics_4629(inp:In4629, dt:number):Out4629 {
...
export const mm4629={d:'obstacle_spawn'};