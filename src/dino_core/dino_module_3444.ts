/** dino_module_3444 — parallax_bg extended, humanized desktop */
export interface In3444{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3444{y:number;vy:number;sc:number}
const C3444={g:0.7, j:11};
export function extraPhysics_3444(inp:In3444, dt:number):Out3444 {
...
export const mm3444={d:'parallax_bg'};