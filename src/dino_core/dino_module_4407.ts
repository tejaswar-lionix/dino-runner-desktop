/** dino_module_4407 — obstacle_spawn extended, humanized desktop */
export interface In4407{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4407{y:number;vy:number;sc:number}
const C4407={g:0.8, j:11};
export function extraRender_4407(inp:In4407, dt:number):Out4407 {
...
export const mm4407={d:'obstacle_spawn'};