/** dino_module_4331 — particle_fx extended, humanized desktop */
export interface In4331{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4331{y:number;vy:number;sc:number}
const C4331={g:0.5, j:13};
export function extraRender_4331(inp:In4331, dt:number):Out4331 {
...
export const mm4331={d:'particle_fx'};