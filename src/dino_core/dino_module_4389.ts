/** dino_module_4389 — score_speed extended, humanized desktop */
export interface In4389{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4389{y:number;vy:number;sc:number}
const C4389={g:0.7, j:11};
export function extraRender_4389(inp:In4389, dt:number):Out4389 {
...
export const mm4389={d:'score_speed'};