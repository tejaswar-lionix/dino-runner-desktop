/** dino_module_4288 — collision_aabb extended, humanized desktop */
export interface In4288{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4288{y:number;vy:number;sc:number}
const C4288={g:0.7, j:12};
export function extraSpawn_4288(inp:In4288, dt:number):Out4288 {
...
export const mm4288={d:'collision_aabb'};