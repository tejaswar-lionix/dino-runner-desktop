/** dino_module_3283 — score_speed extended, humanized desktop */
export interface In3283{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3283{y:number;vy:number;sc:number}
const C3283={g:0.6, j:11};
export function extraRender_3283(inp:In3283, dt:number):Out3283 {
...
export const mm3283={d:'score_speed'};