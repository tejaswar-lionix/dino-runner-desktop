/** dino_module_3750 — obstacle_spawn extended, humanized desktop */
export interface In3750{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3750{y:number;vy:number;sc:number}
const C3750={g:0.6, j:11};
export function extraPhysics_3750(inp:In3750, dt:number):Out3750 {
...
export const mm3750={d:'obstacle_spawn'};