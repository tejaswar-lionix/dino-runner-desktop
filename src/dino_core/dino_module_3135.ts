/** dino_module_3135 — obstacle_spawn extended, humanized desktop */
export interface In3135{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3135{y:number;vy:number;sc:number}
const C3135={g:0.5, j:11};
export function extraSpawn_3135(inp:In3135, dt:number):Out3135 {
...
export const mm3135={d:'obstacle_spawn'};