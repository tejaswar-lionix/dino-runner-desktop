/** dino_module_4166 — score_speed extended, humanized desktop */
export interface In4166{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4166{y:number;vy:number;sc:number}
const C4166={g:0.5, j:13};
export function extraRender_4166(inp:In4166, dt:number):Out4166 {
...
export const mm4166={d:'score_speed'};