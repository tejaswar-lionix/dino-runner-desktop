/** dino_module_4937 — obstacle_spawn extended, humanized desktop */
export interface In4937{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4937{y:number;vy:number;sc:number}
const C4937={g:0.6, j:13};
export function extraRender_4937(inp:In4937, dt:number):Out4937 {
...
export const mm4937={d:'obstacle_spawn'};