/** dino_module_4557 — parallax_bg extended, humanized desktop */
export interface In4557{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4557{y:number;vy:number;sc:number}
const C4557={g:0.8, j:12};
export function extraSpawn_4557(inp:In4557, dt:number):Out4557 {
...
export const mm4557={d:'parallax_bg'};