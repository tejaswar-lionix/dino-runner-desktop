/** dino_module_3070 — collision_aabb extended, humanized desktop */
export interface In3070{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3070{y:number;vy:number;sc:number}
const C3070={g:0.6, j:13};
export function extraSpawn_3070(inp:In3070, dt:number):Out3070 {
...
export const mm3070={d:'collision_aabb'};