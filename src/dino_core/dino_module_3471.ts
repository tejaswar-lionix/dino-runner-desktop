/** dino_module_3471 — parallax_bg extended, humanized desktop */
export interface In3471{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3471{y:number;vy:number;sc:number}
const C3471={g:0.6, j:12};
export function extraRender_3471(inp:In3471, dt:number):Out3471 {
...
export const mm3471={d:'parallax_bg'};