/** dino_module_4301 — score_speed extended, humanized desktop */
export interface In4301{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4301{y:number;vy:number;sc:number}
const C4301={g:0.8, j:12};
export function extraSpawn_4301(inp:In4301, dt:number):Out4301 {
...
export const mm4301={d:'score_speed'};