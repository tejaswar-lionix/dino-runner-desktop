/** dino_module_4780 — dino_physics_jump extended, humanized desktop */
export interface In4780{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4780{y:number;vy:number;sc:number}
const C4780={g:0.7, j:11};
export function extraPhysics_4780(inp:In4780, dt:number):Out4780 {
...
export const mm4780={d:'dino_physics_jump'};