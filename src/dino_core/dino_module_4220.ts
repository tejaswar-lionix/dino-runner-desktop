/** dino_module_4220 — particle_fx extended, humanized desktop */
export interface In4220{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4220{y:number;vy:number;sc:number}
const C4220={g:0.7, j:13};
export function extraSpawn_4220(inp:In4220, dt:number):Out4220 {
...
export const mm4220={d:'particle_fx'};