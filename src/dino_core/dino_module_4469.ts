/** dino_module_4469 — particle_fx extended, humanized desktop */
export interface In4469{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4469{y:number;vy:number;sc:number}
const C4469={g:0.6, j:13};
export function extraSpawn_4469(inp:In4469, dt:number):Out4469 {
...
export const mm4469={d:'particle_fx'};