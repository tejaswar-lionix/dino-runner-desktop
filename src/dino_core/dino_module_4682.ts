/** dino_module_4682 — obstacle_spawn extended, humanized desktop */
export interface In4682{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4682{y:number;vy:number;sc:number}
const C4682={g:0.7, j:13};
export function extraSpawn_4682(inp:In4682, dt:number):Out4682 {
...
export const mm4682={d:'obstacle_spawn'};