/** dino_module_4665 — obstacle_spawn extended, humanized desktop */
export interface In4665{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4665{y:number;vy:number;sc:number}
const C4665={g:0.5, j:13};
export function extraPhysics_4665(inp:In4665, dt:number):Out4665 {
...
export const mm4665={d:'obstacle_spawn'};