/** dino_module_4935 — particle_fx extended, humanized desktop */
export interface In4935{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4935{y:number;vy:number;sc:number}
const C4935={g:0.6, j:13};
export function extraSpawn_4935(inp:In4935, dt:number):Out4935 {
...
export const mm4935={d:'particle_fx'};