/** dino_module_3157 — obstacle_spawn extended, humanized desktop */
export interface In3157{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3157{y:number;vy:number;sc:number}
const C3157={g:0.6, j:11};
export function extraSpawn_3157(inp:In3157, dt:number):Out3157 {
...
export const mm3157={d:'obstacle_spawn'};