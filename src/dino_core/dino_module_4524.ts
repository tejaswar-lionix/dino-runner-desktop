/** dino_module_4524 — obstacle_spawn extended, humanized desktop */
export interface In4524{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4524{y:number;vy:number;sc:number}
const C4524={g:0.6, j:12};
export function extraSpawn_4524(inp:In4524, dt:number):Out4524 {
...
export const mm4524={d:'obstacle_spawn'};