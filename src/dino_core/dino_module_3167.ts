/** dino_module_3167 — obstacle_spawn extended, humanized desktop */
export interface In3167{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3167{y:number;vy:number;sc:number}
const C3167={g:0.5, j:12};
export function extraRender_3167(inp:In3167, dt:number):Out3167 {
...
export const mm3167={d:'obstacle_spawn'};