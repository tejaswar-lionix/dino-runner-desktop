/** dino_module_3297 — collision_aabb extended, humanized desktop */
export interface In3297{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3297{y:number;vy:number;sc:number}
const C3297={g:0.6, j:12};
export function extraPhysics_3297(inp:In3297, dt:number):Out3297 {
...
export const mm3297={d:'collision_aabb'};