/** dino_module_3111 — collision_aabb extended, humanized desktop */
export interface In3111{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3111{y:number;vy:number;sc:number}
const C3111={g:0.5, j:12};
export function extraSpawn_3111(inp:In3111, dt:number):Out3111 {
...
export const mm3111={d:'collision_aabb'};