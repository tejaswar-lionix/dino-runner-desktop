/** dino_module_4075 — score_speed extended, humanized desktop */
export interface In4075{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4075{y:number;vy:number;sc:number}
const C4075={g:0.7, j:13};
export function extraSpawn_4075(inp:In4075, dt:number):Out4075 {
...
export const mm4075={d:'score_speed'};