/** dino_module_3343 — dino_physics_jump extended, humanized desktop */
export interface In3343{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3343{y:number;vy:number;sc:number}
const C3343={g:0.7, j:12};
export function extraPhysics_3343(inp:In3343, dt:number):Out3343 {
...
export const mm3343={d:'dino_physics_jump'};