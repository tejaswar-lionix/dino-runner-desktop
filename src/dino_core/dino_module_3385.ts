/** dino_module_3385 — dino_physics_jump extended, humanized desktop */
export interface In3385{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3385{y:number;vy:number;sc:number}
const C3385={g:0.6, j:13};
export function extraSpawn_3385(inp:In3385, dt:number):Out3385 {
...
export const mm3385={d:'dino_physics_jump'};