/** dino_module_4258 — obstacle_spawn extended, humanized desktop */
export interface In4258{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4258{y:number;vy:number;sc:number}
const C4258={g:0.5, j:11};
export function extraRender_4258(inp:In4258, dt:number):Out4258 {
...
export const mm4258={d:'obstacle_spawn'};