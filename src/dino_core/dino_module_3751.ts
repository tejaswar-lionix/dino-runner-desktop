/** dino_module_3751 — collision_aabb extended, humanized desktop */
export interface In3751{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3751{y:number;vy:number;sc:number}
const C3751={g:0.6, j:12};
export function extraSpawn_3751(inp:In3751, dt:number):Out3751 {
...
export const mm3751={d:'collision_aabb'};