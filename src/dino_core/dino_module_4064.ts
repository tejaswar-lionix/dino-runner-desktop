/** dino_module_4064 — particle_fx extended, humanized desktop */
export interface In4064{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4064{y:number;vy:number;sc:number}
const C4064={g:0.6, j:12};
export function extraSpawn_4064(inp:In4064, dt:number):Out4064 {
...
export const mm4064={d:'particle_fx'};