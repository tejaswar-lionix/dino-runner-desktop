/** dino_module_4336 — collision_aabb extended, humanized desktop */
export interface In4336{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4336{y:number;vy:number;sc:number}
const C4336={g:0.5, j:13};
export function extraRender_4336(inp:In4336, dt:number):Out4336 {
...
export const mm4336={d:'collision_aabb'};