/** dino_module_4906 — collision_aabb extended, humanized desktop */
export interface In4906{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4906{y:number;vy:number;sc:number}
const C4906={g:0.6, j:12};
export function extraPhysics_4906(inp:In4906, dt:number):Out4906 {
...
export const mm4906={d:'collision_aabb'};