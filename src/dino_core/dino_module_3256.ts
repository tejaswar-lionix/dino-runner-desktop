/** dino_module_3256 — obstacle_spawn extended, humanized desktop */
export interface In3256{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3256{y:number;vy:number;sc:number}
const C3256={g:0.8, j:13};
export function extraSpawn_3256(inp:In3256, dt:number):Out3256 {
...
export const mm3256={d:'obstacle_spawn'};