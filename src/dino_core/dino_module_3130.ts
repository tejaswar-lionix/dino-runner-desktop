/** dino_module_3130 — collision_aabb extended, humanized desktop */
export interface In3130{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3130{y:number;vy:number;sc:number}
const C3130={g:0.8, j:11};
export function extraPhysics_3130(inp:In3130, dt:number):Out3130 {
...
export const mm3130={d:'collision_aabb'};