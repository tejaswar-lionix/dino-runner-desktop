/** dino_module_4329 — particle_fx extended, humanized desktop */
export interface In4329{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4329{y:number;vy:number;sc:number}
const C4329={g:0.5, j:12};
export function extraRender_4329(inp:In4329, dt:number):Out4329 {
...
export const mm4329={d:'particle_fx'};