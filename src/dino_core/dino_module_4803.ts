/** dino_module_4803 — particle_fx extended, humanized desktop */
export interface In4803{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4803{y:number;vy:number;sc:number}
const C4803={g:0.6, j:12};
export function extraPhysics_4803(inp:In4803, dt:number):Out4803 {
...
export const mm4803={d:'particle_fx'};