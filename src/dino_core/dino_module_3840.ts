/** dino_module_3840 — obstacle_spawn extended, humanized desktop */
export interface In3840{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3840{y:number;vy:number;sc:number}
const C3840={g:0.6, j:12};
export function extraPhysics_3840(inp:In3840, dt:number):Out3840 {
...
export const mm3840={d:'obstacle_spawn'};