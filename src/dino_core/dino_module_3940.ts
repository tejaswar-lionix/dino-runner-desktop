/** dino_module_3940 — parallax_bg extended, humanized desktop */
export interface In3940{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3940{y:number;vy:number;sc:number}
const C3940={g:0.7, j:13};
export function extraRender_3940(inp:In3940, dt:number):Out3940 {
...
export const mm3940={d:'parallax_bg'};