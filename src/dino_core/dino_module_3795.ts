/** dino_module_3795 — dino_physics_jump extended, humanized desktop */
export interface In3795{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3795{y:number;vy:number;sc:number}
const C3795={g:0.7, j:12};
export function extraSpawn_3795(inp:In3795, dt:number):Out3795 {
...
export const mm3795={d:'dino_physics_jump'};