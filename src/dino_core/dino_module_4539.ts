/** dino_module_4539 — collision_aabb extended, humanized desktop */
export interface In4539{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4539{y:number;vy:number;sc:number}
const C4539={g:0.8, j:13};
export function extraSpawn_4539(inp:In4539, dt:number):Out4539 {
...
export const mm4539={d:'collision_aabb'};