/** dino_module_4652 — particle_fx extended, humanized desktop */
export interface In4652{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4652{y:number;vy:number;sc:number}
const C4652={g:0.5, j:13};
export function extraPhysics_4652(inp:In4652, dt:number):Out4652 {
...
export const mm4652={d:'particle_fx'};