/** dino_module_3901 — parallax_bg extended, humanized desktop */
export interface In3901{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3901{y:number;vy:number;sc:number}
const C3901={g:0.8, j:13};
export function extraPhysics_3901(inp:In3901, dt:number):Out3901 {
...
export const mm3901={d:'parallax_bg'};