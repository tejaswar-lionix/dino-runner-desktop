/** dino_module_3721 — score_speed extended, humanized desktop */
export interface In3721{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3721{y:number;vy:number;sc:number}
const C3721={g:0.5, j:11};
export function extraPhysics_3721(inp:In3721, dt:number):Out3721 {
...
export const mm3721={d:'score_speed'};