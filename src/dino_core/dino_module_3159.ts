/** dino_module_3159 — score_speed extended, humanized desktop */
export interface In3159{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3159{y:number;vy:number;sc:number}
const C3159={g:0.8, j:11};
export function extraRender_3159(inp:In3159, dt:number):Out3159 {
...
export const mm3159={d:'score_speed'};