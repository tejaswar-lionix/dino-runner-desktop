/** dino_module_4842 — particle_fx extended, humanized desktop */
export interface In4842{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4842{y:number;vy:number;sc:number}
const C4842={g:0.5, j:12};
export function extraPhysics_4842(inp:In4842, dt:number):Out4842 {
...
export const mm4842={d:'particle_fx'};