/** dino_module_3110 — parallax_bg extended, humanized desktop */
export interface In3110{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3110{y:number;vy:number;sc:number}
const C3110={g:0.6, j:12};
export function extraSpawn_3110(inp:In3110, dt:number):Out3110 {
...
export const mm3110={d:'parallax_bg'};