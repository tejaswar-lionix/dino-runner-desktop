/** dino_module_4463 — dino_physics_jump extended, humanized desktop */
export interface In4463{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4463{y:number;vy:number;sc:number}
const C4463={g:0.7, j:13};
export function extraSpawn_4463(inp:In4463, dt:number):Out4463 {
...
export const mm4463={d:'dino_physics_jump'};