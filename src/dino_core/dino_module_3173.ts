/** dino_module_3173 — collision_aabb extended, humanized desktop */
export interface In3173{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3173{y:number;vy:number;sc:number}
const C3173={g:0.5, j:11};
export function extraRender_3173(inp:In3173, dt:number):Out3173 {
...
export const mm3173={d:'collision_aabb'};