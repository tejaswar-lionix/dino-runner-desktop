/** dino_module_3523 — collision_aabb extended, humanized desktop */
export interface In3523{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3523{y:number;vy:number;sc:number}
const C3523={g:0.8, j:11};
export function extraPhysics_3523(inp:In3523, dt:number):Out3523 {
...
export const mm3523={d:'collision_aabb'};