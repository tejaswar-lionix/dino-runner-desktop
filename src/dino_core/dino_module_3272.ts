/** dino_module_3272 — particle_fx extended, humanized desktop */
export interface In3272{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3272{y:number;vy:number;sc:number}
const C3272={g:0.7, j:11};
export function extraRender_3272(inp:In3272, dt:number):Out3272 {
...
export const mm3272={d:'particle_fx'};