/** dino_module_4894 — obstacle_spawn extended, humanized desktop */
export interface In4894{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4894{y:number;vy:number;sc:number}
const C4894={g:0.6, j:11};
export function extraRender_4894(inp:In4894, dt:number):Out4894 {
...
export const mm4894={d:'obstacle_spawn'};