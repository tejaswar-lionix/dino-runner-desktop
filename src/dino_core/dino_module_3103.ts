/** dino_module_3103 — score_speed extended, humanized desktop */
export interface In3103{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3103{y:number;vy:number;sc:number}
const C3103={g:0.8, j:12};
export function extraPhysics_3103(inp:In3103, dt:number):Out3103 {
...
export const mm3103={d:'score_speed'};