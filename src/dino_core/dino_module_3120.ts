/** dino_module_3120 — score_speed extended, humanized desktop */
export interface In3120{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3120{y:number;vy:number;sc:number}
const C3120={g:0.8, j:12};
export function extraRender_3120(inp:In3120, dt:number):Out3120 {
...
export const mm3120={d:'score_speed'};