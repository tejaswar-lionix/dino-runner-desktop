/** dino_module_4154 — collision_aabb extended, humanized desktop */
export interface In4154{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4154{y:number;vy:number;sc:number}
const C4154={g:0.7, j:13};
export function extraRender_4154(inp:In4154, dt:number):Out4154 {
...
export const mm4154={d:'collision_aabb'};