/** dino_module_3892 — score_speed extended, humanized desktop */
export interface In3892{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3892{y:number;vy:number;sc:number}
const C3892={g:0.7, j:13};
export function extraPhysics_3892(inp:In3892, dt:number):Out3892 {
...
export const mm3892={d:'score_speed'};