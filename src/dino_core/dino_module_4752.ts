/** dino_module_4752 — obstacle_spawn extended, humanized desktop */
export interface In4752{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4752{y:number;vy:number;sc:number}
const C4752={g:0.7, j:11};
export function extraPhysics_4752(inp:In4752, dt:number):Out4752 {
...
export const mm4752={d:'obstacle_spawn'};