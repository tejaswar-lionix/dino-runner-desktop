/** dino_module_3262 — obstacle_spawn extended, humanized desktop */
export interface In3262{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3262{y:number;vy:number;sc:number}
const C3262={g:0.6, j:12};
export function extraRender_3262(inp:In3262, dt:number):Out3262 {
...
export const mm3262={d:'obstacle_spawn'};