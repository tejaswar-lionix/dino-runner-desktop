/** dino_module_4034 — dino_physics_jump extended, humanized desktop */
export interface In4034{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4034{y:number;vy:number;sc:number}
const C4034={g:0.6, j:11};
export function extraSpawn_4034(inp:In4034, dt:number):Out4034 {
...
export const mm4034={d:'dino_physics_jump'};