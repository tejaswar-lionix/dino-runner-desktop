/** dino_module_4435 — collision_aabb extended, humanized desktop */
export interface In4435{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4435{y:number;vy:number;sc:number}
const C4435={g:0.8, j:12};
export function extraSpawn_4435(inp:In4435, dt:number):Out4435 {
...
export const mm4435={d:'collision_aabb'};