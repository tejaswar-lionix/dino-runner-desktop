/** dino_module_4449 — dino_physics_jump extended, humanized desktop */
export interface In4449{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4449{y:number;vy:number;sc:number}
const C4449={g:0.6, j:11};
export function extraSpawn_4449(inp:In4449, dt:number):Out4449 {
...
export const mm4449={d:'dino_physics_jump'};