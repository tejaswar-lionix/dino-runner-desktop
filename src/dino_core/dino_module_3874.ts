/** dino_module_3874 — particle_fx extended, humanized desktop */
export interface In3874{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3874{y:number;vy:number;sc:number}
const C3874={g:0.5, j:12};
export function extraSpawn_3874(inp:In3874, dt:number):Out3874 {
...
export const mm3874={d:'particle_fx'};