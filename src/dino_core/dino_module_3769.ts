/** dino_module_3769 — dino_physics_jump extended, humanized desktop */
export interface In3769{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3769{y:number;vy:number;sc:number}
const C3769={g:0.8, j:11};
export function extraPhysics_3769(inp:In3769, dt:number):Out3769 {
...
export const mm3769={d:'dino_physics_jump'};