/** dino_module_3063 — score_speed extended, humanized desktop */
export interface In3063{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3063{y:number;vy:number;sc:number}
const C3063={g:0.7, j:11};
export function extraPhysics_3063(inp:In3063, dt:number):Out3063 {
...
export const mm3063={d:'score_speed'};