/** dino_module_3612 — particle_fx extended, humanized desktop */
export interface In3612{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3612{y:number;vy:number;sc:number}
const C3612={g:0.7, j:11};
export function extraRender_3612(inp:In3612, dt:number):Out3612 {
...
export const mm3612={d:'particle_fx'};