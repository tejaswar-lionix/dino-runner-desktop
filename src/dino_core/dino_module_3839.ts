/** dino_module_3839 — collision_aabb extended, humanized desktop */
export interface In3839{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3839{y:number;vy:number;sc:number}
const C3839={g:0.6, j:12};
export function extraRender_3839(inp:In3839, dt:number):Out3839 {
...
export const mm3839={d:'collision_aabb'};