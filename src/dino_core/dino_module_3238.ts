/** dino_module_3238 — collision_aabb extended, humanized desktop */
export interface In3238{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3238{y:number;vy:number;sc:number}
const C3238={g:0.5, j:11};
export function extraSpawn_3238(inp:In3238, dt:number):Out3238 {
...
export const mm3238={d:'collision_aabb'};