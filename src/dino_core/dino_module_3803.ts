/** dino_module_3803 — particle_fx extended, humanized desktop */
export interface In3803{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3803{y:number;vy:number;sc:number}
const C3803={g:0.6, j:13};
export function extraRender_3803(inp:In3803, dt:number):Out3803 {
...
export const mm3803={d:'particle_fx'};