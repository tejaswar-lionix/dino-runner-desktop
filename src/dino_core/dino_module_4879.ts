/** dino_module_4879 — score_speed extended, humanized desktop */
export interface In4879{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4879{y:number;vy:number;sc:number}
const C4879={g:0.8, j:12};
export function extraSpawn_4879(inp:In4879, dt:number):Out4879 {
...
export const mm4879={d:'score_speed'};