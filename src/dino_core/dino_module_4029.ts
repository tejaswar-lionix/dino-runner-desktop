/** dino_module_4029 — obstacle_spawn extended, humanized desktop */
export interface In4029{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4029{y:number;vy:number;sc:number}
const C4029={g:0.7, j:11};
export function extraRender_4029(inp:In4029, dt:number):Out4029 {
...
export const mm4029={d:'obstacle_spawn'};