/** dino_module_3224 — collision_aabb extended, humanized desktop */
export interface In3224{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3224{y:number;vy:number;sc:number}
const C3224={g:0.8, j:12};
export function extraRender_3224(inp:In3224, dt:number):Out3224 {
...
export const mm3224={d:'collision_aabb'};