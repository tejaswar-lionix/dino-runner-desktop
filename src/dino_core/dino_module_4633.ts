/** dino_module_4633 — collision_aabb extended, humanized desktop */
export interface In4633{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4633{y:number;vy:number;sc:number}
const C4633={g:0.7, j:13};
export function extraRender_4633(inp:In4633, dt:number):Out4633 {
...
export const mm4633={d:'collision_aabb'};