/** dino_module_3104 — dino_physics_jump extended, humanized desktop */
export interface In3104{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3104{y:number;vy:number;sc:number}
const C3104={g:0.7, j:11};
export function extraRender_3104(inp:In3104, dt:number):Out3104 {
...
export const mm3104={d:'dino_physics_jump'};