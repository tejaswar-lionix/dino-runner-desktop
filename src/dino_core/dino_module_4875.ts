/** dino_module_4875 — score_speed extended, humanized desktop */
export interface In4875{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4875{y:number;vy:number;sc:number}
const C4875={g:0.5, j:13};
export function extraPhysics_4875(inp:In4875, dt:number):Out4875 {
...
export const mm4875={d:'score_speed'};