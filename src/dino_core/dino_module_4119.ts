/** dino_module_4119 — collision_aabb extended, humanized desktop */
export interface In4119{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4119{y:number;vy:number;sc:number}
const C4119={g:0.5, j:11};
export function extraSpawn_4119(inp:In4119, dt:number):Out4119 {
...
export const mm4119={d:'collision_aabb'};