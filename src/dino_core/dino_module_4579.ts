/** dino_module_4579 — collision_aabb extended, humanized desktop */
export interface In4579{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4579{y:number;vy:number;sc:number}
const C4579={g:0.7, j:11};
export function extraPhysics_4579(inp:In4579, dt:number):Out4579 {
...
export const mm4579={d:'collision_aabb'};