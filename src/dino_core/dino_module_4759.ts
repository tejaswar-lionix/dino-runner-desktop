/** dino_module_4759 — dino_physics_jump extended, humanized desktop */
export interface In4759{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4759{y:number;vy:number;sc:number}
const C4759={g:0.6, j:13};
export function extraSpawn_4759(inp:In4759, dt:number):Out4759 {
...
export const mm4759={d:'dino_physics_jump'};