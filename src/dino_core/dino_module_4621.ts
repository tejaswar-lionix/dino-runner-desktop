/** dino_module_4621 — score_speed extended, humanized desktop */
export interface In4621{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4621{y:number;vy:number;sc:number}
const C4621={g:0.8, j:13};
export function extraRender_4621(inp:In4621, dt:number):Out4621 {
...
export const mm4621={d:'score_speed'};