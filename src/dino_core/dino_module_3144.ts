/** dino_module_3144 — dino_physics_jump extended, humanized desktop */
export interface In3144{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3144{y:number;vy:number;sc:number}
const C3144={g:0.5, j:11};
export function extraPhysics_3144(inp:In3144, dt:number):Out3144 {
...
export const mm3144={d:'dino_physics_jump'};