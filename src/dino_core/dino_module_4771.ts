/** dino_module_4771 — particle_fx extended, humanized desktop */
export interface In4771{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4771{y:number;vy:number;sc:number}
const C4771={g:0.6, j:13};
export function extraPhysics_4771(inp:In4771, dt:number):Out4771 {
...
export const mm4771={d:'particle_fx'};