/** dino_module_4391 — dino_physics_jump extended, humanized desktop */
export interface In4391{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4391{y:number;vy:number;sc:number}
const C4391={g:0.5, j:11};
export function extraSpawn_4391(inp:In4391, dt:number):Out4391 {
...
export const mm4391={d:'dino_physics_jump'};