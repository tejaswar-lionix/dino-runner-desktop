/** dino_module_4862 — parallax_bg extended, humanized desktop */
export interface In4862{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4862{y:number;vy:number;sc:number}
const C4862={g:0.7, j:13};
export function extraSpawn_4862(inp:In4862, dt:number):Out4862 {
...
export const mm4862={d:'parallax_bg'};