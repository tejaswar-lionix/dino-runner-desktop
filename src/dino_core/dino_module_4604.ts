/** dino_module_4604 — particle_fx extended, humanized desktop */
export interface In4604{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4604{y:number;vy:number;sc:number}
const C4604={g:0.5, j:11};
export function extraSpawn_4604(inp:In4604, dt:number):Out4604 {
...
export const mm4604={d:'particle_fx'};