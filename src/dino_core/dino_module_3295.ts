/** dino_module_3295 — particle_fx extended, humanized desktop */
export interface In3295{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3295{y:number;vy:number;sc:number}
const C3295={g:0.7, j:11};
export function extraRender_3295(inp:In3295, dt:number):Out3295 {
...
export const mm3295={d:'particle_fx'};