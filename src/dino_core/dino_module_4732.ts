/** dino_module_4732 — dino_physics_jump extended, humanized desktop */
export interface In4732{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4732{y:number;vy:number;sc:number}
const C4732={g:0.7, j:12};
export function extraPhysics_4732(inp:In4732, dt:number):Out4732 {
...
export const mm4732={d:'dino_physics_jump'};