/** dino_module_3999 — score_speed extended, humanized desktop */
export interface In3999{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3999{y:number;vy:number;sc:number}
const C3999={g:0.6, j:11};
export function extraSpawn_3999(inp:In3999, dt:number):Out3999 {
...
export const mm3999={d:'score_speed'};