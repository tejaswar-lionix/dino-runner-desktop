/** dino_module_4805 — collision_aabb extended, humanized desktop */
export interface In4805{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4805{y:number;vy:number;sc:number}
const C4805={g:0.5, j:13};
export function extraPhysics_4805(inp:In4805, dt:number):Out4805 {
...
export const mm4805={d:'collision_aabb'};