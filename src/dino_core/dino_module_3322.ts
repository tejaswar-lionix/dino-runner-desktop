/** dino_module_3322 — obstacle_spawn extended, humanized desktop */
export interface In3322{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3322{y:number;vy:number;sc:number}
const C3322={g:0.5, j:11};
export function extraSpawn_3322(inp:In3322, dt:number):Out3322 {
...
export const mm3322={d:'obstacle_spawn'};