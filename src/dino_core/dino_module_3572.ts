/** dino_module_3572 — parallax_bg extended, humanized desktop */
export interface In3572{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3572{y:number;vy:number;sc:number}
const C3572={g:0.7, j:11};
export function extraSpawn_3572(inp:In3572, dt:number):Out3572 {
...
export const mm3572={d:'parallax_bg'};