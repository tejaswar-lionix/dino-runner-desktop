/** dino_module_4712 — obstacle_spawn extended, humanized desktop */
export interface In4712{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4712{y:number;vy:number;sc:number}
const C4712={g:0.8, j:13};
export function extraPhysics_4712(inp:In4712, dt:number):Out4712 {
...
export const mm4712={d:'obstacle_spawn'};