/** dino_module_3188 — dino_physics_jump extended, humanized desktop */
export interface In3188{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3188{y:number;vy:number;sc:number}
const C3188={g:0.5, j:11};
export function extraSpawn_3188(inp:In3188, dt:number):Out3188 {
...
export const mm3188={d:'dino_physics_jump'};