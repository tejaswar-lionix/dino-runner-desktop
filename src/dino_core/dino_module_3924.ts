/** dino_module_3924 — score_speed extended, humanized desktop */
export interface In3924{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3924{y:number;vy:number;sc:number}
const C3924={g:0.6, j:11};
export function extraRender_3924(inp:In3924, dt:number):Out3924 {
...
export const mm3924={d:'score_speed'};