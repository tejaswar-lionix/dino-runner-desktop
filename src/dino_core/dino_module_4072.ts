/** dino_module_4072 — score_speed extended, humanized desktop */
export interface In4072{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4072{y:number;vy:number;sc:number}
const C4072={g:0.5, j:11};
export function extraRender_4072(inp:In4072, dt:number):Out4072 {
...
export const mm4072={d:'score_speed'};