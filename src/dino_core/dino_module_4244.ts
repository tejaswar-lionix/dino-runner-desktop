/** dino_module_4244 — obstacle_spawn extended, humanized desktop */
export interface In4244{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4244{y:number;vy:number;sc:number}
const C4244={g:0.7, j:13};
export function extraSpawn_4244(inp:In4244, dt:number):Out4244 {
...
export const mm4244={d:'obstacle_spawn'};