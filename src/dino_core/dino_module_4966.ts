/** dino_module_4966 — particle_fx extended, humanized desktop */
export interface In4966{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4966{y:number;vy:number;sc:number}
const C4966={g:0.8, j:12};
export function extraRender_4966(inp:In4966, dt:number):Out4966 {
...
export const mm4966={d:'particle_fx'};