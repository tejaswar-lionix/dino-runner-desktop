/** dino_module_4372 — dino_physics_jump extended, humanized desktop */
export interface In4372{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4372{y:number;vy:number;sc:number}
const C4372={g:0.6, j:13};
export function extraPhysics_4372(inp:In4372, dt:number):Out4372 {
...
export const mm4372={d:'dino_physics_jump'};