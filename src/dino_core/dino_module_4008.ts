/** dino_module_4008 — particle_fx extended, humanized desktop */
export interface In4008{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4008{y:number;vy:number;sc:number}
const C4008={g:0.5, j:13};
export function extraRender_4008(inp:In4008, dt:number):Out4008 {
...
export const mm4008={d:'particle_fx'};