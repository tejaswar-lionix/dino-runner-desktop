/** dino_module_3182 — collision_aabb extended, humanized desktop */
export interface In3182{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3182{y:number;vy:number;sc:number}
const C3182={g:0.5, j:13};
export function extraPhysics_3182(inp:In3182, dt:number):Out3182 {
...
export const mm3182={d:'collision_aabb'};