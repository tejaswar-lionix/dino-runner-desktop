/** dino_module_3550 — particle_fx extended, humanized desktop */
export interface In3550{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3550{y:number;vy:number;sc:number}
const C3550={g:0.5, j:12};
export function extraSpawn_3550(inp:In3550, dt:number):Out3550 {
...
export const mm3550={d:'particle_fx'};