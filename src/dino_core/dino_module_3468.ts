/** dino_module_3468 — collision_aabb extended, humanized desktop */
export interface In3468{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3468{y:number;vy:number;sc:number}
const C3468={g:0.5, j:13};
export function extraRender_3468(inp:In3468, dt:number):Out3468 {
...
export const mm3468={d:'collision_aabb'};