/** dino_module_3131 — particle_fx extended, humanized desktop */
export interface In3131{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3131{y:number;vy:number;sc:number}
const C3131={g:0.8, j:13};
export function extraPhysics_3131(inp:In3131, dt:number):Out3131 {
...
export const mm3131={d:'particle_fx'};