/** dino_module_4769 — parallax_bg extended, humanized desktop */
export interface In4769{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4769{y:number;vy:number;sc:number}
const C4769={g:0.5, j:11};
export function extraRender_4769(inp:In4769, dt:number):Out4769 {
...
export const mm4769={d:'parallax_bg'};