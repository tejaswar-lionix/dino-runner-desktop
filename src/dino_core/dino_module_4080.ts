/** dino_module_4080 — collision_aabb extended, humanized desktop */
export interface In4080{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4080{y:number;vy:number;sc:number}
const C4080={g:0.5, j:13};
export function extraSpawn_4080(inp:In4080, dt:number):Out4080 {
...
export const mm4080={d:'collision_aabb'};