/** dino_module_4377 — dino_physics_jump extended, humanized desktop */
export interface In4377{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4377{y:number;vy:number;sc:number}
const C4377={g:0.6, j:13};
export function extraRender_4377(inp:In4377, dt:number):Out4377 {
...
export const mm4377={d:'dino_physics_jump'};