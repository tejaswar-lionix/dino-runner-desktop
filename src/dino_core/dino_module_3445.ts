/** dino_module_3445 — collision_aabb extended, humanized desktop */
export interface In3445{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3445{y:number;vy:number;sc:number}
const C3445={g:0.7, j:13};
export function extraPhysics_3445(inp:In3445, dt:number):Out3445 {
...
export const mm3445={d:'collision_aabb'};