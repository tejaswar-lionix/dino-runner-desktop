/** dino_module_3817 — dino_physics_jump extended, humanized desktop */
export interface In3817{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3817{y:number;vy:number;sc:number}
const C3817={g:0.5, j:11};
export function extraRender_3817(inp:In3817, dt:number):Out3817 {
...
export const mm3817={d:'dino_physics_jump'};