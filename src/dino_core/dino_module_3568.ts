/** dino_module_3568 — collision_aabb extended, humanized desktop */
export interface In3568{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3568{y:number;vy:number;sc:number}
const C3568={g:0.8, j:12};
export function extraRender_3568(inp:In3568, dt:number):Out3568 {
...
export const mm3568={d:'collision_aabb'};