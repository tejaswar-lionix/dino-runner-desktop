/** dino_module_4420 — collision_aabb extended, humanized desktop */
export interface In4420{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4420{y:number;vy:number;sc:number}
const C4420={g:0.6, j:13};
export function extraSpawn_4420(inp:In4420, dt:number):Out4420 {
...
export const mm4420={d:'collision_aabb'};