/** dino_module_3068 — score_speed extended, humanized desktop */
export interface In3068{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3068{y:number;vy:number;sc:number}
const C3068={g:0.6, j:11};
export function extraPhysics_3068(inp:In3068, dt:number):Out3068 {
...
export const mm3068={d:'score_speed'};