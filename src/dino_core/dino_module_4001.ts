/** dino_module_4001 — dino_physics_jump extended, humanized desktop */
export interface In4001{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4001{y:number;vy:number;sc:number}
const C4001={g:0.7, j:11};
export function extraSpawn_4001(inp:In4001, dt:number):Out4001 {
...
export const mm4001={d:'dino_physics_jump'};