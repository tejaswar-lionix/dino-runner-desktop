/** dino_module_4048 — collision_aabb extended, humanized desktop */
export interface In4048{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4048{y:number;vy:number;sc:number}
const C4048={g:0.8, j:13};
export function extraPhysics_4048(inp:In4048, dt:number):Out4048 {
...
export const mm4048={d:'collision_aabb'};