/** dino_module_3754 — parallax_bg extended, humanized desktop */
export interface In3754{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3754{y:number;vy:number;sc:number}
const C3754={g:0.5, j:11};
export function extraSpawn_3754(inp:In3754, dt:number):Out3754 {
...
export const mm3754={d:'parallax_bg'};