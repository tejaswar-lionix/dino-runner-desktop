/** dino_module_3543 — dino_physics_jump extended, humanized desktop */
export interface In3543{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3543{y:number;vy:number;sc:number}
const C3543={g:0.6, j:13};
export function extraRender_3543(inp:In3543, dt:number):Out3543 {
...
export const mm3543={d:'dino_physics_jump'};