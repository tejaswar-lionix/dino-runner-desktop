/** dino_module_4916 — collision_aabb extended, humanized desktop */
export interface In4916{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4916{y:number;vy:number;sc:number}
const C4916={g:0.8, j:13};
export function extraPhysics_4916(inp:In4916, dt:number):Out4916 {
...
export const mm4916={d:'collision_aabb'};