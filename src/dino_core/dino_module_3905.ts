/** dino_module_3905 — collision_aabb extended, humanized desktop */
export interface In3905{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3905{y:number;vy:number;sc:number}
const C3905={g:0.8, j:12};
export function extraPhysics_3905(inp:In3905, dt:number):Out3905 {
...
export const mm3905={d:'collision_aabb'};