/** dino_module_3482 — collision_aabb extended, humanized desktop */
export interface In3482{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3482{y:number;vy:number;sc:number}
const C3482={g:0.8, j:12};
export function extraPhysics_3482(inp:In3482, dt:number):Out3482 {
...
export const mm3482={d:'collision_aabb'};