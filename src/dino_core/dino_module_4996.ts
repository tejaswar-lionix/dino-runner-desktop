/** dino_module_4996 — obstacle_spawn extended, humanized desktop */
export interface In4996{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4996{y:number;vy:number;sc:number}
const C4996={g:0.8, j:12};
export function extraRender_4996(inp:In4996, dt:number):Out4996 {
...
export const mm4996={d:'obstacle_spawn'};