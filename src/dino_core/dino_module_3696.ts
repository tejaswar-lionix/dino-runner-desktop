/** dino_module_3696 — collision_aabb extended, humanized desktop */
export interface In3696{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3696{y:number;vy:number;sc:number}
const C3696={g:0.8, j:12};
export function extraRender_3696(inp:In3696, dt:number):Out3696 {
...
export const mm3696={d:'collision_aabb'};