/** dino_module_3708 — score_speed extended, humanized desktop */
export interface In3708{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3708{y:number;vy:number;sc:number}
const C3708={g:0.7, j:12};
export function extraSpawn_3708(inp:In3708, dt:number):Out3708 {
...
export const mm3708={d:'score_speed'};