/** dino_module_3647 — collision_aabb extended, humanized desktop */
export interface In3647{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3647{y:number;vy:number;sc:number}
const C3647={g:0.7, j:13};
export function extraRender_3647(inp:In3647, dt:number):Out3647 {
...
export const mm3647={d:'collision_aabb'};