/** dino_module_4393 — parallax_bg extended, humanized desktop */
export interface In4393{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4393{y:number;vy:number;sc:number}
const C4393={g:0.8, j:12};
export function extraSpawn_4393(inp:In4393, dt:number):Out4393 {
...
export const mm4393={d:'parallax_bg'};