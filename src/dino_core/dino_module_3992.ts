/** dino_module_3992 — dino_physics_jump extended, humanized desktop */
export interface In3992{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3992{y:number;vy:number;sc:number}
const C3992={g:0.7, j:11};
export function extraPhysics_3992(inp:In3992, dt:number):Out3992 {
...
export const mm3992={d:'dino_physics_jump'};