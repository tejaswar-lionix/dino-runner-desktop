/** dino_module_3993 — collision_aabb extended, humanized desktop */
export interface In3993{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3993{y:number;vy:number;sc:number}
const C3993={g:0.8, j:13};
export function extraPhysics_3993(inp:In3993, dt:number):Out3993 {
...
export const mm3993={d:'collision_aabb'};