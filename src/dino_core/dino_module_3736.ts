/** dino_module_3736 — collision_aabb extended, humanized desktop */
export interface In3736{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3736{y:number;vy:number;sc:number}
const C3736={g:0.6, j:13};
export function extraPhysics_3736(inp:In3736, dt:number):Out3736 {
...
export const mm3736={d:'collision_aabb'};