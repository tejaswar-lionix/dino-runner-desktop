/** dino_module_3197 — particle_fx extended, humanized desktop */
export interface In3197{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3197{y:number;vy:number;sc:number}
const C3197={g:0.6, j:12};
export function extraPhysics_3197(inp:In3197, dt:number):Out3197 {
...
export const mm3197={d:'particle_fx'};