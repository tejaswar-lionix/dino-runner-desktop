/** dino_module_4320 — score_speed extended, humanized desktop */
export interface In4320{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4320{y:number;vy:number;sc:number}
const C4320={g:0.7, j:11};
export function extraSpawn_4320(inp:In4320, dt:number):Out4320 {
...
export const mm4320={d:'score_speed'};