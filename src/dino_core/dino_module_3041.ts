/** dino_module_3041 — obstacle_spawn extended, humanized desktop */
export interface In3041{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3041{y:number;vy:number;sc:number}
const C3041={g:0.8, j:13};
export function extraPhysics_3041(inp:In3041, dt:number):Out3041 {
...
export const mm3041={d:'obstacle_spawn'};