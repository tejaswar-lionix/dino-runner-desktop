/** dino_module_3806 — parallax_bg extended, humanized desktop */
export interface In3806{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3806{y:number;vy:number;sc:number}
const C3806={g:0.7, j:12};
export function extraSpawn_3806(inp:In3806, dt:number):Out3806 {
...
export const mm3806={d:'parallax_bg'};