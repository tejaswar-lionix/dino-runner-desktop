/** dino_module_3221 — obstacle_spawn extended, humanized desktop */
export interface In3221{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3221{y:number;vy:number;sc:number}
const C3221={g:0.7, j:11};
export function extraRender_3221(inp:In3221, dt:number):Out3221 {
...
export const mm3221={d:'obstacle_spawn'};