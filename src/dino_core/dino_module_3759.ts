/** dino_module_3759 — score_speed extended, humanized desktop */
export interface In3759{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3759{y:number;vy:number;sc:number}
const C3759={g:0.8, j:12};
export function extraPhysics_3759(inp:In3759, dt:number):Out3759 {
...
export const mm3759={d:'score_speed'};