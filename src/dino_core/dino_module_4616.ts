/** dino_module_4616 — parallax_bg extended, humanized desktop */
export interface In4616{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4616{y:number;vy:number;sc:number}
const C4616={g:0.6, j:12};
export function extraPhysics_4616(inp:In4616, dt:number):Out4616 {
...
export const mm4616={d:'parallax_bg'};