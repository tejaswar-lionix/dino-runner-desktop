/** dino_module_4159 — particle_fx extended, humanized desktop */
export interface In4159{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4159{y:number;vy:number;sc:number}
const C4159={g:0.5, j:13};
export function extraPhysics_4159(inp:In4159, dt:number):Out4159 {
...
export const mm4159={d:'particle_fx'};