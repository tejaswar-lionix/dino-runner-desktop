/** dino_module_4438 — particle_fx extended, humanized desktop */
export interface In4438{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4438{y:number;vy:number;sc:number}
const C4438={g:0.8, j:13};
export function extraRender_4438(inp:In4438, dt:number):Out4438 {
...
export const mm4438={d:'particle_fx'};