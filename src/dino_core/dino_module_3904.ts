/** dino_module_3904 — dino_physics_jump extended, humanized desktop */
export interface In3904{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3904{y:number;vy:number;sc:number}
const C3904={g:0.7, j:13};
export function extraRender_3904(inp:In3904, dt:number):Out3904 {
...
export const mm3904={d:'dino_physics_jump'};