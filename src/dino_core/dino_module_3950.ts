/** dino_module_3950 — collision_aabb extended, humanized desktop */
export interface In3950{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3950{y:number;vy:number;sc:number}
const C3950={g:0.8, j:13};
export function extraRender_3950(inp:In3950, dt:number):Out3950 {
...
export const mm3950={d:'collision_aabb'};