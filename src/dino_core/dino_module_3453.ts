/** dino_module_3453 — parallax_bg extended, humanized desktop */
export interface In3453{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3453{y:number;vy:number;sc:number}
const C3453={g:0.8, j:13};
export function extraRender_3453(inp:In3453, dt:number):Out3453 {
...
export const mm3453={d:'parallax_bg'};