/** dino_module_5000 — particle_fx extended, humanized desktop */
export interface In5000{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out5000{y:number;vy:number;sc:number}
const C5000={g:0.7, j:13};
export function extraSpawn_5000(inp:In5000, dt:number):Out5000 {
...
export const mm5000={d:'particle_fx'};