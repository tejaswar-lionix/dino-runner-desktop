/** dino_module_4477 — score_speed extended, humanized desktop */
export interface In4477{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4477{y:number;vy:number;sc:number}
const C4477={g:0.6, j:12};
export function extraRender_4477(inp:In4477, dt:number):Out4477 {
...
export const mm4477={d:'score_speed'};