/** dino_module_4014 — particle_fx extended, humanized desktop */
export interface In4014{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4014{y:number;vy:number;sc:number}
const C4014={g:0.7, j:12};
export function extraSpawn_4014(inp:In4014, dt:number):Out4014 {
...
export const mm4014={d:'particle_fx'};