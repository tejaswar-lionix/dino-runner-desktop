/** dino_module_3179 — particle_fx extended, humanized desktop */
export interface In3179{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3179{y:number;vy:number;sc:number}
const C3179={g:0.6, j:11};
export function extraRender_3179(inp:In3179, dt:number):Out3179 {
...
export const mm3179={d:'particle_fx'};