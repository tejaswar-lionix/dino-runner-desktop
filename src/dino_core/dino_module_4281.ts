/** dino_module_4281 — particle_fx extended, humanized desktop */
export interface In4281{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4281{y:number;vy:number;sc:number}
const C4281={g:0.5, j:13};
export function extraSpawn_4281(inp:In4281, dt:number):Out4281 {
...
export const mm4281={d:'particle_fx'};