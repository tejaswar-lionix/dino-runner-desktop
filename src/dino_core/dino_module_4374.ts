/** dino_module_4374 — particle_fx extended, humanized desktop */
export interface In4374{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4374{y:number;vy:number;sc:number}
const C4374={g:0.6, j:12};
export function extraRender_4374(inp:In4374, dt:number):Out4374 {
...
export const mm4374={d:'particle_fx'};