/** dino_module_4814 — collision_aabb extended, humanized desktop */
export interface In4814{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4814{y:number;vy:number;sc:number}
const C4814={g:0.6, j:12};
export function extraSpawn_4814(inp:In4814, dt:number):Out4814 {
...
export const mm4814={d:'collision_aabb'};