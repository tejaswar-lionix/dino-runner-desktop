/** dino_module_4296 — dino_physics_jump extended, humanized desktop */
export interface In4296{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4296{y:number;vy:number;sc:number}
const C4296={g:0.6, j:13};
export function extraSpawn_4296(inp:In4296, dt:number):Out4296 {
...
export const mm4296={d:'dino_physics_jump'};