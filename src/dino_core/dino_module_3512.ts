/** dino_module_3512 — dino_physics_jump extended, humanized desktop */
export interface In3512{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3512{y:number;vy:number;sc:number}
const C3512={g:0.6, j:11};
export function extraPhysics_3512(inp:In3512, dt:number):Out3512 {
...
export const mm3512={d:'dino_physics_jump'};