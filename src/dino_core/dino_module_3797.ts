/** dino_module_3797 — parallax_bg extended, humanized desktop */
export interface In3797{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3797{y:number;vy:number;sc:number}
const C3797={g:0.6, j:13};
export function extraPhysics_3797(inp:In3797, dt:number):Out3797 {
...
export const mm3797={d:'parallax_bg'};