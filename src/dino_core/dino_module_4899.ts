/** dino_module_4899 — particle_fx extended, humanized desktop */
export interface In4899{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4899{y:number;vy:number;sc:number}
const C4899={g:0.5, j:12};
export function extraRender_4899(inp:In4899, dt:number):Out4899 {
...
export const mm4899={d:'particle_fx'};