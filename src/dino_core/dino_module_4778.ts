/** dino_module_4778 — dino_physics_jump extended, humanized desktop */
export interface In4778{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4778{y:number;vy:number;sc:number}
const C4778={g:0.5, j:13};
export function extraPhysics_4778(inp:In4778, dt:number):Out4778 {
...
export const mm4778={d:'dino_physics_jump'};