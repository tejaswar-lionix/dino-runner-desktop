/** dino_module_3655 — particle_fx extended, humanized desktop */
export interface In3655{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3655{y:number;vy:number;sc:number}
const C3655={g:0.6, j:12};
export function extraSpawn_3655(inp:In3655, dt:number):Out3655 {
...
export const mm3655={d:'particle_fx'};