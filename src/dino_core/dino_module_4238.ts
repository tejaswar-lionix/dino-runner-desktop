/** dino_module_4238 — particle_fx extended, humanized desktop */
export interface In4238{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4238{y:number;vy:number;sc:number}
const C4238={g:0.6, j:13};
export function extraPhysics_4238(inp:In4238, dt:number):Out4238 {
...
export const mm4238={d:'particle_fx'};