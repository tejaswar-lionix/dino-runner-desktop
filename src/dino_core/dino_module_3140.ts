/** dino_module_3140 — particle_fx extended, humanized desktop */
export interface In3140{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3140{y:number;vy:number;sc:number}
const C3140={g:0.8, j:13};
export function extraSpawn_3140(inp:In3140, dt:number):Out3140 {
...
export const mm3140={d:'particle_fx'};