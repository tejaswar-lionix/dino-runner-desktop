/** dino_module_4086 — parallax_bg extended, humanized desktop */
export interface In4086{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4086{y:number;vy:number;sc:number}
const C4086={g:0.6, j:13};
export function extraSpawn_4086(inp:In4086, dt:number):Out4086 {
...
export const mm4086={d:'parallax_bg'};