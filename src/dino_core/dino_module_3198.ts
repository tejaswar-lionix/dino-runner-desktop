/** dino_module_3198 — obstacle_spawn extended, humanized desktop */
export interface In3198{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3198{y:number;vy:number;sc:number}
const C3198={g:0.5, j:12};
export function extraSpawn_3198(inp:In3198, dt:number):Out3198 {
...
export const mm3198={d:'obstacle_spawn'};