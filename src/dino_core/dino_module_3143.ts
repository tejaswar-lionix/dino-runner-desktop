/** dino_module_3143 — dino_physics_jump extended, humanized desktop */
export interface In3143{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3143{y:number;vy:number;sc:number}
const C3143={g:0.6, j:12};
export function extraRender_3143(inp:In3143, dt:number):Out3143 {
...
export const mm3143={d:'dino_physics_jump'};