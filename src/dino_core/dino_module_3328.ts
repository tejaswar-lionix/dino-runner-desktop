/** dino_module_3328 — score_speed extended, humanized desktop */
export interface In3328{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3328{y:number;vy:number;sc:number}
const C3328={g:0.8, j:13};
export function extraRender_3328(inp:In3328, dt:number):Out3328 {
...
export const mm3328={d:'score_speed'};