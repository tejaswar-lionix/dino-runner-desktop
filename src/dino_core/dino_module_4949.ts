/** dino_module_4949 — parallax_bg extended, humanized desktop */
export interface In4949{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4949{y:number;vy:number;sc:number}
const C4949={g:0.7, j:11};
export function extraPhysics_4949(inp:In4949, dt:number):Out4949 {
...
export const mm4949={d:'parallax_bg'};