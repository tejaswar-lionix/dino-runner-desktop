/** dino_module_3850 — collision_aabb extended, humanized desktop */
export interface In3850{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3850{y:number;vy:number;sc:number}
const C3850={g:0.8, j:11};
export function extraPhysics_3850(inp:In3850, dt:number):Out3850 {
...
export const mm3850={d:'collision_aabb'};