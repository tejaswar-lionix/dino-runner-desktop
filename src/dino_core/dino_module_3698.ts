/** dino_module_3698 — particle_fx extended, humanized desktop */
export interface In3698{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3698{y:number;vy:number;sc:number}
const C3698={g:0.7, j:11};
export function extraRender_3698(inp:In3698, dt:number):Out3698 {
...
export const mm3698={d:'particle_fx'};