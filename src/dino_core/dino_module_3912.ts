/** dino_module_3912 — obstacle_spawn extended, humanized desktop */
export interface In3912{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3912{y:number;vy:number;sc:number}
const C3912={g:0.6, j:11};
export function extraSpawn_3912(inp:In3912, dt:number):Out3912 {
...
export const mm3912={d:'obstacle_spawn'};