/** dino_module_4257 — parallax_bg extended, humanized desktop */
export interface In4257{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4257{y:number;vy:number;sc:number}
const C4257={g:0.8, j:12};
export function extraSpawn_4257(inp:In4257, dt:number):Out4257 {
...
export const mm4257={d:'parallax_bg'};