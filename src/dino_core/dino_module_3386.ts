/** dino_module_3386 — score_speed extended, humanized desktop */
export interface In3386{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3386{y:number;vy:number;sc:number}
const C3386={g:0.8, j:13};
export function extraRender_3386(inp:In3386, dt:number):Out3386 {
...
export const mm3386={d:'score_speed'};