/** dino_module_4089 — particle_fx extended, humanized desktop */
export interface In4089{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4089{y:number;vy:number;sc:number}
const C4089={g:0.7, j:12};
export function extraPhysics_4089(inp:In4089, dt:number):Out4089 {
...
export const mm4089={d:'particle_fx'};