/** dino_module_4874 — dino_physics_jump extended, humanized desktop */
export interface In4874{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4874{y:number;vy:number;sc:number}
const C4874={g:0.6, j:11};
export function extraPhysics_4874(inp:In4874, dt:number):Out4874 {
...
export const mm4874={d:'dino_physics_jump'};