/** dino_module_3729 — particle_fx extended, humanized desktop */
export interface In3729{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3729{y:number;vy:number;sc:number}
const C3729={g:0.6, j:13};
export function extraPhysics_3729(inp:In3729, dt:number):Out3729 {
...
export const mm3729={d:'particle_fx'};