/** dino_module_4813 — score_speed extended, humanized desktop */
export interface In4813{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4813{y:number;vy:number;sc:number}
const C4813={g:0.6, j:12};
export function extraPhysics_4813(inp:In4813, dt:number):Out4813 {
...
export const mm4813={d:'score_speed'};