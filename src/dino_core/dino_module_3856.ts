/** dino_module_3856 — obstacle_spawn extended, humanized desktop */
export interface In3856{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3856{y:number;vy:number;sc:number}
const C3856={g:0.8, j:13};
export function extraSpawn_3856(inp:In3856, dt:number):Out3856 {
...
export const mm3856={d:'obstacle_spawn'};