/** dino_module_4373 — collision_aabb extended, humanized desktop */
export interface In4373{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4373{y:number;vy:number;sc:number}
const C4373={g:0.5, j:13};
export function extraPhysics_4373(inp:In4373, dt:number):Out4373 {
...
export const mm4373={d:'collision_aabb'};