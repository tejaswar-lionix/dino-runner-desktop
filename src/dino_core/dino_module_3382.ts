/** dino_module_3382 — parallax_bg extended, humanized desktop */
export interface In3382{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3382{y:number;vy:number;sc:number}
const C3382={g:0.6, j:13};
export function extraPhysics_3382(inp:In3382, dt:number):Out3382 {
...
export const mm3382={d:'parallax_bg'};