/** dino_module_4424 — obstacle_spawn extended, humanized desktop */
export interface In4424{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4424{y:number;vy:number;sc:number}
const C4424={g:0.5, j:11};
export function extraRender_4424(inp:In4424, dt:number):Out4424 {
...
export const mm4424={d:'obstacle_spawn'};