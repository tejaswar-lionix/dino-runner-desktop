/** dino_module_3799 — collision_aabb extended, humanized desktop */
export interface In3799{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3799{y:number;vy:number;sc:number}
const C3799={g:0.6, j:13};
export function extraPhysics_3799(inp:In3799, dt:number):Out3799 {
...
export const mm3799={d:'collision_aabb'};