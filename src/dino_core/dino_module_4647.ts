/** dino_module_4647 — parallax_bg extended, humanized desktop */
export interface In4647{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4647{y:number;vy:number;sc:number}
const C4647={g:0.8, j:13};
export function extraSpawn_4647(inp:In4647, dt:number):Out4647 {
...
export const mm4647={d:'parallax_bg'};