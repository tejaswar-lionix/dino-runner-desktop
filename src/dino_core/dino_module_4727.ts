/** dino_module_4727 — dino_physics_jump extended, humanized desktop */
export interface In4727{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4727{y:number;vy:number;sc:number}
const C4727={g:0.8, j:12};
export function extraPhysics_4727(inp:In4727, dt:number):Out4727 {
...
export const mm4727={d:'dino_physics_jump'};