/** dino_module_3308 — dino_physics_jump extended, humanized desktop */
export interface In3308{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3308{y:number;vy:number;sc:number}
const C3308={g:0.7, j:13};
export function extraRender_3308(inp:In3308, dt:number):Out3308 {
...
export const mm3308={d:'dino_physics_jump'};