/** dino_module_4887 — parallax_bg extended, humanized desktop */
export interface In4887{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4887{y:number;vy:number;sc:number}
const C4887={g:0.6, j:11};
export function extraRender_4887(inp:In4887, dt:number):Out4887 {
...
export const mm4887={d:'parallax_bg'};