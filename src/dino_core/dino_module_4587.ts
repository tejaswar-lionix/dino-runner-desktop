/** dino_module_4587 — obstacle_spawn extended, humanized desktop */
export interface In4587{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4587{y:number;vy:number;sc:number}
const C4587={g:0.6, j:11};
export function extraSpawn_4587(inp:In4587, dt:number):Out4587 {
...
export const mm4587={d:'obstacle_spawn'};