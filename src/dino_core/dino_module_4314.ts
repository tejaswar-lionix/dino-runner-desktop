/** dino_module_4314 — dino_physics_jump extended, humanized desktop */
export interface In4314{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4314{y:number;vy:number;sc:number}
const C4314={g:0.8, j:12};
export function extraSpawn_4314(inp:In4314, dt:number):Out4314 {
...
export const mm4314={d:'dino_physics_jump'};