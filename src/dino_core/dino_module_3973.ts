/** dino_module_3973 — particle_fx extended, humanized desktop */
export interface In3973{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3973{y:number;vy:number;sc:number}
const C3973={g:0.6, j:13};
export function extraPhysics_3973(inp:In3973, dt:number):Out3973 {
...
export const mm3973={d:'particle_fx'};