/** dino_module_4926 — particle_fx extended, humanized desktop */
export interface In4926{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4926{y:number;vy:number;sc:number}
const C4926={g:0.6, j:12};
export function extraPhysics_4926(inp:In4926, dt:number):Out4926 {
...
export const mm4926={d:'particle_fx'};