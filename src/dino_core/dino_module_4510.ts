/** dino_module_4510 — dino_physics_jump extended, humanized desktop */
export interface In4510{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4510{y:number;vy:number;sc:number}
const C4510={g:0.6, j:12};
export function extraRender_4510(inp:In4510, dt:number):Out4510 {
...
export const mm4510={d:'dino_physics_jump'};