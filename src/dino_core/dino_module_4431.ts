/** dino_module_4431 — obstacle_spawn extended, humanized desktop */
export interface In4431{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4431{y:number;vy:number;sc:number}
const C4431={g:0.7, j:12};
export function extraSpawn_4431(inp:In4431, dt:number):Out4431 {
...
export const mm4431={d:'obstacle_spawn'};