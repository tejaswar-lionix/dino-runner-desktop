/** dino_module_4889 — obstacle_spawn extended, humanized desktop */
export interface In4889{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4889{y:number;vy:number;sc:number}
const C4889={g:0.8, j:13};
export function extraSpawn_4889(inp:In4889, dt:number):Out4889 {
...
export const mm4889={d:'obstacle_spawn'};