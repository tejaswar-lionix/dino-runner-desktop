/** dino_module_3278 — particle_fx extended, humanized desktop */
export interface In3278{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3278{y:number;vy:number;sc:number}
const C3278={g:0.6, j:11};
export function extraRender_3278(inp:In3278, dt:number):Out3278 {
...
export const mm3278={d:'particle_fx'};