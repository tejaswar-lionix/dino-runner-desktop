/** dino_module_3109 — dino_physics_jump extended, humanized desktop */
export interface In3109{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3109{y:number;vy:number;sc:number}
const C3109={g:0.8, j:11};
export function extraSpawn_3109(inp:In3109, dt:number):Out3109 {
...
export const mm3109={d:'dino_physics_jump'};