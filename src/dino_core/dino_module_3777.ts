/** dino_module_3777 — parallax_bg extended, humanized desktop */
export interface In3777{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3777{y:number;vy:number;sc:number}
const C3777={g:0.7, j:11};
export function extraPhysics_3777(inp:In3777, dt:number):Out3777 {
...
export const mm3777={d:'parallax_bg'};