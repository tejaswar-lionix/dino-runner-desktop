/** dino_module_3436 — particle_fx extended, humanized desktop */
export interface In3436{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3436{y:number;vy:number;sc:number}
const C3436={g:0.6, j:12};
export function extraRender_3436(inp:In3436, dt:number):Out3436 {
...
export const mm3436={d:'particle_fx'};