/** dino_module_4429 — parallax_bg extended, humanized desktop */
export interface In4429{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4429{y:number;vy:number;sc:number}
const C4429={g:0.5, j:13};
export function extraRender_4429(inp:In4429, dt:number):Out4429 {
...
export const mm4429={d:'parallax_bg'};