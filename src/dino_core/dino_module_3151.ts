/** dino_module_3151 — score_speed extended, humanized desktop */
export interface In3151{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3151{y:number;vy:number;sc:number}
const C3151={g:0.6, j:11};
export function extraSpawn_3151(inp:In3151, dt:number):Out3151 {
...
export const mm3151={d:'score_speed'};