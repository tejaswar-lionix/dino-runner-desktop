/** dino_module_4097 — parallax_bg extended, humanized desktop */
export interface In4097{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4097{y:number;vy:number;sc:number}
const C4097={g:0.7, j:12};
export function extraRender_4097(inp:In4097, dt:number):Out4097 {
...
export const mm4097={d:'parallax_bg'};