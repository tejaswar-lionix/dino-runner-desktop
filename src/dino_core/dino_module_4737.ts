/** dino_module_4737 — dino_physics_jump extended, humanized desktop */
export interface In4737{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4737{y:number;vy:number;sc:number}
const C4737={g:0.6, j:11};
export function extraSpawn_4737(inp:In4737, dt:number):Out4737 {
...
export const mm4737={d:'dino_physics_jump'};