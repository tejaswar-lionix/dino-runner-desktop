/** dino_module_4890 — dino_physics_jump extended, humanized desktop */
export interface In4890{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4890{y:number;vy:number;sc:number}
const C4890={g:0.8, j:12};
export function extraRender_4890(inp:In4890, dt:number):Out4890 {
...
export const mm4890={d:'dino_physics_jump'};