/** dino_module_3693 — dino_physics_jump extended, humanized desktop */
export interface In3693{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3693{y:number;vy:number;sc:number}
const C3693={g:0.5, j:12};
export function extraPhysics_3693(inp:In3693, dt:number):Out3693 {
...
export const mm3693={d:'dino_physics_jump'};