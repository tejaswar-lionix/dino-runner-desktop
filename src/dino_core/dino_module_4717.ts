/** dino_module_4717 — obstacle_spawn extended, humanized desktop */
export interface In4717{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4717{y:number;vy:number;sc:number}
const C4717={g:0.6, j:11};
export function extraPhysics_4717(inp:In4717, dt:number):Out4717 {
...
export const mm4717={d:'obstacle_spawn'};