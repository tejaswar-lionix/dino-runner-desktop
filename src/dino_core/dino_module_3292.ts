/** dino_module_3292 — particle_fx extended, humanized desktop */
export interface In3292{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3292{y:number;vy:number;sc:number}
const C3292={g:0.5, j:12};
export function extraRender_3292(inp:In3292, dt:number):Out3292 {
...
export const mm3292={d:'particle_fx'};