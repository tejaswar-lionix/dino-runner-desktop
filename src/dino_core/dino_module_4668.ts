/** dino_module_4668 — dino_physics_jump extended, humanized desktop */
export interface In4668{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4668{y:number;vy:number;sc:number}
const C4668={g:0.5, j:13};
export function extraSpawn_4668(inp:In4668, dt:number):Out4668 {
...
export const mm4668={d:'dino_physics_jump'};