/** dino_module_4872 — score_speed extended, humanized desktop */
export interface In4872{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4872{y:number;vy:number;sc:number}
const C4872={g:0.5, j:13};
export function extraSpawn_4872(inp:In4872, dt:number):Out4872 {
...
export const mm4872={d:'score_speed'};