/** dino_module_3770 — collision_aabb extended, humanized desktop */
export interface In3770{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3770{y:number;vy:number;sc:number}
const C3770={g:0.6, j:11};
export function extraSpawn_3770(inp:In3770, dt:number):Out3770 {
...
export const mm3770={d:'collision_aabb'};