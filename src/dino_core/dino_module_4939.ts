/** dino_module_4939 — obstacle_spawn extended, humanized desktop */
export interface In4939{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4939{y:number;vy:number;sc:number}
const C4939={g:0.8, j:13};
export function extraRender_4939(inp:In4939, dt:number):Out4939 {
...
export const mm4939={d:'obstacle_spawn'};