/** dino_module_3974 — collision_aabb extended, humanized desktop */
export interface In3974{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3974{y:number;vy:number;sc:number}
const C3974={g:0.8, j:12};
export function extraSpawn_3974(inp:In3974, dt:number):Out3974 {
...
export const mm3974={d:'collision_aabb'};