/** dino_module_4781 — parallax_bg extended, humanized desktop */
export interface In4781{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4781{y:number;vy:number;sc:number}
const C4781={g:0.7, j:13};
export function extraRender_4781(inp:In4781, dt:number):Out4781 {
...
export const mm4781={d:'parallax_bg'};