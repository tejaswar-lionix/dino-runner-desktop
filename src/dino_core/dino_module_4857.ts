/** dino_module_4857 — dino_physics_jump extended, humanized desktop */
export interface In4857{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4857{y:number;vy:number;sc:number}
const C4857={g:0.6, j:12};
export function extraPhysics_4857(inp:In4857, dt:number):Out4857 {
...
export const mm4857={d:'dino_physics_jump'};