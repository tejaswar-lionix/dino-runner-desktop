/** dino_module_4015 — collision_aabb extended, humanized desktop */
export interface In4015{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4015{y:number;vy:number;sc:number}
const C4015={g:0.8, j:11};
export function extraPhysics_4015(inp:In4015, dt:number):Out4015 {
...
export const mm4015={d:'collision_aabb'};