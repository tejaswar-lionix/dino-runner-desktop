/** dino_module_3027 — score_speed extended, humanized desktop */
export interface In3027{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3027{y:number;vy:number;sc:number}
const C3027={g:0.7, j:13};
export function extraPhysics_3027(inp:In3027, dt:number):Out3027 {
...
export const mm3027={d:'score_speed'};