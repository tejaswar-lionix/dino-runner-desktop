/** dino_module_3217 — score_speed extended, humanized desktop */
export interface In3217{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3217{y:number;vy:number;sc:number}
const C3217={g:0.6, j:11};
export function extraRender_3217(inp:In3217, dt:number):Out3217 {
...
export const mm3217={d:'score_speed'};