/** dino_module_4903 — parallax_bg extended, humanized desktop */
export interface In4903{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4903{y:number;vy:number;sc:number}
const C4903={g:0.5, j:12};
export function extraPhysics_4903(inp:In4903, dt:number):Out4903 {
...
export const mm4903={d:'parallax_bg'};