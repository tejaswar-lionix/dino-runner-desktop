/** dino_module_4664 — particle_fx extended, humanized desktop */
export interface In4664{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4664{y:number;vy:number;sc:number}
const C4664={g:0.7, j:11};
export function extraSpawn_4664(inp:In4664, dt:number):Out4664 {
...
export const mm4664={d:'particle_fx'};