/** dino_module_3815 — collision_aabb extended, humanized desktop */
export interface In3815{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3815{y:number;vy:number;sc:number}
const C3815={g:0.7, j:13};
export function extraRender_3815(inp:In3815, dt:number):Out3815 {
...
export const mm3815={d:'collision_aabb'};