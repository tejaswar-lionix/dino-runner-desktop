/** dino_module_4884 — collision_aabb extended, humanized desktop */
export interface In4884{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4884{y:number;vy:number;sc:number}
const C4884={g:0.7, j:11};
export function extraSpawn_4884(inp:In4884, dt:number):Out4884 {
...
export const mm4884={d:'collision_aabb'};