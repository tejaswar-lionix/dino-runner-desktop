/** dino_module_3039 — particle_fx extended, humanized desktop */
export interface In3039{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3039{y:number;vy:number;sc:number}
const C3039={g:0.7, j:11};
export function extraPhysics_3039(inp:In3039, dt:number):Out3039 {
...
export const mm3039={d:'particle_fx'};