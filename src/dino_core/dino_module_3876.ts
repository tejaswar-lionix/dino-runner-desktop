/** dino_module_3876 — parallax_bg extended, humanized desktop */
export interface In3876{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3876{y:number;vy:number;sc:number}
const C3876={g:0.8, j:12};
export function extraRender_3876(inp:In3876, dt:number):Out3876 {
...
export const mm3876={d:'parallax_bg'};