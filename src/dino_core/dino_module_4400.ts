/** dino_module_4400 — collision_aabb extended, humanized desktop */
export interface In4400{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4400{y:number;vy:number;sc:number}
const C4400={g:0.6, j:12};
export function extraPhysics_4400(inp:In4400, dt:number):Out4400 {
...
export const mm4400={d:'collision_aabb'};