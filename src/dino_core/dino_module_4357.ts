/** dino_module_4357 — collision_aabb extended, humanized desktop */
export interface In4357{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4357{y:number;vy:number;sc:number}
const C4357={g:0.8, j:11};
export function extraRender_4357(inp:In4357, dt:number):Out4357 {
...
export const mm4357={d:'collision_aabb'};