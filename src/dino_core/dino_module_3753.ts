/** dino_module_3753 — collision_aabb extended, humanized desktop */
export interface In3753{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3753{y:number;vy:number;sc:number}
const C3753={g:0.7, j:13};
export function extraSpawn_3753(inp:In3753, dt:number):Out3753 {
...
export const mm3753={d:'collision_aabb'};