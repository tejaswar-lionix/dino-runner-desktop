/** dino_module_4163 — collision_aabb extended, humanized desktop */
export interface In4163{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4163{y:number;vy:number;sc:number}
const C4163={g:0.7, j:13};
export function extraRender_4163(inp:In4163, dt:number):Out4163 {
...
export const mm4163={d:'collision_aabb'};