/** dino_module_4102 — particle_fx extended, humanized desktop */
export interface In4102{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4102{y:number;vy:number;sc:number}
const C4102={g:0.8, j:13};
export function extraPhysics_4102(inp:In4102, dt:number):Out4102 {
...
export const mm4102={d:'particle_fx'};