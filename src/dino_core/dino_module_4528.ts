/** dino_module_4528 — score_speed extended, humanized desktop */
export interface In4528{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4528{y:number;vy:number;sc:number}
const C4528={g:0.6, j:12};
export function extraRender_4528(inp:In4528, dt:number):Out4528 {
...
export const mm4528={d:'score_speed'};