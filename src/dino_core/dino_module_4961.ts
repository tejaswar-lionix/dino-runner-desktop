/** dino_module_4961 — dino_physics_jump extended, humanized desktop */
export interface In4961{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4961{y:number;vy:number;sc:number}
const C4961={g:0.7, j:12};
export function extraRender_4961(inp:In4961, dt:number):Out4961 {
...
export const mm4961={d:'dino_physics_jump'};