/** dino_module_4581 — obstacle_spawn extended, humanized desktop */
export interface In4581{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4581{y:number;vy:number;sc:number}
const C4581={g:0.5, j:11};
export function extraPhysics_4581(inp:In4581, dt:number):Out4581 {
...
export const mm4581={d:'obstacle_spawn'};