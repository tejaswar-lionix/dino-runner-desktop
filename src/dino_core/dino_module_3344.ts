/** dino_module_3344 — particle_fx extended, humanized desktop */
export interface In3344{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3344{y:number;vy:number;sc:number}
const C3344={g:0.8, j:11};
export function extraPhysics_3344(inp:In3344, dt:number):Out3344 {
...
export const mm3344={d:'particle_fx'};