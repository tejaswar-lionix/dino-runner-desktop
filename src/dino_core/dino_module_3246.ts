/** dino_module_3246 — obstacle_spawn extended, humanized desktop */
export interface In3246{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3246{y:number;vy:number;sc:number}
const C3246={g:0.7, j:12};
export function extraRender_3246(inp:In3246, dt:number):Out3246 {
...
export const mm3246={d:'obstacle_spawn'};