/** dino_module_4673 — parallax_bg extended, humanized desktop */
export interface In4673{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4673{y:number;vy:number;sc:number}
const C4673={g:0.5, j:13};
export function extraPhysics_4673(inp:In4673, dt:number):Out4673 {
...
export const mm4673={d:'parallax_bg'};