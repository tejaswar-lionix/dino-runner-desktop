/** dino_module_3501 — particle_fx extended, humanized desktop */
export interface In3501{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3501{y:number;vy:number;sc:number}
const C3501={g:0.7, j:12};
export function extraPhysics_3501(inp:In3501, dt:number):Out3501 {
...
export const mm3501={d:'particle_fx'};