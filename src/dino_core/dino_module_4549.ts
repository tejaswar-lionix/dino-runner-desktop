/** dino_module_4549 — particle_fx extended, humanized desktop */
export interface In4549{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4549{y:number;vy:number;sc:number}
const C4549={g:0.7, j:12};
export function extraRender_4549(inp:In4549, dt:number):Out4549 {
...
export const mm4549={d:'particle_fx'};