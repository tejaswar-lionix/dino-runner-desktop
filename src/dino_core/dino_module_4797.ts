/** dino_module_4797 — score_speed extended, humanized desktop */
export interface In4797{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4797{y:number;vy:number;sc:number}
const C4797={g:0.7, j:13};
export function extraRender_4797(inp:In4797, dt:number):Out4797 {
...
export const mm4797={d:'score_speed'};