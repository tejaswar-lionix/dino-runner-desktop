/** dino_module_4259 — obstacle_spawn extended, humanized desktop */
export interface In4259{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4259{y:number;vy:number;sc:number}
const C4259={g:0.8, j:11};
export function extraPhysics_4259(inp:In4259, dt:number):Out4259 {
...
export const mm4259={d:'obstacle_spawn'};