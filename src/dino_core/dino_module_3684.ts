/** dino_module_3684 — parallax_bg extended, humanized desktop */
export interface In3684{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3684{y:number;vy:number;sc:number}
const C3684={g:0.8, j:11};
export function extraSpawn_3684(inp:In3684, dt:number):Out3684 {
...
export const mm3684={d:'parallax_bg'};