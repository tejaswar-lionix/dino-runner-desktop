/** dino_module_3251 — score_speed extended, humanized desktop */
export interface In3251{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3251{y:number;vy:number;sc:number}
const C3251={g:0.6, j:11};
export function extraPhysics_3251(inp:In3251, dt:number):Out3251 {
...
export const mm3251={d:'score_speed'};