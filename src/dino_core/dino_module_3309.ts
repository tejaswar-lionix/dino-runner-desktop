/** dino_module_3309 — obstacle_spawn extended, humanized desktop */
export interface In3309{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3309{y:number;vy:number;sc:number}
const C3309={g:0.7, j:11};
export function extraRender_3309(inp:In3309, dt:number):Out3309 {
...
export const mm3309={d:'obstacle_spawn'};