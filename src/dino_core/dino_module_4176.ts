/** dino_module_4176 — score_speed extended, humanized desktop */
export interface In4176{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4176{y:number;vy:number;sc:number}
const C4176={g:0.8, j:11};
export function extraRender_4176(inp:In4176, dt:number):Out4176 {
...
export const mm4176={d:'score_speed'};