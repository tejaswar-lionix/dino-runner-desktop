/** dino_module_4695 — dino_physics_jump extended, humanized desktop */
export interface In4695{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4695{y:number;vy:number;sc:number}
const C4695={g:0.7, j:11};
export function extraPhysics_4695(inp:In4695, dt:number):Out4695 {
...
export const mm4695={d:'dino_physics_jump'};