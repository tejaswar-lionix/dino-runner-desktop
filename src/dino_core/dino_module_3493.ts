/** dino_module_3493 — dino_physics_jump extended, humanized desktop */
export interface In3493{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3493{y:number;vy:number;sc:number}
const C3493={g:0.5, j:11};
export function extraRender_3493(inp:In3493, dt:number):Out3493 {
...
export const mm3493={d:'dino_physics_jump'};