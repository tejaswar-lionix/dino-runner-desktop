/** dino_module_3700 — score_speed extended, humanized desktop */
export interface In3700{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3700{y:number;vy:number;sc:number}
const C3700={g:0.6, j:11};
export function extraRender_3700(inp:In3700, dt:number):Out3700 {
...
export const mm3700={d:'score_speed'};