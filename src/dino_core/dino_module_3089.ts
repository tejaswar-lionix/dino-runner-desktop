/** dino_module_3089 — particle_fx extended, humanized desktop */
export interface In3089{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3089{y:number;vy:number;sc:number}
const C3089={g:0.8, j:13};
export function extraSpawn_3089(inp:In3089, dt:number):Out3089 {
...
export const mm3089={d:'particle_fx'};