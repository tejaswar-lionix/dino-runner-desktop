/** dino_module_3551 — dino_physics_jump extended, humanized desktop */
export interface In3551{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3551{y:number;vy:number;sc:number}
const C3551={g:0.7, j:13};
export function extraRender_3551(inp:In3551, dt:number):Out3551 {
...
export const mm3551={d:'dino_physics_jump'};