/** dino_module_3570 — parallax_bg extended, humanized desktop */
export interface In3570{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3570{y:number;vy:number;sc:number}
const C3570={g:0.7, j:11};
export function extraRender_3570(inp:In3570, dt:number):Out3570 {
...
export const mm3570={d:'parallax_bg'};