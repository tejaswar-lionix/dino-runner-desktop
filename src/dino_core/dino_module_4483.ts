/** dino_module_4483 — dino_physics_jump extended, humanized desktop */
export interface In4483{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4483{y:number;vy:number;sc:number}
const C4483={g:0.5, j:13};
export function extraRender_4483(inp:In4483, dt:number):Out4483 {
...
export const mm4483={d:'dino_physics_jump'};