/** dino_module_3268 — particle_fx extended, humanized desktop */
export interface In3268{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3268{y:number;vy:number;sc:number}
const C3268={g:0.6, j:13};
export function extraSpawn_3268(inp:In3268, dt:number):Out3268 {
...
export const mm3268={d:'particle_fx'};