/** dino_module_3133 — collision_aabb extended, humanized desktop */
export interface In3133{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3133{y:number;vy:number;sc:number}
const C3133={g:0.5, j:13};
export function extraRender_3133(inp:In3133, dt:number):Out3133 {
...
export const mm3133={d:'collision_aabb'};