/** dino_module_4091 — parallax_bg extended, humanized desktop */
export interface In4091{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4091{y:number;vy:number;sc:number}
const C4091={g:0.6, j:12};
export function extraRender_4091(inp:In4091, dt:number):Out4091 {
...
export const mm4091={d:'parallax_bg'};