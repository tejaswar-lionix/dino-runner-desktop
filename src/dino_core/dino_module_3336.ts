/** dino_module_3336 — score_speed extended, humanized desktop */
export interface In3336{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3336{y:number;vy:number;sc:number}
const C3336={g:0.5, j:13};
export function extraPhysics_3336(inp:In3336, dt:number):Out3336 {
...
export const mm3336={d:'score_speed'};