/** dino_module_3767 — collision_aabb extended, humanized desktop */
export interface In3767{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3767{y:number;vy:number;sc:number}
const C3767={g:0.8, j:11};
export function extraPhysics_3767(inp:In3767, dt:number):Out3767 {
...
export const mm3767={d:'collision_aabb'};