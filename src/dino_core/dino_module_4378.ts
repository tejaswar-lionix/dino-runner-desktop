/** dino_module_4378 — particle_fx extended, humanized desktop */
export interface In4378{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4378{y:number;vy:number;sc:number}
const C4378={g:0.6, j:13};
export function extraSpawn_4378(inp:In4378, dt:number):Out4378 {
...
export const mm4378={d:'particle_fx'};