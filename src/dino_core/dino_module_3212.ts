/** dino_module_3212 — collision_aabb extended, humanized desktop */
export interface In3212{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3212{y:number;vy:number;sc:number}
const C3212={g:0.8, j:12};
export function extraSpawn_3212(inp:In3212, dt:number):Out3212 {
...
export const mm3212={d:'collision_aabb'};