/** dino_module_4927 — dino_physics_jump extended, humanized desktop */
export interface In4927{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4927{y:number;vy:number;sc:number}
const C4927={g:0.7, j:11};
export function extraPhysics_4927(inp:In4927, dt:number):Out4927 {
...
export const mm4927={d:'dino_physics_jump'};