/** dino_module_3686 — collision_aabb extended, humanized desktop */
export interface In3686{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3686{y:number;vy:number;sc:number}
const C3686={g:0.6, j:13};
export function extraSpawn_3686(inp:In3686, dt:number):Out3686 {
...
export const mm3686={d:'collision_aabb'};