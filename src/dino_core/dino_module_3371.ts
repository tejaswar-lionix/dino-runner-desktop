/** dino_module_3371 — obstacle_spawn extended, humanized desktop */
export interface In3371{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3371{y:number;vy:number;sc:number}
const C3371={g:0.6, j:11};
export function extraPhysics_3371(inp:In3371, dt:number):Out3371 {
...
export const mm3371={d:'obstacle_spawn'};