/** dino_module_3037 — particle_fx extended, humanized desktop */
export interface In3037{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3037{y:number;vy:number;sc:number}
const C3037={g:0.5, j:11};
export function extraPhysics_3037(inp:In3037, dt:number):Out3037 {
...
export const mm3037={d:'particle_fx'};