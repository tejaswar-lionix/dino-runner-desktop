/** dino_module_4760 — collision_aabb extended, humanized desktop */
export interface In4760{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4760{y:number;vy:number;sc:number}
const C4760={g:0.6, j:11};
export function extraPhysics_4760(inp:In4760, dt:number):Out4760 {
...
export const mm4760={d:'collision_aabb'};