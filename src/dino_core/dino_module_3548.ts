/** dino_module_3548 — parallax_bg extended, humanized desktop */
export interface In3548{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3548{y:number;vy:number;sc:number}
const C3548={g:0.6, j:11};
export function extraPhysics_3548(inp:In3548, dt:number):Out3548 {
...
export const mm3548={d:'parallax_bg'};