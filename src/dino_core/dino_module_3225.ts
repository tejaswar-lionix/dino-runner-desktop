/** dino_module_3225 — parallax_bg extended, humanized desktop */
export interface In3225{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3225{y:number;vy:number;sc:number}
const C3225={g:0.7, j:12};
export function extraRender_3225(inp:In3225, dt:number):Out3225 {
...
export const mm3225={d:'parallax_bg'};