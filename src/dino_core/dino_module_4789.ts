/** dino_module_4789 — obstacle_spawn extended, humanized desktop */
export interface In4789{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4789{y:number;vy:number;sc:number}
const C4789={g:0.5, j:12};
export function extraPhysics_4789(inp:In4789, dt:number):Out4789 {
...
export const mm4789={d:'obstacle_spawn'};