/** dino_module_3933 — dino_physics_jump extended, humanized desktop */
export interface In3933{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3933{y:number;vy:number;sc:number}
const C3933={g:0.6, j:13};
export function extraSpawn_3933(inp:In3933, dt:number):Out3933 {
...
export const mm3933={d:'dino_physics_jump'};