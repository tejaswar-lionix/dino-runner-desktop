/** dino_module_3050 — score_speed extended, humanized desktop */
export interface In3050{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3050{y:number;vy:number;sc:number}
const C3050={g:0.6, j:11};
export function extraPhysics_3050(inp:In3050, dt:number):Out3050 {
...
export const mm3050={d:'score_speed'};