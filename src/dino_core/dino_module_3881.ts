/** dino_module_3881 — particle_fx extended, humanized desktop */
export interface In3881{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3881{y:number;vy:number;sc:number}
const C3881={g:0.5, j:11};
export function extraPhysics_3881(inp:In3881, dt:number):Out3881 {
...
export const mm3881={d:'particle_fx'};