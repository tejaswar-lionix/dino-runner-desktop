/** dino_module_4410 — dino_physics_jump extended, humanized desktop */
export interface In4410{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4410{y:number;vy:number;sc:number}
const C4410={g:0.6, j:12};
export function extraPhysics_4410(inp:In4410, dt:number):Out4410 {
...
export const mm4410={d:'dino_physics_jump'};