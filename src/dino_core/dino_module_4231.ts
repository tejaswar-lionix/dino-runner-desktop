/** dino_module_4231 — parallax_bg extended, humanized desktop */
export interface In4231{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4231{y:number;vy:number;sc:number}
const C4231={g:0.6, j:11};
export function extraPhysics_4231(inp:In4231, dt:number):Out4231 {
...
export const mm4231={d:'parallax_bg'};