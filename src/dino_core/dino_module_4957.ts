/** dino_module_4957 — particle_fx extended, humanized desktop */
export interface In4957{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4957{y:number;vy:number;sc:number}
const C4957={g:0.7, j:12};
export function extraPhysics_4957(inp:In4957, dt:number):Out4957 {
...
export const mm4957={d:'particle_fx'};