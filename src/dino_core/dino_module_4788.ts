/** dino_module_4788 — score_speed extended, humanized desktop */
export interface In4788{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4788{y:number;vy:number;sc:number}
const C4788={g:0.7, j:13};
export function extraPhysics_4788(inp:In4788, dt:number):Out4788 {
...
export const mm4788={d:'score_speed'};