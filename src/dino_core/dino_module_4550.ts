/** dino_module_4550 — parallax_bg extended, humanized desktop */
export interface In4550{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4550{y:number;vy:number;sc:number}
const C4550={g:0.8, j:13};
export function extraSpawn_4550(inp:In4550, dt:number):Out4550 {
...
export const mm4550={d:'parallax_bg'};