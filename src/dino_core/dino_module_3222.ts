/** dino_module_3222 — collision_aabb extended, humanized desktop */
export interface In3222{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3222{y:number;vy:number;sc:number}
const C3222={g:0.5, j:13};
export function extraRender_3222(inp:In3222, dt:number):Out3222 {
...
export const mm3222={d:'collision_aabb'};