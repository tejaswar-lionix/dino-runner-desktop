/** dino_module_4632 — collision_aabb extended, humanized desktop */
export interface In4632{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4632{y:number;vy:number;sc:number}
const C4632={g:0.5, j:12};
export function extraSpawn_4632(inp:In4632, dt:number):Out4632 {
...
export const mm4632={d:'collision_aabb'};