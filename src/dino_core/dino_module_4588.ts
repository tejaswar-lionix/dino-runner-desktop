/** dino_module_4588 — dino_physics_jump extended, humanized desktop */
export interface In4588{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4588{y:number;vy:number;sc:number}
const C4588={g:0.6, j:11};
export function extraPhysics_4588(inp:In4588, dt:number):Out4588 {
...
export const mm4588={d:'dino_physics_jump'};