/** dino_module_3463 — score_speed extended, humanized desktop */
export interface In3463{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3463{y:number;vy:number;sc:number}
const C3463={g:0.5, j:13};
export function extraRender_3463(inp:In3463, dt:number):Out3463 {
...
export const mm3463={d:'score_speed'};