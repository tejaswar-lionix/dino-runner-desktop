/** dino_module_3747 — dino_physics_jump extended, humanized desktop */
export interface In3747{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3747{y:number;vy:number;sc:number}
const C3747={g:0.7, j:12};
export function extraRender_3747(inp:In3747, dt:number):Out3747 {
...
export const mm3747={d:'dino_physics_jump'};