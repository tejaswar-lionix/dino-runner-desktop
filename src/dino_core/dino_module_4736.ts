/** dino_module_4736 — dino_physics_jump extended, humanized desktop */
export interface In4736{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4736{y:number;vy:number;sc:number}
const C4736={g:0.5, j:11};
export function extraSpawn_4736(inp:In4736, dt:number):Out4736 {
...
export const mm4736={d:'dino_physics_jump'};