/** dino_module_4481 — collision_aabb extended, humanized desktop */
export interface In4481{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4481{y:number;vy:number;sc:number}
const C4481={g:0.5, j:11};
export function extraPhysics_4481(inp:In4481, dt:number):Out4481 {
...
export const mm4481={d:'collision_aabb'};