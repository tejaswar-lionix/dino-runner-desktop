/** dino_module_3771 — parallax_bg extended, humanized desktop */
export interface In3771{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3771{y:number;vy:number;sc:number}
const C3771={g:0.6, j:11};
export function extraPhysics_3771(inp:In3771, dt:number):Out3771 {
...
export const mm3771={d:'parallax_bg'};