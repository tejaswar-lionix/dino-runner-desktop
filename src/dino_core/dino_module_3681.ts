/** dino_module_3681 — collision_aabb extended, humanized desktop */
export interface In3681{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3681{y:number;vy:number;sc:number}
const C3681={g:0.8, j:13};
export function extraPhysics_3681(inp:In3681, dt:number):Out3681 {
...
export const mm3681={d:'collision_aabb'};