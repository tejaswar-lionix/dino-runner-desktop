/** dino_module_4402 — obstacle_spawn extended, humanized desktop */
export interface In4402{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4402{y:number;vy:number;sc:number}
const C4402={g:0.6, j:12};
export function extraSpawn_4402(inp:In4402, dt:number):Out4402 {
...
export const mm4402={d:'obstacle_spawn'};