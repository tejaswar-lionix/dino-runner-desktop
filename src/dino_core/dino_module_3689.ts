/** dino_module_3689 — collision_aabb extended, humanized desktop */
export interface In3689{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3689{y:number;vy:number;sc:number}
const C3689={g:0.8, j:12};
export function extraSpawn_3689(inp:In3689, dt:number):Out3689 {
...
export const mm3689={d:'collision_aabb'};