/** dino_module_3936 — score_speed extended, humanized desktop */
export interface In3936{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3936{y:number;vy:number;sc:number}
const C3936={g:0.7, j:12};
export function extraRender_3936(inp:In3936, dt:number):Out3936 {
...
export const mm3936={d:'score_speed'};