/** dino_module_3184 — parallax_bg extended, humanized desktop */
export interface In3184{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3184{y:number;vy:number;sc:number}
const C3184={g:0.5, j:11};
export function extraSpawn_3184(inp:In3184, dt:number):Out3184 {
...
export const mm3184={d:'parallax_bg'};