/** dino_module_4580 — collision_aabb extended, humanized desktop */
export interface In4580{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4580{y:number;vy:number;sc:number}
const C4580={g:0.6, j:13};
export function extraRender_4580(inp:In4580, dt:number):Out4580 {
...
export const mm4580={d:'collision_aabb'};