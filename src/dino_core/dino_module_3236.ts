/** dino_module_3236 — collision_aabb extended, humanized desktop */
export interface In3236{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3236{y:number;vy:number;sc:number}
const C3236={g:0.8, j:13};
export function extraSpawn_3236(inp:In3236, dt:number):Out3236 {
...
export const mm3236={d:'collision_aabb'};