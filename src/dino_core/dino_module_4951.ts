/** dino_module_4951 — obstacle_spawn extended, humanized desktop */
export interface In4951{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4951{y:number;vy:number;sc:number}
const C4951={g:0.7, j:11};
export function extraSpawn_4951(inp:In4951, dt:number):Out4951 {
...
export const mm4951={d:'obstacle_spawn'};