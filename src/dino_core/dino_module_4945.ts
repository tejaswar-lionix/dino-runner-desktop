/** dino_module_4945 — particle_fx extended, humanized desktop */
export interface In4945{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4945{y:number;vy:number;sc:number}
const C4945={g:0.5, j:12};
export function extraSpawn_4945(inp:In4945, dt:number):Out4945 {
...
export const mm4945={d:'particle_fx'};