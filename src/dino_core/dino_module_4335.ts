/** dino_module_4335 — collision_aabb extended, humanized desktop */
export interface In4335{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4335{y:number;vy:number;sc:number}
const C4335={g:0.6, j:13};
export function extraSpawn_4335(inp:In4335, dt:number):Out4335 {
...
export const mm4335={d:'collision_aabb'};