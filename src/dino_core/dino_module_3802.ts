/** dino_module_3802 — dino_physics_jump extended, humanized desktop */
export interface In3802{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3802{y:number;vy:number;sc:number}
const C3802={g:0.5, j:13};
export function extraRender_3802(inp:In3802, dt:number):Out3802 {
...
export const mm3802={d:'dino_physics_jump'};