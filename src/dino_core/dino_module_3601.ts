/** dino_module_3601 — collision_aabb extended, humanized desktop */
export interface In3601{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3601{y:number;vy:number;sc:number}
const C3601={g:0.5, j:13};
export function extraPhysics_3601(inp:In3601, dt:number):Out3601 {
...
export const mm3601={d:'collision_aabb'};