/** dino_module_3812 — parallax_bg extended, humanized desktop */
export interface In3812{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3812{y:number;vy:number;sc:number}
const C3812={g:0.7, j:12};
export function extraSpawn_3812(inp:In3812, dt:number):Out3812 {
...
export const mm3812={d:'parallax_bg'};