/** dino_module_3610 — obstacle_spawn extended, humanized desktop */
export interface In3610{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3610{y:number;vy:number;sc:number}
const C3610={g:0.6, j:13};
export function extraRender_3610(inp:In3610, dt:number):Out3610 {
...
export const mm3610={d:'obstacle_spawn'};