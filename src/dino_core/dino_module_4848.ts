/** dino_module_4848 — collision_aabb extended, humanized desktop */
export interface In4848{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4848{y:number;vy:number;sc:number}
const C4848={g:0.6, j:11};
export function extraPhysics_4848(inp:In4848, dt:number):Out4848 {
...
export const mm4848={d:'collision_aabb'};