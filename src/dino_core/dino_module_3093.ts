/** dino_module_3093 — score_speed extended, humanized desktop */
export interface In3093{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3093{y:number;vy:number;sc:number}
const C3093={g:0.7, j:13};
export function extraRender_3093(inp:In3093, dt:number):Out3093 {
...
export const mm3093={d:'score_speed'};