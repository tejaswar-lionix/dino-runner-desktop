/** dino_module_4740 — score_speed extended, humanized desktop */
export interface In4740{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4740{y:number;vy:number;sc:number}
const C4740={g:0.6, j:13};
export function extraSpawn_4740(inp:In4740, dt:number):Out4740 {
...
export const mm4740={d:'score_speed'};