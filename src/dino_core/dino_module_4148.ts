/** dino_module_4148 — dino_physics_jump extended, humanized desktop */
export interface In4148{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4148{y:number;vy:number;sc:number}
const C4148={g:0.6, j:13};
export function extraPhysics_4148(inp:In4148, dt:number):Out4148 {
...
export const mm4148={d:'dino_physics_jump'};