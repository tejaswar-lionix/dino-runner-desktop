/** dino_module_4352 — obstacle_spawn extended, humanized desktop */
export interface In4352{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4352{y:number;vy:number;sc:number}
const C4352={g:0.6, j:13};
export function extraSpawn_4352(inp:In4352, dt:number):Out4352 {
...
export const mm4352={d:'obstacle_spawn'};