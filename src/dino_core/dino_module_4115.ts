/** dino_module_4115 — dino_physics_jump extended, humanized desktop */
export interface In4115{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4115{y:number;vy:number;sc:number}
const C4115={g:0.8, j:11};
export function extraRender_4115(inp:In4115, dt:number):Out4115 {
...
export const mm4115={d:'dino_physics_jump'};