/** dino_module_3613 — obstacle_spawn extended, humanized desktop */
export interface In3613{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3613{y:number;vy:number;sc:number}
const C3613={g:0.7, j:13};
export function extraSpawn_3613(inp:In3613, dt:number):Out3613 {
...
export const mm3613={d:'obstacle_spawn'};