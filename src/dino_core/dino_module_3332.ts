/** dino_module_3332 — parallax_bg extended, humanized desktop */
export interface In3332{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3332{y:number;vy:number;sc:number}
const C3332={g:0.6, j:11};
export function extraSpawn_3332(inp:In3332, dt:number):Out3332 {
...
export const mm3332={d:'parallax_bg'};