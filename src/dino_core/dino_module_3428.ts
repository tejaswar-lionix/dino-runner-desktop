/** dino_module_3428 — dino_physics_jump extended, humanized desktop */
export interface In3428{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3428{y:number;vy:number;sc:number}
const C3428={g:0.6, j:12};
export function extraRender_3428(inp:In3428, dt:number):Out3428 {
...
export const mm3428={d:'dino_physics_jump'};