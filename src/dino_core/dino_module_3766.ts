/** dino_module_3766 — score_speed extended, humanized desktop */
export interface In3766{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3766{y:number;vy:number;sc:number}
const C3766={g:0.7, j:13};
export function extraRender_3766(inp:In3766, dt:number):Out3766 {
...
export const mm3766={d:'score_speed'};