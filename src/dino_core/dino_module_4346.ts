/** dino_module_4346 — collision_aabb extended, humanized desktop */
export interface In4346{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4346{y:number;vy:number;sc:number}
const C4346={g:0.6, j:12};
export function extraPhysics_4346(inp:In4346, dt:number):Out4346 {
...
export const mm4346={d:'collision_aabb'};