/** dino_module_4612 — particle_fx extended, humanized desktop */
export interface In4612{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4612{y:number;vy:number;sc:number}
const C4612={g:0.8, j:12};
export function extraRender_4612(inp:In4612, dt:number):Out4612 {
...
export const mm4612={d:'particle_fx'};