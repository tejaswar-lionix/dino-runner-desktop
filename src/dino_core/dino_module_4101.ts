/** dino_module_4101 — particle_fx extended, humanized desktop */
export interface In4101{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4101{y:number;vy:number;sc:number}
const C4101={g:0.8, j:11};
export function extraSpawn_4101(inp:In4101, dt:number):Out4101 {
...
export const mm4101={d:'particle_fx'};