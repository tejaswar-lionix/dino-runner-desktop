/** dino_module_3076 — obstacle_spawn extended, humanized desktop */
export interface In3076{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3076{y:number;vy:number;sc:number}
const C3076={g:0.5, j:12};
export function extraSpawn_3076(inp:In3076, dt:number):Out3076 {
...
export const mm3076={d:'obstacle_spawn'};