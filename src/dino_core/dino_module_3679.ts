/** dino_module_3679 — collision_aabb extended, humanized desktop */
export interface In3679{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3679{y:number;vy:number;sc:number}
const C3679={g:0.8, j:11};
export function extraSpawn_3679(inp:In3679, dt:number):Out3679 {
...
export const mm3679={d:'collision_aabb'};