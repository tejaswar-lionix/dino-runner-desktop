/** dino_module_3793 — obstacle_spawn extended, humanized desktop */
export interface In3793{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3793{y:number;vy:number;sc:number}
const C3793={g:0.5, j:11};
export function extraPhysics_3793(inp:In3793, dt:number):Out3793 {
...
export const mm3793={d:'obstacle_spawn'};