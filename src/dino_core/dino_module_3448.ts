/** dino_module_3448 — parallax_bg extended, humanized desktop */
export interface In3448{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3448{y:number;vy:number;sc:number}
const C3448={g:0.8, j:12};
export function extraPhysics_3448(inp:In3448, dt:number):Out3448 {
...
export const mm3448={d:'parallax_bg'};