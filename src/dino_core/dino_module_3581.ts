/** dino_module_3581 — score_speed extended, humanized desktop */
export interface In3581{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3581{y:number;vy:number;sc:number}
const C3581={g:0.7, j:11};
export function extraRender_3581(inp:In3581, dt:number):Out3581 {
...
export const mm3581={d:'score_speed'};