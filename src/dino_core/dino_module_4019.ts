/** dino_module_4019 — collision_aabb extended, humanized desktop */
export interface In4019{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4019{y:number;vy:number;sc:number}
const C4019={g:0.6, j:12};
export function extraRender_4019(inp:In4019, dt:number):Out4019 {
...
export const mm4019={d:'collision_aabb'};