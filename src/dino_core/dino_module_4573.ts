/** dino_module_4573 — particle_fx extended, humanized desktop */
export interface In4573{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4573{y:number;vy:number;sc:number}
const C4573={g:0.6, j:11};
export function extraRender_4573(inp:In4573, dt:number):Out4573 {
...
export const mm4573={d:'particle_fx'};