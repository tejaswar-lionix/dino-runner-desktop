/** dino_module_3922 — score_speed extended, humanized desktop */
export interface In3922{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3922{y:number;vy:number;sc:number}
const C3922={g:0.5, j:13};
export function extraRender_3922(inp:In3922, dt:number):Out3922 {
...
export const mm3922={d:'score_speed'};