/** dino_module_4655 — dino_physics_jump extended, humanized desktop */
export interface In4655{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4655{y:number;vy:number;sc:number}
const C4655={g:0.6, j:11};
export function extraSpawn_4655(inp:In4655, dt:number):Out4655 {
...
export const mm4655={d:'dino_physics_jump'};