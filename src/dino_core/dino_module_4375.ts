/** dino_module_4375 — dino_physics_jump extended, humanized desktop */
export interface In4375{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4375{y:number;vy:number;sc:number}
const C4375={g:0.6, j:12};
export function extraPhysics_4375(inp:In4375, dt:number):Out4375 {
...
export const mm4375={d:'dino_physics_jump'};