/** dino_module_4885 — dino_physics_jump extended, humanized desktop */
export interface In4885{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4885{y:number;vy:number;sc:number}
const C4885={g:0.5, j:13};
export function extraRender_4885(inp:In4885, dt:number):Out4885 {
...
export const mm4885={d:'dino_physics_jump'};