/** dino_module_3819 — collision_aabb extended, humanized desktop */
export interface In3819{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3819{y:number;vy:number;sc:number}
const C3819={g:0.7, j:13};
export function extraSpawn_3819(inp:In3819, dt:number):Out3819 {
...
export const mm3819={d:'collision_aabb'};