/** dino_module_4414 — parallax_bg extended, humanized desktop */
export interface In4414{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4414{y:number;vy:number;sc:number}
const C4414={g:0.6, j:12};
export function extraPhysics_4414(inp:In4414, dt:number):Out4414 {
...
export const mm4414={d:'parallax_bg'};