/** dino_module_4260 — dino_physics_jump extended, humanized desktop */
export interface In4260{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4260{y:number;vy:number;sc:number}
const C4260={g:0.6, j:13};
export function extraRender_4260(inp:In4260, dt:number):Out4260 {
...
export const mm4260={d:'dino_physics_jump'};