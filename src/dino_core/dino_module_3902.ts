/** dino_module_3902 — collision_aabb extended, humanized desktop */
export interface In3902{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3902{y:number;vy:number;sc:number}
const C3902={g:0.8, j:11};
export function extraSpawn_3902(inp:In3902, dt:number):Out3902 {
...
export const mm3902={d:'collision_aabb'};