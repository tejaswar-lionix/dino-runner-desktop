/** dino_module_4955 — score_speed extended, humanized desktop */
export interface In4955{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4955{y:number;vy:number;sc:number}
const C4955={g:0.5, j:11};
export function extraPhysics_4955(inp:In4955, dt:number):Out4955 {
...
export const mm4955={d:'score_speed'};