/** dino_module_3094 — score_speed extended, humanized desktop */
export interface In3094{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3094{y:number;vy:number;sc:number}
const C3094={g:0.6, j:11};
export function extraPhysics_3094(inp:In3094, dt:number):Out3094 {
...
export const mm3094={d:'score_speed'};