/** dino_module_4745 — score_speed extended, humanized desktop */
export interface In4745{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4745{y:number;vy:number;sc:number}
const C4745={g:0.6, j:12};
export function extraSpawn_4745(inp:In4745, dt:number):Out4745 {
...
export const mm4745={d:'score_speed'};