/** dino_module_3837 — dino_physics_jump extended, humanized desktop */
export interface In3837{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3837{y:number;vy:number;sc:number}
const C3837={g:0.6, j:13};
export function extraSpawn_3837(inp:In3837, dt:number):Out3837 {
...
export const mm3837={d:'dino_physics_jump'};