/** dino_module_3442 — dino_physics_jump extended, humanized desktop */
export interface In3442{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3442{y:number;vy:number;sc:number}
const C3442={g:0.5, j:12};
export function extraSpawn_3442(inp:In3442, dt:number):Out3442 {
...
export const mm3442={d:'dino_physics_jump'};