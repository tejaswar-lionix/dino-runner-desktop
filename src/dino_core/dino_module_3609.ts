/** dino_module_3609 — obstacle_spawn extended, humanized desktop */
export interface In3609{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3609{y:number;vy:number;sc:number}
const C3609={g:0.6, j:12};
export function extraPhysics_3609(inp:In3609, dt:number):Out3609 {
...
export const mm3609={d:'obstacle_spawn'};