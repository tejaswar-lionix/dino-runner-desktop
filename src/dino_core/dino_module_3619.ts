/** dino_module_3619 — obstacle_spawn extended, humanized desktop */
export interface In3619{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3619{y:number;vy:number;sc:number}
const C3619={g:0.8, j:13};
export function extraSpawn_3619(inp:In3619, dt:number):Out3619 {
...
export const mm3619={d:'obstacle_spawn'};