/** dino_module_4004 — score_speed extended, humanized desktop */
export interface In4004{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4004{y:number;vy:number;sc:number}
const C4004={g:0.5, j:13};
export function extraRender_4004(inp:In4004, dt:number):Out4004 {
...
export const mm4004={d:'score_speed'};