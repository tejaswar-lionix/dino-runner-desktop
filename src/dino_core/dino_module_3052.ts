/** dino_module_3052 — obstacle_spawn extended, humanized desktop */
export interface In3052{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3052{y:number;vy:number;sc:number}
const C3052={g:0.7, j:13};
export function extraSpawn_3052(inp:In3052, dt:number):Out3052 {
...
export const mm3052={d:'obstacle_spawn'};