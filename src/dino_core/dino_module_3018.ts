/** dino_module_3018 — score_speed extended, humanized desktop */
export interface In3018{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3018{y:number;vy:number;sc:number}
const C3018={g:0.5, j:13};
export function extraRender_3018(inp:In3018, dt:number):Out3018 {
...
export const mm3018={d:'score_speed'};