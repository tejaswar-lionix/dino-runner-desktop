/** dino_module_3126 — parallax_bg extended, humanized desktop */
export interface In3126{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3126{y:number;vy:number;sc:number}
const C3126={g:0.7, j:13};
export function extraSpawn_3126(inp:In3126, dt:number):Out3126 {
...
export const mm3126={d:'parallax_bg'};