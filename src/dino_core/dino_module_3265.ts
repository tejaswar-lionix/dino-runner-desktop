/** dino_module_3265 — dino_physics_jump extended, humanized desktop */
export interface In3265{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3265{y:number;vy:number;sc:number}
const C3265={g:0.6, j:11};
export function extraSpawn_3265(inp:In3265, dt:number):Out3265 {
...
export const mm3265={d:'dino_physics_jump'};