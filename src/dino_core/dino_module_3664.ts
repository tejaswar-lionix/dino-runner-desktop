/** dino_module_3664 — parallax_bg extended, humanized desktop */
export interface In3664{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3664{y:number;vy:number;sc:number}
const C3664={g:0.5, j:13};
export function extraPhysics_3664(inp:In3664, dt:number):Out3664 {
...
export const mm3664={d:'parallax_bg'};