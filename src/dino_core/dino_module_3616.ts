/** dino_module_3616 — dino_physics_jump extended, humanized desktop */
export interface In3616{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3616{y:number;vy:number;sc:number}
const C3616={g:0.5, j:12};
export function extraPhysics_3616(inp:In3616, dt:number):Out3616 {
...
export const mm3616={d:'dino_physics_jump'};