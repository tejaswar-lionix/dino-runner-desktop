/** dino_module_4864 — score_speed extended, humanized desktop */
export interface In4864{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4864{y:number;vy:number;sc:number}
const C4864={g:0.5, j:12};
export function extraSpawn_4864(inp:In4864, dt:number):Out4864 {
...
export const mm4864={d:'score_speed'};