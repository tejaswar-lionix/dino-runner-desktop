/** dino_module_4948 — collision_aabb extended, humanized desktop */
export interface In4948{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4948{y:number;vy:number;sc:number}
const C4948={g:0.7, j:11};
export function extraPhysics_4948(inp:In4948, dt:number):Out4948 {
...
export const mm4948={d:'collision_aabb'};