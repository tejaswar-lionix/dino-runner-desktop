/** dino_module_4730 — collision_aabb extended, humanized desktop */
export interface In4730{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4730{y:number;vy:number;sc:number}
const C4730={g:0.6, j:12};
export function extraRender_4730(inp:In4730, dt:number):Out4730 {
...
export const mm4730={d:'collision_aabb'};