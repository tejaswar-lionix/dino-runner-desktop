/** dino_module_3425 — dino_physics_jump extended, humanized desktop */
export interface In3425{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3425{y:number;vy:number;sc:number}
const C3425={g:0.5, j:11};
export function extraPhysics_3425(inp:In3425, dt:number):Out3425 {
...
export const mm3425={d:'dino_physics_jump'};