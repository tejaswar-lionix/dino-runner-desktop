/** dino_module_4105 — particle_fx extended, humanized desktop */
export interface In4105{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4105{y:number;vy:number;sc:number}
const C4105={g:0.5, j:13};
export function extraSpawn_4105(inp:In4105, dt:number):Out4105 {
...
export const mm4105={d:'particle_fx'};