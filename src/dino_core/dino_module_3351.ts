/** dino_module_3351 — collision_aabb extended, humanized desktop */
export interface In3351{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3351{y:number;vy:number;sc:number}
const C3351={g:0.5, j:12};
export function extraPhysics_3351(inp:In3351, dt:number):Out3351 {
...
export const mm3351={d:'collision_aabb'};