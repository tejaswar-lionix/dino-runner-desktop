/** dino_module_4538 — particle_fx extended, humanized desktop */
export interface In4538{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4538{y:number;vy:number;sc:number}
const C4538={g:0.5, j:11};
export function extraSpawn_4538(inp:In4538, dt:number):Out4538 {
...
export const mm4538={d:'particle_fx'};