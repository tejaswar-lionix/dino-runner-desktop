/** dino_module_3977 — dino_physics_jump extended, humanized desktop */
export interface In3977{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3977{y:number;vy:number;sc:number}
const C3977={g:0.8, j:13};
export function extraSpawn_3977(inp:In3977, dt:number):Out3977 {
...
export const mm3977={d:'dino_physics_jump'};