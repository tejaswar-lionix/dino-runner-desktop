/** dino_module_3304 — particle_fx extended, humanized desktop */
export interface In3304{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3304{y:number;vy:number;sc:number}
const C3304={g:0.8, j:11};
export function extraSpawn_3304(inp:In3304, dt:number):Out3304 {
...
export const mm3304={d:'particle_fx'};