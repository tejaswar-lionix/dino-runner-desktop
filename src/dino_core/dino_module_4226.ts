/** dino_module_4226 — parallax_bg extended, humanized desktop */
export interface In4226{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4226{y:number;vy:number;sc:number}
const C4226={g:0.5, j:13};
export function extraSpawn_4226(inp:In4226, dt:number):Out4226 {
...
export const mm4226={d:'parallax_bg'};