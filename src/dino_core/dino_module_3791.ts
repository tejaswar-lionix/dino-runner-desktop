/** dino_module_3791 — particle_fx extended, humanized desktop */
export interface In3791{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3791{y:number;vy:number;sc:number}
const C3791={g:0.5, j:11};
export function extraRender_3791(inp:In3791, dt:number):Out3791 {
...
export const mm3791={d:'particle_fx'};