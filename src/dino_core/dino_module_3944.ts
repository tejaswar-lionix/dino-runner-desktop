/** dino_module_3944 — score_speed extended, humanized desktop */
export interface In3944{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3944{y:number;vy:number;sc:number}
const C3944={g:0.7, j:13};
export function extraRender_3944(inp:In3944, dt:number):Out3944 {
...
export const mm3944={d:'score_speed'};