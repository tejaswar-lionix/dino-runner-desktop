/** dino_module_4395 — particle_fx extended, humanized desktop */
export interface In4395{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4395{y:number;vy:number;sc:number}
const C4395={g:0.6, j:13};
export function extraRender_4395(inp:In4395, dt:number):Out4395 {
...
export const mm4395={d:'particle_fx'};