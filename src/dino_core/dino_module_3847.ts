/** dino_module_3847 — score_speed extended, humanized desktop */
export interface In3847{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3847{y:number;vy:number;sc:number}
const C3847={g:0.8, j:11};
export function extraSpawn_3847(inp:In3847, dt:number):Out3847 {
...
export const mm3847={d:'score_speed'};