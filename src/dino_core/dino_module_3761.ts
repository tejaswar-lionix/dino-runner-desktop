/** dino_module_3761 — collision_aabb extended, humanized desktop */
export interface In3761{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3761{y:number;vy:number;sc:number}
const C3761={g:0.6, j:11};
export function extraPhysics_3761(inp:In3761, dt:number):Out3761 {
...
export const mm3761={d:'collision_aabb'};