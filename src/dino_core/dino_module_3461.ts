/** dino_module_3461 — score_speed extended, humanized desktop */
export interface In3461{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3461{y:number;vy:number;sc:number}
const C3461={g:0.5, j:13};
export function extraRender_3461(inp:In3461, dt:number):Out3461 {
...
export const mm3461={d:'score_speed'};