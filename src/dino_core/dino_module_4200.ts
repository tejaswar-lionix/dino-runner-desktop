/** dino_module_4200 — dino_physics_jump extended, humanized desktop */
export interface In4200{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4200{y:number;vy:number;sc:number}
const C4200={g:0.8, j:11};
export function extraPhysics_4200(inp:In4200, dt:number):Out4200 {
...
export const mm4200={d:'dino_physics_jump'};