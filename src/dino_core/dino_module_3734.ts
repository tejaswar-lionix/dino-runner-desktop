/** dino_module_3734 — collision_aabb extended, humanized desktop */
export interface In3734{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3734{y:number;vy:number;sc:number}
const C3734={g:0.6, j:11};
export function extraSpawn_3734(inp:In3734, dt:number):Out3734 {
...
export const mm3734={d:'collision_aabb'};