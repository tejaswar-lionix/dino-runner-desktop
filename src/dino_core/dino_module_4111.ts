/** dino_module_4111 — dino_physics_jump extended, humanized desktop */
export interface In4111{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4111{y:number;vy:number;sc:number}
const C4111={g:0.8, j:11};
export function extraSpawn_4111(inp:In4111, dt:number):Out4111 {
...
export const mm4111={d:'dino_physics_jump'};