/** dino_module_4514 — collision_aabb extended, humanized desktop */
export interface In4514{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4514{y:number;vy:number;sc:number}
const C4514={g:0.5, j:12};
export function extraSpawn_4514(inp:In4514, dt:number):Out4514 {
...
export const mm4514={d:'collision_aabb'};