/** dino_module_4624 — parallax_bg extended, humanized desktop */
export interface In4624{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4624{y:number;vy:number;sc:number}
const C4624={g:0.5, j:13};
export function extraSpawn_4624(inp:In4624, dt:number):Out4624 {
...
export const mm4624={d:'parallax_bg'};