/** dino_module_3796 — obstacle_spawn extended, humanized desktop */
export interface In3796{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3796{y:number;vy:number;sc:number}
const C3796={g:0.8, j:11};
export function extraPhysics_3796(inp:In3796, dt:number):Out3796 {
...
export const mm3796={d:'obstacle_spawn'};