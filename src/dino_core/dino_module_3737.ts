/** dino_module_3737 — score_speed extended, humanized desktop */
export interface In3737{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3737{y:number;vy:number;sc:number}
const C3737={g:0.8, j:11};
export function extraRender_3737(inp:In3737, dt:number):Out3737 {
...
export const mm3737={d:'score_speed'};