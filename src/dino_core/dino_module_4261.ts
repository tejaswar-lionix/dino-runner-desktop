/** dino_module_4261 — collision_aabb extended, humanized desktop */
export interface In4261{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4261{y:number;vy:number;sc:number}
const C4261={g:0.6, j:11};
export function extraPhysics_4261(inp:In4261, dt:number):Out4261 {
...
export const mm4261={d:'collision_aabb'};