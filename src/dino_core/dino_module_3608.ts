/** dino_module_3608 — collision_aabb extended, humanized desktop */
export interface In3608{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3608{y:number;vy:number;sc:number}
const C3608={g:0.8, j:13};
export function extraRender_3608(inp:In3608, dt:number):Out3608 {
...
export const mm3608={d:'collision_aabb'};