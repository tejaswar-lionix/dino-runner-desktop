/** dino_module_4125 — score_speed extended, humanized desktop */
export interface In4125{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4125{y:number;vy:number;sc:number}
const C4125={g:0.7, j:11};
export function extraSpawn_4125(inp:In4125, dt:number):Out4125 {
...
export const mm4125={d:'score_speed'};