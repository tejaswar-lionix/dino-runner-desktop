/** dino_module_3402 — score_speed extended, humanized desktop */
export interface In3402{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3402{y:number;vy:number;sc:number}
const C3402={g:0.8, j:13};
export function extraPhysics_3402(inp:In3402, dt:number):Out3402 {
...
export const mm3402={d:'score_speed'};