/** dino_module_3214 — parallax_bg extended, humanized desktop */
export interface In3214{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3214{y:number;vy:number;sc:number}
const C3214={g:0.7, j:11};
export function extraSpawn_3214(inp:In3214, dt:number):Out3214 {
...
export const mm3214={d:'parallax_bg'};