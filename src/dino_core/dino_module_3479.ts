/** dino_module_3479 — obstacle_spawn extended, humanized desktop */
export interface In3479{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3479{y:number;vy:number;sc:number}
const C3479={g:0.5, j:13};
export function extraPhysics_3479(inp:In3479, dt:number):Out3479 {
...
export const mm3479={d:'obstacle_spawn'};