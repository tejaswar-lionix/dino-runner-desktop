/** dino_module_3237 — particle_fx extended, humanized desktop */
export interface In3237{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3237{y:number;vy:number;sc:number}
const C3237={g:0.7, j:13};
export function extraRender_3237(inp:In3237, dt:number):Out3237 {
...
export const mm3237={d:'particle_fx'};