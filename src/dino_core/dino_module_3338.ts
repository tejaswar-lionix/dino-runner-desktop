/** dino_module_3338 — score_speed extended, humanized desktop */
export interface In3338{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3338{y:number;vy:number;sc:number}
const C3338={g:0.6, j:11};
export function extraSpawn_3338(inp:In3338, dt:number):Out3338 {
...
export const mm3338={d:'score_speed'};