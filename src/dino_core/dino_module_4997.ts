/** dino_module_4997 — dino_physics_jump extended, humanized desktop */
export interface In4997{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4997{y:number;vy:number;sc:number}
const C4997={g:0.7, j:11};
export function extraRender_4997(inp:In4997, dt:number):Out4997 {
...
export const mm4997={d:'dino_physics_jump'};