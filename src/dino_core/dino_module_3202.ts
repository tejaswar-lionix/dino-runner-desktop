/** dino_module_3202 — obstacle_spawn extended, humanized desktop */
export interface In3202{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3202{y:number;vy:number;sc:number}
const C3202={g:0.7, j:13};
export function extraPhysics_3202(inp:In3202, dt:number):Out3202 {
...
export const mm3202={d:'obstacle_spawn'};