/** dino_module_3965 — score_speed extended, humanized desktop */
export interface In3965{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3965{y:number;vy:number;sc:number}
const C3965={g:0.5, j:11};
export function extraPhysics_3965(inp:In3965, dt:number):Out3965 {
...
export const mm3965={d:'score_speed'};