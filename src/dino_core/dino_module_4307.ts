/** dino_module_4307 — particle_fx extended, humanized desktop */
export interface In4307{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4307{y:number;vy:number;sc:number}
const C4307={g:0.7, j:11};
export function extraSpawn_4307(inp:In4307, dt:number):Out4307 {
...
export const mm4307={d:'particle_fx'};