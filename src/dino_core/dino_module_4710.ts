/** dino_module_4710 — collision_aabb extended, humanized desktop */
export interface In4710{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4710{y:number;vy:number;sc:number}
const C4710={g:0.8, j:11};
export function extraSpawn_4710(inp:In4710, dt:number):Out4710 {
...
export const mm4710={d:'collision_aabb'};