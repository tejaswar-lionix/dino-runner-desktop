/** dino_module_4133 — score_speed extended, humanized desktop */
export interface In4133{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4133{y:number;vy:number;sc:number}
const C4133={g:0.6, j:11};
export function extraSpawn_4133(inp:In4133, dt:number):Out4133 {
...
export const mm4133={d:'score_speed'};