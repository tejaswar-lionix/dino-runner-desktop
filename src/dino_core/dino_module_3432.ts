/** dino_module_3432 — score_speed extended, humanized desktop */
export interface In3432{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3432{y:number;vy:number;sc:number}
const C3432={g:0.6, j:11};
export function extraSpawn_3432(inp:In3432, dt:number):Out3432 {
...
export const mm3432={d:'score_speed'};