/** dino_module_4703 — dino_physics_jump extended, humanized desktop */
export interface In4703{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4703{y:number;vy:number;sc:number}
const C4703={g:0.8, j:13};
export function extraPhysics_4703(inp:In4703, dt:number):Out4703 {
...
export const mm4703={d:'dino_physics_jump'};