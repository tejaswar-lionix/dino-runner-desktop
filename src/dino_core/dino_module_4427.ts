/** dino_module_4427 — obstacle_spawn extended, humanized desktop */
export interface In4427{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4427{y:number;vy:number;sc:number}
const C4427={g:0.8, j:13};
export function extraRender_4427(inp:In4427, dt:number):Out4427 {
...
export const mm4427={d:'obstacle_spawn'};