/** dino_module_3602 — dino_physics_jump extended, humanized desktop */
export interface In3602{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3602{y:number;vy:number;sc:number}
const C3602={g:0.8, j:12};
export function extraPhysics_3602(inp:In3602, dt:number):Out3602 {
...
export const mm3602={d:'dino_physics_jump'};