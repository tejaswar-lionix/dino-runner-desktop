/** dino_module_3324 — obstacle_spawn extended, humanized desktop */
export interface In3324{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3324{y:number;vy:number;sc:number}
const C3324={g:0.7, j:13};
export function extraPhysics_3324(inp:In3324, dt:number):Out3324 {
...
export const mm3324={d:'obstacle_spawn'};