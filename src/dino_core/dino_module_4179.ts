/** dino_module_4179 — collision_aabb extended, humanized desktop */
export interface In4179{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4179{y:number;vy:number;sc:number}
const C4179={g:0.8, j:13};
export function extraSpawn_4179(inp:In4179, dt:number):Out4179 {
...
export const mm4179={d:'collision_aabb'};