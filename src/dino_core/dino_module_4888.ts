/** dino_module_4888 — collision_aabb extended, humanized desktop */
export interface In4888{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4888{y:number;vy:number;sc:number}
const C4888={g:0.6, j:12};
export function extraPhysics_4888(inp:In4888, dt:number):Out4888 {
...
export const mm4888={d:'collision_aabb'};