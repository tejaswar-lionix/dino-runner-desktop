/** dino_module_3204 — collision_aabb extended, humanized desktop */
export interface In3204{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3204{y:number;vy:number;sc:number}
const C3204={g:0.6, j:13};
export function extraRender_3204(inp:In3204, dt:number):Out3204 {
...
export const mm3204={d:'collision_aabb'};