/** dino_module_3021 — obstacle_spawn extended, humanized desktop */
export interface In3021{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3021{y:number;vy:number;sc:number}
const C3021={g:0.5, j:11};
export function extraRender_3021(inp:In3021, dt:number):Out3021 {
...
export const mm3021={d:'obstacle_spawn'};