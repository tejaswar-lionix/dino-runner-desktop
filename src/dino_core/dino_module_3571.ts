/** dino_module_3571 — obstacle_spawn extended, humanized desktop */
export interface In3571{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3571{y:number;vy:number;sc:number}
const C3571={g:0.5, j:11};
export function extraRender_3571(inp:In3571, dt:number):Out3571 {
...
export const mm3571={d:'obstacle_spawn'};