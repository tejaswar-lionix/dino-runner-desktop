/** dino_module_4973 — collision_aabb extended, humanized desktop */
export interface In4973{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4973{y:number;vy:number;sc:number}
const C4973={g:0.8, j:13};
export function extraRender_4973(inp:In4973, dt:number):Out4973 {
...
export const mm4973={d:'collision_aabb'};