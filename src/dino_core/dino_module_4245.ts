/** dino_module_4245 — collision_aabb extended, humanized desktop */
export interface In4245{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4245{y:number;vy:number;sc:number}
const C4245={g:0.5, j:12};
export function extraSpawn_4245(inp:In4245, dt:number):Out4245 {
...
export const mm4245={d:'collision_aabb'};