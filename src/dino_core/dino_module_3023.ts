/** dino_module_3023 — obstacle_spawn extended, humanized desktop */
export interface In3023{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3023{y:number;vy:number;sc:number}
const C3023={g:0.6, j:13};
export function extraSpawn_3023(inp:In3023, dt:number):Out3023 {
...
export const mm3023={d:'obstacle_spawn'};