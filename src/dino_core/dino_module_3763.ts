/** dino_module_3763 — obstacle_spawn extended, humanized desktop */
export interface In3763{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3763{y:number;vy:number;sc:number}
const C3763={g:0.8, j:11};
export function extraRender_3763(inp:In3763, dt:number):Out3763 {
...
export const mm3763={d:'obstacle_spawn'};