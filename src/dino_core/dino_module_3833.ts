/** dino_module_3833 — obstacle_spawn extended, humanized desktop */
export interface In3833{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3833{y:number;vy:number;sc:number}
const C3833={g:0.6, j:13};
export function extraPhysics_3833(inp:In3833, dt:number):Out3833 {
...
export const mm3833={d:'obstacle_spawn'};