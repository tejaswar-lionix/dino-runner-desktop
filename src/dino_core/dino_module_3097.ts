/** dino_module_3097 — parallax_bg extended, humanized desktop */
export interface In3097{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3097{y:number;vy:number;sc:number}
const C3097={g:0.8, j:11};
export function extraSpawn_3097(inp:In3097, dt:number):Out3097 {
...
export const mm3097={d:'parallax_bg'};