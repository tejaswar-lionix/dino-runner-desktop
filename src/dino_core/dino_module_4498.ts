/** dino_module_4498 — parallax_bg extended, humanized desktop */
export interface In4498{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4498{y:number;vy:number;sc:number}
const C4498={g:0.7, j:12};
export function extraRender_4498(inp:In4498, dt:number):Out4498 {
...
export const mm4498={d:'parallax_bg'};