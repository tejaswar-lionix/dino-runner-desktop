/** dino_module_3969 — dino_physics_jump extended, humanized desktop */
export interface In3969{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3969{y:number;vy:number;sc:number}
const C3969={g:0.6, j:11};
export function extraSpawn_3969(inp:In3969, dt:number):Out3969 {
...
export const mm3969={d:'dino_physics_jump'};