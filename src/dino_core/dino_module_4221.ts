/** dino_module_4221 — obstacle_spawn extended, humanized desktop */
export interface In4221{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4221{y:number;vy:number;sc:number}
const C4221={g:0.8, j:11};
export function extraSpawn_4221(inp:In4221, dt:number):Out4221 {
...
export const mm4221={d:'obstacle_spawn'};