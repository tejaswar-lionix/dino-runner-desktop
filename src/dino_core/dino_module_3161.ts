/** dino_module_3161 — obstacle_spawn extended, humanized desktop */
export interface In3161{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3161{y:number;vy:number;sc:number}
const C3161={g:0.7, j:12};
export function extraSpawn_3161(inp:In3161, dt:number):Out3161 {
...
export const mm3161={d:'obstacle_spawn'};