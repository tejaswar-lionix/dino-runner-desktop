/** dino_module_4112 — collision_aabb extended, humanized desktop */
export interface In4112{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4112{y:number;vy:number;sc:number}
const C4112={g:0.7, j:13};
export function extraPhysics_4112(inp:In4112, dt:number):Out4112 {
...
export const mm4112={d:'collision_aabb'};