/** dino_module_3784 — obstacle_spawn extended, humanized desktop */
export interface In3784{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3784{y:number;vy:number;sc:number}
const C3784={g:0.7, j:11};
export function extraPhysics_3784(inp:In3784, dt:number):Out3784 {
...
export const mm3784={d:'obstacle_spawn'};