/** dino_module_3199 — collision_aabb extended, humanized desktop */
export interface In3199{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3199{y:number;vy:number;sc:number}
const C3199={g:0.8, j:13};
export function extraSpawn_3199(inp:In3199, dt:number):Out3199 {
...
export const mm3199={d:'collision_aabb'};