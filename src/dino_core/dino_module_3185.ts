/** dino_module_3185 — score_speed extended, humanized desktop */
export interface In3185{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3185{y:number;vy:number;sc:number}
const C3185={g:0.7, j:13};
export function extraRender_3185(inp:In3185, dt:number):Out3185 {
...
export const mm3185={d:'score_speed'};