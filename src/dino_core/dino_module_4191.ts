/** dino_module_4191 — score_speed extended, humanized desktop */
export interface In4191{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4191{y:number;vy:number;sc:number}
const C4191={g:0.8, j:12};
export function extraRender_4191(inp:In4191, dt:number):Out4191 {
...
export const mm4191={d:'score_speed'};