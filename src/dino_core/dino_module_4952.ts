/** dino_module_4952 — particle_fx extended, humanized desktop */
export interface In4952{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4952{y:number;vy:number;sc:number}
const C4952={g:0.5, j:13};
export function extraSpawn_4952(inp:In4952, dt:number):Out4952 {
...
export const mm4952={d:'particle_fx'};