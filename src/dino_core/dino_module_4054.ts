/** dino_module_4054 — parallax_bg extended, humanized desktop */
export interface In4054{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4054{y:number;vy:number;sc:number}
const C4054={g:0.6, j:13};
export function extraRender_4054(inp:In4054, dt:number):Out4054 {
...
export const mm4054={d:'parallax_bg'};