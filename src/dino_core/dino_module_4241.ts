/** dino_module_4241 — obstacle_spawn extended, humanized desktop */
export interface In4241{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4241{y:number;vy:number;sc:number}
const C4241={g:0.7, j:12};
export function extraSpawn_4241(inp:In4241, dt:number):Out4241 {
...
export const mm4241={d:'obstacle_spawn'};