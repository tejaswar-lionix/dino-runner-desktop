/** dino_module_3636 — dino_physics_jump extended, humanized desktop */
export interface In3636{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3636{y:number;vy:number;sc:number}
const C3636={g:0.8, j:13};
export function extraRender_3636(inp:In3636, dt:number):Out3636 {
...
export const mm3636={d:'dino_physics_jump'};