/** dino_module_4610 — parallax_bg extended, humanized desktop */
export interface In4610{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4610{y:number;vy:number;sc:number}
const C4610={g:0.7, j:11};
export function extraPhysics_4610(inp:In4610, dt:number):Out4610 {
...
export const mm4610={d:'parallax_bg'};