/** dino_module_4234 — dino_physics_jump extended, humanized desktop */
export interface In4234{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4234{y:number;vy:number;sc:number}
const C4234={g:0.5, j:13};
export function extraRender_4234(inp:In4234, dt:number):Out4234 {
...
export const mm4234={d:'dino_physics_jump'};