/** dino_module_3842 — score_speed extended, humanized desktop */
export interface In3842{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3842{y:number;vy:number;sc:number}
const C3842={g:0.6, j:12};
export function extraPhysics_3842(inp:In3842, dt:number):Out3842 {
...
export const mm3842={d:'score_speed'};