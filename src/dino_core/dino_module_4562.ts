/** dino_module_4562 — particle_fx extended, humanized desktop */
export interface In4562{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4562{y:number;vy:number;sc:number}
const C4562={g:0.5, j:11};
export function extraPhysics_4562(inp:In4562, dt:number):Out4562 {
...
export const mm4562={d:'particle_fx'};