/** dino_module_3257 — collision_aabb extended, humanized desktop */
export interface In3257{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3257{y:number;vy:number;sc:number}
const C3257={g:0.8, j:13};
export function extraPhysics_3257(inp:In3257, dt:number):Out3257 {
...
export const mm3257={d:'collision_aabb'};