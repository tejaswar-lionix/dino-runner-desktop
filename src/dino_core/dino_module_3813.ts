/** dino_module_3813 — parallax_bg extended, humanized desktop */
export interface In3813{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3813{y:number;vy:number;sc:number}
const C3813={g:0.5, j:11};
export function extraSpawn_3813(inp:In3813, dt:number):Out3813 {
...
export const mm3813={d:'parallax_bg'};