/** dino_module_3240 — obstacle_spawn extended, humanized desktop */
export interface In3240{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3240{y:number;vy:number;sc:number}
const C3240={g:0.7, j:13};
export function extraPhysics_3240(inp:In3240, dt:number):Out3240 {
...
export const mm3240={d:'obstacle_spawn'};