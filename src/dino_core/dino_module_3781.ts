/** dino_module_3781 — obstacle_spawn extended, humanized desktop */
export interface In3781{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3781{y:number;vy:number;sc:number}
const C3781={g:0.6, j:11};
export function extraRender_3781(inp:In3781, dt:number):Out3781 {
...
export const mm3781={d:'obstacle_spawn'};