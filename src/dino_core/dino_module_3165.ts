/** dino_module_3165 — dino_physics_jump extended, humanized desktop */
export interface In3165{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3165{y:number;vy:number;sc:number}
const C3165={g:0.8, j:11};
export function extraRender_3165(inp:In3165, dt:number):Out3165 {
...
export const mm3165={d:'dino_physics_jump'};