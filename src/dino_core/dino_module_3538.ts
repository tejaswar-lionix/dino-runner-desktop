/** dino_module_3538 — obstacle_spawn extended, humanized desktop */
export interface In3538{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3538{y:number;vy:number;sc:number}
const C3538={g:0.6, j:13};
export function extraRender_3538(inp:In3538, dt:number):Out3538 {
...
export const mm3538={d:'obstacle_spawn'};