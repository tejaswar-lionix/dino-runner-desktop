/** dino_module_3867 — score_speed extended, humanized desktop */
export interface In3867{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3867{y:number;vy:number;sc:number}
const C3867={g:0.8, j:13};
export function extraSpawn_3867(inp:In3867, dt:number):Out3867 {
...
export const mm3867={d:'score_speed'};