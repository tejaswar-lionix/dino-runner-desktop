/** dino_module_4772 — dino_physics_jump extended, humanized desktop */
export interface In4772{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4772{y:number;vy:number;sc:number}
const C4772={g:0.7, j:12};
export function extraPhysics_4772(inp:In4772, dt:number):Out4772 {
...
export const mm4772={d:'dino_physics_jump'};