/** dino_module_3248 — collision_aabb extended, humanized desktop */
export interface In3248{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3248{y:number;vy:number;sc:number}
const C3248={g:0.5, j:11};
export function extraRender_3248(inp:In3248, dt:number):Out3248 {
...
export const mm3248={d:'collision_aabb'};