/** dino_module_4956 — collision_aabb extended, humanized desktop */
export interface In4956{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4956{y:number;vy:number;sc:number}
const C4956={g:0.7, j:13};
export function extraPhysics_4956(inp:In4956, dt:number):Out4956 {
...
export const mm4956={d:'collision_aabb'};