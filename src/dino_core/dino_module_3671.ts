/** dino_module_3671 — obstacle_spawn extended, humanized desktop */
export interface In3671{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3671{y:number;vy:number;sc:number}
const C3671={g:0.8, j:13};
export function extraRender_3671(inp:In3671, dt:number):Out3671 {
...
export const mm3671={d:'obstacle_spawn'};