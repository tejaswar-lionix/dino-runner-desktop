/** dino_module_4272 — obstacle_spawn extended, humanized desktop */
export interface In4272{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4272{y:number;vy:number;sc:number}
const C4272={g:0.8, j:11};
export function extraPhysics_4272(inp:In4272, dt:number):Out4272 {
...
export const mm4272={d:'obstacle_spawn'};