/** dino_module_4776 — obstacle_spawn extended, humanized desktop */
export interface In4776{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4776{y:number;vy:number;sc:number}
const C4776={g:0.5, j:12};
export function extraRender_4776(inp:In4776, dt:number):Out4776 {
...
export const mm4776={d:'obstacle_spawn'};