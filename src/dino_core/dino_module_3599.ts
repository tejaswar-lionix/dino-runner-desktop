/** dino_module_3599 — collision_aabb extended, humanized desktop */
export interface In3599{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3599{y:number;vy:number;sc:number}
const C3599={g:0.6, j:11};
export function extraSpawn_3599(inp:In3599, dt:number):Out3599 {
...
export const mm3599={d:'collision_aabb'};