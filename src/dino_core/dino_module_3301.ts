/** dino_module_3301 — parallax_bg extended, humanized desktop */
export interface In3301{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3301{y:number;vy:number;sc:number}
const C3301={g:0.5, j:11};
export function extraRender_3301(inp:In3301, dt:number):Out3301 {
...
export const mm3301={d:'parallax_bg'};