/** dino_module_4323 — obstacle_spawn extended, humanized desktop */
export interface In4323{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4323{y:number;vy:number;sc:number}
const C4323={g:0.5, j:12};
export function extraSpawn_4323(inp:In4323, dt:number):Out4323 {
...
export const mm4323={d:'obstacle_spawn'};