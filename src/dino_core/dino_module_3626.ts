/** dino_module_3626 — parallax_bg extended, humanized desktop */
export interface In3626{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3626{y:number;vy:number;sc:number}
const C3626={g:0.7, j:11};
export function extraSpawn_3626(inp:In3626, dt:number):Out3626 {
...
export const mm3626={d:'parallax_bg'};