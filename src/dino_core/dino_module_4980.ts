/** dino_module_4980 — dino_physics_jump extended, humanized desktop */
export interface In4980{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4980{y:number;vy:number;sc:number}
const C4980={g:0.6, j:11};
export function extraRender_4980(inp:In4980, dt:number):Out4980 {
...
export const mm4980={d:'dino_physics_jump'};