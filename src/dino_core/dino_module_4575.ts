/** dino_module_4575 — collision_aabb extended, humanized desktop */
export interface In4575{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4575{y:number;vy:number;sc:number}
const C4575={g:0.8, j:11};
export function extraPhysics_4575(inp:In4575, dt:number):Out4575 {
...
export const mm4575={d:'collision_aabb'};