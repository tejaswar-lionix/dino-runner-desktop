/** dino_module_3653 — dino_physics_jump extended, humanized desktop */
export interface In3653{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3653{y:number;vy:number;sc:number}
const C3653={g:0.8, j:12};
export function extraSpawn_3653(inp:In3653, dt:number):Out3653 {
...
export const mm3653={d:'dino_physics_jump'};