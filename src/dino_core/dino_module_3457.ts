/** dino_module_3457 — particle_fx extended, humanized desktop */
export interface In3457{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3457{y:number;vy:number;sc:number}
const C3457={g:0.7, j:13};
export function extraRender_3457(inp:In3457, dt:number):Out3457 {
...
export const mm3457={d:'particle_fx'};