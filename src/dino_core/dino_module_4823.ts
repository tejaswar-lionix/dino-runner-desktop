/** dino_module_4823 — dino_physics_jump extended, humanized desktop */
export interface In4823{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4823{y:number;vy:number;sc:number}
const C4823={g:0.6, j:13};
export function extraRender_4823(inp:In4823, dt:number):Out4823 {
...
export const mm4823={d:'dino_physics_jump'};