/** dino_module_3830 — obstacle_spawn extended, humanized desktop */
export interface In3830{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3830{y:number;vy:number;sc:number}
const C3830={g:0.5, j:12};
export function extraSpawn_3830(inp:In3830, dt:number):Out3830 {
...
export const mm3830={d:'obstacle_spawn'};