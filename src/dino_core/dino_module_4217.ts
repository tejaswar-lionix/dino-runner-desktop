/** dino_module_4217 — obstacle_spawn extended, humanized desktop */
export interface In4217{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4217{y:number;vy:number;sc:number}
const C4217={g:0.7, j:13};
export function extraPhysics_4217(inp:In4217, dt:number):Out4217 {
...
export const mm4217={d:'obstacle_spawn'};