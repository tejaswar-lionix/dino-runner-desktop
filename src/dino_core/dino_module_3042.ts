/** dino_module_3042 — score_speed extended, humanized desktop */
export interface In3042{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3042{y:number;vy:number;sc:number}
const C3042={g:0.5, j:12};
export function extraSpawn_3042(inp:In3042, dt:number):Out3042 {
...
export const mm3042={d:'score_speed'};