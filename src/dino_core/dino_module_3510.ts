/** dino_module_3510 — dino_physics_jump extended, humanized desktop */
export interface In3510{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3510{y:number;vy:number;sc:number}
const C3510={g:0.5, j:12};
export function extraSpawn_3510(inp:In3510, dt:number):Out3510 {
...
export const mm3510={d:'dino_physics_jump'};