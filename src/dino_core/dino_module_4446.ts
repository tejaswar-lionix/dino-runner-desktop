/** dino_module_4446 — score_speed extended, humanized desktop */
export interface In4446{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4446{y:number;vy:number;sc:number}
const C4446={g:0.6, j:11};
export function extraPhysics_4446(inp:In4446, dt:number):Out4446 {
...
export const mm4446={d:'score_speed'};