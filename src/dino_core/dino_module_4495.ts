/** dino_module_4495 — collision_aabb extended, humanized desktop */
export interface In4495{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4495{y:number;vy:number;sc:number}
const C4495={g:0.7, j:13};
export function extraPhysics_4495(inp:In4495, dt:number):Out4495 {
...
export const mm4495={d:'collision_aabb'};