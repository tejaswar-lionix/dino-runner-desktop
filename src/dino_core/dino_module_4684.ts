/** dino_module_4684 — score_speed extended, humanized desktop */
export interface In4684{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4684{y:number;vy:number;sc:number}
const C4684={g:0.7, j:12};
export function extraRender_4684(inp:In4684, dt:number):Out4684 {
...
export const mm4684={d:'score_speed'};