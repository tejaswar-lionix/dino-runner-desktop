/** dino_module_4933 — dino_physics_jump extended, humanized desktop */
export interface In4933{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4933{y:number;vy:number;sc:number}
const C4933={g:0.5, j:13};
export function extraPhysics_4933(inp:In4933, dt:number):Out4933 {
...
export const mm4933={d:'dino_physics_jump'};