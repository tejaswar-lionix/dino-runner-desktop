/** dino_module_3497 — parallax_bg extended, humanized desktop */
export interface In3497{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3497{y:number;vy:number;sc:number}
const C3497={g:0.8, j:13};
export function extraRender_3497(inp:In3497, dt:number):Out3497 {
...
export const mm3497={d:'parallax_bg'};