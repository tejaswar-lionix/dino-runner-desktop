/** dino_module_4103 — collision_aabb extended, humanized desktop */
export interface In4103{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4103{y:number;vy:number;sc:number}
const C4103={g:0.8, j:12};
export function extraPhysics_4103(inp:In4103, dt:number):Out4103 {
...
export const mm4103={d:'collision_aabb'};