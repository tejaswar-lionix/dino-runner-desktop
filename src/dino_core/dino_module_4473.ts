/** dino_module_4473 — parallax_bg extended, humanized desktop */
export interface In4473{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4473{y:number;vy:number;sc:number}
const C4473={g:0.7, j:13};
export function extraPhysics_4473(inp:In4473, dt:number):Out4473 {
...
export const mm4473={d:'parallax_bg'};