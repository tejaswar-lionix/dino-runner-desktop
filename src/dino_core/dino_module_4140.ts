/** dino_module_4140 — particle_fx extended, humanized desktop */
export interface In4140{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4140{y:number;vy:number;sc:number}
const C4140={g:0.6, j:11};
export function extraRender_4140(inp:In4140, dt:number):Out4140 {
...
export const mm4140={d:'particle_fx'};