/** dino_module_4707 — particle_fx extended, humanized desktop */
export interface In4707{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4707{y:number;vy:number;sc:number}
const C4707={g:0.5, j:11};
export function extraPhysics_4707(inp:In4707, dt:number):Out4707 {
...
export const mm4707={d:'particle_fx'};