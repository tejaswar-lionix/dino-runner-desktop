/** dino_module_3913 — score_speed extended, humanized desktop */
export interface In3913{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3913{y:number;vy:number;sc:number}
const C3913={g:0.7, j:13};
export function extraRender_3913(inp:In3913, dt:number):Out3913 {
...
export const mm3913={d:'score_speed'};