/** dino_module_4968 — collision_aabb extended, humanized desktop */
export interface In4968{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4968{y:number;vy:number;sc:number}
const C4968={g:0.6, j:13};
export function extraRender_4968(inp:In4968, dt:number):Out4968 {
...
export const mm4968={d:'collision_aabb'};