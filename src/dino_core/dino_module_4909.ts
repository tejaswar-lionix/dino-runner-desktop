/** dino_module_4909 — collision_aabb extended, humanized desktop */
export interface In4909{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4909{y:number;vy:number;sc:number}
const C4909={g:0.8, j:11};
export function extraPhysics_4909(inp:In4909, dt:number):Out4909 {
...
export const mm4909={d:'collision_aabb'};