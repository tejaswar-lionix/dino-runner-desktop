/** dino_module_3174 — particle_fx extended, humanized desktop */
export interface In3174{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3174{y:number;vy:number;sc:number}
const C3174={g:0.6, j:11};
export function extraPhysics_3174(inp:In3174, dt:number):Out3174 {
...
export const mm3174={d:'particle_fx'};