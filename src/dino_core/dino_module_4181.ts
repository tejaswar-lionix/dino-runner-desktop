/** dino_module_4181 — parallax_bg extended, humanized desktop */
export interface In4181{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4181{y:number;vy:number;sc:number}
const C4181={g:0.8, j:13};
export function extraPhysics_4181(inp:In4181, dt:number):Out4181 {
...
export const mm4181={d:'parallax_bg'};