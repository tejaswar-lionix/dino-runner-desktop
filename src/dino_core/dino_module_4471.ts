/** dino_module_4471 — score_speed extended, humanized desktop */
export interface In4471{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4471{y:number;vy:number;sc:number}
const C4471={g:0.5, j:12};
export function extraPhysics_4471(inp:In4471, dt:number):Out4471 {
...
export const mm4471={d:'score_speed'};