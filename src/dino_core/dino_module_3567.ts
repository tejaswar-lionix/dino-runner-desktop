/** dino_module_3567 — obstacle_spawn extended, humanized desktop */
export interface In3567{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3567{y:number;vy:number;sc:number}
const C3567={g:0.6, j:13};
export function extraRender_3567(inp:In3567, dt:number):Out3567 {
...
export const mm3567={d:'obstacle_spawn'};