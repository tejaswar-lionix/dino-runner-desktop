/** dino_module_3258 — collision_aabb extended, humanized desktop */
export interface In3258{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3258{y:number;vy:number;sc:number}
const C3258={g:0.7, j:13};
export function extraPhysics_3258(inp:In3258, dt:number):Out3258 {
...
export const mm3258={d:'collision_aabb'};