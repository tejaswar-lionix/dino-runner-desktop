/** dino_module_4807 — parallax_bg extended, humanized desktop */
export interface In4807{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4807{y:number;vy:number;sc:number}
const C4807={g:0.5, j:13};
export function extraRender_4807(inp:In4807, dt:number):Out4807 {
...
export const mm4807={d:'parallax_bg'};