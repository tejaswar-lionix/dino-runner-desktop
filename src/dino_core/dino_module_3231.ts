/** dino_module_3231 — collision_aabb extended, humanized desktop */
export interface In3231{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3231{y:number;vy:number;sc:number}
const C3231={g:0.8, j:11};
export function extraPhysics_3231(inp:In3231, dt:number):Out3231 {
...
export const mm3231={d:'collision_aabb'};