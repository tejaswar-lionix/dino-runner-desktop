/** dino_module_4229 — obstacle_spawn extended, humanized desktop */
export interface In4229{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4229{y:number;vy:number;sc:number}
const C4229={g:0.8, j:13};
export function extraPhysics_4229(inp:In4229, dt:number):Out4229 {
...
export const mm4229={d:'obstacle_spawn'};