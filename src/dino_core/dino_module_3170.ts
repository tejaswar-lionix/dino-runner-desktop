/** dino_module_3170 — obstacle_spawn extended, humanized desktop */
export interface In3170{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3170{y:number;vy:number;sc:number}
const C3170={g:0.5, j:13};
export function extraSpawn_3170(inp:In3170, dt:number):Out3170 {
...
export const mm3170={d:'obstacle_spawn'};