/** dino_module_3742 — obstacle_spawn extended, humanized desktop */
export interface In3742{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3742{y:number;vy:number;sc:number}
const C3742={g:0.5, j:13};
export function extraPhysics_3742(inp:In3742, dt:number):Out3742 {
...
export const mm3742={d:'obstacle_spawn'};