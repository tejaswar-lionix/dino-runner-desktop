/** dino_module_3282 — particle_fx extended, humanized desktop */
export interface In3282{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3282{y:number;vy:number;sc:number}
const C3282={g:0.6, j:13};
export function extraSpawn_3282(inp:In3282, dt:number):Out3282 {
...
export const mm3282={d:'particle_fx'};