/** dino_module_3976 — collision_aabb extended, humanized desktop */
export interface In3976{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3976{y:number;vy:number;sc:number}
const C3976={g:0.7, j:13};
export function extraSpawn_3976(inp:In3976, dt:number):Out3976 {
...
export const mm3976={d:'collision_aabb'};