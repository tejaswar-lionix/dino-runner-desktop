/** dino_module_4721 — parallax_bg extended, humanized desktop */
export interface In4721{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4721{y:number;vy:number;sc:number}
const C4721={g:0.6, j:11};
export function extraRender_4721(inp:In4721, dt:number):Out4721 {
...
export const mm4721={d:'parallax_bg'};