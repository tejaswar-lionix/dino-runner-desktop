/** dino_module_3972 — dino_physics_jump extended, humanized desktop */
export interface In3972{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3972{y:number;vy:number;sc:number}
const C3972={g:0.6, j:12};
export function extraSpawn_3972(inp:In3972, dt:number):Out3972 {
...
export const mm3972={d:'dino_physics_jump'};