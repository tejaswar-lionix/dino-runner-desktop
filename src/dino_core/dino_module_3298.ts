/** dino_module_3298 — obstacle_spawn extended, humanized desktop */
export interface In3298{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3298{y:number;vy:number;sc:number}
const C3298={g:0.8, j:11};
export function extraRender_3298(inp:In3298, dt:number):Out3298 {
...
export const mm3298={d:'obstacle_spawn'};