/** dino_module_3710 — score_speed extended, humanized desktop */
export interface In3710{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3710{y:number;vy:number;sc:number}
const C3710={g:0.7, j:13};
export function extraSpawn_3710(inp:In3710, dt:number):Out3710 {
...
export const mm3710={d:'score_speed'};