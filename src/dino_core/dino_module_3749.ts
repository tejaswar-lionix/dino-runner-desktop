/** dino_module_3749 — particle_fx extended, humanized desktop */
export interface In3749{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3749{y:number;vy:number;sc:number}
const C3749={g:0.6, j:12};
export function extraRender_3749(inp:In3749, dt:number):Out3749 {
...
export const mm3749={d:'particle_fx'};