/** dino_module_3908 — parallax_bg extended, humanized desktop */
export interface In3908{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3908{y:number;vy:number;sc:number}
const C3908={g:0.8, j:12};
export function extraRender_3908(inp:In3908, dt:number):Out3908 {
...
export const mm3908={d:'parallax_bg'};