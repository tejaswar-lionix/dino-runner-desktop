/** dino_module_4545 — obstacle_spawn extended, humanized desktop */
export interface In4545{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4545{y:number;vy:number;sc:number}
const C4545={g:0.5, j:13};
export function extraRender_4545(inp:In4545, dt:number):Out4545 {
...
export const mm4545={d:'obstacle_spawn'};