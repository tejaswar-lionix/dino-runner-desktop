/** dino_module_3475 — collision_aabb extended, humanized desktop */
export interface In3475{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3475{y:number;vy:number;sc:number}
const C3475={g:0.7, j:12};
export function extraPhysics_3475(inp:In3475, dt:number):Out3475 {
...
export const mm3475={d:'collision_aabb'};