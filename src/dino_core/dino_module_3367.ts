/** dino_module_3367 — particle_fx extended, humanized desktop */
export interface In3367{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3367{y:number;vy:number;sc:number}
const C3367={g:0.6, j:11};
export function extraPhysics_3367(inp:In3367, dt:number):Out3367 {
...
export const mm3367={d:'particle_fx'};