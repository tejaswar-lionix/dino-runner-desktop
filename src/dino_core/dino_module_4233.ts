/** dino_module_4233 — obstacle_spawn extended, humanized desktop */
export interface In4233{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4233{y:number;vy:number;sc:number}
const C4233={g:0.8, j:12};
export function extraSpawn_4233(inp:In4233, dt:number):Out4233 {
...
export const mm4233={d:'obstacle_spawn'};