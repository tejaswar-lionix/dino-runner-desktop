/** dino_module_4643 — particle_fx extended, humanized desktop */
export interface In4643{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4643{y:number;vy:number;sc:number}
const C4643={g:0.6, j:11};
export function extraSpawn_4643(inp:In4643, dt:number):Out4643 {
...
export const mm4643={d:'particle_fx'};