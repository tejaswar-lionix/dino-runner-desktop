/** dino_module_3938 — score_speed extended, humanized desktop */
export interface In3938{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3938{y:number;vy:number;sc:number}
const C3938={g:0.6, j:13};
export function extraSpawn_3938(inp:In3938, dt:number):Out3938 {
...
export const mm3938={d:'score_speed'};