/** dino_module_3596 — parallax_bg extended, humanized desktop */
export interface In3596{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3596{y:number;vy:number;sc:number}
const C3596={g:0.8, j:12};
export function extraPhysics_3596(inp:In3596, dt:number):Out3596 {
...
export const mm3596={d:'parallax_bg'};