/** dino_module_4355 — dino_physics_jump extended, humanized desktop */
export interface In4355{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4355{y:number;vy:number;sc:number}
const C4355={g:0.6, j:12};
export function extraRender_4355(inp:In4355, dt:number):Out4355 {
...
export const mm4355={d:'dino_physics_jump'};