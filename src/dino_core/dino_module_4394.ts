/** dino_module_4394 — parallax_bg extended, humanized desktop */
export interface In4394{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4394{y:number;vy:number;sc:number}
const C4394={g:0.7, j:12};
export function extraPhysics_4394(inp:In4394, dt:number):Out4394 {
...
export const mm4394={d:'parallax_bg'};