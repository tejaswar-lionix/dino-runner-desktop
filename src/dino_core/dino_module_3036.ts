/** dino_module_3036 — collision_aabb extended, humanized desktop */
export interface In3036{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3036{y:number;vy:number;sc:number}
const C3036={g:0.7, j:12};
export function extraRender_3036(inp:In3036, dt:number):Out3036 {
...
export const mm3036={d:'collision_aabb'};