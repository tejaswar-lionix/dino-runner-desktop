/** dino_module_4399 — obstacle_spawn extended, humanized desktop */
export interface In4399{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4399{y:number;vy:number;sc:number}
const C4399={g:0.7, j:11};
export function extraPhysics_4399(inp:In4399, dt:number):Out4399 {
...
export const mm4399={d:'obstacle_spawn'};