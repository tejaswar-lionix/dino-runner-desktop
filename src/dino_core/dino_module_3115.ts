/** dino_module_3115 — dino_physics_jump extended, humanized desktop */
export interface In3115{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3115{y:number;vy:number;sc:number}
const C3115={g:0.7, j:13};
export function extraSpawn_3115(inp:In3115, dt:number):Out3115 {
...
export const mm3115={d:'dino_physics_jump'};