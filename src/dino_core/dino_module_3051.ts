/** dino_module_3051 — collision_aabb extended, humanized desktop */
export interface In3051{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3051{y:number;vy:number;sc:number}
const C3051={g:0.8, j:12};
export function extraRender_3051(inp:In3051, dt:number):Out3051 {
...
export const mm3051={d:'collision_aabb'};