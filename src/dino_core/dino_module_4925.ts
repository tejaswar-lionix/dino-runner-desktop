/** dino_module_4925 — parallax_bg extended, humanized desktop */
export interface In4925{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4925{y:number;vy:number;sc:number}
const C4925={g:0.6, j:13};
export function extraRender_4925(inp:In4925, dt:number):Out4925 {
...
export const mm4925={d:'parallax_bg'};