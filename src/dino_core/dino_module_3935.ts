/** dino_module_3935 — obstacle_spawn extended, humanized desktop */
export interface In3935{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3935{y:number;vy:number;sc:number}
const C3935={g:0.8, j:11};
export function extraRender_3935(inp:In3935, dt:number):Out3935 {
...
export const mm3935={d:'obstacle_spawn'};