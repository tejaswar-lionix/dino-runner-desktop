/** dino_module_4076 — dino_physics_jump extended, humanized desktop */
export interface In4076{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4076{y:number;vy:number;sc:number}
const C4076={g:0.6, j:13};
export function extraPhysics_4076(inp:In4076, dt:number):Out4076 {
...
export const mm4076={d:'dino_physics_jump'};