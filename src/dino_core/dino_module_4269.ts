/** dino_module_4269 — parallax_bg extended, humanized desktop */
export interface In4269{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4269{y:number;vy:number;sc:number}
const C4269={g:0.5, j:11};
export function extraSpawn_4269(inp:In4269, dt:number):Out4269 {
...
export const mm4269={d:'parallax_bg'};