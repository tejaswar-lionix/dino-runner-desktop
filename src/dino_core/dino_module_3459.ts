/** dino_module_3459 — obstacle_spawn extended, humanized desktop */
export interface In3459{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3459{y:number;vy:number;sc:number}
const C3459={g:0.8, j:11};
export function extraRender_3459(inp:In3459, dt:number):Out3459 {
...
export const mm3459={d:'obstacle_spawn'};