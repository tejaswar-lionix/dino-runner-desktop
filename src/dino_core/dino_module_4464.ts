/** dino_module_4464 — score_speed extended, humanized desktop */
export interface In4464{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4464{y:number;vy:number;sc:number}
const C4464={g:0.5, j:11};
export function extraPhysics_4464(inp:In4464, dt:number):Out4464 {
...
export const mm4464={d:'score_speed'};