/** dino_module_4207 — score_speed extended, humanized desktop */
export interface In4207{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4207{y:number;vy:number;sc:number}
const C4207={g:0.8, j:12};
export function extraRender_4207(inp:In4207, dt:number):Out4207 {
...
export const mm4207={d:'score_speed'};