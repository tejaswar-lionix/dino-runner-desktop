/** dino_module_4067 — collision_aabb extended, humanized desktop */
export interface In4067{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4067{y:number;vy:number;sc:number}
const C4067={g:0.8, j:12};
export function extraPhysics_4067(inp:In4067, dt:number):Out4067 {
...
export const mm4067={d:'collision_aabb'};