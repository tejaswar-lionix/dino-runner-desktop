/** dino_module_4615 — dino_physics_jump extended, humanized desktop */
export interface In4615{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4615{y:number;vy:number;sc:number}
const C4615={g:0.5, j:12};
export function extraSpawn_4615(inp:In4615, dt:number):Out4615 {
...
export const mm4615={d:'dino_physics_jump'};