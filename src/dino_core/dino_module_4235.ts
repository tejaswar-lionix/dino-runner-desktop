/** dino_module_4235 — parallax_bg extended, humanized desktop */
export interface In4235{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4235{y:number;vy:number;sc:number}
const C4235={g:0.6, j:11};
export function extraSpawn_4235(inp:In4235, dt:number):Out4235 {
...
export const mm4235={d:'parallax_bg'};