/** dino_module_3213 — score_speed extended, humanized desktop */
export interface In3213{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3213{y:number;vy:number;sc:number}
const C3213={g:0.7, j:11};
export function extraRender_3213(inp:In3213, dt:number):Out3213 {
...
export const mm3213={d:'score_speed'};