/** dino_module_3631 — collision_aabb extended, humanized desktop */
export interface In3631{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3631{y:number;vy:number;sc:number}
const C3631={g:0.6, j:12};
export function extraRender_3631(inp:In3631, dt:number):Out3631 {
...
export const mm3631={d:'collision_aabb'};