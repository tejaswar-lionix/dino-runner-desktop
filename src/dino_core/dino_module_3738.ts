/** dino_module_3738 — particle_fx extended, humanized desktop */
export interface In3738{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3738{y:number;vy:number;sc:number}
const C3738={g:0.8, j:13};
export function extraRender_3738(inp:In3738, dt:number):Out3738 {
...
export const mm3738={d:'particle_fx'};