/** dino_module_3735 — score_speed extended, humanized desktop */
export interface In3735{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3735{y:number;vy:number;sc:number}
const C3735={g:0.7, j:12};
export function extraPhysics_3735(inp:In3735, dt:number):Out3735 {
...
export const mm3735={d:'score_speed'};