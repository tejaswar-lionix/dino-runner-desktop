/** dino_module_4719 — particle_fx extended, humanized desktop */
export interface In4719{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4719{y:number;vy:number;sc:number}
const C4719={g:0.6, j:13};
export function extraPhysics_4719(inp:In4719, dt:number):Out4719 {
...
export const mm4719={d:'particle_fx'};