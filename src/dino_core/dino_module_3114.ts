/** dino_module_3114 — score_speed extended, humanized desktop */
export interface In3114{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3114{y:number;vy:number;sc:number}
const C3114={g:0.7, j:12};
export function extraRender_3114(inp:In3114, dt:number):Out3114 {
...
export const mm3114={d:'score_speed'};