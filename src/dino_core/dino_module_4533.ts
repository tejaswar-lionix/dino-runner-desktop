/** dino_module_4533 — collision_aabb extended, humanized desktop */
export interface In4533{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4533{y:number;vy:number;sc:number}
const C4533={g:0.5, j:11};
export function extraPhysics_4533(inp:In4533, dt:number):Out4533 {
...
export const mm4533={d:'collision_aabb'};