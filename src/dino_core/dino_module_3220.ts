/** dino_module_3220 — particle_fx extended, humanized desktop */
export interface In3220{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3220{y:number;vy:number;sc:number}
const C3220={g:0.6, j:11};
export function extraRender_3220(inp:In3220, dt:number):Out3220 {
...
export const mm3220={d:'particle_fx'};