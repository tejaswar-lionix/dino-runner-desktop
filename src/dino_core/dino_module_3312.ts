/** dino_module_3312 — collision_aabb extended, humanized desktop */
export interface In3312{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3312{y:number;vy:number;sc:number}
const C3312={g:0.8, j:11};
export function extraRender_3312(inp:In3312, dt:number):Out3312 {
...
export const mm3312={d:'collision_aabb'};