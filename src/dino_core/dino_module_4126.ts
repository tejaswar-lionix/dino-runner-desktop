/** dino_module_4126 — score_speed extended, humanized desktop */
export interface In4126{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4126{y:number;vy:number;sc:number}
const C4126={g:0.5, j:13};
export function extraPhysics_4126(inp:In4126, dt:number):Out4126 {
...
export const mm4126={d:'score_speed'};