/** dino_module_3477 — dino_physics_jump extended, humanized desktop */
export interface In3477{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3477{y:number;vy:number;sc:number}
const C3477={g:0.8, j:13};
export function extraPhysics_3477(inp:In3477, dt:number):Out3477 {
...
export const mm3477={d:'dino_physics_jump'};