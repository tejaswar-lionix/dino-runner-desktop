/** dino_module_4277 — particle_fx extended, humanized desktop */
export interface In4277{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4277{y:number;vy:number;sc:number}
const C4277={g:0.7, j:11};
export function extraPhysics_4277(inp:In4277, dt:number):Out4277 {
...
export const mm4277={d:'particle_fx'};