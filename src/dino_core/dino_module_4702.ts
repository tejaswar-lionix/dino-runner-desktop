/** dino_module_4702 — parallax_bg extended, humanized desktop */
export interface In4702{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4702{y:number;vy:number;sc:number}
const C4702={g:0.6, j:13};
export function extraSpawn_4702(inp:In4702, dt:number):Out4702 {
...
export const mm4702={d:'parallax_bg'};