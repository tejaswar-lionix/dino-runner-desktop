/** dino_module_4967 — dino_physics_jump extended, humanized desktop */
export interface In4967{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4967{y:number;vy:number;sc:number}
const C4967={g:0.7, j:13};
export function extraRender_4967(inp:In4967, dt:number):Out4967 {
...
export const mm4967={d:'dino_physics_jump'};