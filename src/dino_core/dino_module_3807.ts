/** dino_module_3807 — obstacle_spawn extended, humanized desktop */
export interface In3807{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3807{y:number;vy:number;sc:number}
const C3807={g:0.8, j:12};
export function extraPhysics_3807(inp:In3807, dt:number):Out3807 {
...
export const mm3807={d:'obstacle_spawn'};