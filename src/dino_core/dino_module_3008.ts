/** dino_module_3008 — parallax_bg extended, humanized desktop */
export interface In3008{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3008{y:number;vy:number;sc:number}
const C3008={g:0.8, j:13};
export function extraSpawn_3008(inp:In3008, dt:number):Out3008 {
...
export const mm3008={d:'parallax_bg'};