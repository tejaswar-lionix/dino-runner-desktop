/** dino_module_3046 — score_speed extended, humanized desktop */
export interface In3046{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3046{y:number;vy:number;sc:number}
const C3046={g:0.5, j:12};
export function extraPhysics_3046(inp:In3046, dt:number):Out3046 {
...
export const mm3046={d:'score_speed'};