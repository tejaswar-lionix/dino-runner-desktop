/** dino_module_4396 — parallax_bg extended, humanized desktop */
export interface In4396{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4396{y:number;vy:number;sc:number}
const C4396={g:0.7, j:11};
export function extraSpawn_4396(inp:In4396, dt:number):Out4396 {
...
export const mm4396={d:'parallax_bg'};