/** dino_module_4704 — particle_fx extended, humanized desktop */
export interface In4704{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4704{y:number;vy:number;sc:number}
const C4704={g:0.6, j:11};
export function extraSpawn_4704(inp:In4704, dt:number):Out4704 {
...
export const mm4704={d:'particle_fx'};