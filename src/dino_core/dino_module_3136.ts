/** dino_module_3136 — collision_aabb extended, humanized desktop */
export interface In3136{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3136{y:number;vy:number;sc:number}
const C3136={g:0.7, j:12};
export function extraRender_3136(inp:In3136, dt:number):Out3136 {
...
export const mm3136={d:'collision_aabb'};