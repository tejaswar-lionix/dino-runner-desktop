/** dino_module_3038 — dino_physics_jump extended, humanized desktop */
export interface In3038{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3038{y:number;vy:number;sc:number}
const C3038={g:0.7, j:13};
export function extraPhysics_3038(inp:In3038, dt:number):Out3038 {
...
export const mm3038={d:'dino_physics_jump'};