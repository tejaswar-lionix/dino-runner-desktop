/** dino_module_4023 — collision_aabb extended, humanized desktop */
export interface In4023{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4023{y:number;vy:number;sc:number}
const C4023={g:0.8, j:11};
export function extraPhysics_4023(inp:In4023, dt:number):Out4023 {
...
export const mm4023={d:'collision_aabb'};