/** dino_module_4251 — dino_physics_jump extended, humanized desktop */
export interface In4251{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4251{y:number;vy:number;sc:number}
const C4251={g:0.6, j:11};
export function extraRender_4251(inp:In4251, dt:number):Out4251 {
...
export const mm4251={d:'dino_physics_jump'};