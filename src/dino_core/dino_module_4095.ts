/** dino_module_4095 — dino_physics_jump extended, humanized desktop */
export interface In4095{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4095{y:number;vy:number;sc:number}
const C4095={g:0.6, j:13};
export function extraPhysics_4095(inp:In4095, dt:number):Out4095 {
...
export const mm4095={d:'dino_physics_jump'};