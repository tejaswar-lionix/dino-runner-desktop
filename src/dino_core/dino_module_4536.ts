/** dino_module_4536 — parallax_bg extended, humanized desktop */
export interface In4536{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4536{y:number;vy:number;sc:number}
const C4536={g:0.7, j:13};
export function extraSpawn_4536(inp:In4536, dt:number):Out4536 {
...
export const mm4536={d:'parallax_bg'};