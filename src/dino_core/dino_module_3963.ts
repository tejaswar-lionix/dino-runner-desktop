/** dino_module_3963 — collision_aabb extended, humanized desktop */
export interface In3963{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3963{y:number;vy:number;sc:number}
const C3963={g:0.7, j:12};
export function extraPhysics_3963(inp:In3963, dt:number):Out3963 {
...
export const mm3963={d:'collision_aabb'};