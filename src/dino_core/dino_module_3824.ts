/** dino_module_3824 — dino_physics_jump extended, humanized desktop */
export interface In3824{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3824{y:number;vy:number;sc:number}
const C3824={g:0.8, j:12};
export function extraRender_3824(inp:In3824, dt:number):Out3824 {
...
export const mm3824={d:'dino_physics_jump'};