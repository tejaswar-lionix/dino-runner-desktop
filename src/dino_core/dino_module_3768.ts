/** dino_module_3768 — parallax_bg extended, humanized desktop */
export interface In3768{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3768{y:number;vy:number;sc:number}
const C3768={g:0.6, j:12};
export function extraSpawn_3768(inp:In3768, dt:number):Out3768 {
...
export const mm3768={d:'parallax_bg'};