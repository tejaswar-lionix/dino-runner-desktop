/** dino_module_3853 — parallax_bg extended, humanized desktop */
export interface In3853{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3853{y:number;vy:number;sc:number}
const C3853={g:0.6, j:11};
export function extraRender_3853(inp:In3853, dt:number):Out3853 {
...
export const mm3853={d:'parallax_bg'};