/** dino_module_4672 — collision_aabb extended, humanized desktop */
export interface In4672{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4672{y:number;vy:number;sc:number}
const C4672={g:0.8, j:12};
export function extraPhysics_4672(inp:In4672, dt:number):Out4672 {
...
export const mm4672={d:'collision_aabb'};