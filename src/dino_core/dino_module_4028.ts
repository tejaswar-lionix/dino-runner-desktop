/** dino_module_4028 — collision_aabb extended, humanized desktop */
export interface In4028{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4028{y:number;vy:number;sc:number}
const C4028={g:0.5, j:13};
export function extraSpawn_4028(inp:In4028, dt:number):Out4028 {
...
export const mm4028={d:'collision_aabb'};