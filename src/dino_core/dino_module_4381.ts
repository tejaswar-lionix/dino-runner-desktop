/** dino_module_4381 — parallax_bg extended, humanized desktop */
export interface In4381{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4381{y:number;vy:number;sc:number}
const C4381={g:0.8, j:13};
export function extraRender_4381(inp:In4381, dt:number):Out4381 {
...
export const mm4381={d:'parallax_bg'};