/** dino_module_4164 — obstacle_spawn extended, humanized desktop */
export interface In4164{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4164{y:number;vy:number;sc:number}
const C4164={g:0.7, j:13};
export function extraRender_4164(inp:In4164, dt:number):Out4164 {
...
export const mm4164={d:'obstacle_spawn'};