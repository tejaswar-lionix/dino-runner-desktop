/** dino_module_3011 — score_speed extended, humanized desktop */
export interface In3011{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3011{y:number;vy:number;sc:number}
const C3011={g:0.8, j:13};
export function extraSpawn_3011(inp:In3011, dt:number):Out3011 {
...
export const mm3011={d:'score_speed'};