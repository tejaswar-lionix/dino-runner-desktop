/** dino_module_3595 — particle_fx extended, humanized desktop */
export interface In3595{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3595{y:number;vy:number;sc:number}
const C3595={g:0.8, j:11};
export function extraPhysics_3595(inp:In3595, dt:number):Out3595 {
...
export const mm3595={d:'particle_fx'};