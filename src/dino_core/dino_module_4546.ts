/** dino_module_4546 — dino_physics_jump extended, humanized desktop */
export interface In4546{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4546{y:number;vy:number;sc:number}
const C4546={g:0.6, j:13};
export function extraRender_4546(inp:In4546, dt:number):Out4546 {
...
export const mm4546={d:'dino_physics_jump'};