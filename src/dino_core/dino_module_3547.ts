/** dino_module_3547 — collision_aabb extended, humanized desktop */
export interface In3547{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3547{y:number;vy:number;sc:number}
const C3547={g:0.6, j:12};
export function extraPhysics_3547(inp:In3547, dt:number):Out3547 {
...
export const mm3547={d:'collision_aabb'};