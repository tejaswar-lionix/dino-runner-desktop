/** dino_module_4883 — obstacle_spawn extended, humanized desktop */
export interface In4883{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4883{y:number;vy:number;sc:number}
const C4883={g:0.5, j:12};
export function extraPhysics_4883(inp:In4883, dt:number):Out4883 {
...
export const mm4883={d:'obstacle_spawn'};