/** dino_module_3564 — collision_aabb extended, humanized desktop */
export interface In3564{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3564{y:number;vy:number;sc:number}
const C3564={g:0.5, j:11};
export function extraPhysics_3564(inp:In3564, dt:number):Out3564 {
...
export const mm3564={d:'collision_aabb'};