/** dino_module_3868 — dino_physics_jump extended, humanized desktop */
export interface In3868{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3868{y:number;vy:number;sc:number}
const C3868={g:0.8, j:13};
export function extraRender_3868(inp:In3868, dt:number):Out3868 {
...
export const mm3868={d:'dino_physics_jump'};