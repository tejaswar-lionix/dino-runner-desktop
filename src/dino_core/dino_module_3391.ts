/** dino_module_3391 — obstacle_spawn extended, humanized desktop */
export interface In3391{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3391{y:number;vy:number;sc:number}
const C3391={g:0.5, j:13};
export function extraRender_3391(inp:In3391, dt:number):Out3391 {
...
export const mm3391={d:'obstacle_spawn'};