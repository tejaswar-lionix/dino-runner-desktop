/** dino_module_3893 — parallax_bg extended, humanized desktop */
export interface In3893{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3893{y:number;vy:number;sc:number}
const C3893={g:0.6, j:11};
export function extraSpawn_3893(inp:In3893, dt:number):Out3893 {
...
export const mm3893={d:'parallax_bg'};