/** dino_module_3656 — particle_fx extended, humanized desktop */
export interface In3656{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3656{y:number;vy:number;sc:number}
const C3656={g:0.6, j:12};
export function extraRender_3656(inp:In3656, dt:number):Out3656 {
...
export const mm3656={d:'particle_fx'};