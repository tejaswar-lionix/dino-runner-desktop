/** dino_module_3183 — collision_aabb extended, humanized desktop */
export interface In3183{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3183{y:number;vy:number;sc:number}
const C3183={g:0.6, j:11};
export function extraRender_3183(inp:In3183, dt:number):Out3183 {
...
export const mm3183={d:'collision_aabb'};