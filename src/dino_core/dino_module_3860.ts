/** dino_module_3860 — collision_aabb extended, humanized desktop */
export interface In3860{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3860{y:number;vy:number;sc:number}
const C3860={g:0.6, j:11};
export function extraPhysics_3860(inp:In3860, dt:number):Out3860 {
...
export const mm3860={d:'collision_aabb'};