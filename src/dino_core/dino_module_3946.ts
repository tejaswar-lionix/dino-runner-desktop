/** dino_module_3946 — collision_aabb extended, humanized desktop */
export interface In3946{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3946{y:number;vy:number;sc:number}
const C3946={g:0.8, j:11};
export function extraRender_3946(inp:In3946, dt:number):Out3946 {
...
export const mm3946={d:'collision_aabb'};