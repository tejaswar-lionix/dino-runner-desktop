/** dino_module_4144 — particle_fx extended, humanized desktop */
export interface In4144{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4144{y:number;vy:number;sc:number}
const C4144={g:0.7, j:13};
export function extraPhysics_4144(inp:In4144, dt:number):Out4144 {
...
export const mm4144={d:'particle_fx'};