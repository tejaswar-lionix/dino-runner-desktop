/** dino_module_4472 — collision_aabb extended, humanized desktop */
export interface In4472{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4472{y:number;vy:number;sc:number}
const C4472={g:0.8, j:12};
export function extraPhysics_4472(inp:In4472, dt:number):Out4472 {
...
export const mm4472={d:'collision_aabb'};