/** dino_module_4970 — obstacle_spawn extended, humanized desktop */
export interface In4970{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4970{y:number;vy:number;sc:number}
const C4970={g:0.6, j:11};
export function extraRender_4970(inp:In4970, dt:number):Out4970 {
...
export const mm4970={d:'obstacle_spawn'};