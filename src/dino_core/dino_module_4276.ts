/** dino_module_4276 — collision_aabb extended, humanized desktop */
export interface In4276{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4276{y:number;vy:number;sc:number}
const C4276={g:0.7, j:13};
export function extraSpawn_4276(inp:In4276, dt:number):Out4276 {
...
export const mm4276={d:'collision_aabb'};