/** dino_module_3503 — obstacle_spawn extended, humanized desktop */
export interface In3503{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3503{y:number;vy:number;sc:number}
const C3503={g:0.6, j:13};
export function extraSpawn_3503(inp:In3503, dt:number):Out3503 {
...
export const mm3503={d:'obstacle_spawn'};