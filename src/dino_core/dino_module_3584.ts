/** dino_module_3584 — obstacle_spawn extended, humanized desktop */
export interface In3584{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3584{y:number;vy:number;sc:number}
const C3584={g:0.5, j:13};
export function extraPhysics_3584(inp:In3584, dt:number):Out3584 {
...
export const mm3584={d:'obstacle_spawn'};