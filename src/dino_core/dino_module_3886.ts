/** dino_module_3886 — obstacle_spawn extended, humanized desktop */
export interface In3886{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3886{y:number;vy:number;sc:number}
const C3886={g:0.8, j:11};
export function extraPhysics_3886(inp:In3886, dt:number):Out3886 {
...
export const mm3886={d:'obstacle_spawn'};