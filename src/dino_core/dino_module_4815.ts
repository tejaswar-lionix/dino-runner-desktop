/** dino_module_4815 — parallax_bg extended, humanized desktop */
export interface In4815{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4815{y:number;vy:number;sc:number}
const C4815={g:0.5, j:11};
export function extraSpawn_4815(inp:In4815, dt:number):Out4815 {
...
export const mm4815={d:'parallax_bg'};