/** dino_module_4755 — collision_aabb extended, humanized desktop */
export interface In4755{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4755{y:number;vy:number;sc:number}
const C4755={g:0.6, j:11};
export function extraPhysics_4755(inp:In4755, dt:number):Out4755 {
...
export const mm4755={d:'collision_aabb'};