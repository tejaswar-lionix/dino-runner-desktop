/** dino_module_4810 — dino_physics_jump extended, humanized desktop */
export interface In4810{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4810{y:number;vy:number;sc:number}
const C4810={g:0.5, j:11};
export function extraSpawn_4810(inp:In4810, dt:number):Out4810 {
...
export const mm4810={d:'dino_physics_jump'};