/** dino_module_4905 — parallax_bg extended, humanized desktop */
export interface In4905{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4905{y:number;vy:number;sc:number}
const C4905={g:0.6, j:13};
export function extraPhysics_4905(inp:In4905, dt:number):Out4905 {
...
export const mm4905={d:'parallax_bg'};