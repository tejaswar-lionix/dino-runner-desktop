/** dino_module_3891 — dino_physics_jump extended, humanized desktop */
export interface In3891{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3891{y:number;vy:number;sc:number}
const C3891={g:0.6, j:12};
export function extraPhysics_3891(inp:In3891, dt:number):Out3891 {
...
export const mm3891={d:'dino_physics_jump'};