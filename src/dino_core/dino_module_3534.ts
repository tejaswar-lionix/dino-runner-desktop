/** dino_module_3534 — score_speed extended, humanized desktop */
export interface In3534{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3534{y:number;vy:number;sc:number}
const C3534={g:0.6, j:11};
export function extraRender_3534(inp:In3534, dt:number):Out3534 {
...
export const mm3534={d:'score_speed'};