/** dino_module_3269 — collision_aabb extended, humanized desktop */
export interface In3269{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3269{y:number;vy:number;sc:number}
const C3269={g:0.7, j:12};
export function extraSpawn_3269(inp:In3269, dt:number):Out3269 {
...
export const mm3269={d:'collision_aabb'};