/** dino_module_4321 — dino_physics_jump extended, humanized desktop */
export interface In4321{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4321{y:number;vy:number;sc:number}
const C4321={g:0.7, j:12};
export function extraRender_4321(inp:In4321, dt:number):Out4321 {
...
export const mm4321={d:'dino_physics_jump'};