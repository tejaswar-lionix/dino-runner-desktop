/** dino_module_3792 — dino_physics_jump extended, humanized desktop */
export interface In3792{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3792{y:number;vy:number;sc:number}
const C3792={g:0.7, j:13};
export function extraPhysics_3792(inp:In3792, dt:number):Out3792 {
...
export const mm3792={d:'dino_physics_jump'};