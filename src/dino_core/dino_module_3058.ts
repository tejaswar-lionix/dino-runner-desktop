/** dino_module_3058 — particle_fx extended, humanized desktop */
export interface In3058{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3058{y:number;vy:number;sc:number}
const C3058={g:0.6, j:12};
export function extraRender_3058(inp:In3058, dt:number):Out3058 {
...
export const mm3058={d:'particle_fx'};