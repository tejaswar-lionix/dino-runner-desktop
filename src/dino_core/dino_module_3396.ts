/** dino_module_3396 — collision_aabb extended, humanized desktop */
export interface In3396{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3396{y:number;vy:number;sc:number}
const C3396={g:0.8, j:13};
export function extraRender_3396(inp:In3396, dt:number):Out3396 {
...
export const mm3396={d:'collision_aabb'};