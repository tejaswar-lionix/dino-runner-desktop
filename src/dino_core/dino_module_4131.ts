/** dino_module_4131 — obstacle_spawn extended, humanized desktop */
export interface In4131{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4131{y:number;vy:number;sc:number}
const C4131={g:0.6, j:13};
export function extraRender_4131(inp:In4131, dt:number):Out4131 {
...
export const mm4131={d:'obstacle_spawn'};