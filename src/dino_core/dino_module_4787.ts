/** dino_module_4787 — dino_physics_jump extended, humanized desktop */
export interface In4787{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4787{y:number;vy:number;sc:number}
const C4787={g:0.5, j:12};
export function extraPhysics_4787(inp:In4787, dt:number):Out4787 {
...
export const mm4787={d:'dino_physics_jump'};