/** dino_module_3139 — collision_aabb extended, humanized desktop */
export interface In3139{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3139{y:number;vy:number;sc:number}
const C3139={g:0.7, j:11};
export function extraPhysics_3139(inp:In3139, dt:number):Out3139 {
...
export const mm3139={d:'collision_aabb'};