/** dino_module_4685 — score_speed extended, humanized desktop */
export interface In4685{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4685{y:number;vy:number;sc:number}
const C4685={g:0.7, j:13};
export function extraPhysics_4685(inp:In4685, dt:number):Out4685 {
...
export const mm4685={d:'score_speed'};