/** dino_module_3635 — obstacle_spawn extended, humanized desktop */
export interface In3635{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3635{y:number;vy:number;sc:number}
const C3635={g:0.7, j:12};
export function extraRender_3635(inp:In3635, dt:number):Out3635 {
...
export const mm3635={d:'obstacle_spawn'};