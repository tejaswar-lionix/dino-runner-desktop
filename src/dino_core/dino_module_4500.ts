/** dino_module_4500 — collision_aabb extended, humanized desktop */
export interface In4500{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4500{y:number;vy:number;sc:number}
const C4500={g:0.5, j:13};
export function extraPhysics_4500(inp:In4500, dt:number):Out4500 {
...
export const mm4500={d:'collision_aabb'};