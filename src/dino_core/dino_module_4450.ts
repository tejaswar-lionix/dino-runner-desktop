/** dino_module_4450 — dino_physics_jump extended, humanized desktop */
export interface In4450{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4450{y:number;vy:number;sc:number}
const C4450={g:0.7, j:11};
export function extraSpawn_4450(inp:In4450, dt:number):Out4450 {
...
export const mm4450={d:'dino_physics_jump'};