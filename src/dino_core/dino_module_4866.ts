/** dino_module_4866 — obstacle_spawn extended, humanized desktop */
export interface In4866{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4866{y:number;vy:number;sc:number}
const C4866={g:0.7, j:11};
export function extraSpawn_4866(inp:In4866, dt:number):Out4866 {
...
export const mm4866={d:'obstacle_spawn'};