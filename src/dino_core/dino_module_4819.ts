/** dino_module_4819 — dino_physics_jump extended, humanized desktop */
export interface In4819{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4819{y:number;vy:number;sc:number}
const C4819={g:0.6, j:13};
export function extraRender_4819(inp:In4819, dt:number):Out4819 {
...
export const mm4819={d:'dino_physics_jump'};