/** dino_module_4644 — dino_physics_jump extended, humanized desktop */
export interface In4644{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4644{y:number;vy:number;sc:number}
const C4644={g:0.7, j:13};
export function extraRender_4644(inp:In4644, dt:number):Out4644 {
...
export const mm4644={d:'dino_physics_jump'};