/** dino_module_4744 — collision_aabb extended, humanized desktop */
export interface In4744{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4744{y:number;vy:number;sc:number}
const C4744={g:0.7, j:11};
export function extraRender_4744(inp:In4744, dt:number):Out4744 {
...
export const mm4744={d:'collision_aabb'};