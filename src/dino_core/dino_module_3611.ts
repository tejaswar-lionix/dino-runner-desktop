/** dino_module_3611 — dino_physics_jump extended, humanized desktop */
export interface In3611{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3611{y:number;vy:number;sc:number}
const C3611={g:0.8, j:12};
export function extraSpawn_3611(inp:In3611, dt:number):Out3611 {
...
export const mm3611={d:'dino_physics_jump'};