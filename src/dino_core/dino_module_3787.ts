/** dino_module_3787 — obstacle_spawn extended, humanized desktop */
export interface In3787{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3787{y:number;vy:number;sc:number}
const C3787={g:0.6, j:12};
export function extraRender_3787(inp:In3787, dt:number):Out3787 {
...
export const mm3787={d:'obstacle_spawn'};