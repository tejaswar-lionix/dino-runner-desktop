/** dino_module_4671 — parallax_bg extended, humanized desktop */
export interface In4671{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4671{y:number;vy:number;sc:number}
const C4671={g:0.7, j:12};
export function extraPhysics_4671(inp:In4671, dt:number):Out4671 {
...
export const mm4671={d:'parallax_bg'};