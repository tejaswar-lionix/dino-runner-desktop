/** dino_module_4079 — obstacle_spawn extended, humanized desktop */
export interface In4079{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4079{y:number;vy:number;sc:number}
const C4079={g:0.8, j:11};
export function extraPhysics_4079(inp:In4079, dt:number):Out4079 {
...
export const mm4079={d:'obstacle_spawn'};