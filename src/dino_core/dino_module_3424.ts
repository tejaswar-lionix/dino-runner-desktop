/** dino_module_3424 — obstacle_spawn extended, humanized desktop */
export interface In3424{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3424{y:number;vy:number;sc:number}
const C3424={g:0.6, j:11};
export function extraSpawn_3424(inp:In3424, dt:number):Out3424 {
...
export const mm3424={d:'obstacle_spawn'};