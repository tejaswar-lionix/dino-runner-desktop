/** dino_module_3055 — dino_physics_jump extended, humanized desktop */
export interface In3055{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3055{y:number;vy:number;sc:number}
const C3055={g:0.6, j:13};
export function extraPhysics_3055(inp:In3055, dt:number):Out3055 {
...
export const mm3055={d:'dino_physics_jump'};