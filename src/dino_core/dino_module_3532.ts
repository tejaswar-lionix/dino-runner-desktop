/** dino_module_3532 — obstacle_spawn extended, humanized desktop */
export interface In3532{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3532{y:number;vy:number;sc:number}
const C3532={g:0.7, j:12};
export function extraPhysics_3532(inp:In3532, dt:number):Out3532 {
...
export const mm3532={d:'obstacle_spawn'};