/** dino_module_4343 — dino_physics_jump extended, humanized desktop */
export interface In4343{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4343{y:number;vy:number;sc:number}
const C4343={g:0.8, j:11};
export function extraSpawn_4343(inp:In4343, dt:number):Out4343 {
...
export const mm4343={d:'dino_physics_jump'};