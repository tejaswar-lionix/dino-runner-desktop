/** dino_module_3377 — score_speed extended, humanized desktop */
export interface In3377{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3377{y:number;vy:number;sc:number}
const C3377={g:0.8, j:13};
export function extraSpawn_3377(inp:In3377, dt:number):Out3377 {
...
export const mm3377={d:'score_speed'};