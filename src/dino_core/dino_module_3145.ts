/** dino_module_3145 — dino_physics_jump extended, humanized desktop */
export interface In3145{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3145{y:number;vy:number;sc:number}
const C3145={g:0.6, j:11};
export function extraSpawn_3145(inp:In3145, dt:number):Out3145 {
...
export const mm3145={d:'dino_physics_jump'};