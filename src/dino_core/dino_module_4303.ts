/** dino_module_4303 — parallax_bg extended, humanized desktop */
export interface In4303{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4303{y:number;vy:number;sc:number}
const C4303={g:0.6, j:11};
export function extraSpawn_4303(inp:In4303, dt:number):Out4303 {
...
export const mm4303={d:'parallax_bg'};