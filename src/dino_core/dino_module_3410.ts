/** dino_module_3410 — collision_aabb extended, humanized desktop */
export interface In3410{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3410{y:number;vy:number;sc:number}
const C3410={g:0.8, j:13};
export function extraPhysics_3410(inp:In3410, dt:number):Out3410 {
...
export const mm3410={d:'collision_aabb'};