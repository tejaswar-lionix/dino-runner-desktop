/** dino_module_3066 — particle_fx extended, humanized desktop */
export interface In3066{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3066{y:number;vy:number;sc:number}
const C3066={g:0.5, j:13};
export function extraRender_3066(inp:In3066, dt:number):Out3066 {
...
export const mm3066={d:'particle_fx'};