/** dino_module_3578 — dino_physics_jump extended, humanized desktop */
export interface In3578{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3578{y:number;vy:number;sc:number}
const C3578={g:0.6, j:11};
export function extraSpawn_3578(inp:In3578, dt:number):Out3578 {
...
export const mm3578={d:'dino_physics_jump'};