/** dino_module_3661 — particle_fx extended, humanized desktop */
export interface In3661{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3661{y:number;vy:number;sc:number}
const C3661={g:0.5, j:11};
export function extraSpawn_3661(inp:In3661, dt:number):Out3661 {
...
export const mm3661={d:'particle_fx'};