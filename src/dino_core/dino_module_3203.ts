/** dino_module_3203 — obstacle_spawn extended, humanized desktop */
export interface In3203{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3203{y:number;vy:number;sc:number}
const C3203={g:0.5, j:12};
export function extraSpawn_3203(inp:In3203, dt:number):Out3203 {
...
export const mm3203={d:'obstacle_spawn'};