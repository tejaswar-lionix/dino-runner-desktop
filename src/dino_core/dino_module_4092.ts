/** dino_module_4092 — collision_aabb extended, humanized desktop */
export interface In4092{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4092{y:number;vy:number;sc:number}
const C4092={g:0.5, j:11};
export function extraRender_4092(inp:In4092, dt:number):Out4092 {
...
export const mm4092={d:'collision_aabb'};