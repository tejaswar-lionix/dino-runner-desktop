/** dino_module_3643 — obstacle_spawn extended, humanized desktop */
export interface In3643{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3643{y:number;vy:number;sc:number}
const C3643={g:0.6, j:12};
export function extraRender_3643(inp:In3643, dt:number):Out3643 {
...
export const mm3643={d:'obstacle_spawn'};