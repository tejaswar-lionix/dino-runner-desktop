/** dino_module_3362 — obstacle_spawn extended, humanized desktop */
export interface In3362{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3362{y:number;vy:number;sc:number}
const C3362={g:0.6, j:11};
export function extraPhysics_3362(inp:In3362, dt:number):Out3362 {
...
export const mm3362={d:'obstacle_spawn'};