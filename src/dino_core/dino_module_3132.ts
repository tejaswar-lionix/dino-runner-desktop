/** dino_module_3132 — particle_fx extended, humanized desktop */
export interface In3132{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3132{y:number;vy:number;sc:number}
const C3132={g:0.6, j:13};
export function extraPhysics_3132(inp:In3132, dt:number):Out3132 {
...
export const mm3132={d:'particle_fx'};