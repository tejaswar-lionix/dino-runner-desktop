/** dino_module_4071 — collision_aabb extended, humanized desktop */
export interface In4071{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4071{y:number;vy:number;sc:number}
const C4071={g:0.5, j:12};
export function extraPhysics_4071(inp:In4071, dt:number):Out4071 {
...
export const mm4071={d:'collision_aabb'};