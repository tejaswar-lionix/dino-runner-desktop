/** dino_module_4416 — score_speed extended, humanized desktop */
export interface In4416{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4416{y:number;vy:number;sc:number}
const C4416={g:0.6, j:13};
export function extraRender_4416(inp:In4416, dt:number):Out4416 {
...
export const mm4416={d:'score_speed'};