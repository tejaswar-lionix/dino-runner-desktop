/** dino_module_4129 — obstacle_spawn extended, humanized desktop */
export interface In4129{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4129{y:number;vy:number;sc:number}
const C4129={g:0.7, j:13};
export function extraSpawn_4129(inp:In4129, dt:number):Out4129 {
...
export const mm4129={d:'obstacle_spawn'};