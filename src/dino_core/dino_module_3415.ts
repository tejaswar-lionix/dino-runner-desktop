/** dino_module_3415 — collision_aabb extended, humanized desktop */
export interface In3415{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3415{y:number;vy:number;sc:number}
const C3415={g:0.5, j:13};
export function extraSpawn_3415(inp:In3415, dt:number):Out3415 {
...
export const mm3415={d:'collision_aabb'};