/** dino_module_3526 — dino_physics_jump extended, humanized desktop */
export interface In3526{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3526{y:number;vy:number;sc:number}
const C3526={g:0.5, j:13};
export function extraPhysics_3526(inp:In3526, dt:number):Out3526 {
...
export const mm3526={d:'dino_physics_jump'};