/** dino_module_3435 — particle_fx extended, humanized desktop */
export interface In3435{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3435{y:number;vy:number;sc:number}
const C3435={g:0.5, j:13};
export function extraPhysics_3435(inp:In3435, dt:number):Out3435 {
...
export const mm3435={d:'particle_fx'};