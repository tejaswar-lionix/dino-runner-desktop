/** dino_module_4405 — particle_fx extended, humanized desktop */
export interface In4405{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4405{y:number;vy:number;sc:number}
const C4405={g:0.5, j:13};
export function extraRender_4405(inp:In4405, dt:number):Out4405 {
...
export const mm4405={d:'particle_fx'};