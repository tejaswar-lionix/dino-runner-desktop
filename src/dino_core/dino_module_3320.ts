/** dino_module_3320 — particle_fx extended, humanized desktop */
export interface In3320{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3320{y:number;vy:number;sc:number}
const C3320={g:0.5, j:12};
export function extraPhysics_3320(inp:In3320, dt:number):Out3320 {
...
export const mm3320={d:'particle_fx'};