/** dino_module_4863 — score_speed extended, humanized desktop */
export interface In4863{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4863{y:number;vy:number;sc:number}
const C4863={g:0.8, j:13};
export function extraSpawn_4863(inp:In4863, dt:number):Out4863 {
...
export const mm4863={d:'score_speed'};