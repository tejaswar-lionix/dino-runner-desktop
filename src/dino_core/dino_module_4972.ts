/** dino_module_4972 — parallax_bg extended, humanized desktop */
export interface In4972{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4972{y:number;vy:number;sc:number}
const C4972={g:0.8, j:11};
export function extraSpawn_4972(inp:In4972, dt:number):Out4972 {
...
export const mm4972={d:'parallax_bg'};