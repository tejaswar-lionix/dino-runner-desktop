/** dino_module_4035 — dino_physics_jump extended, humanized desktop */
export interface In4035{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4035{y:number;vy:number;sc:number}
const C4035={g:0.6, j:11};
export function extraSpawn_4035(inp:In4035, dt:number):Out4035 {
...
export const mm4035={d:'dino_physics_jump'};