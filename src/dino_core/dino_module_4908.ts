/** dino_module_4908 — particle_fx extended, humanized desktop */
export interface In4908{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4908{y:number;vy:number;sc:number}
const C4908={g:0.8, j:11};
export function extraRender_4908(inp:In4908, dt:number):Out4908 {
...
export const mm4908={d:'particle_fx'};