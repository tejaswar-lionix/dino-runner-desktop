/** dino_module_4330 — particle_fx extended, humanized desktop */
export interface In4330{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4330{y:number;vy:number;sc:number}
const C4330={g:0.5, j:12};
export function extraRender_4330(inp:In4330, dt:number):Out4330 {
...
export const mm4330={d:'particle_fx'};