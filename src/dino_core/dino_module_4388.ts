/** dino_module_4388 — particle_fx extended, humanized desktop */
export interface In4388{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4388{y:number;vy:number;sc:number}
const C4388={g:0.8, j:12};
export function extraSpawn_4388(inp:In4388, dt:number):Out4388 {
...
export const mm4388={d:'particle_fx'};