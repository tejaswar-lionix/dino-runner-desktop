/** dino_module_4686 — particle_fx extended, humanized desktop */
export interface In4686{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4686{y:number;vy:number;sc:number}
const C4686={g:0.7, j:12};
export function extraPhysics_4686(inp:In4686, dt:number):Out4686 {
...
export const mm4686={d:'particle_fx'};