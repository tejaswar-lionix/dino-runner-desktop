/** dino_module_4197 — parallax_bg extended, humanized desktop */
export interface In4197{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4197{y:number;vy:number;sc:number}
const C4197={g:0.5, j:13};
export function extraRender_4197(inp:In4197, dt:number):Out4197 {
...
export const mm4197={d:'parallax_bg'};