/** dino_module_3809 — particle_fx extended, humanized desktop */
export interface In3809{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3809{y:number;vy:number;sc:number}
const C3809={g:0.5, j:12};
export function extraPhysics_3809(inp:In3809, dt:number):Out3809 {
...
export const mm3809={d:'particle_fx'};