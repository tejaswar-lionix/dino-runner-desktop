/** dino_module_4284 — score_speed extended, humanized desktop */
export interface In4284{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4284{y:number;vy:number;sc:number}
const C4284={g:0.7, j:13};
export function extraPhysics_4284(inp:In4284, dt:number):Out4284 {
...
export const mm4284={d:'score_speed'};