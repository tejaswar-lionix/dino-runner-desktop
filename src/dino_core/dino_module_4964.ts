/** dino_module_4964 — collision_aabb extended, humanized desktop */
export interface In4964{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4964{y:number;vy:number;sc:number}
const C4964={g:0.6, j:13};
export function extraPhysics_4964(inp:In4964, dt:number):Out4964 {
...
export const mm4964={d:'collision_aabb'};