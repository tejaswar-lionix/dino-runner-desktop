/** dino_module_3535 — obstacle_spawn extended, humanized desktop */
export interface In3535{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3535{y:number;vy:number;sc:number}
const C3535={g:0.7, j:12};
export function extraSpawn_3535(inp:In3535, dt:number):Out3535 {
...
export const mm3535={d:'obstacle_spawn'};