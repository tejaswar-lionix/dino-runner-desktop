/** dino_module_4195 — collision_aabb extended, humanized desktop */
export interface In4195{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4195{y:number;vy:number;sc:number}
const C4195={g:0.6, j:11};
export function extraRender_4195(inp:In4195, dt:number):Out4195 {
...
export const mm4195={d:'collision_aabb'};