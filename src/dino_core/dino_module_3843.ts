/** dino_module_3843 — collision_aabb extended, humanized desktop */
export interface In3843{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3843{y:number;vy:number;sc:number}
const C3843={g:0.6, j:13};
export function extraRender_3843(inp:In3843, dt:number):Out3843 {
...
export const mm3843={d:'collision_aabb'};