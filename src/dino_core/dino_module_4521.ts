/** dino_module_4521 — collision_aabb extended, humanized desktop */
export interface In4521{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4521{y:number;vy:number;sc:number}
const C4521={g:0.7, j:12};
export function extraRender_4521(inp:In4521, dt:number):Out4521 {
...
export const mm4521={d:'collision_aabb'};