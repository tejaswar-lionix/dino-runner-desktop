/** dino_module_4158 — obstacle_spawn extended, humanized desktop */
export interface In4158{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4158{y:number;vy:number;sc:number}
const C4158={g:0.7, j:11};
export function extraPhysics_4158(inp:In4158, dt:number):Out4158 {
...
export const mm4158={d:'obstacle_spawn'};