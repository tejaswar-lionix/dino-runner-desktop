/** dino_module_4827 — dino_physics_jump extended, humanized desktop */
export interface In4827{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4827{y:number;vy:number;sc:number}
const C4827={g:0.6, j:11};
export function extraSpawn_4827(inp:In4827, dt:number):Out4827 {
...
export const mm4827={d:'dino_physics_jump'};