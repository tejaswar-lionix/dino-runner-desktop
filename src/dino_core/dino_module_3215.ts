/** dino_module_3215 — collision_aabb extended, humanized desktop */
export interface In3215{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3215{y:number;vy:number;sc:number}
const C3215={g:0.8, j:12};
export function extraPhysics_3215(inp:In3215, dt:number):Out3215 {
...
export const mm3215={d:'collision_aabb'};