/** dino_module_3049 — score_speed extended, humanized desktop */
export interface In3049{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3049{y:number;vy:number;sc:number}
const C3049={g:0.6, j:11};
export function extraRender_3049(inp:In3049, dt:number):Out3049 {
...
export const mm3049={d:'score_speed'};