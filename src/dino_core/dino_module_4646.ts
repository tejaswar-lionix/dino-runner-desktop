/** dino_module_4646 — collision_aabb extended, humanized desktop */
export interface In4646{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4646{y:number;vy:number;sc:number}
const C4646={g:0.5, j:11};
export function extraSpawn_4646(inp:In4646, dt:number):Out4646 {
...
export const mm4646={d:'collision_aabb'};