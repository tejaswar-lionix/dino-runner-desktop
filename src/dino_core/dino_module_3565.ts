/** dino_module_3565 — parallax_bg extended, humanized desktop */
export interface In3565{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3565{y:number;vy:number;sc:number}
const C3565={g:0.6, j:13};
export function extraRender_3565(inp:In3565, dt:number):Out3565 {
...
export const mm3565={d:'parallax_bg'};