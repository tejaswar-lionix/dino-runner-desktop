/** dino_module_3030 — collision_aabb extended, humanized desktop */
export interface In3030{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3030{y:number;vy:number;sc:number}
const C3030={g:0.6, j:13};
export function extraRender_3030(inp:In3030, dt:number):Out3030 {
...
export const mm3030={d:'collision_aabb'};