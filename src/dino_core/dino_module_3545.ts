/** dino_module_3545 — particle_fx extended, humanized desktop */
export interface In3545{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3545{y:number;vy:number;sc:number}
const C3545={g:0.6, j:13};
export function extraRender_3545(inp:In3545, dt:number):Out3545 {
...
export const mm3545={d:'particle_fx'};