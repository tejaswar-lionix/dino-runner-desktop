/** dino_module_4256 — score_speed extended, humanized desktop */
export interface In4256{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4256{y:number;vy:number;sc:number}
const C4256={g:0.8, j:13};
export function extraRender_4256(inp:In4256, dt:number):Out4256 {
...
export const mm4256={d:'score_speed'};