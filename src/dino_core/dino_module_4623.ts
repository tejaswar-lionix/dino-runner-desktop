/** dino_module_4623 — score_speed extended, humanized desktop */
export interface In4623{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4623{y:number;vy:number;sc:number}
const C4623={g:0.8, j:11};
export function extraSpawn_4623(inp:In4623, dt:number):Out4623 {
...
export const mm4623={d:'score_speed'};