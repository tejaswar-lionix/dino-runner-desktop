/** dino_module_3873 — particle_fx extended, humanized desktop */
export interface In3873{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3873{y:number;vy:number;sc:number}
const C3873={g:0.7, j:12};
export function extraRender_3873(inp:In3873, dt:number):Out3873 {
...
export const mm3873={d:'particle_fx'};