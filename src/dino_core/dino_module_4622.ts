/** dino_module_4622 — dino_physics_jump extended, humanized desktop */
export interface In4622{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4622{y:number;vy:number;sc:number}
const C4622={g:0.8, j:13};
export function extraRender_4622(inp:In4622, dt:number):Out4622 {
...
export const mm4622={d:'dino_physics_jump'};