/** dino_module_3765 — collision_aabb extended, humanized desktop */
export interface In3765{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3765{y:number;vy:number;sc:number}
const C3765={g:0.6, j:12};
export function extraPhysics_3765(inp:In3765, dt:number):Out3765 {
...
export const mm3765={d:'collision_aabb'};