/** dino_module_3478 — particle_fx extended, humanized desktop */
export interface In3478{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3478{y:number;vy:number;sc:number}
const C3478={g:0.6, j:12};
export function extraSpawn_3478(inp:In3478, dt:number):Out3478 {
...
export const mm3478={d:'particle_fx'};