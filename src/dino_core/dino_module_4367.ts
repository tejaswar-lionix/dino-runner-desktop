/** dino_module_4367 — parallax_bg extended, humanized desktop */
export interface In4367{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4367{y:number;vy:number;sc:number}
const C4367={g:0.7, j:13};
export function extraSpawn_4367(inp:In4367, dt:number):Out4367 {
...
export const mm4367={d:'parallax_bg'};