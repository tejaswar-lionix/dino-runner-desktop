/** dino_module_4709 — dino_physics_jump extended, humanized desktop */
export interface In4709{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4709{y:number;vy:number;sc:number}
const C4709={g:0.8, j:13};
export function extraSpawn_4709(inp:In4709, dt:number):Out4709 {
...
export const mm4709={d:'dino_physics_jump'};