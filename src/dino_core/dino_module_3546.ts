/** dino_module_3546 — score_speed extended, humanized desktop */
export interface In3546{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3546{y:number;vy:number;sc:number}
const C3546={g:0.8, j:12};
export function extraRender_3546(inp:In3546, dt:number):Out3546 {
...
export const mm3546={d:'score_speed'};