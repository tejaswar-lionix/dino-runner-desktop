/** dino_module_4243 — particle_fx extended, humanized desktop */
export interface In4243{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4243{y:number;vy:number;sc:number}
const C4243={g:0.6, j:11};
export function extraRender_4243(inp:In4243, dt:number):Out4243 {
...
export const mm4243={d:'particle_fx'};