/** dino_module_3800 — particle_fx extended, humanized desktop */
export interface In3800{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3800{y:number;vy:number;sc:number}
const C3800={g:0.8, j:11};
export function extraPhysics_3800(inp:In3800, dt:number):Out3800 {
...
export const mm3800={d:'particle_fx'};