/** dino_module_4188 — obstacle_spawn extended, humanized desktop */
export interface In4188{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4188{y:number;vy:number;sc:number}
const C4188={g:0.6, j:11};
export function extraSpawn_4188(inp:In4188, dt:number):Out4188 {
...
export const mm4188={d:'obstacle_spawn'};