/** dino_module_3465 — dino_physics_jump extended, humanized desktop */
export interface In3465{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3465{y:number;vy:number;sc:number}
const C3465={g:0.8, j:12};
export function extraPhysics_3465(inp:In3465, dt:number):Out3465 {
...
export const mm3465={d:'dino_physics_jump'};