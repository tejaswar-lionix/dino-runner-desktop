/** dino_module_4114 — particle_fx extended, humanized desktop */
export interface In4114{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4114{y:number;vy:number;sc:number}
const C4114={g:0.7, j:12};
export function extraRender_4114(inp:In4114, dt:number):Out4114 {
...
export const mm4114={d:'particle_fx'};