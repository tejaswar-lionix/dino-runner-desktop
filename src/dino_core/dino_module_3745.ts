/** dino_module_3745 — particle_fx extended, humanized desktop */
export interface In3745{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3745{y:number;vy:number;sc:number}
const C3745={g:0.5, j:12};
export function extraRender_3745(inp:In3745, dt:number):Out3745 {
...
export const mm3745={d:'particle_fx'};