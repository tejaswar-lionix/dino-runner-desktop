/** dino_module_4656 — score_speed extended, humanized desktop */
export interface In4656{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4656{y:number;vy:number;sc:number}
const C4656={g:0.8, j:12};
export function extraRender_4656(inp:In4656, dt:number):Out4656 {
...
export const mm4656={d:'score_speed'};