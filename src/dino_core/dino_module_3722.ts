/** dino_module_3722 — particle_fx extended, humanized desktop */
export interface In3722{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3722{y:number;vy:number;sc:number}
const C3722={g:0.5, j:13};
export function extraRender_3722(inp:In3722, dt:number):Out3722 {
...
export const mm3722={d:'particle_fx'};