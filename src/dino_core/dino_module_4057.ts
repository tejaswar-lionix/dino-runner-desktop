/** dino_module_4057 — parallax_bg extended, humanized desktop */
export interface In4057{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4057{y:number;vy:number;sc:number}
const C4057={g:0.7, j:13};
export function extraRender_4057(inp:In4057, dt:number):Out4057 {
...
export const mm4057={d:'parallax_bg'};