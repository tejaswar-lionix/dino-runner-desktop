/** dino_module_3654 — particle_fx extended, humanized desktop */
export interface In3654{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3654{y:number;vy:number;sc:number}
const C3654={g:0.5, j:12};
export function extraPhysics_3654(inp:In3654, dt:number):Out3654 {
...
export const mm3654={d:'particle_fx'};