/** dino_module_3474 — collision_aabb extended, humanized desktop */
export interface In3474{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3474{y:number;vy:number;sc:number}
const C3474={g:0.6, j:11};
export function extraRender_3474(inp:In3474, dt:number):Out3474 {
...
export const mm3474={d:'collision_aabb'};