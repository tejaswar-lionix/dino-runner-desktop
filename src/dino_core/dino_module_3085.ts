/** dino_module_3085 — collision_aabb extended, humanized desktop */
export interface In3085{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3085{y:number;vy:number;sc:number}
const C3085={g:0.8, j:11};
export function extraRender_3085(inp:In3085, dt:number):Out3085 {
...
export const mm3085={d:'collision_aabb'};