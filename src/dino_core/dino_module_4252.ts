/** dino_module_4252 — collision_aabb extended, humanized desktop */
export interface In4252{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4252{y:number;vy:number;sc:number}
const C4252={g:0.6, j:13};
export function extraPhysics_4252(inp:In4252, dt:number):Out4252 {
...
export const mm4252={d:'collision_aabb'};