/** dino_module_4274 — obstacle_spawn extended, humanized desktop */
export interface In4274{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4274{y:number;vy:number;sc:number}
const C4274={g:0.6, j:12};
export function extraSpawn_4274(inp:In4274, dt:number):Out4274 {
...
export const mm4274={d:'obstacle_spawn'};