/** dino_module_3128 — obstacle_spawn extended, humanized desktop */
export interface In3128{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3128{y:number;vy:number;sc:number}
const C3128={g:0.8, j:13};
export function extraPhysics_3128(inp:In3128, dt:number):Out3128 {
...
export const mm3128={d:'obstacle_spawn'};