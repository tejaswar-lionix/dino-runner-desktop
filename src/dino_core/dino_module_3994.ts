/** dino_module_3994 — score_speed extended, humanized desktop */
export interface In3994{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3994{y:number;vy:number;sc:number}
const C3994={g:0.6, j:11};
export function extraSpawn_3994(inp:In3994, dt:number):Out3994 {
...
export const mm3994={d:'score_speed'};