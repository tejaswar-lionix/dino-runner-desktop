/** dino_module_4901 — particle_fx extended, humanized desktop */
export interface In4901{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4901{y:number;vy:number;sc:number}
const C4901={g:0.5, j:13};
export function extraRender_4901(inp:In4901, dt:number):Out4901 {
...
export const mm4901={d:'particle_fx'};