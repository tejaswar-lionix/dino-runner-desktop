/** dino_module_4666 — parallax_bg extended, humanized desktop */
export interface In4666{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4666{y:number;vy:number;sc:number}
const C4666={g:0.8, j:12};
export function extraPhysics_4666(inp:In4666, dt:number):Out4666 {
...
export const mm4666={d:'parallax_bg'};