/** dino_module_4286 — score_speed extended, humanized desktop */
export interface In4286{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4286{y:number;vy:number;sc:number}
const C4286={g:0.7, j:13};
export function extraPhysics_4286(inp:In4286, dt:number):Out4286 {
...
export const mm4286={d:'score_speed'};