/** dino_module_3883 — parallax_bg extended, humanized desktop */
export interface In3883{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3883{y:number;vy:number;sc:number}
const C3883={g:0.8, j:13};
export function extraSpawn_3883(inp:In3883, dt:number):Out3883 {
...
export const mm3883={d:'parallax_bg'};