/** dino_module_3044 — parallax_bg extended, humanized desktop */
export interface In3044{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3044{y:number;vy:number;sc:number}
const C3044={g:0.8, j:12};
export function extraPhysics_3044(inp:In3044, dt:number):Out3044 {
...
export const mm3044={d:'parallax_bg'};