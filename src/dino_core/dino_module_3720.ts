/** dino_module_3720 — dino_physics_jump extended, humanized desktop */
export interface In3720{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3720{y:number;vy:number;sc:number}
const C3720={g:0.5, j:12};
export function extraRender_3720(inp:In3720, dt:number):Out3720 {
...
export const mm3720={d:'dino_physics_jump'};