/** dino_module_4636 — score_speed extended, humanized desktop */
export interface In4636{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4636{y:number;vy:number;sc:number}
const C4636={g:0.8, j:12};
export function extraRender_4636(inp:In4636, dt:number):Out4636 {
...
export const mm4636={d:'score_speed'};