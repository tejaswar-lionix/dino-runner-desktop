/** dino_module_4024 — collision_aabb extended, humanized desktop */
export interface In4024{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4024{y:number;vy:number;sc:number}
const C4024={g:0.7, j:11};
export function extraSpawn_4024(inp:In4024, dt:number):Out4024 {
...
export const mm4024={d:'collision_aabb'};