/** dino_module_3706 — particle_fx extended, humanized desktop */
export interface In3706{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3706{y:number;vy:number;sc:number}
const C3706={g:0.5, j:13};
export function extraPhysics_3706(inp:In3706, dt:number):Out3706 {
...
export const mm3706={d:'particle_fx'};