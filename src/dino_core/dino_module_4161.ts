/** dino_module_4161 — obstacle_spawn extended, humanized desktop */
export interface In4161{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4161{y:number;vy:number;sc:number}
const C4161={g:0.8, j:11};
export function extraPhysics_4161(inp:In4161, dt:number):Out4161 {
...
export const mm4161={d:'obstacle_spawn'};