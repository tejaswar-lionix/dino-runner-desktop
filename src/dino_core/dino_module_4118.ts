/** dino_module_4118 — particle_fx extended, humanized desktop */
export interface In4118{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4118{y:number;vy:number;sc:number}
const C4118={g:0.8, j:12};
export function extraSpawn_4118(inp:In4118, dt:number):Out4118 {
...
export const mm4118={d:'particle_fx'};