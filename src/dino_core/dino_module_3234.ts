/** dino_module_3234 — dino_physics_jump extended, humanized desktop */
export interface In3234{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3234{y:number;vy:number;sc:number}
const C3234={g:0.6, j:12};
export function extraSpawn_3234(inp:In3234, dt:number):Out3234 {
...
export const mm3234={d:'dino_physics_jump'};