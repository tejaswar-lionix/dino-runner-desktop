/** dino_module_4897 — score_speed extended, humanized desktop */
export interface In4897{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4897{y:number;vy:number;sc:number}
const C4897={g:0.7, j:11};
export function extraPhysics_4897(inp:In4897, dt:number):Out4897 {
...
export const mm4897={d:'score_speed'};