/** dino_module_4920 — collision_aabb extended, humanized desktop */
export interface In4920{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4920{y:number;vy:number;sc:number}
const C4920={g:0.8, j:13};
export function extraSpawn_4920(inp:In4920, dt:number):Out4920 {
...
export const mm4920={d:'collision_aabb'};