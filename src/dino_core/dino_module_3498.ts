/** dino_module_3498 — collision_aabb extended, humanized desktop */
export interface In3498{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3498{y:number;vy:number;sc:number}
const C3498={g:0.8, j:13};
export function extraPhysics_3498(inp:In3498, dt:number):Out3498 {
...
export const mm3498={d:'collision_aabb'};