/** dino_module_4488 — parallax_bg extended, humanized desktop */
export interface In4488{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4488{y:number;vy:number;sc:number}
const C4488={g:0.8, j:13};
export function extraRender_4488(inp:In4488, dt:number):Out4488 {
...
export const mm4488={d:'parallax_bg'};