/** dino_module_3514 — particle_fx extended, humanized desktop */
export interface In3514{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3514{y:number;vy:number;sc:number}
const C3514={g:0.8, j:12};
export function extraPhysics_3514(inp:In3514, dt:number):Out3514 {
...
export const mm3514={d:'particle_fx'};