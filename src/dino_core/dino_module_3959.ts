/** dino_module_3959 — obstacle_spawn extended, humanized desktop */
export interface In3959{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3959{y:number;vy:number;sc:number}
const C3959={g:0.7, j:12};
export function extraSpawn_3959(inp:In3959, dt:number):Out3959 {
...
export const mm3959={d:'obstacle_spawn'};