/** dino_module_3078 — collision_aabb extended, humanized desktop */
export interface In3078{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3078{y:number;vy:number;sc:number}
const C3078={g:0.6, j:11};
export function extraRender_3078(inp:In3078, dt:number):Out3078 {
...
export const mm3078={d:'collision_aabb'};