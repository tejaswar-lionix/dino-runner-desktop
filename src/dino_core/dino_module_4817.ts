/** dino_module_4817 — parallax_bg extended, humanized desktop */
export interface In4817{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4817{y:number;vy:number;sc:number}
const C4817={g:0.8, j:12};
export function extraPhysics_4817(inp:In4817, dt:number):Out4817 {
...
export const mm4817={d:'parallax_bg'};