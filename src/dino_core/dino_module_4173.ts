/** dino_module_4173 — collision_aabb extended, humanized desktop */
export interface In4173{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4173{y:number;vy:number;sc:number}
const C4173={g:0.5, j:12};
export function extraSpawn_4173(inp:In4173, dt:number):Out4173 {
...
export const mm4173={d:'collision_aabb'};