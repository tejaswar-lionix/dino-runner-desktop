/** dino_module_4589 — dino_physics_jump extended, humanized desktop */
export interface In4589{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4589{y:number;vy:number;sc:number}
const C4589={g:0.8, j:12};
export function extraRender_4589(inp:In4589, dt:number):Out4589 {
...
export const mm4589={d:'dino_physics_jump'};