/** dino_module_4669 — obstacle_spawn extended, humanized desktop */
export interface In4669{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4669{y:number;vy:number;sc:number}
const C4669={g:0.7, j:12};
export function extraRender_4669(inp:In4669, dt:number):Out4669 {
...
export const mm4669={d:'obstacle_spawn'};