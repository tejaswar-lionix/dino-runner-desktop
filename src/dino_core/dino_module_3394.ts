/** dino_module_3394 — collision_aabb extended, humanized desktop */
export interface In3394{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3394{y:number;vy:number;sc:number}
const C3394={g:0.8, j:11};
export function extraSpawn_3394(inp:In3394, dt:number):Out3394 {
...
export const mm3394={d:'collision_aabb'};