/** dino_module_4457 — collision_aabb extended, humanized desktop */
export interface In4457{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4457{y:number;vy:number;sc:number}
const C4457={g:0.8, j:12};
export function extraSpawn_4457(inp:In4457, dt:number):Out4457 {
...
export const mm4457={d:'collision_aabb'};