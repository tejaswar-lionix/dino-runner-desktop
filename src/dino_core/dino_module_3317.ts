/** dino_module_3317 — obstacle_spawn extended, humanized desktop */
export interface In3317{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3317{y:number;vy:number;sc:number}
const C3317={g:0.6, j:11};
export function extraRender_3317(inp:In3317, dt:number):Out3317 {
...
export const mm3317={d:'obstacle_spawn'};