/** dino_module_4298 — obstacle_spawn extended, humanized desktop */
export interface In4298{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4298{y:number;vy:number;sc:number}
const C4298={g:0.5, j:11};
export function extraPhysics_4298(inp:In4298, dt:number):Out4298 {
...
export const mm4298={d:'obstacle_spawn'};