/** dino_module_3146 — score_speed extended, humanized desktop */
export interface In3146{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3146{y:number;vy:number;sc:number}
const C3146={g:0.5, j:13};
export function extraPhysics_3146(inp:In3146, dt:number):Out3146 {
...
export const mm3146={d:'score_speed'};