/** dino_module_4921 — score_speed extended, humanized desktop */
export interface In4921{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4921{y:number;vy:number;sc:number}
const C4921={g:0.6, j:12};
export function extraSpawn_4921(inp:In4921, dt:number):Out4921 {
...
export const mm4921={d:'score_speed'};