/** dino_module_3982 — collision_aabb extended, humanized desktop */
export interface In3982{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3982{y:number;vy:number;sc:number}
const C3982={g:0.5, j:11};
export function extraSpawn_3982(inp:In3982, dt:number):Out3982 {
...
export const mm3982={d:'collision_aabb'};