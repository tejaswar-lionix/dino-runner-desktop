/** dino_module_3460 — obstacle_spawn extended, humanized desktop */
export interface In3460{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3460{y:number;vy:number;sc:number}
const C3460={g:0.5, j:11};
export function extraPhysics_3460(inp:In3460, dt:number):Out3460 {
...
export const mm3460={d:'obstacle_spawn'};