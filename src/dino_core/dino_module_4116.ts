/** dino_module_4116 — collision_aabb extended, humanized desktop */
export interface In4116{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4116{y:number;vy:number;sc:number}
const C4116={g:0.7, j:12};
export function extraSpawn_4116(inp:In4116, dt:number):Out4116 {
...
export const mm4116={d:'collision_aabb'};