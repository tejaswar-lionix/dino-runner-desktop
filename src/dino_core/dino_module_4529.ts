/** dino_module_4529 — parallax_bg extended, humanized desktop */
export interface In4529{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4529{y:number;vy:number;sc:number}
const C4529={g:0.8, j:13};
export function extraPhysics_4529(inp:In4529, dt:number):Out4529 {
...
export const mm4529={d:'parallax_bg'};