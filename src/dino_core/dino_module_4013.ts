/** dino_module_4013 — obstacle_spawn extended, humanized desktop */
export interface In4013{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4013{y:number;vy:number;sc:number}
const C4013={g:0.8, j:12};
export function extraPhysics_4013(inp:In4013, dt:number):Out4013 {
...
export const mm4013={d:'obstacle_spawn'};