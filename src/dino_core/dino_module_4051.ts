/** dino_module_4051 — particle_fx extended, humanized desktop */
export interface In4051{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4051{y:number;vy:number;sc:number}
const C4051={g:0.5, j:11};
export function extraPhysics_4051(inp:In4051, dt:number):Out4051 {
...
export const mm4051={d:'particle_fx'};