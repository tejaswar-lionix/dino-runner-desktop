/** dino_module_4120 — obstacle_spawn extended, humanized desktop */
export interface In4120{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4120{y:number;vy:number;sc:number}
const C4120={g:0.6, j:13};
export function extraRender_4120(inp:In4120, dt:number):Out4120 {
...
export const mm4120={d:'obstacle_spawn'};