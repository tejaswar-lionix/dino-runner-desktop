/** dino_module_3189 — dino_physics_jump extended, humanized desktop */
export interface In3189{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3189{y:number;vy:number;sc:number}
const C3189={g:0.6, j:13};
export function extraSpawn_3189(inp:In3189, dt:number):Out3189 {
...
export const mm3189={d:'dino_physics_jump'};