/** dino_module_4263 — obstacle_spawn extended, humanized desktop */
export interface In4263{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4263{y:number;vy:number;sc:number}
const C4263={g:0.7, j:11};
export function extraSpawn_4263(inp:In4263, dt:number):Out4263 {
...
export const mm4263={d:'obstacle_spawn'};