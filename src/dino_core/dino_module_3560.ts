/** dino_module_3560 — parallax_bg extended, humanized desktop */
export interface In3560{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3560{y:number;vy:number;sc:number}
const C3560={g:0.6, j:11};
export function extraRender_3560(inp:In3560, dt:number):Out3560 {
...
export const mm3560={d:'parallax_bg'};