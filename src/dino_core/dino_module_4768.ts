/** dino_module_4768 — particle_fx extended, humanized desktop */
export interface In4768{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4768{y:number;vy:number;sc:number}
const C4768={g:0.7, j:11};
export function extraSpawn_4768(inp:In4768, dt:number):Out4768 {
...
export const mm4768={d:'particle_fx'};