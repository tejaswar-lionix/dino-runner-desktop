/** dino_module_3423 — dino_physics_jump extended, humanized desktop */
export interface In3423{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3423{y:number;vy:number;sc:number}
const C3423={g:0.7, j:11};
export function extraRender_3423(inp:In3423, dt:number):Out3423 {
...
export const mm3423={d:'dino_physics_jump'};