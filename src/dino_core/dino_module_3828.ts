/** dino_module_3828 — parallax_bg extended, humanized desktop */
export interface In3828{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3828{y:number;vy:number;sc:number}
const C3828={g:0.5, j:13};
export function extraSpawn_3828(inp:In3828, dt:number):Out3828 {
...
export const mm3828={d:'parallax_bg'};