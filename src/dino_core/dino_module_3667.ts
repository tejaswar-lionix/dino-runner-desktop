/** dino_module_3667 — particle_fx extended, humanized desktop */
export interface In3667{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3667{y:number;vy:number;sc:number}
const C3667={g:0.6, j:13};
export function extraRender_3667(inp:In3667, dt:number):Out3667 {
...
export const mm3667={d:'particle_fx'};