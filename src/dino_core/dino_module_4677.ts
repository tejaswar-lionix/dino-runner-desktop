/** dino_module_4677 — particle_fx extended, humanized desktop */
export interface In4677{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4677{y:number;vy:number;sc:number}
const C4677={g:0.7, j:13};
export function extraRender_4677(inp:In4677, dt:number):Out4677 {
...
export const mm4677={d:'particle_fx'};