/** dino_module_3060 — dino_physics_jump extended, humanized desktop */
export interface In3060{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3060{y:number;vy:number;sc:number}
const C3060={g:0.7, j:12};
export function extraRender_3060(inp:In3060, dt:number):Out3060 {
...
export const mm3060={d:'dino_physics_jump'};