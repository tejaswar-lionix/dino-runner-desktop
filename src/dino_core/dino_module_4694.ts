/** dino_module_4694 — collision_aabb extended, humanized desktop */
export interface In4694{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4694{y:number;vy:number;sc:number}
const C4694={g:0.7, j:12};
export function extraRender_4694(inp:In4694, dt:number):Out4694 {
...
export const mm4694={d:'collision_aabb'};