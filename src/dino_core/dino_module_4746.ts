/** dino_module_4746 — particle_fx extended, humanized desktop */
export interface In4746{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4746{y:number;vy:number;sc:number}
const C4746={g:0.6, j:11};
export function extraPhysics_4746(inp:In4746, dt:number):Out4746 {
...
export const mm4746={d:'particle_fx'};