/** dino_module_4422 — dino_physics_jump extended, humanized desktop */
export interface In4422{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4422{y:number;vy:number;sc:number}
const C4422={g:0.5, j:11};
export function extraSpawn_4422(inp:In4422, dt:number):Out4422 {
...
export const mm4422={d:'dino_physics_jump'};