/** dino_module_3961 — collision_aabb extended, humanized desktop */
export interface In3961{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3961{y:number;vy:number;sc:number}
const C3961={g:0.7, j:12};
export function extraRender_3961(inp:In3961, dt:number):Out3961 {
...
export const mm3961={d:'collision_aabb'};