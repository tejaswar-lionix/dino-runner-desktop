/** dino_module_4943 — parallax_bg extended, humanized desktop */
export interface In4943{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4943{y:number;vy:number;sc:number}
const C4943={g:0.8, j:13};
export function extraRender_4943(inp:In4943, dt:number):Out4943 {
...
export const mm4943={d:'parallax_bg'};