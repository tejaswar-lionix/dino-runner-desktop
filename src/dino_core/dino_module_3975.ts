/** dino_module_3975 — collision_aabb extended, humanized desktop */
export interface In3975{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3975{y:number;vy:number;sc:number}
const C3975={g:0.7, j:12};
export function extraSpawn_3975(inp:In3975, dt:number):Out3975 {
...
export const mm3975={d:'collision_aabb'};