/** dino_module_4594 — score_speed extended, humanized desktop */
export interface In4594{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4594{y:number;vy:number;sc:number}
const C4594={g:0.7, j:12};
export function extraPhysics_4594(inp:In4594, dt:number):Out4594 {
...
export const mm4594={d:'score_speed'};