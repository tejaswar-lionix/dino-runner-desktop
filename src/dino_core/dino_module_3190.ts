/** dino_module_3190 — collision_aabb extended, humanized desktop */
export interface In3190{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3190{y:number;vy:number;sc:number}
const C3190={g:0.5, j:12};
export function extraPhysics_3190(inp:In3190, dt:number):Out3190 {
...
export const mm3190={d:'collision_aabb'};