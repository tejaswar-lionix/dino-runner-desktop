/** dino_module_3090 — score_speed extended, humanized desktop */
export interface In3090{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3090{y:number;vy:number;sc:number}
const C3090={g:0.6, j:12};
export function extraSpawn_3090(inp:In3090, dt:number):Out3090 {
...
export const mm3090={d:'score_speed'};