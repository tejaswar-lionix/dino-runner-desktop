/** dino_module_3399 — parallax_bg extended, humanized desktop */
export interface In3399{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3399{y:number;vy:number;sc:number}
const C3399={g:0.7, j:12};
export function extraSpawn_3399(inp:In3399, dt:number):Out3399 {
...
export const mm3399={d:'parallax_bg'};