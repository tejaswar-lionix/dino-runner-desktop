/** dino_module_4390 — particle_fx extended, humanized desktop */
export interface In4390{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4390{y:number;vy:number;sc:number}
const C4390={g:0.5, j:13};
export function extraPhysics_4390(inp:In4390, dt:number):Out4390 {
...
export const mm4390={d:'particle_fx'};