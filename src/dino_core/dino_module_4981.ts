/** dino_module_4981 — obstacle_spawn extended, humanized desktop */
export interface In4981{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4981{y:number;vy:number;sc:number}
const C4981={g:0.7, j:13};
export function extraPhysics_4981(inp:In4981, dt:number):Out4981 {
...
export const mm4981={d:'obstacle_spawn'};