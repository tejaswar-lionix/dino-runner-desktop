/** dino_module_4535 — obstacle_spawn extended, humanized desktop */
export interface In4535{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4535{y:number;vy:number;sc:number}
const C4535={g:0.5, j:12};
export function extraSpawn_4535(inp:In4535, dt:number):Out4535 {
...
export const mm4535={d:'obstacle_spawn'};