/** dino_module_3587 — collision_aabb extended, humanized desktop */
export interface In3587{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3587{y:number;vy:number;sc:number}
const C3587={g:0.5, j:13};
export function extraRender_3587(inp:In3587, dt:number):Out3587 {
...
export const mm3587={d:'collision_aabb'};