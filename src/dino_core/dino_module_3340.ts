/** dino_module_3340 — collision_aabb extended, humanized desktop */
export interface In3340{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3340{y:number;vy:number;sc:number}
const C3340={g:0.7, j:11};
export function extraPhysics_3340(inp:In3340, dt:number):Out3340 {
...
export const mm3340={d:'collision_aabb'};