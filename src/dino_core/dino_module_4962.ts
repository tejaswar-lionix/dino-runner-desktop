/** dino_module_4962 — parallax_bg extended, humanized desktop */
export interface In4962{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4962{y:number;vy:number;sc:number}
const C4962={g:0.7, j:12};
export function extraSpawn_4962(inp:In4962, dt:number):Out4962 {
...
export const mm4962={d:'parallax_bg'};