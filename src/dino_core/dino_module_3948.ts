/** dino_module_3948 — dino_physics_jump extended, humanized desktop */
export interface In3948{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3948{y:number;vy:number;sc:number}
const C3948={g:0.5, j:12};
export function extraPhysics_3948(inp:In3948, dt:number):Out3948 {
...
export const mm3948={d:'dino_physics_jump'};