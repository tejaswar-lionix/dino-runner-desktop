/** dino_module_3989 — parallax_bg extended, humanized desktop */
export interface In3989{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3989{y:number;vy:number;sc:number}
const C3989={g:0.8, j:11};
export function extraRender_3989(inp:In3989, dt:number):Out3989 {
...
export const mm3989={d:'parallax_bg'};