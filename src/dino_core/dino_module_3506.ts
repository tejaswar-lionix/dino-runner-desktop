/** dino_module_3506 — obstacle_spawn extended, humanized desktop */
export interface In3506{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3506{y:number;vy:number;sc:number}
const C3506={g:0.5, j:13};
export function extraPhysics_3506(inp:In3506, dt:number):Out3506 {
...
export const mm3506={d:'obstacle_spawn'};