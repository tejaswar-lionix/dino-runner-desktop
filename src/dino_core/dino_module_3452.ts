/** dino_module_3452 — collision_aabb extended, humanized desktop */
export interface In3452{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3452{y:number;vy:number;sc:number}
const C3452={g:0.7, j:12};
export function extraSpawn_3452(inp:In3452, dt:number):Out3452 {
...
export const mm3452={d:'collision_aabb'};