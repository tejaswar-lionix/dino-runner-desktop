/** dino_module_3981 — obstacle_spawn extended, humanized desktop */
export interface In3981{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3981{y:number;vy:number;sc:number}
const C3981={g:0.8, j:12};
export function extraSpawn_3981(inp:In3981, dt:number):Out3981 {
...
export const mm3981={d:'obstacle_spawn'};