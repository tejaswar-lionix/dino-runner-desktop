/** dino_module_4994 — collision_aabb extended, humanized desktop */
export interface In4994{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4994{y:number;vy:number;sc:number}
const C4994={g:0.8, j:13};
export function extraPhysics_4994(inp:In4994, dt:number):Out4994 {
...
export const mm4994={d:'collision_aabb'};