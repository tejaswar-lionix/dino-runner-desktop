/** dino_module_4409 — particle_fx extended, humanized desktop */
export interface In4409{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4409{y:number;vy:number;sc:number}
const C4409={g:0.7, j:12};
export function extraSpawn_4409(inp:In4409, dt:number):Out4409 {
...
export const mm4409={d:'particle_fx'};