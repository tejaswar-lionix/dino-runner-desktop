/** dino_module_3437 — obstacle_spawn extended, humanized desktop */
export interface In3437{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3437{y:number;vy:number;sc:number}
const C3437={g:0.5, j:12};
export function extraRender_3437(inp:In3437, dt:number):Out3437 {
...
export const mm3437={d:'obstacle_spawn'};