/** dino_module_3354 — score_speed extended, humanized desktop */
export interface In3354{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3354{y:number;vy:number;sc:number}
const C3354={g:0.6, j:13};
export function extraPhysics_3354(inp:In3354, dt:number):Out3354 {
...
export const mm3354={d:'score_speed'};