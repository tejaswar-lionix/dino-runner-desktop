/** dino_module_3400 — obstacle_spawn extended, humanized desktop */
export interface In3400{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3400{y:number;vy:number;sc:number}
const C3400={g:0.8, j:13};
export function extraSpawn_3400(inp:In3400, dt:number):Out3400 {
...
export const mm3400={d:'obstacle_spawn'};