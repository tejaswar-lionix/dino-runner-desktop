/** dino_module_4212 — obstacle_spawn extended, humanized desktop */
export interface In4212{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4212{y:number;vy:number;sc:number}
const C4212={g:0.8, j:11};
export function extraSpawn_4212(inp:In4212, dt:number):Out4212 {
...
export const mm4212={d:'obstacle_spawn'};