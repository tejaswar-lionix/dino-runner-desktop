/** dino_module_4364 — collision_aabb extended, humanized desktop */
export interface In4364{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4364{y:number;vy:number;sc:number}
const C4364={g:0.8, j:12};
export function extraSpawn_4364(inp:In4364, dt:number):Out4364 {
...
export const mm4364={d:'collision_aabb'};