/** dino_module_3502 — particle_fx extended, humanized desktop */
export interface In3502{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3502{y:number;vy:number;sc:number}
const C3502={g:0.7, j:13};
export function extraPhysics_3502(inp:In3502, dt:number):Out3502 {
...
export const mm3502={d:'particle_fx'};