/** dino_module_4649 — particle_fx extended, humanized desktop */
export interface In4649{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4649{y:number;vy:number;sc:number}
const C4649={g:0.6, j:13};
export function extraPhysics_4649(inp:In4649, dt:number):Out4649 {
...
export const mm4649={d:'particle_fx'};