/** dino_module_4503 — collision_aabb extended, humanized desktop */
export interface In4503{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4503{y:number;vy:number;sc:number}
const C4503={g:0.7, j:13};
export function extraRender_4503(inp:In4503, dt:number):Out4503 {
...
export const mm4503={d:'collision_aabb'};