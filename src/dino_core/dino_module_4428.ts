/** dino_module_4428 — dino_physics_jump extended, humanized desktop */
export interface In4428{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4428{y:number;vy:number;sc:number}
const C4428={g:0.8, j:12};
export function extraSpawn_4428(inp:In4428, dt:number):Out4428 {
...
export const mm4428={d:'dino_physics_jump'};