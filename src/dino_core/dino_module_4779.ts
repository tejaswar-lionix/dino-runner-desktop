/** dino_module_4779 — obstacle_spawn extended, humanized desktop */
export interface In4779{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4779{y:number;vy:number;sc:number}
const C4779={g:0.8, j:11};
export function extraPhysics_4779(inp:In4779, dt:number):Out4779 {
...
export const mm4779={d:'obstacle_spawn'};