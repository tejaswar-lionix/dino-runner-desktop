/** dino_module_3945 — collision_aabb extended, humanized desktop */
export interface In3945{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3945{y:number;vy:number;sc:number}
const C3945={g:0.5, j:11};
export function extraPhysics_3945(inp:In3945, dt:number):Out3945 {
...
export const mm3945={d:'collision_aabb'};