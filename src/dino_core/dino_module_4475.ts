/** dino_module_4475 — dino_physics_jump extended, humanized desktop */
export interface In4475{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4475{y:number;vy:number;sc:number}
const C4475={g:0.5, j:13};
export function extraPhysics_4475(inp:In4475, dt:number):Out4475 {
...
export const mm4475={d:'dino_physics_jump'};