/** dino_module_3783 — obstacle_spawn extended, humanized desktop */
export interface In3783{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3783{y:number;vy:number;sc:number}
const C3783={g:0.6, j:11};
export function extraRender_3783(inp:In3783, dt:number):Out3783 {
...
export const mm3783={d:'obstacle_spawn'};