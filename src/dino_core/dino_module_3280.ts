/** dino_module_3280 — collision_aabb extended, humanized desktop */
export interface In3280{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3280{y:number;vy:number;sc:number}
const C3280={g:0.8, j:12};
export function extraRender_3280(inp:In3280, dt:number):Out3280 {
...
export const mm3280={d:'collision_aabb'};