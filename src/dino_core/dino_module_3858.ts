/** dino_module_3858 — collision_aabb extended, humanized desktop */
export interface In3858{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3858{y:number;vy:number;sc:number}
const C3858={g:0.7, j:13};
export function extraSpawn_3858(inp:In3858, dt:number):Out3858 {
...
export const mm3858={d:'collision_aabb'};