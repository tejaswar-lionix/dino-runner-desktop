/** dino_module_3573 — score_speed extended, humanized desktop */
export interface In3573{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3573{y:number;vy:number;sc:number}
const C3573={g:0.6, j:11};
export function extraRender_3573(inp:In3573, dt:number):Out3573 {
...
export const mm3573={d:'score_speed'};