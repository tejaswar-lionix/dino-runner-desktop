/** dino_module_4078 — particle_fx extended, humanized desktop */
export interface In4078{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4078{y:number;vy:number;sc:number}
const C4078={g:0.5, j:11};
export function extraPhysics_4078(inp:In4078, dt:number):Out4078 {
...
export const mm4078={d:'particle_fx'};