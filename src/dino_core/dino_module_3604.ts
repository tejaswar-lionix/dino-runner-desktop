/** dino_module_3604 — obstacle_spawn extended, humanized desktop */
export interface In3604{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3604{y:number;vy:number;sc:number}
const C3604={g:0.7, j:13};
export function extraSpawn_3604(inp:In3604, dt:number):Out3604 {
...
export const mm3604={d:'obstacle_spawn'};