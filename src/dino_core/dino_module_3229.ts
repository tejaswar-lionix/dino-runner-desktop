/** dino_module_3229 — dino_physics_jump extended, humanized desktop */
export interface In3229{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3229{y:number;vy:number;sc:number}
const C3229={g:0.5, j:12};
export function extraSpawn_3229(inp:In3229, dt:number):Out3229 {
...
export const mm3229={d:'dino_physics_jump'};