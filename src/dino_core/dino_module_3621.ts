/** dino_module_3621 — collision_aabb extended, humanized desktop */
export interface In3621{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3621{y:number;vy:number;sc:number}
const C3621={g:0.8, j:13};
export function extraRender_3621(inp:In3621, dt:number):Out3621 {
...
export const mm3621={d:'collision_aabb'};