/** dino_module_3495 — collision_aabb extended, humanized desktop */
export interface In3495{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3495{y:number;vy:number;sc:number}
const C3495={g:0.6, j:13};
export function extraPhysics_3495(inp:In3495, dt:number):Out3495 {
...
export const mm3495={d:'collision_aabb'};