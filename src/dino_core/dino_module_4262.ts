/** dino_module_4262 — dino_physics_jump extended, humanized desktop */
export interface In4262{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4262{y:number;vy:number;sc:number}
const C4262={g:0.7, j:13};
export function extraPhysics_4262(inp:In4262, dt:number):Out4262 {
...
export const mm4262={d:'dino_physics_jump'};