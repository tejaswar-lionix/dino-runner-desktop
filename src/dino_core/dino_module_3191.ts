/** dino_module_3191 — parallax_bg extended, humanized desktop */
export interface In3191{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3191{y:number;vy:number;sc:number}
const C3191={g:0.8, j:12};
export function extraRender_3191(inp:In3191, dt:number):Out3191 {
...
export const mm3191={d:'parallax_bg'};