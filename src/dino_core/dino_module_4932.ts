/** dino_module_4932 — obstacle_spawn extended, humanized desktop */
export interface In4932{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4932{y:number;vy:number;sc:number}
const C4932={g:0.8, j:13};
export function extraRender_4932(inp:In4932, dt:number):Out4932 {
...
export const mm4932={d:'obstacle_spawn'};