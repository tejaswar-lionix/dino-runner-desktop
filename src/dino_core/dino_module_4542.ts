/** dino_module_4542 — obstacle_spawn extended, humanized desktop */
export interface In4542{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4542{y:number;vy:number;sc:number}
const C4542={g:0.8, j:11};
export function extraPhysics_4542(inp:In4542, dt:number):Out4542 {
...
export const mm4542={d:'obstacle_spawn'};