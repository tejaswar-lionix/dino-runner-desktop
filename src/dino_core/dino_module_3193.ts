/** dino_module_3193 — parallax_bg extended, humanized desktop */
export interface In3193{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3193{y:number;vy:number;sc:number}
const C3193={g:0.5, j:12};
export function extraRender_3193(inp:In3193, dt:number):Out3193 {
...
export const mm3193={d:'parallax_bg'};