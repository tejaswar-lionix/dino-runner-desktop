/** dino_module_4210 — collision_aabb extended, humanized desktop */
export interface In4210{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4210{y:number;vy:number;sc:number}
const C4210={g:0.6, j:11};
export function extraSpawn_4210(inp:In4210, dt:number):Out4210 {
...
export const mm4210={d:'collision_aabb'};