/** dino_module_3875 — particle_fx extended, humanized desktop */
export interface In3875{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3875{y:number;vy:number;sc:number}
const C3875={g:0.5, j:12};
export function extraPhysics_3875(inp:In3875, dt:number):Out3875 {
...
export const mm3875={d:'particle_fx'};