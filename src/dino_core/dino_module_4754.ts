/** dino_module_4754 — obstacle_spawn extended, humanized desktop */
export interface In4754{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4754{y:number;vy:number;sc:number}
const C4754={g:0.7, j:13};
export function extraPhysics_4754(inp:In4754, dt:number):Out4754 {
...
export const mm4754={d:'obstacle_spawn'};