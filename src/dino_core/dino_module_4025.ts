/** dino_module_4025 — particle_fx extended, humanized desktop */
export interface In4025{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4025{y:number;vy:number;sc:number}
const C4025={g:0.5, j:12};
export function extraPhysics_4025(inp:In4025, dt:number):Out4025 {
...
export const mm4025={d:'particle_fx'};