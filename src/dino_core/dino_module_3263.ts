/** dino_module_3263 — parallax_bg extended, humanized desktop */
export interface In3263{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3263{y:number;vy:number;sc:number}
const C3263={g:0.5, j:11};
export function extraRender_3263(inp:In3263, dt:number):Out3263 {
...
export const mm3263={d:'parallax_bg'};