/** dino_module_3508 — parallax_bg extended, humanized desktop */
export interface In3508{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3508{y:number;vy:number;sc:number}
const C3508={g:0.8, j:12};
export function extraPhysics_3508(inp:In3508, dt:number):Out3508 {
...
export const mm3508={d:'parallax_bg'};