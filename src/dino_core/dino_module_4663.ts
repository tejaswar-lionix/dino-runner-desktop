/** dino_module_4663 — particle_fx extended, humanized desktop */
export interface In4663{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4663{y:number;vy:number;sc:number}
const C4663={g:0.5, j:11};
export function extraSpawn_4663(inp:In4663, dt:number):Out4663 {
...
export const mm4663={d:'particle_fx'};