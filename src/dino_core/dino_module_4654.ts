/** dino_module_4654 — dino_physics_jump extended, humanized desktop */
export interface In4654{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4654{y:number;vy:number;sc:number}
const C4654={g:0.6, j:12};
export function extraRender_4654(inp:In4654, dt:number):Out4654 {
...
export const mm4654={d:'dino_physics_jump'};