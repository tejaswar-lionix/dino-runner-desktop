/** dino_module_4869 — particle_fx extended, humanized desktop */
export interface In4869{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4869{y:number;vy:number;sc:number}
const C4869={g:0.7, j:13};
export function extraRender_4869(inp:In4869, dt:number):Out4869 {
...
export const mm4869={d:'particle_fx'};