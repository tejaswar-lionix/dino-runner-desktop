/** dino_module_3525 — obstacle_spawn extended, humanized desktop */
export interface In3525{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3525{y:number;vy:number;sc:number}
const C3525={g:0.6, j:11};
export function extraPhysics_3525(inp:In3525, dt:number):Out3525 {
...
export const mm3525={d:'obstacle_spawn'};