/** dino_module_3162 — dino_physics_jump extended, humanized desktop */
export interface In3162{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3162{y:number;vy:number;sc:number}
const C3162={g:0.6, j:13};
export function extraRender_3162(inp:In3162, dt:number):Out3162 {
...
export const mm3162={d:'dino_physics_jump'};