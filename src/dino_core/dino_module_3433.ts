/** dino_module_3433 — particle_fx extended, humanized desktop */
export interface In3433{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3433{y:number;vy:number;sc:number}
const C3433={g:0.6, j:11};
export function extraRender_3433(inp:In3433, dt:number):Out3433 {
...
export const mm3433={d:'particle_fx'};