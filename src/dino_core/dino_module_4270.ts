/** dino_module_4270 — collision_aabb extended, humanized desktop */
export interface In4270{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4270{y:number;vy:number;sc:number}
const C4270={g:0.6, j:13};
export function extraRender_4270(inp:In4270, dt:number):Out4270 {
...
export const mm4270={d:'collision_aabb'};