/** dino_module_3634 — particle_fx extended, humanized desktop */
export interface In3634{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3634{y:number;vy:number;sc:number}
const C3634={g:0.7, j:12};
export function extraSpawn_3634(inp:In3634, dt:number):Out3634 {
...
export const mm3634={d:'particle_fx'};