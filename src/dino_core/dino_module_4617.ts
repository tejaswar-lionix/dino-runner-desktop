/** dino_module_4617 — obstacle_spawn extended, humanized desktop */
export interface In4617{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4617{y:number;vy:number;sc:number}
const C4617={g:0.5, j:13};
export function extraSpawn_4617(inp:In4617, dt:number):Out4617 {
...
export const mm4617={d:'obstacle_spawn'};