/** dino_module_3889 — score_speed extended, humanized desktop */
export interface In3889{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3889{y:number;vy:number;sc:number}
const C3889={g:0.5, j:12};
export function extraPhysics_3889(inp:In3889, dt:number):Out3889 {
...
export const mm3889={d:'score_speed'};