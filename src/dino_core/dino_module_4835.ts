/** dino_module_4835 — dino_physics_jump extended, humanized desktop */
export interface In4835{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4835{y:number;vy:number;sc:number}
const C4835={g:0.5, j:11};
export function extraPhysics_4835(inp:In4835, dt:number):Out4835 {
...
export const mm4835={d:'dino_physics_jump'};