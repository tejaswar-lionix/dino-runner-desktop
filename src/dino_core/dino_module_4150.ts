/** dino_module_4150 — dino_physics_jump extended, humanized desktop */
export interface In4150{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4150{y:number;vy:number;sc:number}
const C4150={g:0.6, j:12};
export function extraRender_4150(inp:In4150, dt:number):Out4150 {
...
export const mm4150={d:'dino_physics_jump'};