/** dino_module_3598 — parallax_bg extended, humanized desktop */
export interface In3598{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3598{y:number;vy:number;sc:number}
const C3598={g:0.8, j:13};
export function extraSpawn_3598(inp:In3598, dt:number):Out3598 {
...
export const mm3598={d:'parallax_bg'};