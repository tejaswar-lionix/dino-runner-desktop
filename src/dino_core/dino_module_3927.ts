/** dino_module_3927 — score_speed extended, humanized desktop */
export interface In3927{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3927{y:number;vy:number;sc:number}
const C3927={g:0.8, j:11};
export function extraRender_3927(inp:In3927, dt:number):Out3927 {
...
export const mm3927={d:'score_speed'};