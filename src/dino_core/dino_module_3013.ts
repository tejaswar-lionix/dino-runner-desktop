/** dino_module_3013 — collision_aabb extended, humanized desktop */
export interface In3013{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3013{y:number;vy:number;sc:number}
const C3013={g:0.5, j:13};
export function extraSpawn_3013(inp:In3013, dt:number):Out3013 {
...
export const mm3013={d:'collision_aabb'};