/** dino_module_4854 — particle_fx extended, humanized desktop */
export interface In4854{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4854{y:number;vy:number;sc:number}
const C4854={g:0.5, j:12};
export function extraSpawn_4854(inp:In4854, dt:number):Out4854 {
...
export const mm4854={d:'particle_fx'};