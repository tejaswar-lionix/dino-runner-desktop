/** dino_module_4088 — dino_physics_jump extended, humanized desktop */
export interface In4088{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4088{y:number;vy:number;sc:number}
const C4088={g:0.6, j:13};
export function extraRender_4088(inp:In4088, dt:number):Out4088 {
...
export const mm4088={d:'dino_physics_jump'};