/** dino_module_4366 — score_speed extended, humanized desktop */
export interface In4366{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4366{y:number;vy:number;sc:number}
const C4366={g:0.5, j:12};
export function extraSpawn_4366(inp:In4366, dt:number):Out4366 {
...
export const mm4366={d:'score_speed'};