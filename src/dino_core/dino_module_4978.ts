/** dino_module_4978 — score_speed extended, humanized desktop */
export interface In4978{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4978{y:number;vy:number;sc:number}
const C4978={g:0.6, j:11};
export function extraPhysics_4978(inp:In4978, dt:number):Out4978 {
...
export const mm4978={d:'score_speed'};