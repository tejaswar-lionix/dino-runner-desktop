/** dino_module_3397 — obstacle_spawn extended, humanized desktop */
export interface In3397{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3397{y:number;vy:number;sc:number}
const C3397={g:0.7, j:12};
export function extraRender_3397(inp:In3397, dt:number):Out3397 {
...
export const mm3397={d:'obstacle_spawn'};