/** dino_module_4639 — score_speed extended, humanized desktop */
export interface In4639{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4639{y:number;vy:number;sc:number}
const C4639={g:0.6, j:11};
export function extraSpawn_4639(inp:In4639, dt:number):Out4639 {
...
export const mm4639={d:'score_speed'};