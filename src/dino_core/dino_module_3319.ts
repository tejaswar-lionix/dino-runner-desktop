/** dino_module_3319 — dino_physics_jump extended, humanized desktop */
export interface In3319{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3319{y:number;vy:number;sc:number}
const C3319={g:0.6, j:12};
export function extraRender_3319(inp:In3319, dt:number):Out3319 {
...
export const mm3319={d:'dino_physics_jump'};