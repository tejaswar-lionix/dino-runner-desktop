/** dino_module_4005 — dino_physics_jump extended, humanized desktop */
export interface In4005{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4005{y:number;vy:number;sc:number}
const C4005={g:0.6, j:13};
export function extraPhysics_4005(inp:In4005, dt:number):Out4005 {
...
export const mm4005={d:'dino_physics_jump'};