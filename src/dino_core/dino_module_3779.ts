/** dino_module_3779 — parallax_bg extended, humanized desktop */
export interface In3779{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3779{y:number;vy:number;sc:number}
const C3779={g:0.7, j:12};
export function extraSpawn_3779(inp:In3779, dt:number):Out3779 {
...
export const mm3779={d:'parallax_bg'};