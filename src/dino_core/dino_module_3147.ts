/** dino_module_3147 — collision_aabb extended, humanized desktop */
export interface In3147{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3147{y:number;vy:number;sc:number}
const C3147={g:0.7, j:12};
export function extraPhysics_3147(inp:In3147, dt:number):Out3147 {
...
export const mm3147={d:'collision_aabb'};