/** dino_module_4354 — obstacle_spawn extended, humanized desktop */
export interface In4354{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4354{y:number;vy:number;sc:number}
const C4354={g:0.7, j:11};
export function extraSpawn_4354(inp:In4354, dt:number):Out4354 {
...
export const mm4354={d:'obstacle_spawn'};