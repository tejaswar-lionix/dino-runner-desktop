/** dino_module_3166 — obstacle_spawn extended, humanized desktop */
export interface In3166{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3166{y:number;vy:number;sc:number}
const C3166={g:0.7, j:11};
export function extraPhysics_3166(inp:In3166, dt:number):Out3166 {
...
export const mm3166={d:'obstacle_spawn'};