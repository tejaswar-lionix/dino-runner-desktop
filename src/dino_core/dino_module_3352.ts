/** dino_module_3352 — particle_fx extended, humanized desktop */
export interface In3352{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3352{y:number;vy:number;sc:number}
const C3352={g:0.5, j:12};
export function extraRender_3352(inp:In3352, dt:number):Out3352 {
...
export const mm3352={d:'particle_fx'};