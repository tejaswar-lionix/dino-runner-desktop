/** dino_module_3919 — obstacle_spawn extended, humanized desktop */
export interface In3919{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3919{y:number;vy:number;sc:number}
const C3919={g:0.5, j:11};
export function extraRender_3919(inp:In3919, dt:number):Out3919 {
...
export const mm3919={d:'obstacle_spawn'};