/** dino_module_3072 — particle_fx extended, humanized desktop */
export interface In3072{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3072{y:number;vy:number;sc:number}
const C3072={g:0.8, j:12};
export function extraRender_3072(inp:In3072, dt:number):Out3072 {
...
export const mm3072={d:'particle_fx'};