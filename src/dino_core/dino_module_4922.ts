/** dino_module_4922 — dino_physics_jump extended, humanized desktop */
export interface In4922{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4922{y:number;vy:number;sc:number}
const C4922={g:0.7, j:13};
export function extraRender_4922(inp:In4922, dt:number):Out4922 {
...
export const mm4922={d:'dino_physics_jump'};