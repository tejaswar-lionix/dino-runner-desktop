/** dino_module_4285 — parallax_bg extended, humanized desktop */
export interface In4285{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4285{y:number;vy:number;sc:number}
const C4285={g:0.8, j:13};
export function extraSpawn_4285(inp:In4285, dt:number):Out4285 {
...
export const mm4285={d:'parallax_bg'};