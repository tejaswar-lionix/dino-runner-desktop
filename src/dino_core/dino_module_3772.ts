/** dino_module_3772 — parallax_bg extended, humanized desktop */
export interface In3772{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3772{y:number;vy:number;sc:number}
const C3772={g:0.7, j:13};
export function extraPhysics_3772(inp:In3772, dt:number):Out3772 {
...
export const mm3772={d:'parallax_bg'};