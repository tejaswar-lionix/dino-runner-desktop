/** dino_module_3528 — score_speed extended, humanized desktop */
export interface In3528{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3528{y:number;vy:number;sc:number}
const C3528={g:0.6, j:13};
export function extraPhysics_3528(inp:In3528, dt:number):Out3528 {
...
export const mm3528={d:'score_speed'};