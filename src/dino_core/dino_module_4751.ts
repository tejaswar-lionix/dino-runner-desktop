/** dino_module_4751 — particle_fx extended, humanized desktop */
export interface In4751{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4751{y:number;vy:number;sc:number}
const C4751={g:0.7, j:12};
export function extraRender_4751(inp:In4751, dt:number):Out4751 {
...
export const mm4751={d:'particle_fx'};