/** dino_module_3249 — collision_aabb extended, humanized desktop */
export interface In3249{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3249{y:number;vy:number;sc:number}
const C3249={g:0.6, j:11};
export function extraRender_3249(inp:In3249, dt:number):Out3249 {
...
export const mm3249={d:'collision_aabb'};