/** dino_module_4976 — parallax_bg extended, humanized desktop */
export interface In4976{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4976{y:number;vy:number;sc:number}
const C4976={g:0.6, j:13};
export function extraPhysics_4976(inp:In4976, dt:number):Out4976 {
...
export const mm4976={d:'parallax_bg'};