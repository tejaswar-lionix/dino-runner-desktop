/** dino_module_3683 — parallax_bg extended, humanized desktop */
export interface In3683{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3683{y:number;vy:number;sc:number}
const C3683={g:0.8, j:13};
export function extraRender_3683(inp:In3683, dt:number):Out3683 {
...
export const mm3683={d:'parallax_bg'};