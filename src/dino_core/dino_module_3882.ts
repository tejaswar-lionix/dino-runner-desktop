/** dino_module_3882 — particle_fx extended, humanized desktop */
export interface In3882{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3882{y:number;vy:number;sc:number}
const C3882={g:0.5, j:13};
export function extraSpawn_3882(inp:In3882, dt:number):Out3882 {
...
export const mm3882={d:'particle_fx'};