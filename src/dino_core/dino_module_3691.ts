/** dino_module_3691 — collision_aabb extended, humanized desktop */
export interface In3691{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3691{y:number;vy:number;sc:number}
const C3691={g:0.6, j:11};
export function extraRender_3691(inp:In3691, dt:number):Out3691 {
...
export const mm3691={d:'collision_aabb'};