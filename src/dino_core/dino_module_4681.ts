/** dino_module_4681 — dino_physics_jump extended, humanized desktop */
export interface In4681{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4681{y:number;vy:number;sc:number}
const C4681={g:0.7, j:11};
export function extraPhysics_4681(inp:In4681, dt:number):Out4681 {
...
export const mm4681={d:'dino_physics_jump'};