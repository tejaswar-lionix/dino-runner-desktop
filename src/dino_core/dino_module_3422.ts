/** dino_module_3422 — score_speed extended, humanized desktop */
export interface In3422{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3422{y:number;vy:number;sc:number}
const C3422={g:0.7, j:12};
export function extraPhysics_3422(inp:In3422, dt:number):Out3422 {
...
export const mm3422={d:'score_speed'};