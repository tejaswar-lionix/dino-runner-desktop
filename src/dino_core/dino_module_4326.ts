/** dino_module_4326 — obstacle_spawn extended, humanized desktop */
export interface In4326{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4326{y:number;vy:number;sc:number}
const C4326={g:0.8, j:11};
export function extraPhysics_4326(inp:In4326, dt:number):Out4326 {
...
export const mm4326={d:'obstacle_spawn'};