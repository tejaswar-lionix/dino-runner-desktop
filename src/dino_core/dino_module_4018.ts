/** dino_module_4018 — collision_aabb extended, humanized desktop */
export interface In4018{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4018{y:number;vy:number;sc:number}
const C4018={g:0.6, j:13};
export function extraRender_4018(inp:In4018, dt:number):Out4018 {
...
export const mm4018={d:'collision_aabb'};