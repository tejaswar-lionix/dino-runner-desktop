/** dino_module_4940 — parallax_bg extended, humanized desktop */
export interface In4940{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4940{y:number;vy:number;sc:number}
const C4940={g:0.5, j:12};
export function extraPhysics_4940(inp:In4940, dt:number):Out4940 {
...
export const mm4940={d:'parallax_bg'};