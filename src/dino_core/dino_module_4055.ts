/** dino_module_4055 — score_speed extended, humanized desktop */
export interface In4055{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4055{y:number;vy:number;sc:number}
const C4055={g:0.6, j:13};
export function extraPhysics_4055(inp:In4055, dt:number):Out4055 {
...
export const mm4055={d:'score_speed'};