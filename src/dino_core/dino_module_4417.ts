/** dino_module_4417 — dino_physics_jump extended, humanized desktop */
export interface In4417{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4417{y:number;vy:number;sc:number}
const C4417={g:0.6, j:13};
export function extraSpawn_4417(inp:In4417, dt:number):Out4417 {
...
export const mm4417={d:'dino_physics_jump'};