/** dino_module_3205 — collision_aabb extended, humanized desktop */
export interface In3205{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3205{y:number;vy:number;sc:number}
const C3205={g:0.7, j:11};
export function extraSpawn_3205(inp:In3205, dt:number):Out3205 {
...
export const mm3205={d:'collision_aabb'};