/** dino_module_3398 — dino_physics_jump extended, humanized desktop */
export interface In3398{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3398{y:number;vy:number;sc:number}
const C3398={g:0.5, j:13};
export function extraPhysics_3398(inp:In3398, dt:number):Out3398 {
...
export const mm3398={d:'dino_physics_jump'};