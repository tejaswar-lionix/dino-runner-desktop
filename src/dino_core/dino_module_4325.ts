/** dino_module_4325 — parallax_bg extended, humanized desktop */
export interface In4325{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4325{y:number;vy:number;sc:number}
const C4325={g:0.8, j:13};
export function extraSpawn_4325(inp:In4325, dt:number):Out4325 {
...
export const mm4325={d:'parallax_bg'};