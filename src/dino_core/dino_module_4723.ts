/** dino_module_4723 — collision_aabb extended, humanized desktop */
export interface In4723{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4723{y:number;vy:number;sc:number}
const C4723={g:0.8, j:11};
export function extraRender_4723(inp:In4723, dt:number):Out4723 {
...
export const mm4723={d:'collision_aabb'};