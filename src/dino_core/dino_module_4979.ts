/** dino_module_4979 — dino_physics_jump extended, humanized desktop */
export interface In4979{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4979{y:number;vy:number;sc:number}
const C4979={g:0.5, j:11};
export function extraSpawn_4979(inp:In4979, dt:number):Out4979 {
...
export const mm4979={d:'dino_physics_jump'};