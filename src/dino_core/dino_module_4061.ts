/** dino_module_4061 — obstacle_spawn extended, humanized desktop */
export interface In4061{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4061{y:number;vy:number;sc:number}
const C4061={g:0.6, j:11};
export function extraSpawn_4061(inp:In4061, dt:number):Out4061 {
...
export const mm4061={d:'obstacle_spawn'};