/** dino_module_3524 — parallax_bg extended, humanized desktop */
export interface In3524{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3524{y:number;vy:number;sc:number}
const C3524={g:0.5, j:13};
export function extraRender_3524(inp:In3524, dt:number):Out3524 {
...
export const mm3524={d:'parallax_bg'};