/** dino_module_3705 — score_speed extended, humanized desktop */
export interface In3705{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3705{y:number;vy:number;sc:number}
const C3705={g:0.7, j:12};
export function extraPhysics_3705(inp:In3705, dt:number):Out3705 {
...
export const mm3705={d:'score_speed'};