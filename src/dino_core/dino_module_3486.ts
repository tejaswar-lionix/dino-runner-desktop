/** dino_module_3486 — obstacle_spawn extended, humanized desktop */
export interface In3486{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3486{y:number;vy:number;sc:number}
const C3486={g:0.5, j:11};
export function extraSpawn_3486(inp:In3486, dt:number):Out3486 {
...
export const mm3486={d:'obstacle_spawn'};