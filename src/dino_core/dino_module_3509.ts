/** dino_module_3509 — obstacle_spawn extended, humanized desktop */
export interface In3509{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3509{y:number;vy:number;sc:number}
const C3509={g:0.5, j:11};
export function extraSpawn_3509(inp:In3509, dt:number):Out3509 {
...
export const mm3509={d:'obstacle_spawn'};