/** dino_module_3372 — score_speed extended, humanized desktop */
export interface In3372{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3372{y:number;vy:number;sc:number}
const C3372={g:0.6, j:13};
export function extraPhysics_3372(inp:In3372, dt:number):Out3372 {
...
export const mm3372={d:'score_speed'};