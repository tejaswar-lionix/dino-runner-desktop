/** dino_module_4987 — dino_physics_jump extended, humanized desktop */
export interface In4987{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4987{y:number;vy:number;sc:number}
const C4987={g:0.7, j:11};
export function extraPhysics_4987(inp:In4987, dt:number):Out4987 {
...
export const mm4987={d:'dino_physics_jump'};