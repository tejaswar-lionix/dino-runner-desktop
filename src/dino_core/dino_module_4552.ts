/** dino_module_4552 — dino_physics_jump extended, humanized desktop */
export interface In4552{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4552{y:number;vy:number;sc:number}
const C4552={g:0.8, j:12};
export function extraRender_4552(inp:In4552, dt:number):Out4552 {
...
export const mm4552={d:'dino_physics_jump'};