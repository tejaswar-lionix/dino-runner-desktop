/** dino_module_3226 — obstacle_spawn extended, humanized desktop */
export interface In3226{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3226{y:number;vy:number;sc:number}
const C3226={g:0.8, j:12};
export function extraRender_3226(inp:In3226, dt:number):Out3226 {
...
export const mm3226={d:'obstacle_spawn'};