/** dino_module_4729 — score_speed extended, humanized desktop */
export interface In4729{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4729{y:number;vy:number;sc:number}
const C4729={g:0.5, j:12};
export function extraPhysics_4729(inp:In4729, dt:number):Out4729 {
...
export const mm4729={d:'score_speed'};