/** dino_module_4169 — dino_physics_jump extended, humanized desktop */
export interface In4169{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4169{y:number;vy:number;sc:number}
const C4169={g:0.8, j:12};
export function extraSpawn_4169(inp:In4169, dt:number):Out4169 {
...
export const mm4169={d:'dino_physics_jump'};