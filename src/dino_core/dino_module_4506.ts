/** dino_module_4506 — parallax_bg extended, humanized desktop */
export interface In4506{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4506{y:number;vy:number;sc:number}
const C4506={g:0.6, j:11};
export function extraSpawn_4506(inp:In4506, dt:number):Out4506 {
...
export const mm4506={d:'parallax_bg'};