/** dino_module_3407 — parallax_bg extended, humanized desktop */
export interface In3407{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3407{y:number;vy:number;sc:number}
const C3407={g:0.8, j:11};
export function extraPhysics_3407(inp:In3407, dt:number):Out3407 {
...
export const mm3407={d:'parallax_bg'};