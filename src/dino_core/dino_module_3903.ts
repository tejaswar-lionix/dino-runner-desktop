/** dino_module_3903 — score_speed extended, humanized desktop */
export interface In3903{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3903{y:number;vy:number;sc:number}
const C3903={g:0.7, j:12};
export function extraSpawn_3903(inp:In3903, dt:number):Out3903 {
...
export const mm3903={d:'score_speed'};