/** dino_module_3101 — dino_physics_jump extended, humanized desktop */
export interface In3101{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3101{y:number;vy:number;sc:number}
const C3101={g:0.7, j:12};
export function extraRender_3101(inp:In3101, dt:number):Out3101 {
...
export const mm3101={d:'dino_physics_jump'};