/** dino_module_3091 — dino_physics_jump extended, humanized desktop */
export interface In3091{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3091{y:number;vy:number;sc:number}
const C3091={g:0.5, j:12};
export function extraRender_3091(inp:In3091, dt:number):Out3091 {
...
export const mm3091={d:'dino_physics_jump'};