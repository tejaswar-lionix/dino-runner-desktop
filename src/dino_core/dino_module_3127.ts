/** dino_module_3127 — collision_aabb extended, humanized desktop */
export interface In3127{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3127{y:number;vy:number;sc:number}
const C3127={g:0.5, j:13};
export function extraPhysics_3127(inp:In3127, dt:number):Out3127 {
...
export const mm3127={d:'collision_aabb'};