/** dino_module_3896 — obstacle_spawn extended, humanized desktop */
export interface In3896{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3896{y:number;vy:number;sc:number}
const C3896={g:0.8, j:13};
export function extraSpawn_3896(inp:In3896, dt:number):Out3896 {
...
export const mm3896={d:'obstacle_spawn'};