/** dino_module_3988 — obstacle_spawn extended, humanized desktop */
export interface In3988{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3988{y:number;vy:number;sc:number}
const C3988={g:0.5, j:13};
export function extraRender_3988(inp:In3988, dt:number):Out3988 {
...
export const mm3988={d:'obstacle_spawn'};