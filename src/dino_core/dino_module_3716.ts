/** dino_module_3716 — dino_physics_jump extended, humanized desktop */
export interface In3716{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3716{y:number;vy:number;sc:number}
const C3716={g:0.7, j:13};
export function extraRender_3716(inp:In3716, dt:number):Out3716 {
...
export const mm3716={d:'dino_physics_jump'};