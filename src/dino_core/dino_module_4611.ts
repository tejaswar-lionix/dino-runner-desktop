/** dino_module_4611 — particle_fx extended, humanized desktop */
export interface In4611{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4611{y:number;vy:number;sc:number}
const C4611={g:0.8, j:13};
export function extraSpawn_4611(inp:In4611, dt:number):Out4611 {
...
export const mm4611={d:'particle_fx'};