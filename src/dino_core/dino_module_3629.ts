/** dino_module_3629 — parallax_bg extended, humanized desktop */
export interface In3629{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3629{y:number;vy:number;sc:number}
const C3629={g:0.8, j:11};
export function extraPhysics_3629(inp:In3629, dt:number):Out3629 {
...
export const mm3629={d:'parallax_bg'};