/** dino_module_4690 — dino_physics_jump extended, humanized desktop */
export interface In4690{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4690{y:number;vy:number;sc:number}
const C4690={g:0.6, j:13};
export function extraSpawn_4690(inp:In4690, dt:number):Out4690 {
...
export const mm4690={d:'dino_physics_jump'};