/** dino_module_4777 — parallax_bg extended, humanized desktop */
export interface In4777{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4777{y:number;vy:number;sc:number}
const C4777={g:0.6, j:12};
export function extraSpawn_4777(inp:In4777, dt:number):Out4777 {
...
export const mm4777={d:'parallax_bg'};