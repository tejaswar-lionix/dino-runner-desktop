/** dino_module_3898 — parallax_bg extended, humanized desktop */
export interface In3898{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3898{y:number;vy:number;sc:number}
const C3898={g:0.7, j:11};
export function extraRender_3898(inp:In3898, dt:number):Out3898 {
...
export const mm3898={d:'parallax_bg'};