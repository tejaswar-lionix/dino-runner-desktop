/** dino_module_4891 — obstacle_spawn extended, humanized desktop */
export interface In4891{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4891{y:number;vy:number;sc:number}
const C4891={g:0.5, j:12};
export function extraSpawn_4891(inp:In4891, dt:number):Out4891 {
...
export const mm4891={d:'obstacle_spawn'};