/** dino_module_4121 — dino_physics_jump extended, humanized desktop */
export interface In4121{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4121{y:number;vy:number;sc:number}
const C4121={g:0.8, j:13};
export function extraPhysics_4121(inp:In4121, dt:number):Out4121 {
...
export const mm4121={d:'dino_physics_jump'};