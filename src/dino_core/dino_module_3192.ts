/** dino_module_3192 — score_speed extended, humanized desktop */
export interface In3192{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3192{y:number;vy:number;sc:number}
const C3192={g:0.7, j:12};
export function extraSpawn_3192(inp:In3192, dt:number):Out3192 {
...
export const mm3192={d:'score_speed'};