/** dino_module_3419 — obstacle_spawn extended, humanized desktop */
export interface In3419{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3419{y:number;vy:number;sc:number}
const C3419={g:0.7, j:12};
export function extraRender_3419(inp:In3419, dt:number):Out3419 {
...
export const mm3419={d:'obstacle_spawn'};