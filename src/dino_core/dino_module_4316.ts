/** dino_module_4316 — collision_aabb extended, humanized desktop */
export interface In4316{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4316{y:number;vy:number;sc:number}
const C4316={g:0.7, j:11};
export function extraSpawn_4316(inp:In4316, dt:number):Out4316 {
...
export const mm4316={d:'collision_aabb'};