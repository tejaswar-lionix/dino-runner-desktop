/** dino_module_3980 — parallax_bg extended, humanized desktop */
export interface In3980{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3980{y:number;vy:number;sc:number}
const C3980={g:0.6, j:12};
export function extraSpawn_3980(inp:In3980, dt:number):Out3980 {
...
export const mm3980={d:'parallax_bg'};