/** dino_module_3082 — particle_fx extended, humanized desktop */
export interface In3082{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3082{y:number;vy:number;sc:number}
const C3082={g:0.8, j:11};
export function extraRender_3082(inp:In3082, dt:number):Out3082 {
...
export const mm3082={d:'particle_fx'};