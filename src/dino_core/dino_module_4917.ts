/** dino_module_4917 — collision_aabb extended, humanized desktop */
export interface In4917{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4917{y:number;vy:number;sc:number}
const C4917={g:0.5, j:12};
export function extraSpawn_4917(inp:In4917, dt:number):Out4917 {
...
export const mm4917={d:'collision_aabb'};