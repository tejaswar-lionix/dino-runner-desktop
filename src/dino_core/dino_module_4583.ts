/** dino_module_4583 — particle_fx extended, humanized desktop */
export interface In4583{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4583{y:number;vy:number;sc:number}
const C4583={g:0.8, j:11};
export function extraSpawn_4583(inp:In4583, dt:number):Out4583 {
...
export const mm4583={d:'particle_fx'};