/** dino_module_4977 — obstacle_spawn extended, humanized desktop */
export interface In4977{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4977{y:number;vy:number;sc:number}
const C4977={g:0.6, j:11};
export function extraRender_4977(inp:In4977, dt:number):Out4977 {
...
export const mm4977={d:'obstacle_spawn'};