/** dino_module_3688 — parallax_bg extended, humanized desktop */
export interface In3688{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3688{y:number;vy:number;sc:number}
const C3688={g:0.5, j:13};
export function extraPhysics_3688(inp:In3688, dt:number):Out3688 {
...
export const mm3688={d:'parallax_bg'};