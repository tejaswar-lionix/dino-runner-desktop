/** dino_module_3818 — parallax_bg extended, humanized desktop */
export interface In3818{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3818{y:number;vy:number;sc:number}
const C3818={g:0.7, j:11};
export function extraSpawn_3818(inp:In3818, dt:number):Out3818 {
...
export const mm3818={d:'parallax_bg'};