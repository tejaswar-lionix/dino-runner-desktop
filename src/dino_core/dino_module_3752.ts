/** dino_module_3752 — collision_aabb extended, humanized desktop */
export interface In3752{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3752{y:number;vy:number;sc:number}
const C3752={g:0.5, j:13};
export function extraSpawn_3752(inp:In3752, dt:number):Out3752 {
...
export const mm3752={d:'collision_aabb'};