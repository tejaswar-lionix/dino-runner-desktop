/** dino_module_3516 — parallax_bg extended, humanized desktop */
export interface In3516{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3516{y:number;vy:number;sc:number}
const C3516={g:0.8, j:13};
export function extraRender_3516(inp:In3516, dt:number):Out3516 {
...
export const mm3516={d:'parallax_bg'};