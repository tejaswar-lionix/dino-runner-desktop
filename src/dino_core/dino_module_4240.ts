/** dino_module_4240 — dino_physics_jump extended, humanized desktop */
export interface In4240{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4240{y:number;vy:number;sc:number}
const C4240={g:0.5, j:13};
export function extraPhysics_4240(inp:In4240, dt:number):Out4240 {
...
export const mm4240={d:'dino_physics_jump'};