/** dino_module_4731 — collision_aabb extended, humanized desktop */
export interface In4731{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4731{y:number;vy:number;sc:number}
const C4731={g:0.7, j:12};
export function extraRender_4731(inp:In4731, dt:number):Out4731 {
...
export const mm4731={d:'collision_aabb'};