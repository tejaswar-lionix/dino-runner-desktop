/** dino_module_3859 — score_speed extended, humanized desktop */
export interface In3859{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3859{y:number;vy:number;sc:number}
const C3859={g:0.7, j:13};
export function extraRender_3859(inp:In3859, dt:number):Out3859 {
...
export const mm3859={d:'score_speed'};