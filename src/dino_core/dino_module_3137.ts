/** dino_module_3137 — particle_fx extended, humanized desktop */
export interface In3137{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3137{y:number;vy:number;sc:number}
const C3137={g:0.6, j:13};
export function extraPhysics_3137(inp:In3137, dt:number):Out3137 {
...
export const mm3137={d:'particle_fx'};