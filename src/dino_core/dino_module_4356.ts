/** dino_module_4356 — score_speed extended, humanized desktop */
export interface In4356{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4356{y:number;vy:number;sc:number}
const C4356={g:0.8, j:12};
export function extraSpawn_4356(inp:In4356, dt:number):Out4356 {
...
export const mm4356={d:'score_speed'};