/** dino_module_4016 — score_speed extended, humanized desktop */
export interface In4016{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4016{y:number;vy:number;sc:number}
const C4016={g:0.6, j:12};
export function extraRender_4016(inp:In4016, dt:number):Out4016 {
...
export const mm4016={d:'score_speed'};