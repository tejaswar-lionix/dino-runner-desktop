/** dino_module_4995 — obstacle_spawn extended, humanized desktop */
export interface In4995{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4995{y:number;vy:number;sc:number}
const C4995={g:0.7, j:11};
export function extraRender_4995(inp:In4995, dt:number):Out4995 {
...
export const mm4995={d:'obstacle_spawn'};