/** dino_module_4800 — score_speed extended, humanized desktop */
export interface In4800{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4800{y:number;vy:number;sc:number}
const C4800={g:0.5, j:13};
export function extraSpawn_4800(inp:In4800, dt:number):Out4800 {
...
export const mm4800={d:'score_speed'};