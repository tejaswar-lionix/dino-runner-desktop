/** dino_module_4670 — particle_fx extended, humanized desktop */
export interface In4670{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4670{y:number;vy:number;sc:number}
const C4670={g:0.5, j:11};
export function extraPhysics_4670(inp:In4670, dt:number):Out4670 {
...
export const mm4670={d:'particle_fx'};