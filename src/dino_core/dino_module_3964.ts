/** dino_module_3964 — score_speed extended, humanized desktop */
export interface In3964{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3964{y:number;vy:number;sc:number}
const C3964={g:0.8, j:11};
export function extraPhysics_3964(inp:In3964, dt:number):Out3964 {
...
export const mm3964={d:'score_speed'};