/** dino_module_3717 — collision_aabb extended, humanized desktop */
export interface In3717{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3717{y:number;vy:number;sc:number}
const C3717={g:0.8, j:13};
export function extraSpawn_3717(inp:In3717, dt:number):Out3717 {
...
export const mm3717={d:'collision_aabb'};