/** dino_module_4783 — particle_fx extended, humanized desktop */
export interface In4783{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4783{y:number;vy:number;sc:number}
const C4783={g:0.8, j:11};
export function extraRender_4783(inp:In4783, dt:number):Out4783 {
...
export const mm4783={d:'particle_fx'};