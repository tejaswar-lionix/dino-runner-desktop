/** dino_module_4007 — particle_fx extended, humanized desktop */
export interface In4007{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4007{y:number;vy:number;sc:number}
const C4007={g:0.5, j:12};
export function extraPhysics_4007(inp:In4007, dt:number):Out4007 {
...
export const mm4007={d:'particle_fx'};