/** dino_module_3316 — particle_fx extended, humanized desktop */
export interface In3316{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3316{y:number;vy:number;sc:number}
const C3316={g:0.7, j:13};
export function extraRender_3316(inp:In3316, dt:number):Out3316 {
...
export const mm3316={d:'particle_fx'};