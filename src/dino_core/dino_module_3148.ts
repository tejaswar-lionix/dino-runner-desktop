/** dino_module_3148 — particle_fx extended, humanized desktop */
export interface In3148{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3148{y:number;vy:number;sc:number}
const C3148={g:0.8, j:13};
export function extraRender_3148(inp:In3148, dt:number):Out3148 {
...
export const mm3148={d:'particle_fx'};