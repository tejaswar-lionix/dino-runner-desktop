/** dino_module_4734 — parallax_bg extended, humanized desktop */
export interface In4734{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4734{y:number;vy:number;sc:number}
const C4734={g:0.5, j:13};
export function extraSpawn_4734(inp:In4734, dt:number):Out4734 {
...
export const mm4734={d:'parallax_bg'};