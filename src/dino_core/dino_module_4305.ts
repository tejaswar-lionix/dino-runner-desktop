/** dino_module_4305 — parallax_bg extended, humanized desktop */
export interface In4305{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4305{y:number;vy:number;sc:number}
const C4305={g:0.5, j:12};
export function extraSpawn_4305(inp:In4305, dt:number):Out4305 {
...
export const mm4305={d:'parallax_bg'};