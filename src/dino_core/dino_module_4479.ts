/** dino_module_4479 — collision_aabb extended, humanized desktop */
export interface In4479{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4479{y:number;vy:number;sc:number}
const C4479={g:0.7, j:12};
export function extraRender_4479(inp:In4479, dt:number):Out4479 {
...
export const mm4479={d:'collision_aabb'};