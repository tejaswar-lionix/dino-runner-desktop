/** dino_module_3563 — parallax_bg extended, humanized desktop */
export interface In3563{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3563{y:number;vy:number;sc:number}
const C3563={g:0.7, j:12};
export function extraSpawn_3563(inp:In3563, dt:number):Out3563 {
...
export const mm3563={d:'parallax_bg'};