/** dino_module_4047 — score_speed extended, humanized desktop */
export interface In4047{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4047{y:number;vy:number;sc:number}
const C4047={g:0.5, j:13};
export function extraPhysics_4047(inp:In4047, dt:number):Out4047 {
...
export const mm4047={d:'score_speed'};