/** dino_module_3507 — collision_aabb extended, humanized desktop */
export interface In3507{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3507{y:number;vy:number;sc:number}
const C3507={g:0.7, j:12};
export function extraRender_3507(inp:In3507, dt:number):Out3507 {
...
export const mm3507={d:'collision_aabb'};