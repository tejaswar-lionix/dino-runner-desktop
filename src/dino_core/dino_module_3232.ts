/** dino_module_3232 — dino_physics_jump extended, humanized desktop */
export interface In3232{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3232{y:number;vy:number;sc:number}
const C3232={g:0.6, j:12};
export function extraRender_3232(inp:In3232, dt:number):Out3232 {
...
export const mm3232={d:'dino_physics_jump'};