/** dino_module_3025 — obstacle_spawn extended, humanized desktop */
export interface In3025{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3025{y:number;vy:number;sc:number}
const C3025={g:0.7, j:12};
export function extraRender_3025(inp:In3025, dt:number):Out3025 {
...
export const mm3025={d:'obstacle_spawn'};