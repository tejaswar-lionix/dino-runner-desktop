/** dino_module_3641 — particle_fx extended, humanized desktop */
export interface In3641{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3641{y:number;vy:number;sc:number}
const C3641={g:0.6, j:11};
export function extraPhysics_3641(inp:In3641, dt:number):Out3641 {
...
export const mm3641={d:'particle_fx'};