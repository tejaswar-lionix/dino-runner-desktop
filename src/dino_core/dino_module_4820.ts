/** dino_module_4820 — score_speed extended, humanized desktop */
export interface In4820{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4820{y:number;vy:number;sc:number}
const C4820={g:0.8, j:11};
export function extraPhysics_4820(inp:In4820, dt:number):Out4820 {
...
export const mm4820={d:'score_speed'};