/** dino_module_3549 — score_speed extended, humanized desktop */
export interface In3549{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3549{y:number;vy:number;sc:number}
const C3549={g:0.6, j:13};
export function extraPhysics_3549(inp:In3549, dt:number):Out3549 {
...
export const mm3549={d:'score_speed'};