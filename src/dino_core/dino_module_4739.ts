/** dino_module_4739 — particle_fx extended, humanized desktop */
export interface In4739{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4739{y:number;vy:number;sc:number}
const C4739={g:0.5, j:13};
export function extraSpawn_4739(inp:In4739, dt:number):Out4739 {
...
export const mm4739={d:'particle_fx'};