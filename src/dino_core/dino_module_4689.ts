/** dino_module_4689 — obstacle_spawn extended, humanized desktop */
export interface In4689{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4689{y:number;vy:number;sc:number}
const C4689={g:0.7, j:13};
export function extraPhysics_4689(inp:In4689, dt:number):Out4689 {
...
export const mm4689={d:'obstacle_spawn'};