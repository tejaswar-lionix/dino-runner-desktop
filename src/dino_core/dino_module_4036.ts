/** dino_module_4036 — particle_fx extended, humanized desktop */
export interface In4036{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4036{y:number;vy:number;sc:number}
const C4036={g:0.5, j:11};
export function extraPhysics_4036(inp:In4036, dt:number):Out4036 {
...
export const mm4036={d:'particle_fx'};