/** dino_module_3652 — collision_aabb extended, humanized desktop */
export interface In3652{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3652{y:number;vy:number;sc:number}
const C3652={g:0.6, j:11};
export function extraRender_3652(inp:In3652, dt:number):Out3652 {
...
export const mm3652={d:'collision_aabb'};