/** dino_module_4037 — dino_physics_jump extended, humanized desktop */
export interface In4037{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4037{y:number;vy:number;sc:number}
const C4037={g:0.8, j:12};
export function extraRender_4037(inp:In4037, dt:number):Out4037 {
...
export const mm4037={d:'dino_physics_jump'};