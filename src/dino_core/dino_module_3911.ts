/** dino_module_3911 — collision_aabb extended, humanized desktop */
export interface In3911{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3911{y:number;vy:number;sc:number}
const C3911={g:0.6, j:13};
export function extraPhysics_3911(inp:In3911, dt:number):Out3911 {
...
export const mm3911={d:'collision_aabb'};