/** dino_module_4614 — obstacle_spawn extended, humanized desktop */
export interface In4614{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4614{y:number;vy:number;sc:number}
const C4614={g:0.5, j:12};
export function extraRender_4614(inp:In4614, dt:number):Out4614 {
...
export const mm4614={d:'obstacle_spawn'};