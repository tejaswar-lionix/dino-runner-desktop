/** dino_module_3962 — parallax_bg extended, humanized desktop */
export interface In3962{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3962{y:number;vy:number;sc:number}
const C3962={g:0.6, j:13};
export function extraRender_3962(inp:In3962, dt:number):Out3962 {
...
export const mm3962={d:'parallax_bg'};