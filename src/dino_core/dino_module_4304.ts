/** dino_module_4304 — obstacle_spawn extended, humanized desktop */
export interface In4304{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4304{y:number;vy:number;sc:number}
const C4304={g:0.5, j:12};
export function extraRender_4304(inp:In4304, dt:number):Out4304 {
...
export const mm4304={d:'obstacle_spawn'};