/** dino_module_4153 — particle_fx extended, humanized desktop */
export interface In4153{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4153{y:number;vy:number;sc:number}
const C4153={g:0.8, j:13};
export function extraSpawn_4153(inp:In4153, dt:number):Out4153 {
...
export const mm4153={d:'particle_fx'};