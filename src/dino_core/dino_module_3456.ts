/** dino_module_3456 — particle_fx extended, humanized desktop */
export interface In3456{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3456{y:number;vy:number;sc:number}
const C3456={g:0.5, j:11};
export function extraSpawn_3456(inp:In3456, dt:number):Out3456 {
...
export const mm3456={d:'particle_fx'};