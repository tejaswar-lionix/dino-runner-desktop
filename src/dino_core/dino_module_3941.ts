/** dino_module_3941 — score_speed extended, humanized desktop */
export interface In3941{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3941{y:number;vy:number;sc:number}
const C3941={g:0.7, j:11};
export function extraSpawn_3941(inp:In3941, dt:number):Out3941 {
...
export const mm3941={d:'score_speed'};