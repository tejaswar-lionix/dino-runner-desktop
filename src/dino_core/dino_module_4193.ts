/** dino_module_4193 — dino_physics_jump extended, humanized desktop */
export interface In4193{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4193{y:number;vy:number;sc:number}
const C4193={g:0.7, j:13};
export function extraPhysics_4193(inp:In4193, dt:number):Out4193 {
...
export const mm4193={d:'dino_physics_jump'};