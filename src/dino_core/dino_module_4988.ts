/** dino_module_4988 — collision_aabb extended, humanized desktop */
export interface In4988{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4988{y:number;vy:number;sc:number}
const C4988={g:0.7, j:13};
export function extraSpawn_4988(inp:In4988, dt:number):Out4988 {
...
export const mm4988={d:'collision_aabb'};