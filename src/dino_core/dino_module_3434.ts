/** dino_module_3434 — score_speed extended, humanized desktop */
export interface In3434{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3434{y:number;vy:number;sc:number}
const C3434={g:0.8, j:13};
export function extraPhysics_3434(inp:In3434, dt:number):Out3434 {
...
export const mm3434={d:'score_speed'};