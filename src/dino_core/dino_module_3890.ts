/** dino_module_3890 — score_speed extended, humanized desktop */
export interface In3890{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3890{y:number;vy:number;sc:number}
const C3890={g:0.5, j:12};
export function extraSpawn_3890(inp:In3890, dt:number):Out3890 {
...
export const mm3890={d:'score_speed'};