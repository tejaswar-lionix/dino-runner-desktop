/** dino_module_3954 — dino_physics_jump extended, humanized desktop */
export interface In3954{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3954{y:number;vy:number;sc:number}
const C3954={g:0.5, j:13};
export function extraRender_3954(inp:In3954, dt:number):Out3954 {
...
export const mm3954={d:'dino_physics_jump'};