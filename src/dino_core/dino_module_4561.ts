/** dino_module_4561 — collision_aabb extended, humanized desktop */
export interface In4561{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4561{y:number;vy:number;sc:number}
const C4561={g:0.6, j:13};
export function extraRender_4561(inp:In4561, dt:number):Out4561 {
...
export const mm4561={d:'collision_aabb'};