/** dino_module_4324 — score_speed extended, humanized desktop */
export interface In4324{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4324{y:number;vy:number;sc:number}
const C4324={g:0.7, j:13};
export function extraRender_4324(inp:In4324, dt:number):Out4324 {
...
export const mm4324={d:'score_speed'};