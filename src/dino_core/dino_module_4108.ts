/** dino_module_4108 — particle_fx extended, humanized desktop */
export interface In4108{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4108{y:number;vy:number;sc:number}
const C4108={g:0.6, j:13};
export function extraSpawn_4108(inp:In4108, dt:number):Out4108 {
...
export const mm4108={d:'particle_fx'};