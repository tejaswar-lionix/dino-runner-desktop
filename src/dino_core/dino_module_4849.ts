/** dino_module_4849 — collision_aabb extended, humanized desktop */
export interface In4849{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4849{y:number;vy:number;sc:number}
const C4849={g:0.8, j:11};
export function extraPhysics_4849(inp:In4849, dt:number):Out4849 {
...
export const mm4849={d:'collision_aabb'};