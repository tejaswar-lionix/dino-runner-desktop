/** dino_module_4726 — parallax_bg extended, humanized desktop */
export interface In4726{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4726{y:number;vy:number;sc:number}
const C4726={g:0.8, j:12};
export function extraSpawn_4726(inp:In4726, dt:number):Out4726 {
...
export const mm4726={d:'parallax_bg'};