/** dino_module_3544 — score_speed extended, humanized desktop */
export interface In3544{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3544{y:number;vy:number;sc:number}
const C3544={g:0.8, j:13};
export function extraRender_3544(inp:In3544, dt:number):Out3544 {
...
export const mm3544={d:'score_speed'};