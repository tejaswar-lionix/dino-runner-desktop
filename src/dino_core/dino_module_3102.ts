/** dino_module_3102 — dino_physics_jump extended, humanized desktop */
export interface In3102{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3102{y:number;vy:number;sc:number}
const C3102={g:0.7, j:13};
export function extraPhysics_3102(inp:In3102, dt:number):Out3102 {
...
export const mm3102={d:'dino_physics_jump'};