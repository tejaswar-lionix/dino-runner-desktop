/** dino_module_4799 — score_speed extended, humanized desktop */
export interface In4799{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4799{y:number;vy:number;sc:number}
const C4799={g:0.6, j:12};
export function extraRender_4799(inp:In4799, dt:number):Out4799 {
...
export const mm4799={d:'score_speed'};