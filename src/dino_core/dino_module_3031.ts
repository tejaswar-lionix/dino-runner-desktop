/** dino_module_3031 — collision_aabb extended, humanized desktop */
export interface In3031{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3031{y:number;vy:number;sc:number}
const C3031={g:0.8, j:13};
export function extraRender_3031(inp:In3031, dt:number):Out3031 {
...
export const mm3031={d:'collision_aabb'};