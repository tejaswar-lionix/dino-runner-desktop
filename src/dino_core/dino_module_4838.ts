/** dino_module_4838 — parallax_bg extended, humanized desktop */
export interface In4838{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4838{y:number;vy:number;sc:number}
const C4838={g:0.6, j:11};
export function extraPhysics_4838(inp:In4838, dt:number):Out4838 {
...
export const mm4838={d:'parallax_bg'};