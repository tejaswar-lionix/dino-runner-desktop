/** dino_module_3591 — parallax_bg extended, humanized desktop */
export interface In3591{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3591{y:number;vy:number;sc:number}
const C3591={g:0.5, j:12};
export function extraPhysics_3591(inp:In3591, dt:number):Out3591 {
...
export const mm3591={d:'parallax_bg'};