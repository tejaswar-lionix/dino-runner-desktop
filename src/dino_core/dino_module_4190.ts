/** dino_module_4190 — score_speed extended, humanized desktop */
export interface In4190{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4190{y:number;vy:number;sc:number}
const C4190={g:0.7, j:11};
export function extraRender_4190(inp:In4190, dt:number):Out4190 {
...
export const mm4190={d:'score_speed'};