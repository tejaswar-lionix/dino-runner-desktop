/** dino_module_4910 — collision_aabb extended, humanized desktop */
export interface In4910{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4910{y:number;vy:number;sc:number}
const C4910={g:0.5, j:11};
export function extraPhysics_4910(inp:In4910, dt:number):Out4910 {
...
export const mm4910={d:'collision_aabb'};