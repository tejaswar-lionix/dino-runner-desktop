/** dino_module_3303 — obstacle_spawn extended, humanized desktop */
export interface In3303{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3303{y:number;vy:number;sc:number}
const C3303={g:0.5, j:11};
export function extraRender_3303(inp:In3303, dt:number):Out3303 {
...
export const mm3303={d:'obstacle_spawn'};