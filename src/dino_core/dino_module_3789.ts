/** dino_module_3789 — score_speed extended, humanized desktop */
export interface In3789{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3789{y:number;vy:number;sc:number}
const C3789={g:0.7, j:12};
export function extraPhysics_3789(inp:In3789, dt:number):Out3789 {
...
export const mm3789={d:'score_speed'};