/** dino_module_3957 — dino_physics_jump extended, humanized desktop */
export interface In3957{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3957{y:number;vy:number;sc:number}
const C3957={g:0.6, j:13};
export function extraPhysics_3957(inp:In3957, dt:number):Out3957 {
...
export const mm3957={d:'dino_physics_jump'};