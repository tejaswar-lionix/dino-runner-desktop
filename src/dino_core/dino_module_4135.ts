/** dino_module_4135 — obstacle_spawn extended, humanized desktop */
export interface In4135{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4135{y:number;vy:number;sc:number}
const C4135={g:0.8, j:12};
export function extraPhysics_4135(inp:In4135, dt:number):Out4135 {
...
export const mm4135={d:'obstacle_spawn'};