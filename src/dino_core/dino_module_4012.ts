/** dino_module_4012 — particle_fx extended, humanized desktop */
export interface In4012{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4012{y:number;vy:number;sc:number}
const C4012={g:0.8, j:12};
export function extraRender_4012(inp:In4012, dt:number):Out4012 {
...
export const mm4012={d:'particle_fx'};