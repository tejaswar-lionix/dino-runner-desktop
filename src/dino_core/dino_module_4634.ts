/** dino_module_4634 — collision_aabb extended, humanized desktop */
export interface In4634{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4634{y:number;vy:number;sc:number}
const C4634={g:0.8, j:13};
export function extraRender_4634(inp:In4634, dt:number):Out4634 {
...
export const mm4634={d:'collision_aabb'};