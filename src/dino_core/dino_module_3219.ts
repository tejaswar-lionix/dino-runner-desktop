/** dino_module_3219 — dino_physics_jump extended, humanized desktop */
export interface In3219{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3219{y:number;vy:number;sc:number}
const C3219={g:0.8, j:13};
export function extraSpawn_3219(inp:In3219, dt:number):Out3219 {
...
export const mm3219={d:'dino_physics_jump'};