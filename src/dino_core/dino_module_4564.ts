/** dino_module_4564 — collision_aabb extended, humanized desktop */
export interface In4564{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4564{y:number;vy:number;sc:number}
const C4564={g:0.7, j:12};
export function extraSpawn_4564(inp:In4564, dt:number):Out4564 {
...
export const mm4564={d:'collision_aabb'};