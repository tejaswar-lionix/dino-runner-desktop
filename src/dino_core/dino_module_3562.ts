/** dino_module_3562 — dino_physics_jump extended, humanized desktop */
export interface In3562{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3562{y:number;vy:number;sc:number}
const C3562={g:0.8, j:13};
export function extraPhysics_3562(inp:In3562, dt:number):Out3562 {
...
export const mm3562={d:'dino_physics_jump'};