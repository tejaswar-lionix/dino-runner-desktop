/** dino_module_4026 — parallax_bg extended, humanized desktop */
export interface In4026{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4026{y:number;vy:number;sc:number}
const C4026={g:0.6, j:12};
export function extraSpawn_4026(inp:In4026, dt:number):Out4026 {
...
export const mm4026={d:'parallax_bg'};