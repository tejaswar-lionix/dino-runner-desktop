/** dino_module_3622 — obstacle_spawn extended, humanized desktop */
export interface In3622{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3622{y:number;vy:number;sc:number}
const C3622={g:0.5, j:12};
export function extraPhysics_3622(inp:In3622, dt:number):Out3622 {
...
export const mm3622={d:'obstacle_spawn'};