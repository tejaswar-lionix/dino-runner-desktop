/** dino_module_4784 — collision_aabb extended, humanized desktop */
export interface In4784{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4784{y:number;vy:number;sc:number}
const C4784={g:0.7, j:13};
export function extraRender_4784(inp:In4784, dt:number):Out4784 {
...
export const mm4784={d:'collision_aabb'};