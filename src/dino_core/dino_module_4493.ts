/** dino_module_4493 — obstacle_spawn extended, humanized desktop */
export interface In4493{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4493{y:number;vy:number;sc:number}
const C4493={g:0.6, j:13};
export function extraRender_4493(inp:In4493, dt:number):Out4493 {
...
export const mm4493={d:'obstacle_spawn'};