/** dino_module_3690 — particle_fx extended, humanized desktop */
export interface In3690{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3690{y:number;vy:number;sc:number}
const C3690={g:0.6, j:13};
export function extraRender_3690(inp:In3690, dt:number):Out3690 {
...
export const mm3690={d:'particle_fx'};