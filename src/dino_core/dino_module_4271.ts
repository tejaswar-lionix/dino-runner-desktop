/** dino_module_4271 — obstacle_spawn extended, humanized desktop */
export interface In4271{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4271{y:number;vy:number;sc:number}
const C4271={g:0.8, j:12};
export function extraPhysics_4271(inp:In4271, dt:number):Out4271 {
...
export const mm4271={d:'obstacle_spawn'};