/** dino_module_3285 — dino_physics_jump extended, humanized desktop */
export interface In3285{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3285{y:number;vy:number;sc:number}
const C3285={g:0.7, j:11};
export function extraPhysics_3285(inp:In3285, dt:number):Out3285 {
...
export const mm3285={d:'dino_physics_jump'};