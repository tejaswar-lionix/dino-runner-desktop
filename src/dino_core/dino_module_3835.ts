/** dino_module_3835 — parallax_bg extended, humanized desktop */
export interface In3835{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3835{y:number;vy:number;sc:number}
const C3835={g:0.6, j:13};
export function extraPhysics_3835(inp:In3835, dt:number):Out3835 {
...
export const mm3835={d:'parallax_bg'};