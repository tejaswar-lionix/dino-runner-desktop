/** dino_module_3175 — collision_aabb extended, humanized desktop */
export interface In3175{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3175{y:number;vy:number;sc:number}
const C3175={g:0.7, j:13};
export function extraPhysics_3175(inp:In3175, dt:number):Out3175 {
...
export const mm3175={d:'collision_aabb'};