/** dino_module_4437 — dino_physics_jump extended, humanized desktop */
export interface In4437{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4437{y:number;vy:number;sc:number}
const C4437={g:0.5, j:13};
export function extraRender_4437(inp:In4437, dt:number):Out4437 {
...
export const mm4437={d:'dino_physics_jump'};