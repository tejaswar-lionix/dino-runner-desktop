/** dino_module_3942 — collision_aabb extended, humanized desktop */
export interface In3942{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3942{y:number;vy:number;sc:number}
const C3942={g:0.8, j:13};
export function extraSpawn_3942(inp:In3942, dt:number):Out3942 {
...
export const mm3942={d:'collision_aabb'};