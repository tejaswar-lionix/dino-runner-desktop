/** dino_module_3321 — obstacle_spawn extended, humanized desktop */
export interface In3321{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3321{y:number;vy:number;sc:number}
const C3321={g:0.6, j:11};
export function extraPhysics_3321(inp:In3321, dt:number):Out3321 {
...
export const mm3321={d:'obstacle_spawn'};