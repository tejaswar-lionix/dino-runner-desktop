/** dino_module_3678 — particle_fx extended, humanized desktop */
export interface In3678{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3678{y:number;vy:number;sc:number}
const C3678={g:0.6, j:13};
export function extraRender_3678(inp:In3678, dt:number):Out3678 {
...
export const mm3678={d:'particle_fx'};