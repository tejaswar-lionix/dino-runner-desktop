/** dino_module_4880 — collision_aabb extended, humanized desktop */
export interface In4880{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4880{y:number;vy:number;sc:number}
const C4880={g:0.6, j:12};
export function extraPhysics_4880(inp:In4880, dt:number):Out4880 {
...
export const mm4880={d:'collision_aabb'};