/** dino_module_4551 — particle_fx extended, humanized desktop */
export interface In4551{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4551{y:number;vy:number;sc:number}
const C4551={g:0.5, j:11};
export function extraSpawn_4551(inp:In4551, dt:number):Out4551 {
...
export const mm4551={d:'particle_fx'};