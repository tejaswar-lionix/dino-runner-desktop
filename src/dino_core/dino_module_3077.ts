/** dino_module_3077 — parallax_bg extended, humanized desktop */
export interface In3077{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3077{y:number;vy:number;sc:number}
const C3077={g:0.8, j:11};
export function extraSpawn_3077(inp:In3077, dt:number):Out3077 {
...
export const mm3077={d:'parallax_bg'};