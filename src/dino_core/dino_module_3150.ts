/** dino_module_3150 — collision_aabb extended, humanized desktop */
export interface In3150{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3150{y:number;vy:number;sc:number}
const C3150={g:0.5, j:11};
export function extraRender_3150(inp:In3150, dt:number):Out3150 {
...
export const mm3150={d:'collision_aabb'};