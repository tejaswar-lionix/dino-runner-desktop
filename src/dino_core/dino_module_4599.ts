/** dino_module_4599 — particle_fx extended, humanized desktop */
export interface In4599{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4599{y:number;vy:number;sc:number}
const C4599={g:0.7, j:12};
export function extraSpawn_4599(inp:In4599, dt:number):Out4599 {
...
export const mm4599={d:'particle_fx'};