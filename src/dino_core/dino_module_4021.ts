/** dino_module_4021 — dino_physics_jump extended, humanized desktop */
export interface In4021{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4021{y:number;vy:number;sc:number}
const C4021={g:0.6, j:12};
export function extraPhysics_4021(inp:In4021, dt:number):Out4021 {
...
export const mm4021={d:'dino_physics_jump'};