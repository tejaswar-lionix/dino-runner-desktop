/** dino_module_3798 — dino_physics_jump extended, humanized desktop */
export interface In3798{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3798{y:number;vy:number;sc:number}
const C3798={g:0.7, j:11};
export function extraSpawn_3798(inp:In3798, dt:number):Out3798 {
...
export const mm3798={d:'dino_physics_jump'};