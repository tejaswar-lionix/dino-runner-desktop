/** dino_module_3533 — obstacle_spawn extended, humanized desktop */
export interface In3533{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3533{y:number;vy:number;sc:number}
const C3533={g:0.6, j:11};
export function extraSpawn_3533(inp:In3533, dt:number):Out3533 {
...
export const mm3533={d:'obstacle_spawn'};