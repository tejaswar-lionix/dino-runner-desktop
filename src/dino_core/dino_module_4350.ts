/** dino_module_4350 — dino_physics_jump extended, humanized desktop */
export interface In4350{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4350{y:number;vy:number;sc:number}
const C4350={g:0.6, j:11};
export function extraRender_4350(inp:In4350, dt:number):Out4350 {
...
export const mm4350={d:'dino_physics_jump'};