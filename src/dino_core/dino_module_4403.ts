/** dino_module_4403 — score_speed extended, humanized desktop */
export interface In4403{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4403{y:number;vy:number;sc:number}
const C4403={g:0.5, j:13};
export function extraRender_4403(inp:In4403, dt:number):Out4403 {
...
export const mm4403={d:'score_speed'};