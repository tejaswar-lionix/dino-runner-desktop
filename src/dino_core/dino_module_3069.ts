/** dino_module_3069 — collision_aabb extended, humanized desktop */
export interface In3069{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3069{y:number;vy:number;sc:number}
const C3069={g:0.5, j:11};
export function extraRender_3069(inp:In3069, dt:number):Out3069 {
...
export const mm3069={d:'collision_aabb'};