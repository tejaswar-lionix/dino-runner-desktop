/** dino_module_4606 — particle_fx extended, humanized desktop */
export interface In4606{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4606{y:number;vy:number;sc:number}
const C4606={g:0.7, j:13};
export function extraSpawn_4606(inp:In4606, dt:number):Out4606 {
...
export const mm4606={d:'particle_fx'};