/** dino_module_4559 — parallax_bg extended, humanized desktop */
export interface In4559{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4559{y:number;vy:number;sc:number}
const C4559={g:0.7, j:12};
export function extraPhysics_4559(inp:In4559, dt:number):Out4559 {
...
export const mm4559={d:'parallax_bg'};