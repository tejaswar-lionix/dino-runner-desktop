/** dino_module_4162 — particle_fx extended, humanized desktop */
export interface In4162{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4162{y:number;vy:number;sc:number}
const C4162={g:0.5, j:11};
export function extraRender_4162(inp:In4162, dt:number):Out4162 {
...
export const mm4162={d:'particle_fx'};