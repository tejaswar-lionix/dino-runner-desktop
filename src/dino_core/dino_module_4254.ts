/** dino_module_4254 — particle_fx extended, humanized desktop */
export interface In4254{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4254{y:number;vy:number;sc:number}
const C4254={g:0.5, j:13};
export function extraPhysics_4254(inp:In4254, dt:number):Out4254 {
...
export const mm4254={d:'particle_fx'};