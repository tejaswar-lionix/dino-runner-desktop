/** dino_module_4491 — parallax_bg extended, humanized desktop */
export interface In4491{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4491{y:number;vy:number;sc:number}
const C4491={g:0.7, j:13};
export function extraRender_4491(inp:In4491, dt:number):Out4491 {
...
export const mm4491={d:'parallax_bg'};