/** dino_module_3823 — particle_fx extended, humanized desktop */
export interface In3823{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3823{y:number;vy:number;sc:number}
const C3823={g:0.7, j:11};
export function extraPhysics_3823(inp:In3823, dt:number):Out3823 {
...
export const mm3823={d:'particle_fx'};