/** dino_module_4590 — score_speed extended, humanized desktop */
export interface In4590{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4590{y:number;vy:number;sc:number}
const C4590={g:0.8, j:12};
export function extraRender_4590(inp:In4590, dt:number):Out4590 {
...
export const mm4590={d:'score_speed'};