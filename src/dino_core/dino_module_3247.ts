/** dino_module_3247 — collision_aabb extended, humanized desktop */
export interface In3247{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3247{y:number;vy:number;sc:number}
const C3247={g:0.5, j:11};
export function extraPhysics_3247(inp:In3247, dt:number):Out3247 {
...
export const mm3247={d:'collision_aabb'};