/** dino_module_4341 — collision_aabb extended, humanized desktop */
export interface In4341{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4341{y:number;vy:number;sc:number}
const C4341={g:0.6, j:12};
export function extraPhysics_4341(inp:In4341, dt:number):Out4341 {
...
export const mm4341={d:'collision_aabb'};