/** dino_module_4419 — particle_fx extended, humanized desktop */
export interface In4419{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4419{y:number;vy:number;sc:number}
const C4419={g:0.5, j:11};
export function extraRender_4419(inp:In4419, dt:number):Out4419 {
...
export const mm4419={d:'particle_fx'};