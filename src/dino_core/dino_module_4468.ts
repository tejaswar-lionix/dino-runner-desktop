/** dino_module_4468 — obstacle_spawn extended, humanized desktop */
export interface In4468{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4468{y:number;vy:number;sc:number}
const C4468={g:0.6, j:11};
export function extraPhysics_4468(inp:In4468, dt:number):Out4468 {
...
export const mm4468={d:'obstacle_spawn'};