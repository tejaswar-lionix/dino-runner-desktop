/** dino_module_3208 — parallax_bg extended, humanized desktop */
export interface In3208{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3208{y:number;vy:number;sc:number}
const C3208={g:0.8, j:12};
export function extraRender_3208(inp:In3208, dt:number):Out3208 {
...
export const mm3208={d:'parallax_bg'};