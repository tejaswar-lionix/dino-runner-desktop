/** dino_module_4840 — particle_fx extended, humanized desktop */
export interface In4840{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4840{y:number;vy:number;sc:number}
const C4840={g:0.6, j:11};
export function extraPhysics_4840(inp:In4840, dt:number):Out4840 {
...
export const mm4840={d:'particle_fx'};