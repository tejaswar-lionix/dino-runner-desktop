/** dino_module_4989 — particle_fx extended, humanized desktop */
export interface In4989{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4989{y:number;vy:number;sc:number}
const C4989={g:0.7, j:12};
export function extraPhysics_4989(inp:In4989, dt:number):Out4989 {
...
export const mm4989={d:'particle_fx'};