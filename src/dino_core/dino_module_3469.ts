/** dino_module_3469 — dino_physics_jump extended, humanized desktop */
export interface In3469{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3469{y:number;vy:number;sc:number}
const C3469={g:0.8, j:13};
export function extraSpawn_3469(inp:In3469, dt:number):Out3469 {
...
export const mm3469={d:'dino_physics_jump'};