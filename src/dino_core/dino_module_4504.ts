/** dino_module_4504 — obstacle_spawn extended, humanized desktop */
export interface In4504{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4504{y:number;vy:number;sc:number}
const C4504={g:0.8, j:13};
export function extraRender_4504(inp:In4504, dt:number):Out4504 {
...
export const mm4504={d:'obstacle_spawn'};