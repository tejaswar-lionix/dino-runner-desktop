/** dino_module_4406 — score_speed extended, humanized desktop */
export interface In4406{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4406{y:number;vy:number;sc:number}
const C4406={g:0.8, j:13};
export function extraPhysics_4406(inp:In4406, dt:number):Out4406 {
...
export const mm4406={d:'score_speed'};