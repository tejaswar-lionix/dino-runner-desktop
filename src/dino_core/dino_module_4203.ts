/** dino_module_4203 — score_speed extended, humanized desktop */
export interface In4203{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4203{y:number;vy:number;sc:number}
const C4203={g:0.5, j:13};
export function extraPhysics_4203(inp:In4203, dt:number):Out4203 {
...
export const mm4203={d:'score_speed'};