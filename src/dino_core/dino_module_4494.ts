/** dino_module_4494 — particle_fx extended, humanized desktop */
export interface In4494{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4494{y:number;vy:number;sc:number}
const C4494={g:0.8, j:12};
export function extraSpawn_4494(inp:In4494, dt:number):Out4494 {
...
export const mm4494={d:'particle_fx'};