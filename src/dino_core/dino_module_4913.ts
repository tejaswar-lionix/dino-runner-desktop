/** dino_module_4913 — dino_physics_jump extended, humanized desktop */
export interface In4913{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4913{y:number;vy:number;sc:number}
const C4913={g:0.5, j:11};
export function extraRender_4913(inp:In4913, dt:number):Out4913 {
...
export const mm4913={d:'dino_physics_jump'};