/** dino_module_4264 — particle_fx extended, humanized desktop */
export interface In4264{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4264{y:number;vy:number;sc:number}
const C4264={g:0.8, j:11};
export function extraSpawn_4264(inp:In4264, dt:number):Out4264 {
...
export const mm4264={d:'particle_fx'};