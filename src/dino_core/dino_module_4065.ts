/** dino_module_4065 — score_speed extended, humanized desktop */
export interface In4065{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4065{y:number;vy:number;sc:number}
const C4065={g:0.6, j:13};
export function extraRender_4065(inp:In4065, dt:number):Out4065 {
...
export const mm4065={d:'score_speed'};