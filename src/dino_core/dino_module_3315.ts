/** dino_module_3315 — obstacle_spawn extended, humanized desktop */
export interface In3315{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3315{y:number;vy:number;sc:number}
const C3315={g:0.6, j:13};
export function extraPhysics_3315(inp:In3315, dt:number):Out3315 {
...
export const mm3315={d:'obstacle_spawn'};