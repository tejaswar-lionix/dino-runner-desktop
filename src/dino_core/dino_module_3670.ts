/** dino_module_3670 — obstacle_spawn extended, humanized desktop */
export interface In3670{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3670{y:number;vy:number;sc:number}
const C3670={g:0.7, j:11};
export function extraPhysics_3670(inp:In3670, dt:number):Out3670 {
...
export const mm3670={d:'obstacle_spawn'};