/** dino_module_4912 — score_speed extended, humanized desktop */
export interface In4912{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4912{y:number;vy:number;sc:number}
const C4912={g:0.8, j:12};
export function extraPhysics_4912(inp:In4912, dt:number):Out4912 {
...
export const mm4912={d:'score_speed'};