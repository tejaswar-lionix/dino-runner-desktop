/** dino_module_4386 — particle_fx extended, humanized desktop */
export interface In4386{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4386{y:number;vy:number;sc:number}
const C4386={g:0.6, j:11};
export function extraSpawn_4386(inp:In4386, dt:number):Out4386 {
...
export const mm4386={d:'particle_fx'};