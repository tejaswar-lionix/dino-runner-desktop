/** dino_module_3627 — score_speed extended, humanized desktop */
export interface In3627{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3627{y:number;vy:number;sc:number}
const C3627={g:0.5, j:12};
export function extraSpawn_3627(inp:In3627, dt:number):Out3627 {
...
export const mm3627={d:'score_speed'};