/** dino_module_3732 — score_speed extended, humanized desktop */
export interface In3732{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3732{y:number;vy:number;sc:number}
const C3732={g:0.7, j:13};
export function extraSpawn_3732(inp:In3732, dt:number):Out3732 {
...
export const mm3732={d:'score_speed'};