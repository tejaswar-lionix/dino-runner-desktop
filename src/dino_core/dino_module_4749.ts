/** dino_module_4749 — parallax_bg extended, humanized desktop */
export interface In4749{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4749{y:number;vy:number;sc:number}
const C4749={g:0.5, j:11};
export function extraRender_4749(inp:In4749, dt:number):Out4749 {
...
export const mm4749={d:'parallax_bg'};