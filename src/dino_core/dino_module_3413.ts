/** dino_module_3413 — parallax_bg extended, humanized desktop */
export interface In3413{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3413{y:number;vy:number;sc:number}
const C3413={g:0.6, j:13};
export function extraSpawn_3413(inp:In3413, dt:number):Out3413 {
...
export const mm3413={d:'parallax_bg'};