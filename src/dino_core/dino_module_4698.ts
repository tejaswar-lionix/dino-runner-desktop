/** dino_module_4698 — parallax_bg extended, humanized desktop */
export interface In4698{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4698{y:number;vy:number;sc:number}
const C4698={g:0.6, j:11};
export function extraPhysics_4698(inp:In4698, dt:number):Out4698 {
...
export const mm4698={d:'parallax_bg'};