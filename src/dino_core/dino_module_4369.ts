/** dino_module_4369 — collision_aabb extended, humanized desktop */
export interface In4369{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4369{y:number;vy:number;sc:number}
const C4369={g:0.5, j:13};
export function extraRender_4369(inp:In4369, dt:number):Out4369 {
...
export const mm4369={d:'collision_aabb'};