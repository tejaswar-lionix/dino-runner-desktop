/** dino_module_3318 — dino_physics_jump extended, humanized desktop */
export interface In3318{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3318{y:number;vy:number;sc:number}
const C3318={g:0.6, j:13};
export function extraPhysics_3318(inp:In3318, dt:number):Out3318 {
...
export const mm3318={d:'dino_physics_jump'};