/** dino_module_3559 — collision_aabb extended, humanized desktop */
export interface In3559{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3559{y:number;vy:number;sc:number}
const C3559={g:0.5, j:11};
export function extraPhysics_3559(inp:In3559, dt:number):Out3559 {
...
export const mm3559={d:'collision_aabb'};