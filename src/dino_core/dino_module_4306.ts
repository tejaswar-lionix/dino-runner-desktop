/** dino_module_4306 — parallax_bg extended, humanized desktop */
export interface In4306{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4306{y:number;vy:number;sc:number}
const C4306={g:0.7, j:12};
export function extraRender_4306(inp:In4306, dt:number):Out4306 {
...
export const mm4306={d:'parallax_bg'};