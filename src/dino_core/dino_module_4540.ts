/** dino_module_4540 — parallax_bg extended, humanized desktop */
export interface In4540{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4540{y:number;vy:number;sc:number}
const C4540={g:0.8, j:13};
export function extraSpawn_4540(inp:In4540, dt:number):Out4540 {
...
export const mm4540={d:'parallax_bg'};