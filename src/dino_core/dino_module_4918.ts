/** dino_module_4918 — obstacle_spawn extended, humanized desktop */
export interface In4918{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4918{y:number;vy:number;sc:number}
const C4918={g:0.5, j:12};
export function extraSpawn_4918(inp:In4918, dt:number):Out4918 {
...
export const mm4918={d:'obstacle_spawn'};