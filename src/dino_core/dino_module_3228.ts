/** dino_module_3228 — dino_physics_jump extended, humanized desktop */
export interface In3228{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3228{y:number;vy:number;sc:number}
const C3228={g:0.7, j:13};
export function extraRender_3228(inp:In3228, dt:number):Out3228 {
...
export const mm3228={d:'dino_physics_jump'};