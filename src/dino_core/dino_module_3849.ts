/** dino_module_3849 — obstacle_spawn extended, humanized desktop */
export interface In3849{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3849{y:number;vy:number;sc:number}
const C3849={g:0.8, j:12};
export function extraRender_3849(inp:In3849, dt:number):Out3849 {
...
export const mm3849={d:'obstacle_spawn'};