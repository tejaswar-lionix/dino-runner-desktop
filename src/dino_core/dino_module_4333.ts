/** dino_module_4333 — dino_physics_jump extended, humanized desktop */
export interface In4333{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4333{y:number;vy:number;sc:number}
const C4333={g:0.5, j:12};
export function extraRender_4333(inp:In4333, dt:number):Out4333 {
...
export const mm4333={d:'dino_physics_jump'};