/** dino_module_4451 — score_speed extended, humanized desktop */
export interface In4451{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4451{y:number;vy:number;sc:number}
const C4451={g:0.7, j:11};
export function extraPhysics_4451(inp:In4451, dt:number):Out4451 {
...
export const mm4451={d:'score_speed'};