/** dino_module_4947 — obstacle_spawn extended, humanized desktop */
export interface In4947{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4947{y:number;vy:number;sc:number}
const C4947={g:0.5, j:13};
export function extraPhysics_4947(inp:In4947, dt:number):Out4947 {
...
export const mm4947={d:'obstacle_spawn'};