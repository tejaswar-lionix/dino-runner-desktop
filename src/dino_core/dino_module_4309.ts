/** dino_module_4309 — particle_fx extended, humanized desktop */
export interface In4309{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4309{y:number;vy:number;sc:number}
const C4309={g:0.5, j:12};
export function extraPhysics_4309(inp:In4309, dt:number):Out4309 {
...
export const mm4309={d:'particle_fx'};