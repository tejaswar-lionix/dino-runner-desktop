/** dino_module_3821 — score_speed extended, humanized desktop */
export interface In3821{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3821{y:number;vy:number;sc:number}
const C3821={g:0.7, j:13};
export function extraSpawn_3821(inp:In3821, dt:number):Out3821 {
...
export const mm3821={d:'score_speed'};