/** dino_module_4287 — particle_fx extended, humanized desktop */
export interface In4287{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4287{y:number;vy:number;sc:number}
const C4287={g:0.6, j:12};
export function extraSpawn_4287(inp:In4287, dt:number):Out4287 {
...
export const mm4287={d:'particle_fx'};