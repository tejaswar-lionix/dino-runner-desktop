/** dino_module_3623 — collision_aabb extended, humanized desktop */
export interface In3623{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3623{y:number;vy:number;sc:number}
const C3623={g:0.6, j:13};
export function extraPhysics_3623(inp:In3623, dt:number):Out3623 {
...
export const mm3623={d:'collision_aabb'};