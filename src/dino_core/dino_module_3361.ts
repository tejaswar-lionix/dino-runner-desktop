/** dino_module_3361 — dino_physics_jump extended, humanized desktop */
export interface In3361{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3361{y:number;vy:number;sc:number}
const C3361={g:0.7, j:13};
export function extraPhysics_3361(inp:In3361, dt:number):Out3361 {
...
export const mm3361={d:'dino_physics_jump'};