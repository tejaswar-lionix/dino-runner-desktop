/** dino_module_4380 — obstacle_spawn extended, humanized desktop */
export interface In4380{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4380{y:number;vy:number;sc:number}
const C4380={g:0.5, j:12};
export function extraPhysics_4380(inp:In4380, dt:number):Out4380 {
...
export const mm4380={d:'obstacle_spawn'};