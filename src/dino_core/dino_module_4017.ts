/** dino_module_4017 — dino_physics_jump extended, humanized desktop */
export interface In4017{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4017{y:number;vy:number;sc:number}
const C4017={g:0.8, j:12};
export function extraRender_4017(inp:In4017, dt:number):Out4017 {
...
export const mm4017={d:'dino_physics_jump'};