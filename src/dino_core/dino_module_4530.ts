/** dino_module_4530 — particle_fx extended, humanized desktop */
export interface In4530{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4530{y:number;vy:number;sc:number}
const C4530={g:0.5, j:12};
export function extraRender_4530(inp:In4530, dt:number):Out4530 {
...
export const mm4530={d:'particle_fx'};