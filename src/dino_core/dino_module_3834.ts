/** dino_module_3834 — parallax_bg extended, humanized desktop */
export interface In3834{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3834{y:number;vy:number;sc:number}
const C3834={g:0.7, j:13};
export function extraPhysics_3834(inp:In3834, dt:number):Out3834 {
...
export const mm3834={d:'parallax_bg'};