/** dino_module_3990 — collision_aabb extended, humanized desktop */
export interface In3990{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3990{y:number;vy:number;sc:number}
const C3990={g:0.7, j:11};
export function extraSpawn_3990(inp:In3990, dt:number):Out3990 {
...
export const mm3990={d:'collision_aabb'};