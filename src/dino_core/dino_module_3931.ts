/** dino_module_3931 — collision_aabb extended, humanized desktop */
export interface In3931{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3931{y:number;vy:number;sc:number}
const C3931={g:0.7, j:13};
export function extraSpawn_3931(inp:In3931, dt:number):Out3931 {
...
export const mm3931={d:'collision_aabb'};