/** dino_module_3625 — particle_fx extended, humanized desktop */
export interface In3625{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3625{y:number;vy:number;sc:number}
const C3625={g:0.6, j:12};
export function extraSpawn_3625(inp:In3625, dt:number):Out3625 {
...
export const mm3625={d:'particle_fx'};