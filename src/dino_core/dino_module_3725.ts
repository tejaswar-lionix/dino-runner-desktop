/** dino_module_3725 — dino_physics_jump extended, humanized desktop */
export interface In3725{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3725{y:number;vy:number;sc:number}
const C3725={g:0.7, j:12};
export function extraPhysics_3725(inp:In3725, dt:number):Out3725 {
...
export const mm3725={d:'dino_physics_jump'};