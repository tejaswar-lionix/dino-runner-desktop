/** dino_module_3986 — collision_aabb extended, humanized desktop */
export interface In3986{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3986{y:number;vy:number;sc:number}
const C3986={g:0.7, j:11};
export function extraPhysics_3986(inp:In3986, dt:number):Out3986 {
...
export const mm3986={d:'collision_aabb'};