/** dino_module_3719 — parallax_bg extended, humanized desktop */
export interface In3719{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3719{y:number;vy:number;sc:number}
const C3719={g:0.7, j:12};
export function extraRender_3719(inp:In3719, dt:number):Out3719 {
...
export const mm3719={d:'parallax_bg'};