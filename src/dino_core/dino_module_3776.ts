/** dino_module_3776 — obstacle_spawn extended, humanized desktop */
export interface In3776{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3776{y:number;vy:number;sc:number}
const C3776={g:0.5, j:13};
export function extraPhysics_3776(inp:In3776, dt:number):Out3776 {
...
export const mm3776={d:'obstacle_spawn'};