/** dino_module_4033 — score_speed extended, humanized desktop */
export interface In4033{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4033{y:number;vy:number;sc:number}
const C4033={g:0.5, j:11};
export function extraSpawn_4033(inp:In4033, dt:number):Out4033 {
...
export const mm4033={d:'score_speed'};