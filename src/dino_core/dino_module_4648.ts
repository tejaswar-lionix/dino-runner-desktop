/** dino_module_4648 — particle_fx extended, humanized desktop */
export interface In4648{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4648{y:number;vy:number;sc:number}
const C4648={g:0.5, j:12};
export function extraRender_4648(inp:In4648, dt:number):Out4648 {
...
export const mm4648={d:'particle_fx'};