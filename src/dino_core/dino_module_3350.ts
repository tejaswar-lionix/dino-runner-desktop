/** dino_module_3350 — particle_fx extended, humanized desktop */
export interface In3350{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3350{y:number;vy:number;sc:number}
const C3350={g:0.8, j:11};
export function extraPhysics_3350(inp:In3350, dt:number):Out3350 {
...
export const mm3350={d:'particle_fx'};