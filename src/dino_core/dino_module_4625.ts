/** dino_module_4625 — particle_fx extended, humanized desktop */
export interface In4625{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4625{y:number;vy:number;sc:number}
const C4625={g:0.6, j:13};
export function extraRender_4625(inp:In4625, dt:number):Out4625 {
...
export const mm4625={d:'particle_fx'};