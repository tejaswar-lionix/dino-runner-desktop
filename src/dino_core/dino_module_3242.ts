/** dino_module_3242 — parallax_bg extended, humanized desktop */
export interface In3242{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3242{y:number;vy:number;sc:number}
const C3242={g:0.8, j:11};
export function extraSpawn_3242(inp:In3242, dt:number):Out3242 {
...
export const mm3242={d:'parallax_bg'};