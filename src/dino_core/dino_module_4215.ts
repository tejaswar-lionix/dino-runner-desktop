/** dino_module_4215 — score_speed extended, humanized desktop */
export interface In4215{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4215{y:number;vy:number;sc:number}
const C4215={g:0.7, j:13};
export function extraSpawn_4215(inp:In4215, dt:number):Out4215 {
...
export const mm4215={d:'score_speed'};