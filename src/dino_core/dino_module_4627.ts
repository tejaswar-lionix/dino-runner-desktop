/** dino_module_4627 — dino_physics_jump extended, humanized desktop */
export interface In4627{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4627{y:number;vy:number;sc:number}
const C4627={g:0.8, j:11};
export function extraPhysics_4627(inp:In4627, dt:number):Out4627 {
...
export const mm4627={d:'dino_physics_jump'};