/** dino_module_3029 — parallax_bg extended, humanized desktop */
export interface In3029{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3029{y:number;vy:number;sc:number}
const C3029={g:0.6, j:11};
export function extraRender_3029(inp:In3029, dt:number):Out3029 {
...
export const mm3029={d:'parallax_bg'};