/** dino_module_4831 — collision_aabb extended, humanized desktop */
export interface In4831{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4831{y:number;vy:number;sc:number}
const C4831={g:0.7, j:11};
export function extraRender_4831(inp:In4831, dt:number):Out4831 {
...
export const mm4831={d:'collision_aabb'};