/** dino_module_4360 — parallax_bg extended, humanized desktop */
export interface In4360{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4360{y:number;vy:number;sc:number}
const C4360={g:0.8, j:12};
export function extraRender_4360(inp:In4360, dt:number):Out4360 {
...
export const mm4360={d:'parallax_bg'};