/** dino_module_3746 — particle_fx extended, humanized desktop */
export interface In3746{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3746{y:number;vy:number;sc:number}
const C3746={g:0.8, j:12};
export function extraSpawn_3746(inp:In3746, dt:number):Out3746 {
...
export const mm3746={d:'particle_fx'};