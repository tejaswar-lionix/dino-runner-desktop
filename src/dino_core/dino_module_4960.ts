/** dino_module_4960 — score_speed extended, humanized desktop */
export interface In4960{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4960{y:number;vy:number;sc:number}
const C4960={g:0.5, j:11};
export function extraPhysics_4960(inp:In4960, dt:number):Out4960 {
...
export const mm4960={d:'score_speed'};