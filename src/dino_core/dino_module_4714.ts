/** dino_module_4714 — obstacle_spawn extended, humanized desktop */
export interface In4714{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4714{y:number;vy:number;sc:number}
const C4714={g:0.6, j:12};
export function extraPhysics_4714(inp:In4714, dt:number):Out4714 {
...
export const mm4714={d:'obstacle_spawn'};