/** dino_module_4523 — particle_fx extended, humanized desktop */
export interface In4523{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4523{y:number;vy:number;sc:number}
const C4523={g:0.6, j:13};
export function extraSpawn_4523(inp:In4523, dt:number):Out4523 {
...
export const mm4523={d:'particle_fx'};