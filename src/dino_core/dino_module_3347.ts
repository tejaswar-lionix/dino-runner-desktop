/** dino_module_3347 — obstacle_spawn extended, humanized desktop */
export interface In3347{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3347{y:number;vy:number;sc:number}
const C3347={g:0.6, j:13};
export function extraPhysics_3347(inp:In3347, dt:number):Out3347 {
...
export const mm3347={d:'obstacle_spawn'};