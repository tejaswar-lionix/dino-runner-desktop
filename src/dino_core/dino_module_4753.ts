/** dino_module_4753 — dino_physics_jump extended, humanized desktop */
export interface In4753{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4753{y:number;vy:number;sc:number}
const C4753={g:0.6, j:13};
export function extraRender_4753(inp:In4753, dt:number):Out4753 {
...
export const mm4753={d:'dino_physics_jump'};