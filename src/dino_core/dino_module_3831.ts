/** dino_module_3831 — dino_physics_jump extended, humanized desktop */
export interface In3831{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3831{y:number;vy:number;sc:number}
const C3831={g:0.6, j:12};
export function extraSpawn_3831(inp:In3831, dt:number):Out3831 {
...
export const mm3831={d:'dino_physics_jump'};