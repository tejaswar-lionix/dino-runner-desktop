/** dino_module_3327 — score_speed extended, humanized desktop */
export interface In3327{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3327{y:number;vy:number;sc:number}
const C3327={g:0.7, j:11};
export function extraRender_3327(inp:In3327, dt:number):Out3327 {
...
export const mm3327={d:'score_speed'};