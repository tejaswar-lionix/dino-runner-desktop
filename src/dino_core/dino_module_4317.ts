/** dino_module_4317 — dino_physics_jump extended, humanized desktop */
export interface In4317{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4317{y:number;vy:number;sc:number}
const C4317={g:0.6, j:11};
export function extraSpawn_4317(inp:In4317, dt:number):Out4317 {
...
export const mm4317={d:'dino_physics_jump'};