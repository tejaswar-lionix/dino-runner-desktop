/** dino_module_3985 — dino_physics_jump extended, humanized desktop */
export interface In3985{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3985{y:number;vy:number;sc:number}
const C3985={g:0.8, j:11};
export function extraPhysics_3985(inp:In3985, dt:number):Out3985 {
...
export const mm3985={d:'dino_physics_jump'};