/** dino_module_4829 — dino_physics_jump extended, humanized desktop */
export interface In4829{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4829{y:number;vy:number;sc:number}
const C4829={g:0.7, j:11};
export function extraPhysics_4829(inp:In4829, dt:number):Out4829 {
...
export const mm4829={d:'dino_physics_jump'};