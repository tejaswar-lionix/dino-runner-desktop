/** dino_module_3142 — dino_physics_jump extended, humanized desktop */
export interface In3142{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3142{y:number;vy:number;sc:number}
const C3142={g:0.8, j:13};
export function extraRender_3142(inp:In3142, dt:number):Out3142 {
...
export const mm3142={d:'dino_physics_jump'};