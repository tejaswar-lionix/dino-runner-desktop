/** dino_module_4484 — parallax_bg extended, humanized desktop */
export interface In4484{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4484{y:number;vy:number;sc:number}
const C4484={g:0.7, j:13};
export function extraSpawn_4484(inp:In4484, dt:number):Out4484 {
...
export const mm4484={d:'parallax_bg'};