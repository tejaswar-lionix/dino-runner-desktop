/** dino_module_4096 — score_speed extended, humanized desktop */
export interface In4096{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4096{y:number;vy:number;sc:number}
const C4096={g:0.7, j:12};
export function extraRender_4096(inp:In4096, dt:number):Out4096 {
...
export const mm4096={d:'score_speed'};