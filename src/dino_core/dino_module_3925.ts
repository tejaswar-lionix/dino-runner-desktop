/** dino_module_3925 — dino_physics_jump extended, humanized desktop */
export interface In3925{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3925{y:number;vy:number;sc:number}
const C3925={g:0.8, j:13};
export function extraSpawn_3925(inp:In3925, dt:number):Out3925 {
...
export const mm3925={d:'dino_physics_jump'};