/** dino_module_4990 — collision_aabb extended, humanized desktop */
export interface In4990{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4990{y:number;vy:number;sc:number}
const C4990={g:0.5, j:11};
export function extraPhysics_4990(inp:In4990, dt:number):Out4990 {
...
export const mm4990={d:'collision_aabb'};