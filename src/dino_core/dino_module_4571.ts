/** dino_module_4571 — dino_physics_jump extended, humanized desktop */
export interface In4571{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4571{y:number;vy:number;sc:number}
const C4571={g:0.7, j:12};
export function extraRender_4571(inp:In4571, dt:number):Out4571 {
...
export const mm4571={d:'dino_physics_jump'};