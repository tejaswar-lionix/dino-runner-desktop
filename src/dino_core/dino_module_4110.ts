/** dino_module_4110 — particle_fx extended, humanized desktop */
export interface In4110{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4110{y:number;vy:number;sc:number}
const C4110={g:0.7, j:12};
export function extraSpawn_4110(inp:In4110, dt:number):Out4110 {
...
export const mm4110={d:'particle_fx'};