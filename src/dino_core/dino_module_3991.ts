/** dino_module_3991 — score_speed extended, humanized desktop */
export interface In3991{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3991{y:number;vy:number;sc:number}
const C3991={g:0.7, j:12};
export function extraPhysics_3991(inp:In3991, dt:number):Out3991 {
...
export const mm3991={d:'score_speed'};