/** dino_module_4975 — obstacle_spawn extended, humanized desktop */
export interface In4975{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4975{y:number;vy:number;sc:number}
const C4975={g:0.6, j:11};
export function extraRender_4975(inp:In4975, dt:number):Out4975 {
...
export const mm4975={d:'obstacle_spawn'};