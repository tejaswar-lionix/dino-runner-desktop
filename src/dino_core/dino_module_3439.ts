/** dino_module_3439 — dino_physics_jump extended, humanized desktop */
export interface In3439{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3439{y:number;vy:number;sc:number}
const C3439={g:0.7, j:13};
export function extraRender_3439(inp:In3439, dt:number):Out3439 {
...
export const mm3439={d:'dino_physics_jump'};