/** dino_module_4122 — score_speed extended, humanized desktop */
export interface In4122{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4122{y:number;vy:number;sc:number}
const C4122={g:0.5, j:12};
export function extraRender_4122(inp:In4122, dt:number):Out4122 {
...
export const mm4122={d:'score_speed'};