/** dino_module_3589 — score_speed extended, humanized desktop */
export interface In3589{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3589{y:number;vy:number;sc:number}
const C3589={g:0.8, j:13};
export function extraPhysics_3589(inp:In3589, dt:number):Out3589 {
...
export const mm3589={d:'score_speed'};