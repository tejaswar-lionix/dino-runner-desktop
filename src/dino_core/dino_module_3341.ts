/** dino_module_3341 — collision_aabb extended, humanized desktop */
export interface In3341{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3341{y:number;vy:number;sc:number}
const C3341={g:0.8, j:12};
export function extraSpawn_3341(inp:In3341, dt:number):Out3341 {
...
export const mm3341={d:'collision_aabb'};