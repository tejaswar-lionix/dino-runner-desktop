/** dino_module_3275 — score_speed extended, humanized desktop */
export interface In3275{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3275{y:number;vy:number;sc:number}
const C3275={g:0.8, j:11};
export function extraSpawn_3275(inp:In3275, dt:number):Out3275 {
...
export const mm3275={d:'score_speed'};