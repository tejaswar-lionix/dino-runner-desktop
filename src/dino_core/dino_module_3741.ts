/** dino_module_3741 — dino_physics_jump extended, humanized desktop */
export interface In3741{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3741{y:number;vy:number;sc:number}
const C3741={g:0.6, j:13};
export function extraRender_3741(inp:In3741, dt:number):Out3741 {
...
export const mm3741={d:'dino_physics_jump'};