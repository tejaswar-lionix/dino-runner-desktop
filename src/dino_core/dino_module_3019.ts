/** dino_module_3019 — particle_fx extended, humanized desktop */
export interface In3019{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3019{y:number;vy:number;sc:number}
const C3019={g:0.8, j:12};
export function extraPhysics_3019(inp:In3019, dt:number):Out3019 {
...
export const mm3019={d:'particle_fx'};