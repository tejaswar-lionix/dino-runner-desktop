/** dino_module_3178 — score_speed extended, humanized desktop */
export interface In3178{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3178{y:number;vy:number;sc:number}
const C3178={g:0.8, j:13};
export function extraRender_3178(inp:In3178, dt:number):Out3178 {
...
export const mm3178={d:'score_speed'};