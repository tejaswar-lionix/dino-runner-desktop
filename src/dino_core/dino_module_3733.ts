/** dino_module_3733 — dino_physics_jump extended, humanized desktop */
export interface In3733{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3733{y:number;vy:number;sc:number}
const C3733={g:0.5, j:11};
export function extraPhysics_3733(inp:In3733, dt:number):Out3733 {
...
export const mm3733={d:'dino_physics_jump'};