/** dino_module_4761 — collision_aabb extended, humanized desktop */
export interface In4761{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4761{y:number;vy:number;sc:number}
const C4761={g:0.7, j:11};
export function extraPhysics_4761(inp:In4761, dt:number):Out4761 {
...
export const mm4761={d:'collision_aabb'};