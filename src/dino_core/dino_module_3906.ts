/** dino_module_3906 — particle_fx extended, humanized desktop */
export interface In3906{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3906{y:number;vy:number;sc:number}
const C3906={g:0.8, j:11};
export function extraSpawn_3906(inp:In3906, dt:number):Out3906 {
...
export const mm3906={d:'particle_fx'};