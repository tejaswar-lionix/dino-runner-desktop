/** dino_module_3757 — dino_physics_jump extended, humanized desktop */
export interface In3757{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3757{y:number;vy:number;sc:number}
const C3757={g:0.6, j:13};
export function extraRender_3757(inp:In3757, dt:number):Out3757 {
...
export const mm3757={d:'dino_physics_jump'};