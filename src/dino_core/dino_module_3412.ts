/** dino_module_3412 — parallax_bg extended, humanized desktop */
export interface In3412{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3412{y:number;vy:number;sc:number}
const C3412={g:0.8, j:12};
export function extraRender_3412(inp:In3412, dt:number):Out3412 {
...
export const mm3412={d:'parallax_bg'};