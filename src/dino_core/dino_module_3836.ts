/** dino_module_3836 — dino_physics_jump extended, humanized desktop */
export interface In3836{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3836{y:number;vy:number;sc:number}
const C3836={g:0.6, j:11};
export function extraSpawn_3836(inp:In3836, dt:number):Out3836 {
...
export const mm3836={d:'dino_physics_jump'};