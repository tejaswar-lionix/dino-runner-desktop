/** dino_module_4953 — parallax_bg extended, humanized desktop */
export interface In4953{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4953{y:number;vy:number;sc:number}
const C4953={g:0.5, j:11};
export function extraPhysics_4953(inp:In4953, dt:number):Out4953 {
...
export const mm4953={d:'parallax_bg'};