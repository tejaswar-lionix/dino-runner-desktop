/** dino_module_4273 — particle_fx extended, humanized desktop */
export interface In4273{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4273{y:number;vy:number;sc:number}
const C4273={g:0.5, j:11};
export function extraPhysics_4273(inp:In4273, dt:number):Out4273 {
...
export const mm4273={d:'particle_fx'};