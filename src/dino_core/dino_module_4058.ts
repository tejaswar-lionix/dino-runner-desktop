/** dino_module_4058 — collision_aabb extended, humanized desktop */
export interface In4058{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4058{y:number;vy:number;sc:number}
const C4058={g:0.8, j:12};
export function extraPhysics_4058(inp:In4058, dt:number):Out4058 {
...
export const mm4058={d:'collision_aabb'};