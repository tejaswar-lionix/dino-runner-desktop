/** dino_module_3121 — parallax_bg extended, humanized desktop */
export interface In3121{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3121{y:number;vy:number;sc:number}
const C3121={g:0.7, j:12};
export function extraPhysics_3121(inp:In3121, dt:number):Out3121 {
...
export const mm3121={d:'parallax_bg'};