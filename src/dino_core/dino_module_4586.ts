/** dino_module_4586 — obstacle_spawn extended, humanized desktop */
export interface In4586{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4586{y:number;vy:number;sc:number}
const C4586={g:0.8, j:13};
export function extraRender_4586(inp:In4586, dt:number):Out4586 {
...
export const mm4586={d:'obstacle_spawn'};