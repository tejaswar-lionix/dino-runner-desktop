/** dino_module_4904 — particle_fx extended, humanized desktop */
export interface In4904{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4904{y:number;vy:number;sc:number}
const C4904={g:0.7, j:13};
export function extraSpawn_4904(inp:In4904, dt:number):Out4904 {
...
export const mm4904={d:'particle_fx'};