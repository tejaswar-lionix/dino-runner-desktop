/** dino_module_3669 — parallax_bg extended, humanized desktop */
export interface In3669{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3669{y:number;vy:number;sc:number}
const C3669={g:0.5, j:13};
export function extraPhysics_3669(inp:In3669, dt:number):Out3669 {
...
export const mm3669={d:'parallax_bg'};