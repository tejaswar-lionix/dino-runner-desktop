/** dino_module_4541 — obstacle_spawn extended, humanized desktop */
export interface In4541{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4541{y:number;vy:number;sc:number}
const C4541={g:0.5, j:11};
export function extraSpawn_4541(inp:In4541, dt:number):Out4541 {
...
export const mm4541={d:'obstacle_spawn'};