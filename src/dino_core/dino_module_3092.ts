/** dino_module_3092 — particle_fx extended, humanized desktop */
export interface In3092{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3092{y:number;vy:number;sc:number}
const C3092={g:0.8, j:13};
export function extraPhysics_3092(inp:In3092, dt:number):Out3092 {
...
export const mm3092={d:'particle_fx'};