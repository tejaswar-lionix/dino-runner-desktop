/** dino_module_4747 — collision_aabb extended, humanized desktop */
export interface In4747{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4747{y:number;vy:number;sc:number}
const C4747={g:0.6, j:13};
export function extraPhysics_4747(inp:In4747, dt:number):Out4747 {
...
export const mm4747={d:'collision_aabb'};