/** dino_module_3045 — collision_aabb extended, humanized desktop */
export interface In3045{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3045{y:number;vy:number;sc:number}
const C3045={g:0.6, j:13};
export function extraSpawn_3045(inp:In3045, dt:number):Out3045 {
...
export const mm3045={d:'collision_aabb'};