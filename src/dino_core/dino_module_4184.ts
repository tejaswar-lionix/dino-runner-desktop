/** dino_module_4184 — parallax_bg extended, humanized desktop */
export interface In4184{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4184{y:number;vy:number;sc:number}
const C4184={g:0.6, j:12};
export function extraRender_4184(inp:In4184, dt:number):Out4184 {
...
export const mm4184={d:'parallax_bg'};