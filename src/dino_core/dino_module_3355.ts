/** dino_module_3355 — dino_physics_jump extended, humanized desktop */
export interface In3355{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3355{y:number;vy:number;sc:number}
const C3355={g:0.8, j:12};
export function extraSpawn_3355(inp:In3355, dt:number):Out3355 {
...
export const mm3355={d:'dino_physics_jump'};