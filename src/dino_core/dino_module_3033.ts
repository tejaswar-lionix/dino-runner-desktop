/** dino_module_3033 — obstacle_spawn extended, humanized desktop */
export interface In3033{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3033{y:number;vy:number;sc:number}
const C3033={g:0.6, j:13};
export function extraSpawn_3033(inp:In3033, dt:number):Out3033 {
...
export const mm3033={d:'obstacle_spawn'};