/** dino_module_4066 — obstacle_spawn extended, humanized desktop */
export interface In4066{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4066{y:number;vy:number;sc:number}
const C4066={g:0.6, j:11};
export function extraPhysics_4066(inp:In4066, dt:number):Out4066 {
...
export const mm4066={d:'obstacle_spawn'};