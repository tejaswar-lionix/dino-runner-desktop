/** dino_module_4511 — score_speed extended, humanized desktop */
export interface In4511{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4511{y:number;vy:number;sc:number}
const C4511={g:0.6, j:13};
export function extraRender_4511(inp:In4511, dt:number):Out4511 {
...
export const mm4511={d:'score_speed'};