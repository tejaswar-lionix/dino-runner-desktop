/** dino_module_4490 — collision_aabb extended, humanized desktop */
export interface In4490{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4490{y:number;vy:number;sc:number}
const C4490={g:0.8, j:11};
export function extraSpawn_4490(inp:In4490, dt:number):Out4490 {
...
export const mm4490={d:'collision_aabb'};