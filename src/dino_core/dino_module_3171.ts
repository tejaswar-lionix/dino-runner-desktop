/** dino_module_3171 — dino_physics_jump extended, humanized desktop */
export interface In3171{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3171{y:number;vy:number;sc:number}
const C3171={g:0.7, j:12};
export function extraPhysics_3171(inp:In3171, dt:number):Out3171 {
...
export const mm3171={d:'dino_physics_jump'};