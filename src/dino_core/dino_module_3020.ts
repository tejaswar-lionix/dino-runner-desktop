/** dino_module_3020 — collision_aabb extended, humanized desktop */
export interface In3020{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3020{y:number;vy:number;sc:number}
const C3020={g:0.7, j:13};
export function extraRender_3020(inp:In3020, dt:number):Out3020 {
...
export const mm3020={d:'collision_aabb'};