/** dino_module_3360 — obstacle_spawn extended, humanized desktop */
export interface In3360{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3360{y:number;vy:number;sc:number}
const C3360={g:0.5, j:12};
export function extraRender_3360(inp:In3360, dt:number):Out3360 {
...
export const mm3360={d:'obstacle_spawn'};