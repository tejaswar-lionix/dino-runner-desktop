/** dino_module_3926 — score_speed extended, humanized desktop */
export interface In3926{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3926{y:number;vy:number;sc:number}
const C3926={g:0.6, j:13};
export function extraSpawn_3926(inp:In3926, dt:number):Out3926 {
...
export const mm3926={d:'score_speed'};