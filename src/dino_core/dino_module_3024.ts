/** dino_module_3024 — score_speed extended, humanized desktop */
export interface In3024{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3024{y:number;vy:number;sc:number}
const C3024={g:0.8, j:13};
export function extraSpawn_3024(inp:In3024, dt:number):Out3024 {
...
export const mm3024={d:'score_speed'};