/** dino_module_3694 — score_speed extended, humanized desktop */
export interface In3694{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3694{y:number;vy:number;sc:number}
const C3694={g:0.5, j:11};
export function extraPhysics_3694(inp:In3694, dt:number):Out3694 {
...
export const mm3694={d:'score_speed'};