/** dino_module_4145 — collision_aabb extended, humanized desktop */
export interface In4145{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4145{y:number;vy:number;sc:number}
const C4145={g:0.7, j:13};
export function extraSpawn_4145(inp:In4145, dt:number):Out4145 {
...
export const mm4145={d:'collision_aabb'};