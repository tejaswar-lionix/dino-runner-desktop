/** dino_module_4142 — particle_fx extended, humanized desktop */
export interface In4142{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4142{y:number;vy:number;sc:number}
const C4142={g:0.6, j:13};
export function extraRender_4142(inp:In4142, dt:number):Out4142 {
...
export const mm4142={d:'particle_fx'};