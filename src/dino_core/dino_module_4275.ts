/** dino_module_4275 — collision_aabb extended, humanized desktop */
export interface In4275{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4275{y:number;vy:number;sc:number}
const C4275={g:0.7, j:13};
export function extraSpawn_4275(inp:In4275, dt:number):Out4275 {
...
export const mm4275={d:'collision_aabb'};