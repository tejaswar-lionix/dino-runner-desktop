/** dino_module_3169 — score_speed extended, humanized desktop */
export interface In3169{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3169{y:number;vy:number;sc:number}
const C3169={g:0.5, j:12};
export function extraPhysics_3169(inp:In3169, dt:number):Out3169 {
...
export const mm3169={d:'score_speed'};