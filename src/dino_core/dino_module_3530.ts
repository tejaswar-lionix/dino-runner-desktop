/** dino_module_3530 — obstacle_spawn extended, humanized desktop */
export interface In3530{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3530{y:number;vy:number;sc:number}
const C3530={g:0.8, j:13};
export function extraPhysics_3530(inp:In3530, dt:number):Out3530 {
...
export const mm3530={d:'obstacle_spawn'};