/** dino_module_4358 — obstacle_spawn extended, humanized desktop */
export interface In4358{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4358{y:number;vy:number;sc:number}
const C4358={g:0.5, j:13};
export function extraPhysics_4358(inp:In4358, dt:number):Out4358 {
...
export const mm4358={d:'obstacle_spawn'};