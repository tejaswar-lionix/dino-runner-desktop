/** dino_module_3181 — obstacle_spawn extended, humanized desktop */
export interface In3181{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3181{y:number;vy:number;sc:number}
const C3181={g:0.5, j:13};
export function extraSpawn_3181(inp:In3181, dt:number):Out3181 {
...
export const mm3181={d:'obstacle_spawn'};