/** dino_module_3010 — parallax_bg extended, humanized desktop */
export interface In3010{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3010{y:number;vy:number;sc:number}
const C3010={g:0.8, j:11};
export function extraSpawn_3010(inp:In3010, dt:number):Out3010 {
...
export const mm3010={d:'parallax_bg'};