/** dino_module_4728 — obstacle_spawn extended, humanized desktop */
export interface In4728{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4728{y:number;vy:number;sc:number}
const C4728={g:0.7, j:13};
export function extraRender_4728(inp:In4728, dt:number):Out4728 {
...
export const mm4728={d:'obstacle_spawn'};