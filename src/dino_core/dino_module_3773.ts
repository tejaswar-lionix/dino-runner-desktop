/** dino_module_3773 — parallax_bg extended, humanized desktop */
export interface In3773{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3773{y:number;vy:number;sc:number}
const C3773={g:0.8, j:13};
export function extraSpawn_3773(inp:In3773, dt:number):Out3773 {
...
export const mm3773={d:'parallax_bg'};