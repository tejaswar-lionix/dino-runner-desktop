/** dino_module_4517 — score_speed extended, humanized desktop */
export interface In4517{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4517{y:number;vy:number;sc:number}
const C4517={g:0.7, j:13};
export function extraSpawn_4517(inp:In4517, dt:number):Out4517 {
...
export const mm4517={d:'score_speed'};