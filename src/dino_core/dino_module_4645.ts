/** dino_module_4645 — collision_aabb extended, humanized desktop */
export interface In4645{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4645{y:number;vy:number;sc:number}
const C4645={g:0.5, j:13};
export function extraRender_4645(inp:In4645, dt:number):Out4645 {
...
export const mm4645={d:'collision_aabb'};