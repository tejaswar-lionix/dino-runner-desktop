/** dino_module_3365 — particle_fx extended, humanized desktop */
export interface In3365{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3365{y:number;vy:number;sc:number}
const C3365={g:0.8, j:12};
export function extraSpawn_3365(inp:In3365, dt:number):Out3365 {
...
export const mm3365={d:'particle_fx'};