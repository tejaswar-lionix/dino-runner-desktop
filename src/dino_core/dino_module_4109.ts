/** dino_module_4109 — particle_fx extended, humanized desktop */
export interface In4109{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4109{y:number;vy:number;sc:number}
const C4109={g:0.7, j:12};
export function extraPhysics_4109(inp:In4109, dt:number):Out4109 {
...
export const mm4109={d:'particle_fx'};