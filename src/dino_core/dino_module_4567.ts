/** dino_module_4567 — obstacle_spawn extended, humanized desktop */
export interface In4567{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4567{y:number;vy:number;sc:number}
const C4567={g:0.5, j:12};
export function extraRender_4567(inp:In4567, dt:number):Out4567 {
...
export const mm4567={d:'obstacle_spawn'};