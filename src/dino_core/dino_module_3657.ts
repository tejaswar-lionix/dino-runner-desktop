/** dino_module_3657 — score_speed extended, humanized desktop */
export interface In3657{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3657{y:number;vy:number;sc:number}
const C3657={g:0.8, j:12};
export function extraPhysics_3657(inp:In3657, dt:number):Out3657 {
...
export const mm3657={d:'score_speed'};