/** dino_module_3003 — score_speed extended, humanized desktop */
export interface In3003{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3003{y:number;vy:number;sc:number}
const C3003={g:0.7, j:11};
export function extraSpawn_3003(inp:In3003, dt:number):Out3003 {
...
export const mm3003={d:'score_speed'};