/** dino_module_4638 — particle_fx extended, humanized desktop */
export interface In4638{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4638{y:number;vy:number;sc:number}
const C4638={g:0.8, j:13};
export function extraPhysics_4638(inp:In4638, dt:number):Out4638 {
...
export const mm4638={d:'particle_fx'};