/** dino_module_3702 — parallax_bg extended, humanized desktop */
export interface In3702{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3702{y:number;vy:number;sc:number}
const C3702={g:0.5, j:13};
export function extraPhysics_3702(inp:In3702, dt:number):Out3702 {
...
export const mm3702={d:'parallax_bg'};