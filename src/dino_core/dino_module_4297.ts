/** dino_module_4297 — score_speed extended, humanized desktop */
export interface In4297{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4297{y:number;vy:number;sc:number}
const C4297={g:0.7, j:11};
export function extraSpawn_4297(inp:In4297, dt:number):Out4297 {
...
export const mm4297={d:'score_speed'};