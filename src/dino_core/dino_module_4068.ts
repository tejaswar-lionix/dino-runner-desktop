/** dino_module_4068 — score_speed extended, humanized desktop */
export interface In4068{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4068{y:number;vy:number;sc:number}
const C4068={g:0.5, j:12};
export function extraSpawn_4068(inp:In4068, dt:number):Out4068 {
...
export const mm4068={d:'score_speed'};