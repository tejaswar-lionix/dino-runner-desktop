/** dino_module_3966 — dino_physics_jump extended, humanized desktop */
export interface In3966{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3966{y:number;vy:number;sc:number}
const C3966={g:0.7, j:11};
export function extraPhysics_3966(inp:In3966, dt:number):Out3966 {
...
export const mm3966={d:'dino_physics_jump'};