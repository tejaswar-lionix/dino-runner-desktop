/** dino_module_3788 — obstacle_spawn extended, humanized desktop */
export interface In3788{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3788{y:number;vy:number;sc:number}
const C3788={g:0.8, j:12};
export function extraPhysics_3788(inp:In3788, dt:number):Out3788 {
...
export const mm3788={d:'obstacle_spawn'};