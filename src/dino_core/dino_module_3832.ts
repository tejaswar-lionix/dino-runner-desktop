/** dino_module_3832 — parallax_bg extended, humanized desktop */
export interface In3832{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3832{y:number;vy:number;sc:number}
const C3832={g:0.8, j:11};
export function extraSpawn_3832(inp:In3832, dt:number):Out3832 {
...
export const mm3832={d:'parallax_bg'};