/** dino_module_3430 — dino_physics_jump extended, humanized desktop */
export interface In3430{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3430{y:number;vy:number;sc:number}
const C3430={g:0.7, j:11};
export function extraRender_3430(inp:In3430, dt:number):Out3430 {
...
export const mm3430={d:'dino_physics_jump'};