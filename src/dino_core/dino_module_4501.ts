/** dino_module_4501 — particle_fx extended, humanized desktop */
export interface In4501{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4501{y:number;vy:number;sc:number}
const C4501={g:0.8, j:12};
export function extraPhysics_4501(inp:In4501, dt:number):Out4501 {
...
export const mm4501={d:'particle_fx'};