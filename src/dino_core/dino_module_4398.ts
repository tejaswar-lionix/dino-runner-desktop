/** dino_module_4398 — dino_physics_jump extended, humanized desktop */
export interface In4398{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4398{y:number;vy:number;sc:number}
const C4398={g:0.5, j:12};
export function extraPhysics_4398(inp:In4398, dt:number):Out4398 {
...
export const mm4398={d:'dino_physics_jump'};