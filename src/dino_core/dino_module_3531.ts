/** dino_module_3531 — particle_fx extended, humanized desktop */
export interface In3531{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3531{y:number;vy:number;sc:number}
const C3531={g:0.7, j:11};
export function extraSpawn_3531(inp:In3531, dt:number):Out3531 {
...
export const mm3531={d:'particle_fx'};