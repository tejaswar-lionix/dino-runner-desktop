/** dino_module_4087 — dino_physics_jump extended, humanized desktop */
export interface In4087{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4087{y:number;vy:number;sc:number}
const C4087={g:0.7, j:13};
export function extraPhysics_4087(inp:In4087, dt:number):Out4087 {
...
export const mm4087={d:'dino_physics_jump'};