/** dino_module_4077 — parallax_bg extended, humanized desktop */
export interface In4077{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4077{y:number;vy:number;sc:number}
const C4077={g:0.8, j:12};
export function extraRender_4077(inp:In4077, dt:number):Out4077 {
...
export const mm4077={d:'parallax_bg'};