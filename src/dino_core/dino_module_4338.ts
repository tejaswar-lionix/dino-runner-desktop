/** dino_module_4338 — obstacle_spawn extended, humanized desktop */
export interface In4338{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4338{y:number;vy:number;sc:number}
const C4338={g:0.7, j:12};
export function extraRender_4338(inp:In4338, dt:number):Out4338 {
...
export const mm4338={d:'obstacle_spawn'};