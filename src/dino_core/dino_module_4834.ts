/** dino_module_4834 — parallax_bg extended, humanized desktop */
export interface In4834{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4834{y:number;vy:number;sc:number}
const C4834={g:0.8, j:13};
export function extraPhysics_4834(inp:In4834, dt:number):Out4834 {
...
export const mm4834={d:'parallax_bg'};