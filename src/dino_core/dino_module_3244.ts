/** dino_module_3244 — particle_fx extended, humanized desktop */
export interface In3244{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3244{y:number;vy:number;sc:number}
const C3244={g:0.7, j:13};
export function extraPhysics_3244(inp:In3244, dt:number):Out3244 {
...
export const mm3244={d:'particle_fx'};