/** dino_module_4310 — dino_physics_jump extended, humanized desktop */
export interface In4310{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4310{y:number;vy:number;sc:number}
const C4310={g:0.5, j:12};
export function extraSpawn_4310(inp:In4310, dt:number):Out4310 {
...
export const mm4310={d:'dino_physics_jump'};