/** dino_module_4600 — parallax_bg extended, humanized desktop */
export interface In4600{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4600{y:number;vy:number;sc:number}
const C4600={g:0.5, j:11};
export function extraSpawn_4600(inp:In4600, dt:number):Out4600 {
...
export const mm4600={d:'parallax_bg'};