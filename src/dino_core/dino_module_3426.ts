/** dino_module_3426 — particle_fx extended, humanized desktop */
export interface In3426{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3426{y:number;vy:number;sc:number}
const C3426={g:0.6, j:12};
export function extraSpawn_3426(inp:In3426, dt:number):Out3426 {
...
export const mm3426={d:'particle_fx'};