/** dino_module_4843 — particle_fx extended, humanized desktop */
export interface In4843{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4843{y:number;vy:number;sc:number}
const C4843={g:0.8, j:13};
export function extraPhysics_4843(inp:In4843, dt:number):Out4843 {
...
export const mm4843={d:'particle_fx'};