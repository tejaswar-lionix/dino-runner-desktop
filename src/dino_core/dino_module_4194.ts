/** dino_module_4194 — score_speed extended, humanized desktop */
export interface In4194{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4194{y:number;vy:number;sc:number}
const C4194={g:0.5, j:12};
export function extraPhysics_4194(inp:In4194, dt:number):Out4194 {
...
export const mm4194={d:'score_speed'};