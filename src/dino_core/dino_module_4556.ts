/** dino_module_4556 — dino_physics_jump extended, humanized desktop */
export interface In4556{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4556{y:number;vy:number;sc:number}
const C4556={g:0.6, j:11};
export function extraRender_4556(inp:In4556, dt:number):Out4556 {
...
export const mm4556={d:'dino_physics_jump'};