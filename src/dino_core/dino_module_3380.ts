/** dino_module_3380 — obstacle_spawn extended, humanized desktop */
export interface In3380{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3380{y:number;vy:number;sc:number}
const C3380={g:0.7, j:12};
export function extraPhysics_3380(inp:In3380, dt:number):Out3380 {
...
export const mm3380={d:'obstacle_spawn'};