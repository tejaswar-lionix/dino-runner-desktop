/** dino_module_4876 — particle_fx extended, humanized desktop */
export interface In4876{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4876{y:number;vy:number;sc:number}
const C4876={g:0.5, j:11};
export function extraPhysics_4876(inp:In4876, dt:number):Out4876 {
...
export const mm4876={d:'particle_fx'};