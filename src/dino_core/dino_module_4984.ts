/** dino_module_4984 — particle_fx extended, humanized desktop */
export interface In4984{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4984{y:number;vy:number;sc:number}
const C4984={g:0.8, j:11};
export function extraPhysics_4984(inp:In4984, dt:number):Out4984 {
...
export const mm4984={d:'particle_fx'};