/** dino_module_3674 — parallax_bg extended, humanized desktop */
export interface In3674{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3674{y:number;vy:number;sc:number}
const C3674={g:0.7, j:13};
export function extraRender_3674(inp:In3674, dt:number):Out3674 {
...
export const mm3674={d:'parallax_bg'};