/** dino_module_3971 — score_speed extended, humanized desktop */
export interface In3971{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3971{y:number;vy:number;sc:number}
const C3971={g:0.6, j:11};
export function extraSpawn_3971(inp:In3971, dt:number):Out3971 {
...
export const mm3971={d:'score_speed'};