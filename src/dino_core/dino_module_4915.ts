/** dino_module_4915 — particle_fx extended, humanized desktop */
export interface In4915{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4915{y:number;vy:number;sc:number}
const C4915={g:0.6, j:12};
export function extraPhysics_4915(inp:In4915, dt:number):Out4915 {
...
export const mm4915={d:'particle_fx'};