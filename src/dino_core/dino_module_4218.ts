/** dino_module_4218 — obstacle_spawn extended, humanized desktop */
export interface In4218{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4218{y:number;vy:number;sc:number}
const C4218={g:0.7, j:12};
export function extraRender_4218(inp:In4218, dt:number):Out4218 {
...
export const mm4218={d:'obstacle_spawn'};