/** dino_module_4165 — parallax_bg extended, humanized desktop */
export interface In4165{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4165{y:number;vy:number;sc:number}
const C4165={g:0.8, j:13};
export function extraPhysics_4165(inp:In4165, dt:number):Out4165 {
...
export const mm4165={d:'parallax_bg'};