/** dino_module_4467 — obstacle_spawn extended, humanized desktop */
export interface In4467{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4467{y:number;vy:number;sc:number}
const C4467={g:0.7, j:12};
export function extraRender_4467(inp:In4467, dt:number):Out4467 {
...
export const mm4467={d:'obstacle_spawn'};