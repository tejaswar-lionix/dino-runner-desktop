/** dino_module_3870 — parallax_bg extended, humanized desktop */
export interface In3870{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3870{y:number;vy:number;sc:number}
const C3870={g:0.6, j:13};
export function extraSpawn_3870(inp:In3870, dt:number):Out3870 {
...
export const mm3870={d:'parallax_bg'};