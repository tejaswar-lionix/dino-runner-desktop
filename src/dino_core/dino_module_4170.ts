/** dino_module_4170 — obstacle_spawn extended, humanized desktop */
export interface In4170{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4170{y:number;vy:number;sc:number}
const C4170={g:0.8, j:11};
export function extraRender_4170(inp:In4170, dt:number):Out4170 {
...
export const mm4170={d:'obstacle_spawn'};