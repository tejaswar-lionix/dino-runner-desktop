/** dino_module_3628 — parallax_bg extended, humanized desktop */
export interface In3628{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3628{y:number;vy:number;sc:number}
const C3628={g:0.5, j:11};
export function extraSpawn_3628(inp:In3628, dt:number):Out3628 {
...
export const mm3628={d:'parallax_bg'};