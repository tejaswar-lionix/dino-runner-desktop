/** dino_module_4359 — particle_fx extended, humanized desktop */
export interface In4359{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4359{y:number;vy:number;sc:number}
const C4359={g:0.7, j:11};
export function extraSpawn_4359(inp:In4359, dt:number):Out4359 {
...
export const mm4359={d:'particle_fx'};