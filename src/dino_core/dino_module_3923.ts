/** dino_module_3923 — particle_fx extended, humanized desktop */
export interface In3923{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3923{y:number;vy:number;sc:number}
const C3923={g:0.6, j:12};
export function extraSpawn_3923(inp:In3923, dt:number):Out3923 {
...
export const mm3923={d:'particle_fx'};