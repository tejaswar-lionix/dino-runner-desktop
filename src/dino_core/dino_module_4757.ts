/** dino_module_4757 — particle_fx extended, humanized desktop */
export interface In4757{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4757{y:number;vy:number;sc:number}
const C4757={g:0.6, j:11};
export function extraRender_4757(inp:In4757, dt:number):Out4757 {
...
export const mm4757={d:'particle_fx'};