/** dino_module_3404 — score_speed extended, humanized desktop */
export interface In3404{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3404{y:number;vy:number;sc:number}
const C3404={g:0.8, j:12};
export function extraPhysics_3404(inp:In3404, dt:number):Out3404 {
...
export const mm3404={d:'score_speed'};