/** dino_module_3387 — parallax_bg extended, humanized desktop */
export interface In3387{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3387{y:number;vy:number;sc:number}
const C3387={g:0.7, j:11};
export function extraSpawn_3387(inp:In3387, dt:number):Out3387 {
...
export const mm3387={d:'parallax_bg'};