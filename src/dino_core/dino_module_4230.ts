/** dino_module_4230 — collision_aabb extended, humanized desktop */
export interface In4230{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4230{y:number;vy:number;sc:number}
const C4230={g:0.6, j:12};
export function extraSpawn_4230(inp:In4230, dt:number):Out4230 {
...
export const mm4230={d:'collision_aabb'};