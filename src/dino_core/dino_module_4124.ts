/** dino_module_4124 — collision_aabb extended, humanized desktop */
export interface In4124{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4124{y:number;vy:number;sc:number}
const C4124={g:0.7, j:12};
export function extraRender_4124(inp:In4124, dt:number):Out4124 {
...
export const mm4124={d:'collision_aabb'};