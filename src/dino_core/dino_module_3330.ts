/** dino_module_3330 — parallax_bg extended, humanized desktop */
export interface In3330{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3330{y:number;vy:number;sc:number}
const C3330={g:0.5, j:11};
export function extraSpawn_3330(inp:In3330, dt:number):Out3330 {
...
export const mm3330={d:'parallax_bg'};