/** dino_module_3153 — parallax_bg extended, humanized desktop */
export interface In3153{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3153{y:number;vy:number;sc:number}
const C3153={g:0.7, j:13};
export function extraRender_3153(inp:In3153, dt:number):Out3153 {
...
export const mm3153={d:'parallax_bg'};