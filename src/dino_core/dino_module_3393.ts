/** dino_module_3393 — parallax_bg extended, humanized desktop */
export interface In3393{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3393{y:number;vy:number;sc:number}
const C3393={g:0.8, j:11};
export function extraPhysics_3393(inp:In3393, dt:number):Out3393 {
...
export const mm3393={d:'parallax_bg'};