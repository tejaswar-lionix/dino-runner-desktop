/** dino_module_3302 — parallax_bg extended, humanized desktop */
export interface In3302{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3302{y:number;vy:number;sc:number}
const C3302={g:0.6, j:11};
export function extraRender_3302(inp:In3302, dt:number):Out3302 {
...
export const mm3302={d:'parallax_bg'};