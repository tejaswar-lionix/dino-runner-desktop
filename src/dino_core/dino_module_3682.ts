/** dino_module_3682 — particle_fx extended, humanized desktop */
export interface In3682{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3682{y:number;vy:number;sc:number}
const C3682={g:0.5, j:13};
export function extraRender_3682(inp:In3682, dt:number):Out3682 {
...
export const mm3682={d:'particle_fx'};