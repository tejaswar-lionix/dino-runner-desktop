/** dino_module_3822 — score_speed extended, humanized desktop */
export interface In3822{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3822{y:number;vy:number;sc:number}
const C3822={g:0.5, j:13};
export function extraRender_3822(inp:In3822, dt:number):Out3822 {
...
export const mm3822={d:'score_speed'};