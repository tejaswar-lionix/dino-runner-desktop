/** dino_module_4505 — parallax_bg extended, humanized desktop */
export interface In4505{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4505{y:number;vy:number;sc:number}
const C4505={g:0.7, j:13};
export function extraRender_4505(inp:In4505, dt:number):Out4505 {
...
export const mm4505={d:'parallax_bg'};