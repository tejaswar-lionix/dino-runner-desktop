/** dino_module_3266 — particle_fx extended, humanized desktop */
export interface In3266{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3266{y:number;vy:number;sc:number}
const C3266={g:0.5, j:12};
export function extraSpawn_3266(inp:In3266, dt:number):Out3266 {
...
export const mm3266={d:'particle_fx'};