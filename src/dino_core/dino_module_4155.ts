/** dino_module_4155 — collision_aabb extended, humanized desktop */
export interface In4155{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4155{y:number;vy:number;sc:number}
const C4155={g:0.5, j:12};
export function extraPhysics_4155(inp:In4155, dt:number):Out4155 {
...
export const mm4155={d:'collision_aabb'};