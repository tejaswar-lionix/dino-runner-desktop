/** dino_module_4512 — score_speed extended, humanized desktop */
export interface In4512{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4512{y:number;vy:number;sc:number}
const C4512={g:0.7, j:12};
export function extraSpawn_4512(inp:In4512, dt:number):Out4512 {
...
export const mm4512={d:'score_speed'};