/** dino_module_4208 — parallax_bg extended, humanized desktop */
export interface In4208{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4208{y:number;vy:number;sc:number}
const C4208={g:0.6, j:13};
export function extraPhysics_4208(inp:In4208, dt:number):Out4208 {
...
export const mm4208={d:'parallax_bg'};