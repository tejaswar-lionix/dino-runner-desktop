/** dino_module_4294 — particle_fx extended, humanized desktop */
export interface In4294{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4294{y:number;vy:number;sc:number}
const C4294={g:0.6, j:13};
export function extraRender_4294(inp:In4294, dt:number):Out4294 {
...
export const mm4294={d:'particle_fx'};