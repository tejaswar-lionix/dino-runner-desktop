/** dino_module_3363 — collision_aabb extended, humanized desktop */
export interface In3363{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3363{y:number;vy:number;sc:number}
const C3363={g:0.7, j:12};
export function extraSpawn_3363(inp:In3363, dt:number):Out3363 {
...
export const mm3363={d:'collision_aabb'};