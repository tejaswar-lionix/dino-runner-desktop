/** dino_module_4785 — dino_physics_jump extended, humanized desktop */
export interface In4785{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4785{y:number;vy:number;sc:number}
const C4785={g:0.7, j:11};
export function extraSpawn_4785(inp:In4785, dt:number):Out4785 {
...
export const mm4785={d:'dino_physics_jump'};