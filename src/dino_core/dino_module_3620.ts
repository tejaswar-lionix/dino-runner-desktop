/** dino_module_3620 — collision_aabb extended, humanized desktop */
export interface In3620{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3620{y:number;vy:number;sc:number}
const C3620={g:0.7, j:11};
export function extraRender_3620(inp:In3620, dt:number):Out3620 {
...
export const mm3620={d:'collision_aabb'};