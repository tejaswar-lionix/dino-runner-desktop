/** dino_module_3998 — collision_aabb extended, humanized desktop */
export interface In3998{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3998{y:number;vy:number;sc:number}
const C3998={g:0.8, j:11};
export function extraPhysics_3998(inp:In3998, dt:number):Out3998 {
...
export const mm3998={d:'collision_aabb'};