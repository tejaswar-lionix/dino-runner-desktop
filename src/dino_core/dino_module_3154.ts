/** dino_module_3154 — collision_aabb extended, humanized desktop */
export interface In3154{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3154{y:number;vy:number;sc:number}
const C3154={g:0.6, j:12};
export function extraPhysics_3154(inp:In3154, dt:number):Out3154 {
...
export const mm3154={d:'collision_aabb'};