/** dino_module_3276 — dino_physics_jump extended, humanized desktop */
export interface In3276{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3276{y:number;vy:number;sc:number}
const C3276={g:0.6, j:12};
export function extraRender_3276(inp:In3276, dt:number):Out3276 {
...
export const mm3276={d:'dino_physics_jump'};