/** dino_module_4250 — dino_physics_jump extended, humanized desktop */
export interface In4250{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4250{y:number;vy:number;sc:number}
const C4250={g:0.6, j:11};
export function extraRender_4250(inp:In4250, dt:number):Out4250 {
...
export const mm4250={d:'dino_physics_jump'};