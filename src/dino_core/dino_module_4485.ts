/** dino_module_4485 — parallax_bg extended, humanized desktop */
export interface In4485{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4485{y:number;vy:number;sc:number}
const C4485={g:0.7, j:13};
export function extraSpawn_4485(inp:In4485, dt:number):Out4485 {
...
export const mm4485={d:'parallax_bg'};