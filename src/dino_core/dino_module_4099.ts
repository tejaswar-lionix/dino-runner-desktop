/** dino_module_4099 — collision_aabb extended, humanized desktop */
export interface In4099{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4099{y:number;vy:number;sc:number}
const C4099={g:0.7, j:12};
export function extraPhysics_4099(inp:In4099, dt:number):Out4099 {
...
export const mm4099={d:'collision_aabb'};