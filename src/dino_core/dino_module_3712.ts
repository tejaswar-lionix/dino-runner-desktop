/** dino_module_3712 — collision_aabb extended, humanized desktop */
export interface In3712{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3712{y:number;vy:number;sc:number}
const C3712={g:0.5, j:13};
export function extraRender_3712(inp:In3712, dt:number):Out3712 {
...
export const mm3712={d:'collision_aabb'};