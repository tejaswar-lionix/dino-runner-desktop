/** dino_module_4456 — parallax_bg extended, humanized desktop */
export interface In4456{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4456{y:number;vy:number;sc:number}
const C4456={g:0.7, j:13};
export function extraPhysics_4456(inp:In4456, dt:number):Out4456 {
...
export const mm4456={d:'parallax_bg'};