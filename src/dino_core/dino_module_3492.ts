/** dino_module_3492 — dino_physics_jump extended, humanized desktop */
export interface In3492{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3492{y:number;vy:number;sc:number}
const C3492={g:0.6, j:12};
export function extraSpawn_3492(inp:In3492, dt:number):Out3492 {
...
export const mm3492={d:'dino_physics_jump'};