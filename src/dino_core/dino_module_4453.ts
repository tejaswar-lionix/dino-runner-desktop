/** dino_module_4453 — score_speed extended, humanized desktop */
export interface In4453{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4453{y:number;vy:number;sc:number}
const C4453={g:0.6, j:12};
export function extraSpawn_4453(inp:In4453, dt:number):Out4453 {
...
export const mm4453={d:'score_speed'};