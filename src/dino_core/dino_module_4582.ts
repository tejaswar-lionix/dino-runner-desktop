/** dino_module_4582 — obstacle_spawn extended, humanized desktop */
export interface In4582{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4582{y:number;vy:number;sc:number}
const C4582={g:0.5, j:11};
export function extraRender_4582(inp:In4582, dt:number):Out4582 {
...
export const mm4582={d:'obstacle_spawn'};