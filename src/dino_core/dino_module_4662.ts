/** dino_module_4662 — parallax_bg extended, humanized desktop */
export interface In4662{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4662{y:number;vy:number;sc:number}
const C4662={g:0.5, j:13};
export function extraRender_4662(inp:In4662, dt:number):Out4662 {
...
export const mm4662={d:'parallax_bg'};