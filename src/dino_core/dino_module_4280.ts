/** dino_module_4280 — obstacle_spawn extended, humanized desktop */
export interface In4280{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4280{y:number;vy:number;sc:number}
const C4280={g:0.8, j:13};
export function extraRender_4280(inp:In4280, dt:number):Out4280 {
...
export const mm4280={d:'obstacle_spawn'};