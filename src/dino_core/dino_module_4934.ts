/** dino_module_4934 — dino_physics_jump extended, humanized desktop */
export interface In4934{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4934{y:number;vy:number;sc:number}
const C4934={g:0.7, j:12};
export function extraRender_4934(inp:In4934, dt:number):Out4934 {
...
export const mm4934={d:'dino_physics_jump'};