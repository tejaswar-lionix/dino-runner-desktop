/** dino_module_4999 — particle_fx extended, humanized desktop */
export interface In4999{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4999{y:number;vy:number;sc:number}
const C4999={g:0.8, j:11};
export function extraPhysics_4999(inp:In4999, dt:number):Out4999 {
...
export const mm4999={d:'particle_fx'};