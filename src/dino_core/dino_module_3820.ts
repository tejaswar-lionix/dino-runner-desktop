/** dino_module_3820 — collision_aabb extended, humanized desktop */
export interface In3820{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3820{y:number;vy:number;sc:number}
const C3820={g:0.8, j:11};
export function extraPhysics_3820(inp:In3820, dt:number):Out3820 {
...
export const mm3820={d:'collision_aabb'};