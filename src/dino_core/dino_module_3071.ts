/** dino_module_3071 — collision_aabb extended, humanized desktop */
export interface In3071{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3071{y:number;vy:number;sc:number}
const C3071={g:0.8, j:13};
export function extraSpawn_3071(inp:In3071, dt:number):Out3071 {
...
export const mm3071={d:'collision_aabb'};