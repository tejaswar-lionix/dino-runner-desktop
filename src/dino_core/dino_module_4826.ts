/** dino_module_4826 — obstacle_spawn extended, humanized desktop */
export interface In4826{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4826{y:number;vy:number;sc:number}
const C4826={g:0.7, j:11};
export function extraRender_4826(inp:In4826, dt:number):Out4826 {
...
export const mm4826={d:'obstacle_spawn'};