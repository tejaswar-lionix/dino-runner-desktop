/** dino_module_3388 — parallax_bg extended, humanized desktop */
export interface In3388{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3388{y:number;vy:number;sc:number}
const C3388={g:0.8, j:13};
export function extraRender_3388(inp:In3388, dt:number):Out3388 {
...
export const mm3388={d:'parallax_bg'};