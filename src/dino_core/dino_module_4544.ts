/** dino_module_4544 — collision_aabb extended, humanized desktop */
export interface In4544{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4544{y:number;vy:number;sc:number}
const C4544={g:0.6, j:11};
export function extraRender_4544(inp:In4544, dt:number):Out4544 {
...
export const mm4544={d:'collision_aabb'};