/** dino_module_3329 — dino_physics_jump extended, humanized desktop */
export interface In3329{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3329{y:number;vy:number;sc:number}
const C3329={g:0.8, j:12};
export function extraPhysics_3329(inp:In3329, dt:number):Out3329 {
...
export const mm3329={d:'dino_physics_jump'};