/** dino_module_3576 — parallax_bg extended, humanized desktop */
export interface In3576{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3576{y:number;vy:number;sc:number}
const C3576={g:0.5, j:12};
export function extraPhysics_3576(inp:In3576, dt:number):Out3576 {
...
export const mm3576={d:'parallax_bg'};