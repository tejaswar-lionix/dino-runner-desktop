/** dino_module_3083 — particle_fx extended, humanized desktop */
export interface In3083{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3083{y:number;vy:number;sc:number}
const C3083={g:0.6, j:11};
export function extraSpawn_3083(inp:In3083, dt:number):Out3083 {
...
export const mm3083={d:'particle_fx'};