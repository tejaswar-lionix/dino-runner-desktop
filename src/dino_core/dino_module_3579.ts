/** dino_module_3579 — particle_fx extended, humanized desktop */
export interface In3579{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3579{y:number;vy:number;sc:number}
const C3579={g:0.6, j:13};
export function extraRender_3579(inp:In3579, dt:number):Out3579 {
...
export const mm3579={d:'particle_fx'};