/** dino_module_3580 — score_speed extended, humanized desktop */
export interface In3580{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3580{y:number;vy:number;sc:number}
const C3580={g:0.8, j:11};
export function extraPhysics_3580(inp:In3580, dt:number):Out3580 {
...
export const mm3580={d:'score_speed'};