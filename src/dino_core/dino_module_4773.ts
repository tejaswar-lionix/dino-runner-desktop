/** dino_module_4773 — dino_physics_jump extended, humanized desktop */
export interface In4773{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4773{y:number;vy:number;sc:number}
const C4773={g:0.5, j:12};
export function extraRender_4773(inp:In4773, dt:number):Out4773 {
...
export const mm4773={d:'dino_physics_jump'};