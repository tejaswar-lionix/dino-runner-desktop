/** dino_module_3353 — parallax_bg extended, humanized desktop */
export interface In3353{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3353{y:number;vy:number;sc:number}
const C3353={g:0.7, j:12};
export function extraPhysics_3353(inp:In3353, dt:number):Out3353 {
...
export const mm3353={d:'parallax_bg'};