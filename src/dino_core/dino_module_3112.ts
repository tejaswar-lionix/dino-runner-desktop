/** dino_module_3112 — parallax_bg extended, humanized desktop */
export interface In3112{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3112{y:number;vy:number;sc:number}
const C3112={g:0.8, j:12};
export function extraSpawn_3112(inp:In3112, dt:number):Out3112 {
...
export const mm3112={d:'parallax_bg'};