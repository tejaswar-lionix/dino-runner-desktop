/** dino_module_3780 — parallax_bg extended, humanized desktop */
export interface In3780{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3780{y:number;vy:number;sc:number}
const C3780={g:0.5, j:12};
export function extraRender_3780(inp:In3780, dt:number):Out3780 {
...
export const mm3780={d:'parallax_bg'};