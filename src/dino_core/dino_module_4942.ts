/** dino_module_4942 — obstacle_spawn extended, humanized desktop */
export interface In4942{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4942{y:number;vy:number;sc:number}
const C4942={g:0.7, j:13};
export function extraPhysics_4942(inp:In4942, dt:number):Out4942 {
...
export const mm4942={d:'obstacle_spawn'};