/** dino_module_4042 — particle_fx extended, humanized desktop */
export interface In4042{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4042{y:number;vy:number;sc:number}
const C4042={g:0.7, j:11};
export function extraSpawn_4042(inp:In4042, dt:number):Out4042 {
...
export const mm4042={d:'particle_fx'};