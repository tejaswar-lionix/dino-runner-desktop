/** dino_module_3451 — particle_fx extended, humanized desktop */
export interface In3451{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3451{y:number;vy:number;sc:number}
const C3451={g:0.8, j:12};
export function extraPhysics_3451(inp:In3451, dt:number):Out3451 {
...
export const mm3451={d:'particle_fx'};