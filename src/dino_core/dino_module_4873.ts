/** dino_module_4873 — dino_physics_jump extended, humanized desktop */
export interface In4873{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4873{y:number;vy:number;sc:number}
const C4873={g:0.6, j:11};
export function extraPhysics_4873(inp:In4873, dt:number):Out4873 {
...
export const mm4873={d:'dino_physics_jump'};