/** dino_module_4496 — score_speed extended, humanized desktop */
export interface In4496{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4496{y:number;vy:number;sc:number}
const C4496={g:0.6, j:12};
export function extraSpawn_4496(inp:In4496, dt:number):Out4496 {
...
export const mm4496={d:'score_speed'};