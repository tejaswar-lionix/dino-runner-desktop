/** dino_module_3381 — score_speed extended, humanized desktop */
export interface In3381{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3381{y:number;vy:number;sc:number}
const C3381={g:0.7, j:11};
export function extraPhysics_3381(inp:In3381, dt:number):Out3381 {
...
export const mm3381={d:'score_speed'};