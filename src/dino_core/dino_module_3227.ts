/** dino_module_3227 — particle_fx extended, humanized desktop */
export interface In3227{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3227{y:number;vy:number;sc:number}
const C3227={g:0.6, j:11};
export function extraPhysics_3227(inp:In3227, dt:number):Out3227 {
...
export const mm3227={d:'particle_fx'};