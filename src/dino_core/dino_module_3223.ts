/** dino_module_3223 — parallax_bg extended, humanized desktop */
export interface In3223{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3223{y:number;vy:number;sc:number}
const C3223={g:0.6, j:11};
export function extraRender_3223(inp:In3223, dt:number):Out3223 {
...
export const mm3223={d:'parallax_bg'};