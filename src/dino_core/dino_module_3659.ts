/** dino_module_3659 — parallax_bg extended, humanized desktop */
export interface In3659{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3659{y:number;vy:number;sc:number}
const C3659={g:0.5, j:13};
export function extraPhysics_3659(inp:In3659, dt:number):Out3659 {
...
export const mm3659={d:'parallax_bg'};