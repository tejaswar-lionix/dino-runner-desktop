/** dino_module_4986 — particle_fx extended, humanized desktop */
export interface In4986{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4986{y:number;vy:number;sc:number}
const C4986={g:0.5, j:12};
export function extraSpawn_4986(inp:In4986, dt:number):Out4986 {
...
export const mm4986={d:'particle_fx'};