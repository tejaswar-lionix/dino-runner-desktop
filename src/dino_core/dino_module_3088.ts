/** dino_module_3088 — particle_fx extended, humanized desktop */
export interface In3088{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3088{y:number;vy:number;sc:number}
const C3088={g:0.7, j:13};
export function extraRender_3088(inp:In3088, dt:number):Out3088 {
...
export const mm3088={d:'particle_fx'};