/** dino_module_3326 — score_speed extended, humanized desktop */
export interface In3326{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3326{y:number;vy:number;sc:number}
const C3326={g:0.7, j:12};
export function extraRender_3326(inp:In3326, dt:number):Out3326 {
...
export const mm3326={d:'score_speed'};