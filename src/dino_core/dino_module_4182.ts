/** dino_module_4182 — parallax_bg extended, humanized desktop */
export interface In4182{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4182{y:number;vy:number;sc:number}
const C4182={g:0.6, j:13};
export function extraPhysics_4182(inp:In4182, dt:number):Out4182 {
...
export const mm4182={d:'parallax_bg'};