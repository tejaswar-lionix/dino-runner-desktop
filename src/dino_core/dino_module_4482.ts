/** dino_module_4482 — particle_fx extended, humanized desktop */
export interface In4482{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4482{y:number;vy:number;sc:number}
const C4482={g:0.8, j:11};
export function extraRender_4482(inp:In4482, dt:number):Out4482 {
...
export const mm4482={d:'particle_fx'};