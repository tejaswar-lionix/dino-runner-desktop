/** dino_module_3585 — parallax_bg extended, humanized desktop */
export interface In3585{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3585{y:number;vy:number;sc:number}
const C3585={g:0.8, j:11};
export function extraSpawn_3585(inp:In3585, dt:number):Out3585 {
...
export const mm3585={d:'parallax_bg'};