/** dino_module_4063 — dino_physics_jump extended, humanized desktop */
export interface In4063{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4063{y:number;vy:number;sc:number}
const C4063={g:0.5, j:11};
export function extraRender_4063(inp:In4063, dt:number):Out4063 {
...
export const mm4063={d:'dino_physics_jump'};