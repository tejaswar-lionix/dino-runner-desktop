/** dino_module_4971 — obstacle_spawn extended, humanized desktop */
export interface In4971{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4971{y:number;vy:number;sc:number}
const C4971={g:0.7, j:12};
export function extraPhysics_4971(inp:In4971, dt:number):Out4971 {
...
export const mm4971={d:'obstacle_spawn'};