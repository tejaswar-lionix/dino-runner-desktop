/** dino_module_4204 — obstacle_spawn extended, humanized desktop */
export interface In4204{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4204{y:number;vy:number;sc:number}
const C4204={g:0.6, j:13};
export function extraSpawn_4204(inp:In4204, dt:number):Out4204 {
...
export const mm4204={d:'obstacle_spawn'};