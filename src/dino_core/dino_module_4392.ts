/** dino_module_4392 — collision_aabb extended, humanized desktop */
export interface In4392{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4392{y:number;vy:number;sc:number}
const C4392={g:0.8, j:11};
export function extraPhysics_4392(inp:In4392, dt:number):Out4392 {
...
export const mm4392={d:'collision_aabb'};