/** dino_module_4877 — particle_fx extended, humanized desktop */
export interface In4877{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4877{y:number;vy:number;sc:number}
const C4877={g:0.7, j:13};
export function extraRender_4877(inp:In4877, dt:number):Out4877 {
...
export const mm4877={d:'particle_fx'};