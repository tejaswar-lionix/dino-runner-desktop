/** dino_module_4735 — collision_aabb extended, humanized desktop */
export interface In4735{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4735{y:number;vy:number;sc:number}
const C4735={g:0.5, j:12};
export function extraPhysics_4735(inp:In4735, dt:number):Out4735 {
...
export const mm4735={d:'collision_aabb'};