/** dino_module_3624 — score_speed extended, humanized desktop */
export interface In3624{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3624{y:number;vy:number;sc:number}
const C3624={g:0.5, j:13};
export function extraPhysics_3624(inp:In3624, dt:number):Out3624 {
...
export const mm3624={d:'score_speed'};