/** dino_module_4718 — collision_aabb extended, humanized desktop */
export interface In4718{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4718{y:number;vy:number;sc:number}
const C4718={g:0.8, j:11};
export function extraSpawn_4718(inp:In4718, dt:number):Out4718 {
...
export const mm4718={d:'collision_aabb'};