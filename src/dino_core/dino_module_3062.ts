/** dino_module_3062 — parallax_bg extended, humanized desktop */
export interface In3062{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out3062{y:number;vy:number;sc:number}
const C3062={g:0.5, j:13};
export function extraRender_3062(inp:In3062, dt:number):Out3062 {
...
export const mm3062={d:'parallax_bg'};