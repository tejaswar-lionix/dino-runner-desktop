/** dino_module_4038 — obstacle_spawn extended, humanized desktop */
export interface In4038{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4038{y:number;vy:number;sc:number}
const C4038={g:0.5, j:13};
export function extraPhysics_4038(inp:In4038, dt:number):Out4038 {
...
export const mm4038={d:'obstacle_spawn'};