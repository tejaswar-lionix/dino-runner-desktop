/** dino_module_4991 — particle_fx extended, humanized desktop */
export interface In4991{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4991{y:number;vy:number;sc:number}
const C4991={g:0.7, j:13};
export function extraPhysics_4991(inp:In4991, dt:number):Out4991 {
...
export const mm4991={d:'particle_fx'};