/** dino_module_4846 — parallax_bg extended, humanized desktop */
export interface In4846{x:number;y:number;vy:number;spd:number;seed:number}
export interface Out4846{y:number;vy:number;sc:number}
const C4846={g:0.6, j:13};
export function extraRender_4846(inp:In4846, dt:number):Out4846 {
...
export const mm4846={d:'parallax_bg'};